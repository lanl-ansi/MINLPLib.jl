...
set_lower_bound(x[2], 30.0)
set_upper_bound(x[2], 100.0)
set_lower_bound(x[3], 30.0)
set_upper_bound(x[3], 100.0)
set_lower_bound(x[4], 30.0)
set_upper_bound(x[4], 100.0)
set_lower_bound(x[5], 30.0)
set_upper_bound(x[5], 100.0)
set_lower_bound(x[6], 30.0)
set_upper_bound(x[6], 100.0)
set_lower_bound(x[7], 30.0)
set_upper_bound(x[7], 100.0)
set_lower_bound(x[8], 30.0)
set_upper_bound(x[8], 100.0)
set_lower_bound(x[9], 30.0)
set_upper_bound(x[9], 100.0)
set_lower_bound(x[10], 30.0)
set_upper_bound(x[10], 100.0)
set_lower_bound(x[11], 30.0)
set_upper_bound(x[11], 100.0)
set_lower_bound(x[12], 30.0)
set_upper_bound(x[12], 100.0)
set_lower_bound(x[13], 30.0)
set_upper_bound(x[13], 100.0)
set_lower_bound(x[14], 30.0)
set_upper_bound(x[14], 100.0)
set_lower_bound(x[15], 30.0)
set_upper_bound(x[15], 100.0)
set_lower_bound(x[16], 30.0)
set_upper_bound(x[16], 100.0)
set_lower_bound(x[17], 30.0)
set_upper_bound(x[17], 100.0)
set_lower_bound(x[18], 30.0)
set_upper_bound(x[18], 100.0)
set_lower_bound(x[19], 30.0)
set_upper_bound(x[19], 100.0)
set_lower_bound(x[20], 30.0)
set_upper_bound(x[20], 100.0)
set_lower_bound(x[21], 30.0)
set_upper_bound(x[21], 100.0)
set_lower_bound(x[22], 30.0)
set_upper_bound(x[22], 100.0)
set_lower_bound(x[23], 30.0)
set_upper_bound(x[23], 100.0)
set_lower_bound(x[24], 30.0)
set_upper_bound(x[24], 100.0)
set_lower_bound(x[25], 30.0)
set_upper_bound(x[25], 100.0)
set_lower_bound(x[26], 30.0)
set_upper_bound(x[26], 100.0)
set_lower_bound(x[27], 30.0)
set_upper_bound(x[27], 100.0)
set_lower_bound(x[28], 30.0)
set_upper_bound(x[28], 100.0)
set_lower_bound(x[29], 30.0)
set_upper_bound(x[29], 100.0)
set_lower_bound(x[30], 30.0)
set_upper_bound(x[30], 100.0)
set_lower_bound(x[31], 30.0)
set_upper_bound(x[31], 100.0)
set_lower_bound(x[32], 30.0)
set_upper_bound(x[32], 100.0)
set_lower_bound(x[67], 0.0729658769900397)
set_upper_bound(x[67], 0.810731966555996)
set_lower_bound(x[68], 0.0729658769900397)
set_upper_bound(x[68], 0.810731966555996)
set_lower_bound(x[69], 0.0729658769900397)
set_upper_bound(x[69], 0.810731966555996)
set_lower_bound(x[70], 0.0729658769900397)
set_upper_bound(x[70], 0.810731966555996)
set_lower_bound(x[71], 0.0729658769900397)
set_upper_bound(x[71], 0.810731966555996)
set_lower_bound(x[72], 0.0729658769900397)
set_upper_bound(x[72], 0.810731966555996)
set_lower_bound(x[73], 0.0729658769900397)
set_upper_bound(x[73], 0.810731966555996)
set_lower_bound(x[74], 0.0729658769900397)
set_upper_bound(x[74], 0.810731966555996)
set_lower_bound(x[75], 0.0729658769900397)
set_upper_bound(x[75], 0.810731966555996)
set_lower_bound(x[76], 0.0729658769900397)
set_upper_bound(x[76], 0.810731966555996)
set_lower_bound(x[77], 0.0729658769900397)
set_upper_bound(x[77], 0.810731966555996)
set_lower_bound(x[78], 0.0729658769900397)
set_upper_bound(x[78], 0.810731966555996)
set_lower_bound(x[79], 0.0729658769900397)
set_upper_bound(x[79], 0.810731966555996)
set_lower_bound(x[80], 0.0729658769900397)
set_upper_bound(x[80], 0.810731966555996)
set_lower_bound(x[81], 0.0729658769900397)
set_upper_bound(x[81], 0.810731966555996)
set_lower_bound(x[82], 0.0729658769900397)
set_upper_bound(x[82], 0.810731966555996)
set_lower_bound(x[83], 0.0729658769900397)
set_upper_bound(x[83], 0.810731966555996)
set_lower_bound(x[84], 0.0729658769900397)
set_upper_bound(x[84], 0.810731966555996)
set_lower_bound(x[85], 0.0729658769900397)
set_upper_bound(x[85], 0.810731966555996)
set_lower_bound(x[86], 0.0729658769900397)
set_upper_bound(x[86], 0.810731966555996)
set_lower_bound(x[87], 0.0729658769900397)
set_upper_bound(x[87], 0.810731966555996)
set_lower_bound(x[88], 0.0729658769900397)
set_upper_bound(x[88], 0.810731966555996)
set_lower_bound(x[89], 0.0729658769900397)
set_upper_bound(x[89], 0.810731966555996)
set_lower_bound(x[90], 0.0729658769900397)
set_upper_bound(x[90], 0.810731966555996)
set_lower_bound(x[91], 0.0729658769900397)
set_upper_bound(x[91], 0.810731966555996)
set_lower_bound(x[92], 0.0729658769900397)
set_upper_bound(x[92], 0.810731966555996)
set_lower_bound(x[93], 0.0729658769900397)
set_upper_bound(x[93], 0.810731966555996)
set_lower_bound(x[94], 0.0729658769900397)
set_upper_bound(x[94], 0.810731966555996)
set_lower_bound(x[95], 0.0729658769900397)
set_upper_bound(x[95], 0.810731966555996)
set_lower_bound(x[96], 0.0729658769900397)
set_upper_bound(x[96], 0.810731966555996)
set_lower_bound(x[97], 0.0729658769900397)
set_upper_bound(x[97], 0.810731966555996)
set_lower_bound(x[98], 0.0729658769900397)
set_upper_bound(x[98], 0.810731966555996)
set_lower_bound(x[99], 0.0729658769900397)
set_upper_bound(x[99], 0.810731966555996)
set_lower_bound(x[100], 0.0729658769900397)
set_upper_bound(x[100], 0.810731966555996)
...
@NLconstraint(m, e33, sign(x[33]) * (abs(x[33]))^1.852 -7.6849192909955*(1.27323954473516*x[67])^2.435*(x[1]-x[2]) == 0.0)
@NLconstraint(m, e34, sign(x[34]) * (abs(x[34]))^1.852 -0.569253280814482*(1.27323954473516*x[68])^2.435*(x[2]-x[3]) == 0.0)
@NLconstraint(m, e35, sign(x[35]) * (abs(x[35]))^1.852 -0.853879921221723*(1.27323954473516*x[69])^2.435*(x[3]-x[4]) == 0.0)
@NLconstraint(m, e36, sign(x[36]) * (abs(x[36]))^1.852 -0.349314513227068*(1.27323954473516*x[70])^2.435*(x[3]-x[20]) == 0.0)
@NLconstraint(m, e37, sign(x[37]) * (abs(x[37]))^1.852 -0.668253851390913*(1.27323954473516*x[71])^2.435*(x[4]-x[5]) == 0.0)
@NLconstraint(m, e38, sign(x[38]) * (abs(x[38]))^1.852 -0.529994433861759*(1.27323954473516*x[72])^2.435*(x[5]-x[6]) == 0.0)
@NLconstraint(m, e39, sign(x[39]) * (abs(x[39]))^1.852 -1.70775984244345*(1.27323954473516*x[73])^2.435*(x[6]-x[7]) == 0.0)
@NLconstraint(m, e40, sign(x[40]) * (abs(x[40]))^1.852 -0.904108151881824*(1.27323954473516*x[74])^2.435*(x[7]-x[8]) == 0.0)
@NLconstraint(m, e41, sign(x[41]) * (abs(x[41]))^1.852 -0.904108151881824*(1.27323954473516*x[75])^2.435*(x[8]-x[9]) == 0.0)
@NLconstraint(m, e42, sign(x[42]) * (abs(x[42]))^1.852 -0.960614911374438*(1.27323954473516*x[76])^2.435*(x[9]-x[10]) == 0.0)
@NLconstraint(m, e43, sign(x[43]) * (abs(x[43]))^1.852 -0.808938872736369*(1.27323954473516*x[77])^2.435*(x[10]-x[11]) == 0.0)
@NLconstraint(m, e44, sign(x[44]) * (abs(x[44]))^1.852 -0.960614911374438*(1.27323954473516*x[78])^2.435*(x[10]-x[14]) == 0.0)
@NLconstraint(m, e45, sign(x[45]) * (abs(x[45]))^1.852 -0.640409940916292*(1.27323954473516*x[79])^2.435*(x[11]-x[12]) == 0.0)
@NLconstraint(m, e46, sign(x[46]) * (abs(x[46]))^1.852 -0.219569122599872*(1.27323954473516*x[80])^2.435*(x[12]-x[13]) == 0.0)
@NLconstraint(m, e47, sign(x[47]) * (abs(x[47]))^1.852 -1.5369838581991*(1.27323954473516*x[81])^2.435*(x[14]-x[15]) == 0.0)
@NLconstraint(m, e48, sign(x[48]) * (abs(x[48]))^1.852 -1.39725805290827*(1.27323954473516*x[82])^2.435*(x[15]-x[16]) == 0.0)
@NLconstraint(m, e49, sign(x[49]) * (abs(x[49]))^1.852 -0.28149887512804*(1.27323954473516*x[83])^2.435*(x[16]-x[17]) == 0.0)
@NLconstraint(m, e50, sign(x[50]) * (abs(x[50]))^1.852 -0.439138245199743*(1.27323954473516*x[84])^2.435*(x[17]-x[18]) == 0.0)
@NLconstraint(m, e51, sign(x[51]) * (abs(x[51]))^1.852 -0.960614911374438*(1.27323954473516*x[85])^2.435*(x[18]-x[19]) == 0.0)
@NLconstraint(m, e52, sign(x[52]) * (abs(x[52]))^1.852 -1.92122982274888*(1.27323954473516*x[86])^2.435*(x[19]-x[3]) == 0.0)
@NLconstraint(m, e53, sign(x[53]) * (abs(x[53]))^1.852 -0.512327952733034*(1.27323954473516*x[87])^2.435*(x[20]-x[21]) == 0.0)
@NLconstraint(m, e54, sign(x[54]) * (abs(x[54]))^1.852 -0.289996954377189*(1.27323954473516*x[88])^2.435*(x[20]-x[23]) == 0.0)
@NLconstraint(m, e55, sign(x[55]) * (abs(x[55]))^1.852 -1.5369838581991*(1.27323954473516*x[89])^2.435*(x[21]-x[22]) == 0.0)
@NLconstraint(m, e56, sign(x[56]) * (abs(x[56]))^1.852 -0.624790186259797*(1.27323954473516*x[90])^2.435*(x[23]-x[24]) == 0.0)
@NLconstraint(m, e57, sign(x[57]) * (abs(x[57]))^1.852 -0.512327952733034*(1.27323954473516*x[91])^2.435*(x[23]-x[28]) == 0.0)
@NLconstraint(m, e58, sign(x[58]) * (abs(x[58]))^1.852 -0.591147637768885*(1.27323954473516*x[92])^2.435*(x[24]-x[25]) == 0.0)
@NLconstraint(m, e59, sign(x[59]) * (abs(x[59]))^1.852 -0.904108151881824*(1.27323954473516*x[93])^2.435*(x[25]-x[26]) == 0.0)
@NLconstraint(m, e60, sign(x[60]) * (abs(x[60]))^1.852 -2.56163976366517*(1.27323954473516*x[94])^2.435*(x[26]-x[27]) == 0.0)
@NLconstraint(m, e61, sign(x[61]) * (abs(x[61]))^1.852 -1.02465590546607*(1.27323954473516*x[95])^2.435*(x[27]-x[16]) == 0.0)
@NLconstraint(m, e62, sign(x[62]) * (abs(x[62]))^1.852 -0.384245964549775*(1.27323954473516*x[96])^2.435*(x[28]-x[29]) == 0.0)
@NLconstraint(m, e63, sign(x[63]) * (abs(x[63]))^1.852 -0.480307455687219*(1.27323954473516*x[97])^2.435*(x[29]-x[30]) == 0.0)
@NLconstraint(m, e64, sign(x[64]) * (abs(x[64]))^1.852 -5.12327952733034*(1.27323954473516*x[98])^2.435*(x[30]-x[31]) == 0.0)
@NLconstraint(m, e65, sign(x[65]) * (abs(x[65]))^1.852 -0.893595266394826*(1.27323954473516*x[99])^2.435*(x[31]-x[32]) == 0.0)
@NLconstraint(m, e66, sign(x[66]) * (abs(x[66]))^1.852 -0.808938872736369*(1.27323954473516*x[100])^2.435*(x[32]-x[25]) == 0.0)
