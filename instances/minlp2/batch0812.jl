...
setupperbound(x[1], 1.6094379124341)
setupperbound(x[2], 1.6094379124341)
setupperbound(x[3], 1.6094379124341)
setupperbound(x[4], 1.6094379124341)
setupperbound(x[5], 1.6094379124341)
setupperbound(x[6], 1.6094379124341)
setupperbound(x[7], 1.6094379124341)
setupperbound(x[8], 1.6094379124341)
setupperbound(x[9], 1.6094379124341)
setupperbound(x[10], 1.6094379124341)
setupperbound(x[11], 1.6094379124341)
setupperbound(x[12], 1.6094379124341)
setlowerbound(x[13], 5.7037824746562)
setupperbound(x[13], 8.00636756765025)
setlowerbound(x[14], 5.7037824746562)
setupperbound(x[14], 8.00636756765025)
setlowerbound(x[15], 5.7037824746562)
setupperbound(x[15], 8.00636756765025)
setlowerbound(x[16], 5.7037824746562)
setupperbound(x[16], 8.00636756765025)
setlowerbound(x[17], 5.7037824746562)
setupperbound(x[17], 8.00636756765025)
setlowerbound(x[18], 5.7037824746562)
setupperbound(x[18], 8.00636756765025)
setlowerbound(x[19], 5.7037824746562)
setupperbound(x[19], 8.00636756765025)
setlowerbound(x[20], 5.7037824746562)
setupperbound(x[20], 8.00636756765025)
setlowerbound(x[21], 5.7037824746562)
setupperbound(x[21], 8.00636756765025)
setlowerbound(x[22], 5.7037824746562)
setupperbound(x[22], 8.00636756765025)
setlowerbound(x[23], 5.7037824746562)
setupperbound(x[23], 8.00636756765025)
setlowerbound(x[24], 5.7037824746562)
setupperbound(x[24], 8.00636756765025)
setlowerbound(x[25], 4.89920702407788)
setupperbound(x[25], 5.93950480817727)
setlowerbound(x[26], 4.2094573693226)
setupperbound(x[26], 6.78259213602813)
setlowerbound(x[27], 4.8436620142491)
setupperbound(x[27], 6.4803112641552)
setlowerbound(x[28], 3.49701248447645)
setupperbound(x[28], 6.45880505893423)
setlowerbound(x[29], 4.2336716274432)
setupperbound(x[29], 6.50229017087397)
setlowerbound(x[30], 3.62545142726039)
setupperbound(x[30], 6.08944495546819)
setlowerbound(x[31], 3.74336763939801)
setupperbound(x[31], 6.35770894206286)
setlowerbound(x[32], 3.03415138345794)
setupperbound(x[32], 7.21791020728598)
setlowerbound(x[33], 0.506817602368452)
setupperbound(x[33], 2.11625551480255)
setlowerbound(x[34], 0.307484699747961)
setupperbound(x[34], 1.91692261218206)
setlowerbound(x[35], 0.867100487683383)
setupperbound(x[35], 2.47653840011748)
setlowerbound(x[36], -0.356674943938732)
setupperbound(x[36], 1.25276296849537)
setlowerbound(x[37], 0.131028262406404)
setupperbound(x[37], 1.7404661748405)
setlowerbound(x[38], -0.162518929497775)
setupperbound(x[38], 1.44691898293633)
setlowerbound(x[39], -0.127833371509885)
setupperbound(x[39], 1.48160454092422)
setlowerbound(x[40], -0.150822889734584)
setupperbound(x[40], 1.45861502269952)


# ----- Constraints ----- #
@NLconstraint(m, e1, -(250*exp(x[1]+0.6*x[13])+550*exp(x[2]+0.6*x[14])+250*exp(x[3]+0.6*x[15])+1000*exp(x[4]+0.6*x[16])+300*exp(x[5]+0.6*x[17])+800*exp(x[6]+0.6*x[18])+200*exp(x[7]+0.6*x[19])+1200*exp(x[8]+0.6*x[20])+250*exp(x[9]+0.6*x[21])+250*exp(x[10]+0.6*x[22])+450*exp(x[11]+0.6*x[23])+700*exp(x[12]+0.6*x[24]))+objvar == 0.0)
