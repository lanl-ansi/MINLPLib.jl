...
@variable(m, x[x_Idx])
setlowerbound(x[1], -18.999999)
setupperbound(x[1], 18.999999)
setlowerbound(x[2], -18.999999)
setupperbound(x[2], 18.999999)
setlowerbound(x[3], -18.999999)
setupperbound(x[3], 18.999999)
setlowerbound(x[4], -18.999999)
setupperbound(x[4], 18.999999)
setlowerbound(x[5], -18.999999)
setupperbound(x[5], 18.999999)
setlowerbound(x[6], -18.999999)
setupperbound(x[6], 18.999999)
setlowerbound(x[7], -18.999999)
setupperbound(x[7], 18.999999)
setlowerbound(x[8], -18.999999)
setupperbound(x[8], 18.999999)
setlowerbound(x[9], -18.999999)
setupperbound(x[9], 18.999999)
setlowerbound(x[10], -18.999999)
setupperbound(x[10], 18.999999)
setlowerbound(x[11], -18.999999)
setupperbound(x[11], 18.999999)
setlowerbound(x[12], -18.999999)
setupperbound(x[12], 18.999999)
setlowerbound(x[13], -18.999999)
setupperbound(x[13], 18.999999)
setlowerbound(x[14], -18.999999)
setupperbound(x[14], 18.999999)
setlowerbound(x[15], -18.999999)
setupperbound(x[15], 18.999999)
setlowerbound(x[16], -18.999999)
setupperbound(x[16], 18.999999)
