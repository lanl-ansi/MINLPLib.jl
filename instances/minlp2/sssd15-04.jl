...
@NLconstraint(m, e37, -x[73]/(1+x[73])+x[77] <= 0.0)
@NLconstraint(m, e38, -x[73]/(1+x[73])+x[78] <= 0.0)
@NLconstraint(m, e39, -x[73]/(1+x[73])+x[79] <= 0.0)
@NLconstraint(m, e40, -x[74]/(1+x[74])+x[80] <= 0.0)
@NLconstraint(m, e41, -x[74]/(1+x[74])+x[81] <= 0.0)
@NLconstraint(m, e42, -x[74]/(1+x[74])+x[82] <= 0.0)
@NLconstraint(m, e43, -x[75]/(1+x[75])+x[83] <= 0.0)
@NLconstraint(m, e44, -x[75]/(1+x[75])+x[84] <= 0.0)
@NLconstraint(m, e45, -x[75]/(1+x[75])+x[85] <= 0.0)
@NLconstraint(m, e46, -x[76]/(1+x[76])+x[86] <= 0.0)
@NLconstraint(m, e47, -x[76]/(1+x[76])+x[87] <= 0.0)
@NLconstraint(m, e48, -x[76]/(1+x[76])+x[88] <= 0.0)
