...
set_upper_bound(x[1], 350.0)
set_lower_bound(x[2], 10.0)
set_upper_bound(x[2], 350.0)
...
set_upper_bound(x[13], 310.0)
set_lower_bound(x[14], 150.0)
set_upper_bound(x[14], 310.0)
set_lower_bound(x[15], 150.0)
set_upper_bound(x[15], 310.0)
set_lower_bound(x[16], 150.0)
set_upper_bound(x[16], 310.0)
