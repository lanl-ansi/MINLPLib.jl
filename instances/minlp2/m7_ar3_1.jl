...
setupperbound(x[58], 6.4807)
setlowerbound(x[59], 2.0)
setupperbound(x[59], 5.4772)
setlowerbound(x[60], 2.1602)
setupperbound(x[60], 5.0)
setlowerbound(x[61], 1.8257)
setupperbound(x[61], 5.0)
setlowerbound(x[62], 1.8)
setupperbound(x[62], 5.1962)
setlowerbound(x[64], 1.7321)
setupperbound(x[64], 5.0)
setlowerbound(x[66], 1.4142)
setupperbound(x[66], 4.2426)
setlowerbound(x[68], 1.4142)
setupperbound(x[68], 4.2426)
setlowerbound(x[70], 2.0)
setupperbound(x[70], 5.4772)
setlowerbound(x[72], 1.8257)
setupperbound(x[72], 5.0)
setlowerbound(x[74], 5.0)
setupperbound(x[74], 8.6603)
setlowerbound(x[76], 2.8868)
setupperbound(x[76], 5.0)
setlowerbound(x[78], 5.0)
setupperbound(x[78], 8.6603)
setlowerbound(x[80], 2.8868)
...
@constraint(m, e48, -0.154304*x[58]-0.462907*x[60] <= -2.0)
@constraint(m, e49, -0.5*x[59]-0.2*x[61] <= -2.0)
@constraint(m, e50, -0.182575*x[59]-0.54772*x[61] <= -2.0)
@constraint(m, e51, -0.555556*x[62]-0.2*x[64] <= -2.0)
@constraint(m, e52, -0.192448*x[62]-0.577356*x[64] <= -2.0)
@constraint(m, e53, -0.707114*x[66]-0.2357*x[68] <= -2.0)
@constraint(m, e54, -0.235705*x[66]-0.7071*x[68] <= -2.0)
@constraint(m, e55, -0.5*x[70]-0.2*x[72] <= -2.0)
@constraint(m, e56, -0.182575*x[70]-0.54772*x[72] <= -2.0)
@constraint(m, e57, -0.2*x[74]-0.2*x[76] <= -2.0)
@constraint(m, e58, -0.115469*x[74]-0.346412*x[76] <= -2.0)
@constraint(m, e59, -0.2*x[78]-0.2*x[80] <= -2.0)
@constraint(m, e60, -0.115469*x[78]-0.346412*x[80] <= -2.0)
