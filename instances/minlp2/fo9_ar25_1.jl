...
setlowerbound(x[94], 2.5298)
setupperbound(x[94], 6.3246)
setlowerbound(x[95], 2.5298)
setupperbound(x[95], 6.3246)
setlowerbound(x[96], 2.5298)
setupperbound(x[96], 6.3246)
setlowerbound(x[97], 2.5298)
setupperbound(x[97], 6.3246)
setlowerbound(x[98], 2.5298)
setupperbound(x[98], 6.3246)
setlowerbound(x[100], 2.5298)
setupperbound(x[100], 6.3246)
setlowerbound(x[102], 3.7947)
setupperbound(x[102], 9.4868)
setlowerbound(x[104], 3.7947)
setupperbound(x[104], 9.4868)
setlowerbound(x[106], 3.7947)
setupperbound(x[106], 9.4868)
setlowerbound(x[108], 3.7947)
setupperbound(x[108], 9.4868)
setlowerbound(x[110], 1.8974)
setupperbound(x[110], 4.7434)
setlowerbound(x[112], 1.8974)
setupperbound(x[112], 4.7434)
setlowerbound(x[114], 1.8974)
setupperbound(x[114], 4.7434)
setlowerbound(x[116], 1.8974)
setupperbound(x[116], 4.7434)
setlowerbound(x[118], 1.8974)
setupperbound(x[118], 4.7434)
setlowerbound(x[120], 1.8974)
setupperbound(x[120], 4.7434)
setlowerbound(x[122], 1.8974)
setupperbound(x[122], 4.7434)
setlowerbound(x[124], 1.8974)
setupperbound(x[124], 4.7434)
