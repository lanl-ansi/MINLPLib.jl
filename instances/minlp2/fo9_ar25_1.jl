...
set_upper_bound(i[71], 100.0)
set_upper_bound(i[72], 100.0)
set_lower_bound(x[94], 2.5298)
set_upper_bound(x[94], 6.3246)
set_lower_bound(x[95], 2.5298)
set_upper_bound(x[95], 6.3246)
set_lower_bound(x[96], 2.5298)
set_upper_bound(x[96], 6.3246)
set_lower_bound(x[97], 2.5298)
set_upper_bound(x[97], 6.3246)
set_lower_bound(x[98], 2.5298)
set_upper_bound(x[98], 6.3246)
set_lower_bound(x[100], 2.5298)
set_upper_bound(x[100], 6.3246)
set_lower_bound(x[102], 3.7947)
set_upper_bound(x[102], 9.4868)
set_lower_bound(x[104], 3.7947)
set_upper_bound(x[104], 9.4868)
set_lower_bound(x[106], 3.7947)
set_upper_bound(x[106], 9.4868)
set_lower_bound(x[108], 3.7947)
set_upper_bound(x[108], 9.4868)
set_lower_bound(x[110], 1.8974)
set_upper_bound(x[110], 4.7434)
set_lower_bound(x[112], 1.8974)
set_upper_bound(x[112], 4.7434)
set_lower_bound(x[114], 1.8974)
set_upper_bound(x[114], 4.7434)
set_lower_bound(x[116], 1.8974)
set_upper_bound(x[116], 4.7434)
set_lower_bound(x[118], 1.8974)
set_upper_bound(x[118], 4.7434)
set_lower_bound(x[120], 1.8974)
set_upper_bound(x[120], 4.7434)
set_lower_bound(x[122], 1.8974)
set_upper_bound(x[122], 4.7434)
set_lower_bound(x[124], 1.8974)
set_upper_bound(x[124], 4.7434)
...
@constraint(m, e77, -0.395288*x[94]-0.158112*x[96] <= -2.0)
@constraint(m, e78, -0.158113*x[94]-0.395288*x[96] <= -2.0)
@constraint(m, e79, -0.395288*x[95]-0.158112*x[97] <= -2.0)
@constraint(m, e80, -0.158113*x[95]-0.395288*x[97] <= -2.0)
@constraint(m, e81, -0.395288*x[98]-0.158112*x[100] <= -2.0)
@constraint(m, e82, -0.158113*x[98]-0.395288*x[100] <= -2.0)
@constraint(m, e83, -0.263525*x[102]-0.105408*x[104] <= -2.0)
@constraint(m, e84, -0.10541*x[102]-0.263522*x[104] <= -2.0)
@constraint(m, e85, -0.263525*x[106]-0.105408*x[108] <= -2.0)
@constraint(m, e86, -0.10541*x[106]-0.263522*x[108] <= -2.0)
@constraint(m, e87, -0.527037*x[110]-0.210822*x[112] <= -2.0)
@constraint(m, e88, -0.210819*x[110]-0.527044*x[112] <= -2.0)
@constraint(m, e89, -0.527037*x[114]-0.210822*x[116] <= -2.0)
@constraint(m, e90, -0.210819*x[114]-0.527044*x[116] <= -2.0)
@constraint(m, e91, -0.527037*x[118]-0.210822*x[120] <= -2.0)
@constraint(m, e92, -0.210819*x[118]-0.527044*x[120] <= -2.0)
@constraint(m, e93, -0.527037*x[122]-0.210822*x[124] <= -2.0)
@constraint(m, e94, -0.210819*x[122]-0.527044*x[124] <= -2.0)
