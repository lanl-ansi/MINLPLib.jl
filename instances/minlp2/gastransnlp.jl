...
@NLconstraint(m, e21, sign(x[1]) * (abs(x[1]))^2+8.99076279639866*x[51]-8.99076279639866*x[63] == 0.0)
@NLconstraint(m, e22, sign(x[2]) * (abs(x[2]))^2+8.99076279639866*x[51]-8.99076279639866*x[63] == 0.0)
@NLconstraint(m, e23, sign(x[3]) * (abs(x[3]))^2+5.99384186426577*x[50]-5.99384186426577*x[51] == 0.0)
@NLconstraint(m, e24, sign(x[4]) * (abs(x[4]))^2+5.99384186426577*x[50]-5.99384186426577*x[51] == 0.0)
@NLconstraint(m, e25, sign(x[5]) * (abs(x[5]))^2-1.38319427636902*x[50]+1.38319427636902*x[64] == 0.0)
@NLconstraint(m, e26, sign(x[6]) * (abs(x[6]))^2+0.0993769948466698*x[46]-0.0993769948466698*x[54] == 0.0)
@NLconstraint(m, e27, sign(x[7]) * (abs(x[7]))^2-0.147352095807131*x[46]+0.147352095807131*x[52] == 0.0)
@NLconstraint(m, e28, sign(x[8]) * (abs(x[8]))^2-0.224905830442463*x[52]+0.224905830442463*x[64] == 0.0)
@NLconstraint(m, e29, sign(x[9]) * (abs(x[9]))^2+0.653873657919902*x[58]-0.653873657919902*x[64] == 0.0)
@NLconstraint(m, e30, sign(x[12]) * (abs(x[12]))^2-1.79815255927973*x[48]+1.79815255927973*x[53] == 0.0)
@NLconstraint(m, e31, sign(x[13]) * (abs(x[13]))^2-0.0265962529480588*x[48]+0.0265962529480588*x[53] == 0.0)
@NLconstraint(m, e32, sign(x[14]) * (abs(x[14]))^2-1.43852204742379*x[53]+1.43852204742379*x[62] == 0.0)
@NLconstraint(m, e33, sign(x[15]) * (abs(x[15]))^2-0.021277002358447*x[53]+0.021277002358447*x[62] == 0.0)
@NLconstraint(m, e34, sign(x[16]) * (abs(x[16]))^2+0.856263123466539*x[56]-0.856263123466539*x[62] == 0.0)
@NLconstraint(m, e35, sign(x[17]) * (abs(x[17]))^2+0.899076279639866*x[45]-0.899076279639866*x[56] == 0.0)
@NLconstraint(m, e36, sign(x[18]) * (abs(x[18]))^2-7.19261023711893*x[45]+7.19261023711893*x[58] == 0.0)
@NLconstraint(m, e37, sign(x[19]) * (abs(x[19]))^2+3.59630511855946*x[55]-3.59630511855946*x[58] == 0.0)
@NLconstraint(m, e38, sign(x[20]) * (abs(x[20]))^2+1.43852204742379*x[49]-1.43852204742379*x[55] == 0.0)
@NLconstraint(m, e39, sign(x[21]) * (abs(x[21]))^2+0.0509935163731392*x[61]-0.0509935163731392*x[62] == 0.0)
@NLconstraint(m, e40, sign(x[23]) * (abs(x[23]))^2+0.0016882734118691*x[47]-0.0016882734118691*x[59] == 0.0)
@NLconstraint(m, e41, sign(x[24]) * (abs(x[24]))^2-0.0275751323938619*x[47]+0.0275751323938619*x[57] == 0.0)
