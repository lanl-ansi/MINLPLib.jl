...
setupperbound(x[25], 1.2)
setupperbound(x[26], -4.034)
setupperbound(x[27], -0.222)
setlowerbound(x[28], 0.0)
setupperbound(x[28], 0.0)
setupperbound(x[29], -15.616)
setupperbound(x[30], -3.918)
setupperbound(x[31], 8.4)
setupperbound(x[32], -5.256)
setupperbound(x[33], -6.385)
setupperbound(x[34], 4.8)
setupperbound(x[35], -6.848)
setupperbound(x[36], -2.12)
setupperbound(x[37], -1.919)
setupperbound(x[38], 0.96)
setlowerbound(x[39], 0.0)
setupperbound(x[39], 0.0)
setlowerbound(x[40], 20.344)
setupperbound(x[40], 22.012)
setlowerbound(x[41], 0.0)
setupperbound(x[41], 0.0)
setlowerbound(x[42], 0.0)
setupperbound(x[42], 0.0)
setlowerbound(x[43], 8.87)
setupperbound(x[43], 11.594)
setlowerbound(x[44], 0.0)
setupperbound(x[44], 0.0)
setupperbound(x[45], 4382.44)
setlowerbound(x[46], 900.0)
setupperbound(x[46], 6400.0)
setupperbound(x[47], 4382.44)
setupperbound(x[48], 4382.44)
setlowerbound(x[49], 2500.0)
setupperbound(x[49], 4382.44)
setlowerbound(x[50], 900.0)
setupperbound(x[50], 6400.0)
setupperbound(x[51], 5929.0)
setlowerbound(x[52], 900.0)
setupperbound(x[52], 6400.0)
setlowerbound(x[53], 900.0)
setupperbound(x[53], 4382.44)
setupperbound(x[54], 5929.0)
setupperbound(x[55], 4382.44)
setupperbound(x[56], 4382.44)
setlowerbound(x[57], 625.0)
setupperbound(x[57], 4382.44)
setupperbound(x[58], 4382.44)
setupperbound(x[59], 3969.0)
setlowerbound(x[60], 2500.0)
setupperbound(x[60], 4382.44)
setupperbound(x[61], 4382.44)
setupperbound(x[62], 4382.44)
setupperbound(x[63], 5929.0)
setupperbound(x[64], 6400.0)
