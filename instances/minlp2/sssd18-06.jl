...
@NLconstraint(m, e50, -x[127]/(1+x[127])+x[133] <= 0.0)
@NLconstraint(m, e51, -x[127]/(1+x[127])+x[134] <= 0.0)
@NLconstraint(m, e52, -x[127]/(1+x[127])+x[135] <= 0.0)
@NLconstraint(m, e53, -x[128]/(1+x[128])+x[136] <= 0.0)
@NLconstraint(m, e54, -x[128]/(1+x[128])+x[137] <= 0.0)
@NLconstraint(m, e55, -x[128]/(1+x[128])+x[138] <= 0.0)
@NLconstraint(m, e56, -x[129]/(1+x[129])+x[139] <= 0.0)
@NLconstraint(m, e57, -x[129]/(1+x[129])+x[140] <= 0.0)
@NLconstraint(m, e58, -x[129]/(1+x[129])+x[141] <= 0.0)
@NLconstraint(m, e59, -x[130]/(1+x[130])+x[142] <= 0.0)
@NLconstraint(m, e60, -x[130]/(1+x[130])+x[143] <= 0.0)
@NLconstraint(m, e61, -x[130]/(1+x[130])+x[144] <= 0.0)
@NLconstraint(m, e62, -x[131]/(1+x[131])+x[145] <= 0.0)
@NLconstraint(m, e63, -x[131]/(1+x[131])+x[146] <= 0.0)
@NLconstraint(m, e64, -x[131]/(1+x[131])+x[147] <= 0.0)
@NLconstraint(m, e65, -x[132]/(1+x[132])+x[148] <= 0.0)
@NLconstraint(m, e66, -x[132]/(1+x[132])+x[149] <= 0.0)
@NLconstraint(m, e67, -x[132]/(1+x[132])+x[150] <= 0.0)
