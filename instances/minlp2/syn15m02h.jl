...
# ----- Constraints ----- #
@constraint(m, e1, objvar+x[32]+x[33]-5*x[44]-10*x[45]+2*x[54]+x[55]-500*x[80]-600*x[81]-350*x[82]-400*x[83]+10*x[88]+5*x[89]+5*x[90]+5*x[91]-80*x[104]-130*x[105]-110*x[106]-120*x[107]-110*x[108]-130*x[109]-80*x[110]-90*x[111]+5*b[274]+4*b[275]+8*b[276]+7*b[277]+6*b[278]+9*b[279]+10*b[280]+9*b[281]+6*b[282]+10*b[283]+7*b[284]+7*b[285]+4*b[286]+3*b[287]+5*b[288]+6*b[289]+2*b[290]+5*b[291]+4*b[292]+7*b[293]+3*b[294]+9*b[295]+7*b[296]+2*b[297]+3*b[298]+b[299]+2*b[300]+6*b[301]+4*b[302]+8*b[303] == 0.0)
