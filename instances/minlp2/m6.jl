...
@variable(m, x[x_Idx])
setlowerbound(x[62], 2.8)
setupperbound(x[62], 7.4833)
setlowerbound(x[63], 2.0)
setupperbound(x[63], 6.3246)
setlowerbound(x[64], 1.8)
setupperbound(x[64], 6.0)
setlowerbound(x[65], 1.2247)
setupperbound(x[65], 4.899)
setlowerbound(x[66], 2.0)
setupperbound(x[66], 6.3246)
setlowerbound(x[67], 5.0)
setupperbound(x[67], 10.0)
setlowerbound(x[68], 15.0)
setupperbound(x[68], 15.0)
setlowerbound(x[69], 1.8708)
setupperbound(x[69], 5.0)
setlowerbound(x[70], 1.5811)
setupperbound(x[70], 5.0)
setlowerbound(x[71], 1.5)
setupperbound(x[71], 5.0)
setlowerbound(x[72], 1.2247)
setupperbound(x[72], 4.899)
setlowerbound(x[73], 1.5811)
setupperbound(x[73], 5.0)
setlowerbound(x[74], 2.5)
