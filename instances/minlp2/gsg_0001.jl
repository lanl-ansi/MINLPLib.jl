...
setlowerbound(x[1], 12.735)
setupperbound(x[1], 12.735)
setupperbound(x[2], 140.0)
setupperbound(x[3], 140.0)
setupperbound(x[4], 140.0)
setupperbound(x[5], 140.0)
setupperbound(x[6], 140.0)
setupperbound(x[7], 140.0)
setupperbound(x[8], 140.0)
setupperbound(x[9], 140.0)
setupperbound(x[10], 140.0)
setupperbound(x[11], 140.0)
setupperbound(x[12], 140.0)
setupperbound(x[13], 140.0)
setupperbound(x[14], 140.0)
setupperbound(x[15], 140.0)
setupperbound(x[16], 140.0)
setupperbound(x[17], 140.0)
setupperbound(x[18], 140.0)
setupperbound(x[19], 140.0)
setupperbound(x[20], 140.0)
setupperbound(x[21], 140.0)
setupperbound(x[22], 140.0)
setupperbound(x[23], 140.0)
setupperbound(x[24], 140.0)
setupperbound(x[25], 140.0)
setupperbound(x[26], 140.0)
setupperbound(x[27], 140.0)
setupperbound(x[28], 140.0)
setupperbound(x[29], 140.0)
setupperbound(x[30], 140.0)
setupperbound(x[31], 140.0)
setupperbound(x[32], 140.0)
setupperbound(x[33], 140.0)
setlowerbound(x[34], 0.1)
setupperbound(x[34], 0.1)
...
setlowerbound(x[45], 0.2)
setupperbound(x[45], 0.2)
setlowerbound(x[46], 0.2)
setupperbound(x[46], 10000.0)
setlowerbound(x[47], 0.2)
setupperbound(x[47], 10000.0)
setlowerbound(x[48], 0.2)
setupperbound(x[48], 10000.0)
setlowerbound(x[49], 0.2)
setupperbound(x[49], 10000.0)
setlowerbound(x[50], 0.2)
setupperbound(x[50], 10000.0)
setlowerbound(x[51], 0.2)
setupperbound(x[51], 10000.0)
setlowerbound(x[52], 0.2)
setupperbound(x[52], 10000.0)
setlowerbound(x[53], 0.2)
setupperbound(x[53], 10000.0)
setlowerbound(x[54], 0.2)
setupperbound(x[54], 10000.0)
setlowerbound(x[55], 0.2)
setupperbound(x[55], 10000.0)
setlowerbound(x[56], 0.01)
setupperbound(x[56], 0.01)
...
setupperbound(x[68], 400.0)
setupperbound(x[69], 400.0)
setupperbound(x[70], 400.0)
setupperbound(x[71], 400.0)
setupperbound(x[72], 400.0)
setupperbound(x[73], 400.0)
setupperbound(x[74], 400.0)
setupperbound(x[75], 400.0)
setupperbound(x[76], 400.0)
setupperbound(x[77], 400.0)
setlowerbound(objvar, 0.0)
setupperbound(objvar, 30000.0)
