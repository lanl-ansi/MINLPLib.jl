...
set_lower_bound(x[1], 68.0)
set_upper_bound(x[1], 71.0)
set_lower_bound(x[2], 65.0)
set_upper_bound(x[2], 87.0)
set_lower_bound(x[3], 107.0)
set_upper_bound(x[3], 126.0)
set_lower_bound(x[4], 38.0)
set_upper_bound(x[4], 49.0)
set_lower_bound(x[5], 40.0)
set_upper_bound(x[5], 55.0)
set_lower_bound(x[6], 54.0)
set_upper_bound(x[6], 68.0)
set_lower_bound(x[7], 92.0)
set_upper_bound(x[7], 106.0)
set_lower_bound(x[8], 113.0)
set_upper_bound(x[8], 117.0)
set_lower_bound(x[9], 82.0)
set_upper_bound(x[9], 87.0)
set_lower_bound(x[10], 76.0)
set_upper_bound(x[10], 85.0)
