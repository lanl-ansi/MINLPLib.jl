...
setlowerbound(x[1], 68.0)
setupperbound(x[1], 71.0)
setlowerbound(x[2], 65.0)
setupperbound(x[2], 87.0)
setlowerbound(x[3], 107.0)
setupperbound(x[3], 126.0)
setlowerbound(x[4], 38.0)
setupperbound(x[4], 49.0)
setlowerbound(x[5], 40.0)
setupperbound(x[5], 55.0)
setlowerbound(x[6], 54.0)
setupperbound(x[6], 68.0)
setlowerbound(x[7], 92.0)
setupperbound(x[7], 106.0)
setlowerbound(x[8], 113.0)
setupperbound(x[8], 117.0)
setlowerbound(x[9], 82.0)
setupperbound(x[9], 87.0)
setlowerbound(x[10], 76.0)
setupperbound(x[10], 85.0)
