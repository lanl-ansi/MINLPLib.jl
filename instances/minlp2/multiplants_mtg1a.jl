...
set_upper_bound(x[149], 250.0)
set_upper_bound(x[150], 250.0)
set_upper_bound(x[151], 250.0)
set_upper_bound(x[152], 250.0)
set_upper_bound(x[153], 250.0)
set_upper_bound(x[154], 250.0)
set_upper_bound(x[155], 250.0)
set_upper_bound(x[156], 250.0)
set_upper_bound(x[157], 500.0)
set_upper_bound(x[158], 500.0)
set_upper_bound(x[159], 500.0)
...
set_upper_bound(x[169], 250.0)
set_upper_bound(x[170], 250.0)
set_upper_bound(x[171], 250.0)
set_upper_bound(x[172], 250.0)
set_upper_bound(x[173], 250.0)
set_upper_bound(x[174], 250.0)
set_upper_bound(x[175], 500.0)
set_upper_bound(x[176], 500.0)
set_upper_bound(x[177], 500.0)
set_upper_bound(x[178], 500.0)
set_upper_bound(x[179], 500.0)
set_upper_bound(x[180], 500.0)
set_lower_bound(x[181], 50.0)
set_lower_bound(x[182], 100.0)
set_lower_bound(x[183], 250.0)
set_lower_bound(x[190], 5.55555555555556)
set_upper_bound(x[190], 250.0)
set_lower_bound(x[191], 16.6666666666667)
set_upper_bound(x[191], 250.0)
set_lower_bound(x[192], 22.7272727272727)
set_upper_bound(x[192], 250.0)
set_lower_bound(x[193], 100.0)
set_upper_bound(x[193], 250.0)
...
@NLconstraint(m, e87, x[181]*x[193]-x[100]-x[101]-x[102] == 0.0)
@NLconstraint(m, e88, x[182]*x[193]-x[109]-x[110]-x[111] == 0.0)
@NLconstraint(m, e89, x[183]*x[193]-x[118]-x[119]-x[120] == 0.0)
...
@NLconstraint(m, e201, -x[184]*(x[175]-x[169])+x[94]+x[95]+x[96]+x[97]+x[98]+x[99] == 0.0)
@NLconstraint(m, e202, -x[185]*(x[176]-x[170])+x[100]+x[101]+x[102] == 0.0)
@NLconstraint(m, e203, -x[186]*(x[177]-x[171])+x[103]+x[104]+x[105]+x[106]+x[107]+x[108] == 0.0)
@NLconstraint(m, e204, -x[187]*(x[178]-x[172])+x[109]+x[110]+x[111] == 0.0)
@NLconstraint(m, e205, -x[188]*(x[179]-x[173])+x[112]+x[113]+x[114]+x[115]+x[116]+x[117] == 0.0)
@NLconstraint(m, e206, -x[189]*(x[180]-x[174])+x[118]+x[119]+x[120] == 0.0)
...
@NLconstraint(m, e237, -(x[170]-x[169])*x[184]-200000*b[82]+x[166] >= -200000.0)
@NLconstraint(m, e238, -(x[172]-x[171])*x[186]-150000*b[83]+x[167] >= -150000.0)
@NLconstraint(m, e239, -(x[174]-x[173])*x[188]-250000*b[84]+x[168] >= -250000.0)
@NLconstraint(m, e240, -(x[176]-x[175])*x[185]-200000*b[82]+x[166] >= -200000.0)
@NLconstraint(m, e241, -(x[178]-x[177])*x[187]-150000*b[83]+x[167] >= -150000.0)
@NLconstraint(m, e242, -(x[180]-x[179])*x[189]-250000*b[84]+x[168] >= -250000.0)
@NLconstraint(m, e243, -(x[169]-x[170])*x[185]-200000*b[85]+x[166] >= -200000.0)
@NLconstraint(m, e244, -(x[171]-x[172])*x[187]-150000*b[86]+x[167] >= -150000.0)
@NLconstraint(m, e245, -(x[173]-x[174])*x[189]-250000*b[87]+x[168] >= -250000.0)
@NLconstraint(m, e246, -(x[175]-x[176])*x[184]-200000*b[85]+x[166] >= -200000.0)
@NLconstraint(m, e247, -(x[177]-x[178])*x[186]-150000*b[86]+x[167] >= -150000.0)
@NLconstraint(m, e248, -(x[179]-x[180])*x[188]-250000*b[87]+x[168] >= -250000.0)
@NLconstraint(m, e249, -(x[185]-x[184])*(x[176]-x[170])-200000*b[88]+x[166] >= -200000.0)
@NLconstraint(m, e250, -(x[187]-x[186])*(x[178]-x[172])-150000*b[89]+x[167] >= -150000.0)
@NLconstraint(m, e251, -(x[189]-x[188])*(x[180]-x[174])-250000*b[90]+x[168] >= -250000.0)
@NLconstraint(m, e252, -(x[184]-x[185])*(x[175]-x[169])-200000*b[91]+x[166] >= -200000.0)
@NLconstraint(m, e253, -(x[186]-x[187])*(x[177]-x[171])-150000*b[92]+x[167] >= -150000.0)
@NLconstraint(m, e254, -(x[188]-x[189])*(x[179]-x[173])-250000*b[93]+x[168] >= -250000.0)
