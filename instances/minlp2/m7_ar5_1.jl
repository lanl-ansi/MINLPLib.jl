...
setupperbound(x[58], 8.3666)
setlowerbound(x[59], 2.0)
setupperbound(x[59], 7.0711)
setlowerbound(x[60], 1.6733)
setupperbound(x[60], 5.0)
setlowerbound(x[61], 1.4142)
setupperbound(x[61], 5.0)
setlowerbound(x[62], 1.8)
setupperbound(x[62], 6.7082)
setlowerbound(x[64], 1.3416)
setupperbound(x[64], 5.0)
setlowerbound(x[66], 1.2)
setupperbound(x[66], 5.4772)
setlowerbound(x[68], 1.0954)
setupperbound(x[68], 5.0)
setlowerbound(x[70], 2.0)
setupperbound(x[70], 7.0711)
setlowerbound(x[72], 1.4142)
setupperbound(x[72], 5.0)
setlowerbound(x[74], 5.0)
setupperbound(x[74], 11.1803)
setlowerbound(x[76], 2.2361)
setupperbound(x[76], 5.0)
setlowerbound(x[78], 5.0)
setupperbound(x[78], 11.1803)
setlowerbound(x[80], 2.2361)
...
@constraint(m, e48, -0.119523*x[58]-0.597614*x[60] <= -2.0)
@constraint(m, e49, -0.5*x[59]-0.2*x[61] <= -2.0)
@constraint(m, e50, -0.141421*x[59]-0.70711*x[61] <= -2.0)
@constraint(m, e51, -0.555556*x[62]-0.2*x[64] <= -2.0)
@constraint(m, e52, -0.149071*x[62]-0.745356*x[64] <= -2.0)
@constraint(m, e53, -0.833333*x[66]-0.2*x[68] <= -2.0)
@constraint(m, e54, -0.182575*x[66]-0.912867*x[68] <= -2.0)
@constraint(m, e55, -0.5*x[70]-0.2*x[72] <= -2.0)
@constraint(m, e56, -0.141421*x[70]-0.70711*x[72] <= -2.0)
@constraint(m, e57, -0.2*x[74]-0.2*x[76] <= -2.0)
@constraint(m, e58, -0.089443*x[74]-0.447212*x[76] <= -2.0)
@constraint(m, e59, -0.2*x[78]-0.2*x[80] <= -2.0)
@constraint(m, e60, -0.089443*x[78]-0.447212*x[80] <= -2.0)
