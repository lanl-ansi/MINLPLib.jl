...
@constraint(m, e2, x[8]+x[9] <= 800.0)
@constraint(m, e3, x[10]+x[11] <= 800.0)
@constraint(m, e4, x[4]+x[5] <= 800.0)
@constraint(m, e5, x[8]+x[9]+x[10]+x[11] <= 800.0)
@constraint(m, e6, x[4]+x[8]+x[10] <= 600.0)
