...
setupperbound(x[8], 12.5)
setupperbound(x[9], 12.5)
setupperbound(x[10], 12.5)
setupperbound(x[11], 17.5)
setupperbound(x[12], 17.5)
setupperbound(x[13], 17.5)
setupperbound(x[14], 12.5)
setupperbound(x[15], 12.5)
setupperbound(x[16], 12.5)
setupperbound(x[17], 17.5)
setupperbound(x[18], 17.5)
setupperbound(x[19], 17.5)
...
setupperbound(x[28], 60.98)
setupperbound(x[29], 12.5)
setupperbound(x[30], 17.5)
setupperbound(x[31], 161.29)
setupperbound(x[32], 161.29)
