...
set_upper_bound(x[58], 5.9161)
set_lower_bound(x[59], 2.0)
set_upper_bound(x[59], 5.0)
set_lower_bound(x[60], 2.3664)
set_upper_bound(x[60], 5.0)
set_lower_bound(x[61], 2.0)
set_upper_bound(x[61], 5.0)
set_lower_bound(x[62], 1.8974)
set_upper_bound(x[62], 4.7434)
set_lower_bound(x[64], 1.8974)
set_upper_bound(x[64], 4.7434)
set_lower_bound(x[66], 1.5492)
set_upper_bound(x[66], 3.873)
set_lower_bound(x[68], 1.5492)
set_upper_bound(x[68], 3.873)
set_lower_bound(x[70], 2.0)
set_upper_bound(x[70], 5.0)
set_lower_bound(x[72], 2.0)
set_upper_bound(x[72], 5.0)
set_lower_bound(x[74], 5.0)
set_upper_bound(x[74], 7.9057)
set_lower_bound(x[76], 3.1623)
set_upper_bound(x[76], 5.0)
set_lower_bound(x[78], 5.0)
set_upper_bound(x[78], 7.9057)
set_lower_bound(x[80], 3.1623)
