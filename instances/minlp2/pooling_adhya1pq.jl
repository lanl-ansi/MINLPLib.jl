...
@NLconstraint(m, e31, -x[2]*x[7]+x[15] == 0.0)
@NLconstraint(m, e32, -x[2]*x[8]+x[16] == 0.0)
@NLconstraint(m, e33, -x[2]*x[9]+x[17] == 0.0)
@NLconstraint(m, e34, -x[2]*x[10]+x[18] == 0.0)
@NLconstraint(m, e35, -x[3]*x[7]+x[19] == 0.0)
@NLconstraint(m, e36, -x[3]*x[8]+x[20] == 0.0)
@NLconstraint(m, e37, -x[3]*x[9]+x[21] == 0.0)
@NLconstraint(m, e38, -x[3]*x[10]+x[22] == 0.0)
@NLconstraint(m, e39, -x[4]*x[11]+x[23] == 0.0)
@NLconstraint(m, e40, -x[4]*x[12]+x[24] == 0.0)
@NLconstraint(m, e41, -x[4]*x[13]+x[25] == 0.0)
@NLconstraint(m, e42, -x[4]*x[14]+x[26] == 0.0)
@NLconstraint(m, e43, -x[5]*x[11]+x[27] == 0.0)
@NLconstraint(m, e44, -x[5]*x[12]+x[28] == 0.0)
@NLconstraint(m, e45, -x[5]*x[13]+x[29] == 0.0)
@NLconstraint(m, e46, -x[5]*x[14]+x[30] == 0.0)
@NLconstraint(m, e47, -x[6]*x[11]+x[31] == 0.0)
@NLconstraint(m, e48, -x[6]*x[12]+x[32] == 0.0)
@NLconstraint(m, e49, -x[6]*x[13]+x[33] == 0.0)
@NLconstraint(m, e50, -x[6]*x[14]+x[34] == 0.0)
