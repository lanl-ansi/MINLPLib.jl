...
set_lower_bound(x[37], 0.526315789473684)
set_upper_bound(x[37], 1.05263157894737)
set_lower_bound(x[38], 0.961538461538462)
set_upper_bound(x[38], 2.11538461538462)
set_lower_bound(x[39], 0.2)
set_upper_bound(x[39], 1.0)
set_upper_bound(x[40], 0.8)
set_lower_bound(x[41], 6.0)
set_upper_bound(x[41], 13.0)
set_lower_bound(x[42], 6.0)
set_upper_bound(x[42], 13.0)
set_lower_bound(x[43], 0.26)
set_upper_bound(x[43], 0.35)
set_lower_bound(x[44], 4.9)
set_upper_bound(x[44], 5.5)
set_lower_bound(x[45], 55.0)
set_upper_bound(x[45], 63.0)
set_lower_bound(x[47], 0.296392099803303)
set_upper_bound(x[47], 0.404171045186323)
set_lower_bound(x[48], 0.134723681728774)
set_upper_bound(x[48], 0.229030258938916)
set_upper_bound(x[49], 90.0)
set_upper_bound(x[50], 200.0)
set_upper_bound(x[51], 26.0)
set_upper_bound(x[52], 1.0)
set_upper_bound(x[53], 34.1)
set_upper_bound(x[54], 1.0)
set_lower_bound(x[55], 0.526315789473684)
set_upper_bound(x[55], 1.05263157894737)
set_lower_bound(x[56], 0.961538461538462)
set_upper_bound(x[56], 2.11538461538462)
set_lower_bound(x[57], 0.2)
set_upper_bound(x[57], 1.0)
set_upper_bound(x[58], 0.8)
set_lower_bound(x[59], 6.0)
set_upper_bound(x[59], 13.0)
set_lower_bound(x[60], 6.0)
set_upper_bound(x[60], 13.0)
set_lower_bound(x[61], 0.26)
set_upper_bound(x[61], 0.35)
set_lower_bound(x[62], 4.9)
set_upper_bound(x[62], 5.5)
set_lower_bound(x[63], 55.0)
set_upper_bound(x[63], 63.0)
set_lower_bound(x[65], 0.296392099803303)
set_upper_bound(x[65], 0.404171045186323)
set_lower_bound(x[66], 0.134723681728774)
set_upper_bound(x[66], 0.229030258938916)
set_upper_bound(x[67], 90.0)
set_upper_bound(x[68], 200.0)
set_upper_bound(x[69], 26.0)
set_upper_bound(x[70], 1.0)
set_upper_bound(x[71], 34.1)
set_upper_bound(x[72], 1.0)
set_lower_bound(x[73], 0.526315789473684)
set_upper_bound(x[73], 1.05263157894737)
set_lower_bound(x[74], 0.961538461538462)
set_upper_bound(x[74], 2.11538461538462)
set_lower_bound(x[75], 0.2)
set_upper_bound(x[75], 1.0)
set_upper_bound(x[76], 0.8)
set_lower_bound(x[77], 6.0)
set_upper_bound(x[77], 13.0)
set_lower_bound(x[78], 6.0)
set_upper_bound(x[78], 13.0)
set_lower_bound(x[79], 0.26)
set_upper_bound(x[79], 0.35)
set_lower_bound(x[80], 4.9)
set_upper_bound(x[80], 5.5)
set_lower_bound(x[81], 55.0)
set_upper_bound(x[81], 63.0)
set_lower_bound(x[83], 0.296392099803303)
set_upper_bound(x[83], 0.404171045186323)
set_lower_bound(x[84], 0.134723681728774)
set_upper_bound(x[84], 0.229030258938916)
set_upper_bound(x[85], 90.0)
set_upper_bound(x[86], 200.0)
set_upper_bound(x[87], 26.0)
set_upper_bound(x[88], 1.0)
set_upper_bound(x[89], 34.1)
set_upper_bound(x[90], 1.0)
set_upper_bound(x[91], 200.0)
set_upper_bound(x[92], 200.0)
set_upper_bound(x[93], 34.1)
set_upper_bound(x[94], 1.0)
set_upper_bound(x[95], 34.1)
