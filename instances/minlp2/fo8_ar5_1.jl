...
set_lower_bound(x[76], 1.7889)
set_upper_bound(x[76], 8.9443)
set_lower_bound(x[77], 1.7889)
set_upper_bound(x[77], 8.9443)
set_lower_bound(x[78], 1.7889)
set_upper_bound(x[78], 8.9443)
set_lower_bound(x[79], 1.7889)
set_upper_bound(x[79], 8.9443)
set_lower_bound(x[80], 1.7889)
set_upper_bound(x[80], 8.9443)
set_lower_bound(x[82], 1.7889)
set_upper_bound(x[82], 8.9443)
set_lower_bound(x[84], 2.7692)
set_upper_bound(x[84], 11.31)
set_lower_bound(x[86], 3.183)
set_upper_bound(x[86], 13.0)
set_lower_bound(x[88], 2.7692)
set_upper_bound(x[88], 11.31)
set_lower_bound(x[90], 3.183)
set_upper_bound(x[90], 13.0)
set_lower_bound(x[92], 1.3416)
set_upper_bound(x[92], 6.7082)
set_lower_bound(x[94], 1.3416)
set_upper_bound(x[94], 6.7082)
set_lower_bound(x[96], 1.3416)
set_upper_bound(x[96], 6.7082)
set_lower_bound(x[98], 1.3416)
set_upper_bound(x[98], 6.7082)
set_lower_bound(x[100], 1.3416)
set_upper_bound(x[100], 6.7082)
set_lower_bound(x[102], 1.3416)
set_upper_bound(x[102], 6.7082)
