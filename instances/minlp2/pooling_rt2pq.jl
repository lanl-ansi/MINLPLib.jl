...
setupperbound(x[8], 60.98)
setupperbound(x[9], 161.29)
setupperbound(x[10], 161.29)
...
setupperbound(x[18], 12.5)
setupperbound(x[19], 12.5)
setupperbound(x[20], 12.5)
setupperbound(x[21], 17.5)
setupperbound(x[22], 17.5)
setupperbound(x[23], 17.5)
setupperbound(x[24], 12.5)
setupperbound(x[25], 12.5)
setupperbound(x[26], 12.5)
setupperbound(x[27], 17.5)
setupperbound(x[28], 17.5)
setupperbound(x[29], 17.5)
