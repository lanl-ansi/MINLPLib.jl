...
set_lower_bound(x[94], 2.8284)
set_upper_bound(x[94], 5.6569)
set_lower_bound(x[95], 2.8284)
set_upper_bound(x[95], 5.6569)
set_lower_bound(x[96], 2.8284)
set_upper_bound(x[96], 5.6569)
set_lower_bound(x[97], 2.8284)
set_upper_bound(x[97], 5.6569)
set_lower_bound(x[98], 2.8284)
set_upper_bound(x[98], 5.6569)
set_lower_bound(x[100], 2.8284)
set_upper_bound(x[100], 5.6569)
set_lower_bound(x[102], 4.2426)
set_upper_bound(x[102], 8.4853)
set_lower_bound(x[104], 4.2426)
set_upper_bound(x[104], 8.4853)
set_lower_bound(x[106], 4.2426)
set_upper_bound(x[106], 8.4853)
set_lower_bound(x[108], 4.2426)
set_upper_bound(x[108], 8.4853)
set_lower_bound(x[110], 2.1213)
set_upper_bound(x[110], 4.2426)
set_lower_bound(x[112], 2.1213)
set_upper_bound(x[112], 4.2426)
set_lower_bound(x[114], 2.1213)
set_upper_bound(x[114], 4.2426)
set_lower_bound(x[116], 2.1213)
set_upper_bound(x[116], 4.2426)
set_lower_bound(x[118], 2.1213)
set_upper_bound(x[118], 4.2426)
set_lower_bound(x[120], 2.1213)
set_upper_bound(x[120], 4.2426)
set_lower_bound(x[122], 2.1213)
set_upper_bound(x[122], 4.2426)
set_lower_bound(x[124], 2.1213)
set_upper_bound(x[124], 4.2426)
...
@constraint(m, e77, -0.353557*x[94]-0.176775*x[96] <= -2.0)
@constraint(m, e78, -0.176775*x[94]-0.353556*x[96] <= -2.0)
@constraint(m, e79, -0.353557*x[95]-0.176775*x[97] <= -2.0)
@constraint(m, e80, -0.176775*x[95]-0.353556*x[97] <= -2.0)
@constraint(m, e81, -0.353557*x[98]-0.176775*x[100] <= -2.0)
@constraint(m, e82, -0.176775*x[98]-0.353556*x[100] <= -2.0)
@constraint(m, e83, -0.235705*x[102]-0.11785*x[104] <= -2.0)
@constraint(m, e84, -0.117851*x[102]-0.235703*x[104] <= -2.0)
@constraint(m, e85, -0.235705*x[106]-0.11785*x[108] <= -2.0)
@constraint(m, e86, -0.117851*x[106]-0.235703*x[108] <= -2.0)
@constraint(m, e87, -0.471409*x[110]-0.2357*x[112] <= -2.0)
@constraint(m, e88, -0.235705*x[110]-0.4714*x[112] <= -2.0)
@constraint(m, e89, -0.471409*x[114]-0.2357*x[116] <= -2.0)
@constraint(m, e90, -0.235705*x[114]-0.4714*x[116] <= -2.0)
@constraint(m, e91, -0.471409*x[118]-0.2357*x[120] <= -2.0)
@constraint(m, e92, -0.235705*x[118]-0.4714*x[120] <= -2.0)
@constraint(m, e93, -0.471409*x[122]-0.2357*x[124] <= -2.0)
@constraint(m, e94, -0.235705*x[122]-0.4714*x[124] <= -2.0)
