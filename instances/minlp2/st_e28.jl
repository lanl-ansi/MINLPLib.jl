...
setupperbound(x[1], 92.0)
setlowerbound(x[2], 90.0)
setupperbound(x[2], 110.0)
setlowerbound(x[3], 20.0)
setupperbound(x[3], 25.0)
setlowerbound(x[5], 78.0)
setupperbound(x[5], 102.0)
setlowerbound(x[6], 33.0)
setupperbound(x[6], 45.0)
setlowerbound(x[7], 27.0)
setupperbound(x[7], 45.0)
setlowerbound(x[8], 27.0)
setupperbound(x[8], 45.0)
setlowerbound(x[9], 27.0)
