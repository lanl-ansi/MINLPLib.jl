...
set_upper_bound(x[27], 0.1)
set_lower_bound(x[28], -0.15)
set_upper_bound(x[28], 0.15)
set_lower_bound(x[29], -0.1)
set_upper_bound(x[29], 0.1)
set_lower_bound(x[30], -0.15)
set_upper_bound(x[30], 0.15)
set_lower_bound(x[31], -0.1)
set_upper_bound(x[31], 0.1)
set_lower_bound(x[32], -0.15)
set_upper_bound(x[32], 0.15)
set_lower_bound(x[33], -0.1)
set_upper_bound(x[33], 0.1)
set_lower_bound(x[34], -0.15)
set_upper_bound(x[34], 0.15)
