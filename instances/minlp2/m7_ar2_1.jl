...
set_upper_bound(x[58], 5.2915)
set_lower_bound(x[59], 2.2361)
set_upper_bound(x[59], 4.4721)
set_lower_bound(x[60], 2.6458)
set_upper_bound(x[60], 5.0)
set_lower_bound(x[61], 2.2361)
set_upper_bound(x[61], 4.4721)
set_lower_bound(x[62], 2.1213)
set_upper_bound(x[62], 4.2426)
set_lower_bound(x[64], 2.1213)
set_upper_bound(x[64], 4.2426)
set_lower_bound(x[66], 1.7321)
set_upper_bound(x[66], 3.4641)
set_lower_bound(x[68], 1.7321)
set_upper_bound(x[68], 3.4641)
set_lower_bound(x[70], 2.2361)
set_upper_bound(x[70], 4.4721)
set_lower_bound(x[72], 2.2361)
set_upper_bound(x[72], 4.4721)
set_lower_bound(x[74], 5.0)
set_upper_bound(x[74], 7.0711)
set_lower_bound(x[76], 3.5355)
set_upper_bound(x[76], 5.0)
set_lower_bound(x[78], 5.0)
set_upper_bound(x[78], 7.0711)
set_lower_bound(x[80], 3.5355)
