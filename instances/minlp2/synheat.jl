...
@constraint(m, e5, 10*x[15]-x[37] == 3700.0)
@constraint(m, e6, 20*x[18]-x[38] == 7400.0)
@constraint(m, e7, -x[25]-x[26]-x[28]-x[29]-x[37] == -2800.0)
@constraint(m, e8, -x[31]-x[32]-x[34]-x[35]-x[38] == -4400.0)
@constraint(m, e9, 15*x[19]-15*x[20]-x[25]-x[31] == 0.0)
@constraint(m, e10, 15*x[20]-15*x[21]-x[26]-x[32] == 0.0)
@constraint(m, e11, 13*x[22]-13*x[23]-x[28]-x[34] == 0.0)
@constraint(m, e12, 13*x[23]-13*x[24]-x[29]-x[35] == 0.0)
...
@NLconstraint(m, e65, -(150*(2*x[25]/(1e-6+(1e-6+0.5*x[41]*x[42]*(x[41]+x[42]))^0.33333)+2*x[26]/(1e-6+(1e-6+0.5*x[42]*x[43]*(x[42]+x[43]))^0.33333)+2*x[28]/(1e-6+(1e-6+0.5*x[44]*x[45]*(x[44]+x[45]))^0.33333)+2*x[29]/(1e-6+(1e-6+0.5*x[45]*x[46]*(x[45]+x[46]))^0.33333)+2*x[31]/(1e-6+(1e-6+0.5*x[47]*x[48]*(x[47]+x[48]))^0.33333)+2*x[32]/(1e-6+(1e-6+0.5*x[48]*x[49]*(x[48]+x[49]))^0.33333)+2*x[34]/(1e-6+(1e-6+0.5*x[50]*x[51]*(x[50]+x[51]))^0.33333)+2*x[35]/(1e-6+(1e-6+0.5*x[51]*x[52]*(x[51]+x[52]))^0.33333))+150*(1.2*x[39]/(1e-6+30*x[55]*(15+0.5*x[55]))^0.33333+1.2*x[40]/(1e-6+180*x[56]*(90+0.5*x[56]))^0.33333)+150*(2*x[37]/(1e-6+35*x[53]*(70+x[53]))^0.33333+2*x[38]/(1e-6+35*x[54]*(70+x[54]))^0.33333)+80*x[39]+80*x[40]+15*x[37]+15*x[38])-5500*b[1]-5500*b[2]-5500*b[3]-5500*b[4]-5500*b[5]-5500*b[6]-5500*b[7]-5500*b[8]-5500*b[9]-5500*b[10]-5500*b[11]-5500*b[12]-29995.6190569812*x[27]-29995.6190569812*x[30]-29995.6190569812*x[33]-29995.6190569812*x[36]+objvar == 0.0024)
