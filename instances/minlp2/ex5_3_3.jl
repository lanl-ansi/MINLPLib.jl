...
setupperbound(x[9], 600.0)
setupperbound(x[10], 600.0)
setupperbound(x[11], 600.0)
setupperbound(x[12], 600.0)
setupperbound(x[13], 600.0)
setupperbound(x[14], 600.0)
setupperbound(x[15], 600.0)
setupperbound(x[16], 600.0)
setupperbound(x[17], 600.0)
setupperbound(x[18], 600.0)
setupperbound(x[19], 600.0)
setupperbound(x[20], 600.0)
setupperbound(x[21], 600.0)
setupperbound(x[22], 600.0)
setupperbound(x[23], 600.0)
setupperbound(x[24], 600.0)
setupperbound(x[25], 600.0)
setupperbound(x[26], 600.0)
setupperbound(x[27], 600.0)
