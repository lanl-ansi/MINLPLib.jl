...
setlowerbound(x[77], 2.3094)
setupperbound(x[77], 6.9282)
setlowerbound(x[78], 2.3094)
setupperbound(x[78], 6.9282)
setlowerbound(x[79], 2.3094)
setupperbound(x[79], 6.9282)
setlowerbound(x[80], 2.3094)
setupperbound(x[80], 6.9282)
setlowerbound(x[82], 2.3094)
setupperbound(x[82], 6.9282)
setlowerbound(x[84], 3.4641)
setupperbound(x[84], 10.3923)
setlowerbound(x[86], 3.4641)
setupperbound(x[86], 10.3923)
setlowerbound(x[88], 3.4641)
setupperbound(x[88], 10.3923)
setlowerbound(x[90], 3.4641)
setupperbound(x[90], 10.3923)
setlowerbound(x[92], 1.7321)
setupperbound(x[92], 5.1962)
setlowerbound(x[94], 1.7321)
setupperbound(x[94], 5.1962)
setlowerbound(x[96], 1.7321)
setupperbound(x[96], 5.1962)
setlowerbound(x[98], 1.7321)
setupperbound(x[98], 5.1962)
setlowerbound(x[100], 1.7321)
setupperbound(x[100], 5.1962)
setlowerbound(x[102], 1.7321)
setupperbound(x[102], 5.1962)
