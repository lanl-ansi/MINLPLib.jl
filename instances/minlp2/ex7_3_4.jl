...
# ----- Constraints ----- #
@constraint(m, e1, -x[12]+objvar == 0.0)
@NLconstraint(m, e2,  (x[11])^4*x[10]- (x[11])^2*x[8]+x[6] == 0.0)
@NLconstraint(m, e3,  (x[11])^2*x[9]-x[7] == 0.0)
...
@NLconstraint(m, e16, -3*(-9.81* (x[2])^2*x[3]-9.81*x[3]*x[1]*x[2]-4.312* (x[3])^2*x[2]+264.896*x[3]*x[2]+x[4]*x[5]-9.274*x[5])+x[8] == 0.0)
@NLconstraint(m, e17, -(7* (x[3])^2*x[4]*x[2]-64.918* (x[3])^2*x[2]+380.067*x[3]*x[2]+3*x[5]*x[2]+3*x[5]*x[1])+x[9] == 0.0)
