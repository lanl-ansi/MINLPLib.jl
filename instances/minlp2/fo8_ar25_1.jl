...
set_lower_bound(x[77], 2.5298)
set_upper_bound(x[77], 6.3246)
set_lower_bound(x[78], 2.5298)
set_upper_bound(x[78], 6.3246)
set_lower_bound(x[79], 2.5298)
set_upper_bound(x[79], 6.3246)
set_lower_bound(x[80], 2.5298)
set_upper_bound(x[80], 6.3246)
set_lower_bound(x[82], 2.5298)
set_upper_bound(x[82], 6.3246)
set_lower_bound(x[84], 3.7947)
set_upper_bound(x[84], 9.4868)
set_lower_bound(x[86], 3.7947)
set_upper_bound(x[86], 9.4868)
set_lower_bound(x[88], 3.7947)
set_upper_bound(x[88], 9.4868)
set_lower_bound(x[90], 3.7947)
set_upper_bound(x[90], 9.4868)
set_lower_bound(x[92], 1.8974)
set_upper_bound(x[92], 4.7434)
set_lower_bound(x[94], 1.8974)
set_upper_bound(x[94], 4.7434)
set_lower_bound(x[96], 1.8974)
set_upper_bound(x[96], 4.7434)
set_lower_bound(x[98], 1.8974)
set_upper_bound(x[98], 4.7434)
set_lower_bound(x[100], 1.8974)
set_upper_bound(x[100], 4.7434)
set_lower_bound(x[102], 1.8974)
set_upper_bound(x[102], 4.7434)
