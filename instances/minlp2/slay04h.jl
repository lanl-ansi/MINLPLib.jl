...
# ----- Constraints ----- #
@NLconstraint(m, e1, -(150*( ((-4)+x[1])^2+ ((-10)+x[5])^2)+390*( ((-10)+x[2])^2+ ((-15)+x[6])^2)+240*( ((-7)+x[3])^2+ ((-9)+x[7])^2)+70*( ((-3)+x[4])^2+ ((-3)+x[8])^2))-300*x[129]-240*x[130]-210*x[131]-100*x[132]-150*x[133]-120*x[134]-300*x[135]-240*x[136]-210*x[137]-100*x[138]-150*x[139]-120*x[140]+objvar == 0.0)
