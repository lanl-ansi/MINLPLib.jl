...
set_lower_bound(x[46], 0.85)
set_upper_bound(x[46], 1.0)
set_lower_bound(x[47], 0.85)
set_upper_bound(x[47], 1.0)
set_lower_bound(x[48], 0.85)
set_upper_bound(x[48], 1.0)
set_lower_bound(x[49], 0.85)
...
@NLconstraint(m, e23, x[12]*x[34]+x[14]*x[37]+x[16]*x[40]+x[18]*x[43]+0.333333333333333*x[20] == 80.0)
@NLconstraint(m, e24, x[12]*x[35]+x[14]*x[38]+x[16]*x[41]+x[18]*x[44]+0.333333333333333*x[20] == 30.0)
@NLconstraint(m, e25, x[12]*x[36]+x[14]*x[39]+x[16]*x[42]+x[18]*x[45]+0.333333333333333*x[20] == 20.0)
@NLconstraint(m, e26, x[13]*x[34]+x[15]*x[37]+x[17]*x[40]+x[19]*x[43]+0.333333333333333*x[21] == 20.0)
@NLconstraint(m, e27, x[13]*x[35]+x[15]*x[38]+x[17]*x[41]+x[19]*x[44]+0.333333333333333*x[21] == 70.0)
@NLconstraint(m, e28, x[13]*x[36]+x[15]*x[39]+x[17]*x[42]+x[19]*x[45]+0.333333333333333*x[21] == 80.0)
