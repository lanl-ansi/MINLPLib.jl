...
setlowerbound(x[60], 1.7889)
setupperbound(x[60], 8.54)
setlowerbound(x[61], 1.7889)
setupperbound(x[61], 8.54)
setlowerbound(x[62], 1.8735)
setupperbound(x[62], 8.9443)
setlowerbound(x[63], 1.8735)
setupperbound(x[63], 8.9443)
setlowerbound(x[64], 1.7889)
setupperbound(x[64], 8.54)
setlowerbound(x[66], 1.8735)
setupperbound(x[66], 8.9443)
setlowerbound(x[68], 2.7692)
setupperbound(x[68], 8.54)
setlowerbound(x[70], 4.2155)
setupperbound(x[70], 13.0)
setlowerbound(x[72], 1.3416)
setupperbound(x[72], 6.7082)
setlowerbound(x[74], 1.3416)
setupperbound(x[74], 6.7082)
setlowerbound(x[76], 1.3416)
setupperbound(x[76], 6.7082)
