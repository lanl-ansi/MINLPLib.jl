...
setlowerbound(x[23], -1.69454444444444)
setupperbound(x[23], 1.69454444444444)
setlowerbound(x[24], -1.69454444444444)
setupperbound(x[24], 1.69454444444444)
setlowerbound(x[25], -1.69454444444444)
setupperbound(x[25], 1.69454444444444)
setlowerbound(x[26], -1.69444444444444)
setupperbound(x[26], 1.69444444444444)
setlowerbound(x[27], -1.69454444444444)
setupperbound(x[27], 1.69454444444444)
setlowerbound(x[28], -1.69454444444444)
setupperbound(x[28], 1.69454444444444)
setlowerbound(x[29], -1.69444444444444)
setupperbound(x[29], 1.69444444444444)
setlowerbound(x[30], -1.69444444444444)
setupperbound(x[30], 1.69444444444444)
setlowerbound(x[31], -1.69454444444444)
setupperbound(x[31], 1.69454444444444)
setlowerbound(x[32], -3.48536077097506)
setupperbound(x[32], 3.48536077097506)
setlowerbound(x[33], -3.48536077097506)
setupperbound(x[33], 3.48536077097506)
setlowerbound(x[34], -3.48536077097506)
setupperbound(x[34], 3.48536077097506)
setlowerbound(x[35], -3.48526077097506)
setupperbound(x[35], 3.48526077097506)
setlowerbound(x[36], -3.48536077097506)
setupperbound(x[36], 3.48536077097506)
setlowerbound(x[37], -3.48536077097506)
setupperbound(x[37], 3.48536077097506)
setlowerbound(x[38], -3.48526077097506)
setupperbound(x[38], 3.48526077097506)
setlowerbound(x[39], -3.48526077097506)
setupperbound(x[39], 3.48526077097506)
setlowerbound(x[40], -3.48536077097506)
setupperbound(x[40], 3.48536077097506)
...
setlowerbound(x[98], 16.9646003293849)
setlowerbound(x[99], 0.333333333333333)
setupperbound(x[99], 0.666666666666667)
setlowerbound(x[100], 0.333333333333333)
setupperbound(x[100], 0.666666666666667)
setlowerbound(x[101], 0.333333333333333)
setupperbound(x[101], 0.666666666666667)
setlowerbound(x[102], 0.666666666666667)
setupperbound(x[102], 1.42857142857143)
setlowerbound(x[103], 0.666666666666667)
setupperbound(x[103], 1.42857142857143)
setlowerbound(x[104], 0.666666666666667)
setupperbound(x[104], 1.42857142857143)
setlowerbound(x[105], 4.5)
setupperbound(x[105], 7.0)
setlowerbound(x[106], 2.5)
...
setupperbound(x[109], 3.0)
setlowerbound(x[110], 1.0)
setupperbound(x[110], 3.0)
setlowerbound(x[111], 0.7)
setupperbound(x[111], 6.3)
setlowerbound(x[112], 0.7)
setupperbound(x[112], 3.3)
setlowerbound(x[113], 0.7)
setupperbound(x[113], 3.3)
