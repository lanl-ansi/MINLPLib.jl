...
setcategory(b[1], :Bin)
setlowerbound(x[86], 1.7889)
setupperbound(x[86], 8.54)
setlowerbound(x[87], 1.7889)
setupperbound(x[87], 8.54)
setlowerbound(x[88], 1.7889)
setupperbound(x[88], 8.54)
setlowerbound(x[89], 2.7692)
setupperbound(x[89], 8.5399)
setlowerbound(x[90], 1.3416)
setupperbound(x[90], 6.7082)
setlowerbound(x[91], 1.3416)
setupperbound(x[91], 6.7082)
setlowerbound(x[92], 1.3416)
setupperbound(x[92], 6.7082)
setlowerbound(x[93], 8.54)
setupperbound(x[93], 8.54)
setlowerbound(x[94], 1.8735)
setupperbound(x[94], 8.944)
setlowerbound(x[95], 1.8735)
setupperbound(x[95], 8.944)
setlowerbound(x[96], 1.8735)
setupperbound(x[96], 8.944)
setlowerbound(x[97], 4.2155)
setupperbound(x[97], 13.0)
setlowerbound(x[98], 1.3416)
setupperbound(x[98], 6.7082)
setlowerbound(x[99], 1.3416)
setupperbound(x[99], 6.7082)
...
# ----- Constraints ----- #
@constraint(m, e1, objvar-5*x[48]-5*x[49]-x[54]-x[55]-3*x[58]-3*x[59]-x[64]-x[65]-2*x[66]-2*x[67]-x[72]-x[73]-4*x[74]-4*x[75]-4*x[76]-4*x[77]-2*x[82]-2*x[83]-x[84]-x[85] == 0.0)
