...
setupperbound(x[58], 7.4833)
setlowerbound(x[59], 2.0)
setupperbound(x[59], 6.3246)
setlowerbound(x[60], 1.8708)
setupperbound(x[60], 5.0)
setlowerbound(x[61], 1.5811)
setupperbound(x[61], 5.0)
setlowerbound(x[62], 1.8)
setupperbound(x[62], 6.0)
setlowerbound(x[64], 1.5)
setupperbound(x[64], 5.0)
setlowerbound(x[66], 1.2247)
setupperbound(x[66], 4.899)
setlowerbound(x[68], 1.2247)
setupperbound(x[68], 4.899)
setlowerbound(x[70], 2.0)
setupperbound(x[70], 6.3246)
setlowerbound(x[72], 1.5811)
setupperbound(x[72], 5.0)
setlowerbound(x[74], 5.0)
setupperbound(x[74], 10.0)
setlowerbound(x[76], 2.5)
setupperbound(x[76], 5.0)
setlowerbound(x[78], 5.0)
setupperbound(x[78], 10.0)
setlowerbound(x[80], 2.5)
