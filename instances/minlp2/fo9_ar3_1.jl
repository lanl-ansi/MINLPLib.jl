...
set_lower_bound(x[94], 2.3094)
set_upper_bound(x[94], 6.9282)
set_lower_bound(x[95], 2.3094)
set_upper_bound(x[95], 6.9282)
set_lower_bound(x[96], 2.3094)
set_upper_bound(x[96], 6.9282)
set_lower_bound(x[97], 2.3094)
set_upper_bound(x[97], 6.9282)
set_lower_bound(x[98], 2.3094)
set_upper_bound(x[98], 6.9282)
set_lower_bound(x[100], 2.3094)
set_upper_bound(x[100], 6.9282)
set_lower_bound(x[102], 3.4641)
set_upper_bound(x[102], 10.3923)
set_lower_bound(x[104], 3.4641)
set_upper_bound(x[104], 10.3923)
set_lower_bound(x[106], 3.4641)
set_upper_bound(x[106], 10.3923)
set_lower_bound(x[108], 3.4641)
set_upper_bound(x[108], 10.3923)
set_lower_bound(x[110], 1.7321)
set_upper_bound(x[110], 5.1962)
set_lower_bound(x[112], 1.7321)
set_upper_bound(x[112], 5.1962)
set_lower_bound(x[114], 1.7321)
set_upper_bound(x[114], 5.1962)
set_lower_bound(x[116], 1.7321)
set_upper_bound(x[116], 5.1962)
set_lower_bound(x[118], 1.7321)
set_upper_bound(x[118], 5.1962)
set_lower_bound(x[120], 1.7321)
set_upper_bound(x[120], 5.1962)
set_lower_bound(x[122], 1.7321)
set_upper_bound(x[122], 5.1962)
set_lower_bound(x[124], 1.7321)
set_upper_bound(x[124], 5.1962)
...
@constraint(m, e77, -0.433013*x[94]-0.144338*x[96] <= -2.0)
@constraint(m, e78, -0.144338*x[94]-0.433013*x[96] <= -2.0)
@constraint(m, e79, -0.433013*x[95]-0.144338*x[97] <= -2.0)
@constraint(m, e80, -0.144338*x[95]-0.433013*x[97] <= -2.0)
@constraint(m, e81, -0.433013*x[98]-0.144338*x[100] <= -2.0)
@constraint(m, e82, -0.144338*x[98]-0.433013*x[100] <= -2.0)
@constraint(m, e83, -0.288675*x[102]-0.096225*x[104] <= -2.0)
@constraint(m, e84, -0.096225*x[102]-0.288675*x[104] <= -2.0)
@constraint(m, e85, -0.288675*x[106]-0.096225*x[108] <= -2.0)
@constraint(m, e86, -0.096225*x[106]-0.288675*x[108] <= -2.0)
@constraint(m, e87, -0.577334*x[110]-0.192456*x[112] <= -2.0)
@constraint(m, e88, -0.192448*x[110]-0.577356*x[112] <= -2.0)
@constraint(m, e89, -0.577334*x[114]-0.192456*x[116] <= -2.0)
@constraint(m, e90, -0.192448*x[114]-0.577356*x[116] <= -2.0)
@constraint(m, e91, -0.577334*x[118]-0.192456*x[120] <= -2.0)
@constraint(m, e92, -0.192448*x[118]-0.577356*x[120] <= -2.0)
@constraint(m, e93, -0.577334*x[122]-0.192456*x[124] <= -2.0)
@constraint(m, e94, -0.192448*x[122]-0.577356*x[124] <= -2.0)
