...
setlowerbound(x[94], 2.3094)
setupperbound(x[94], 6.9282)
setlowerbound(x[95], 2.3094)
setupperbound(x[95], 6.9282)
setlowerbound(x[96], 2.3094)
setupperbound(x[96], 6.9282)
setlowerbound(x[97], 2.3094)
setupperbound(x[97], 6.9282)
setlowerbound(x[98], 2.3094)
setupperbound(x[98], 6.9282)
setlowerbound(x[100], 2.3094)
setupperbound(x[100], 6.9282)
setlowerbound(x[102], 3.4641)
setupperbound(x[102], 10.3923)
setlowerbound(x[104], 3.4641)
setupperbound(x[104], 10.3923)
setlowerbound(x[106], 3.4641)
setupperbound(x[106], 10.3923)
setlowerbound(x[108], 3.4641)
setupperbound(x[108], 10.3923)
setlowerbound(x[110], 1.7321)
setupperbound(x[110], 5.1962)
setlowerbound(x[112], 1.7321)
setupperbound(x[112], 5.1962)
setlowerbound(x[114], 1.7321)
setupperbound(x[114], 5.1962)
setlowerbound(x[116], 1.7321)
setupperbound(x[116], 5.1962)
setlowerbound(x[118], 1.7321)
setupperbound(x[118], 5.1962)
setlowerbound(x[120], 1.7321)
setupperbound(x[120], 5.1962)
setlowerbound(x[122], 1.7321)
setupperbound(x[122], 5.1962)
setlowerbound(x[124], 1.7321)
setupperbound(x[124], 5.1962)
