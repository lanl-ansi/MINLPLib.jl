...
setlowerbound(x[31], 0.05245)
setupperbound(x[31], 0.0857)
setlowerbound(x[32], 0.06175)
setupperbound(x[32], 0.095)
setlowerbound(x[33], 0.0619)
setupperbound(x[33], 0.0939)
setlowerbound(x[34], 0.0368)
setupperbound(x[34], 0.0768)
setlowerbound(x[35], 0.0368)
setupperbound(x[35], 0.0768)
