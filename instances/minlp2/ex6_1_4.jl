...
# ----- Constraints ----- #
@NLconstraint(m, e1, -((0.28809+log(x[2]))*x[2]+(-0.29158+log(x[3]))*x[3]+(0.59336+log(x[4]))*x[4]+x[2]*(1.44805026165593*x[6]+0.989428667054834*x[7])+x[3]*(1.12676386427658*x[5]+1.00363012835441*x[7])+x[4]*(0.0347225450624344*x[5]+0.82681418300153*x[6]))+objvar == 0.0)
