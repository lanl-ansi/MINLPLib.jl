...
setupperbound(x[6], 2000.0)
setupperbound(x[7], 2000.0)
setupperbound(x[8], 2000.0)
...
setupperbound(x[18], 2000.0)
setlowerbound(x[19], 1500.0)
setupperbound(x[19], 1500.0)
setlowerbound(x[20], 2000.0)
...
setupperbound(x[28], 2000.0)
setupperbound(x[29], 2000.0)
...
setupperbound(x[38], 2000.0)
setlowerbound(x[39], 2000.0)
setupperbound(x[39], 2000.0)
