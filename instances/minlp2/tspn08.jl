...
setlowerbound(x[2], 55.0)
setupperbound(x[2], 68.0)
setlowerbound(x[3], 29.0)
setupperbound(x[3], 38.0)
setlowerbound(x[4], 12.0)
setupperbound(x[4], 22.0)
setlowerbound(x[5], 5.0)
setupperbound(x[5], 16.0)
setlowerbound(x[6], 82.0)
setupperbound(x[6], 91.0)
setlowerbound(x[7], 94.0)
setupperbound(x[7], 105.0)
setupperbound(x[8], 17.0)
setlowerbound(x[9], 16.0)
setupperbound(x[9], 38.0)
setlowerbound(x[10], 97.0)
setupperbound(x[10], 114.0)
setlowerbound(x[11], 57.0)
setupperbound(x[11], 68.0)
setlowerbound(x[12], 108.0)
setupperbound(x[12], 125.0)
setupperbound(x[13], 23.0)
setlowerbound(x[14], 7.0)
setupperbound(x[14], 25.0)
setlowerbound(x[15], 48.0)
setupperbound(x[15], 74.0)
setlowerbound(x[16], 88.0)
setupperbound(x[16], 112.0)
