...
setupperbound(i[41], 100.0)
setupperbound(i[42], 100.0)
setlowerbound(x[60], 2.5298)
setupperbound(x[60], 6.3246)
setlowerbound(x[61], 2.5298)
setupperbound(x[61], 6.3246)
setlowerbound(x[62], 2.5298)
setupperbound(x[62], 6.3246)
setlowerbound(x[63], 2.5298)
setupperbound(x[63], 6.3246)
setlowerbound(x[64], 2.5298)
setupperbound(x[64], 6.3246)
setlowerbound(x[66], 2.5298)
setupperbound(x[66], 6.3246)
setlowerbound(x[68], 3.7947)
setupperbound(x[68], 8.54)
setlowerbound(x[70], 4.2155)
setupperbound(x[70], 9.4868)
setlowerbound(x[72], 1.8974)
setupperbound(x[72], 4.7434)
setlowerbound(x[74], 1.8974)
setupperbound(x[74], 4.7434)
setlowerbound(x[76], 1.8974)
setupperbound(x[76], 4.7434)
setlowerbound(x[78], 1.8974)
setupperbound(x[78], 4.7434)
...
@constraint(m, e47, -0.395288*x[60]-0.158112*x[62] <= -2.0)
@constraint(m, e48, -0.158113*x[60]-0.395288*x[62] <= -2.0)
@constraint(m, e49, -0.395288*x[61]-0.158112*x[63] <= -2.0)
@constraint(m, e50, -0.158113*x[61]-0.395288*x[63] <= -2.0)
@constraint(m, e51, -0.395288*x[64]-0.158112*x[66] <= -2.0)
@constraint(m, e52, -0.158113*x[64]-0.395288*x[66] <= -2.0)
@constraint(m, e53, -0.263525*x[68]-0.105408*x[70] <= -2.0)
@constraint(m, e54, -0.117096*x[68]-0.237222*x[70] <= -2.0)
@constraint(m, e55, -0.527037*x[72]-0.210822*x[74] <= -2.0)
@constraint(m, e56, -0.210819*x[72]-0.527044*x[74] <= -2.0)
@constraint(m, e57, -0.527037*x[76]-0.210822*x[78] <= -2.0)
@constraint(m, e58, -0.210819*x[76]-0.527044*x[78] <= -2.0)
@constraint(m, e59, -0.527037*x[80]-0.210822*x[82] <= -2.0)
@constraint(m, e60, -0.210819*x[80]-0.527044*x[82] <= -2.0)
