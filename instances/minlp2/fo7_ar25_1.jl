...
set_lower_bound(x[60], 2.5298)
set_upper_bound(x[60], 6.3246)
set_lower_bound(x[61], 2.5298)
set_upper_bound(x[61], 6.3246)
set_lower_bound(x[62], 2.5298)
set_upper_bound(x[62], 6.3246)
set_lower_bound(x[63], 2.5298)
set_upper_bound(x[63], 6.3246)
set_lower_bound(x[64], 2.5298)
set_upper_bound(x[64], 6.3246)
set_lower_bound(x[66], 2.5298)
set_upper_bound(x[66], 6.3246)
set_lower_bound(x[68], 3.7947)
set_upper_bound(x[68], 8.54)
set_lower_bound(x[70], 4.2155)
set_upper_bound(x[70], 9.4868)
set_lower_bound(x[72], 1.8974)
set_upper_bound(x[72], 4.7434)
set_lower_bound(x[74], 1.8974)
set_upper_bound(x[74], 4.7434)
set_lower_bound(x[76], 1.8974)
set_upper_bound(x[76], 4.7434)
