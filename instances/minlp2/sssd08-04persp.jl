...
@NLconstraint(m, e30, x[49]*b[33]+x[49]*x[45]-x[45]*b[33] <= 0.0)
@NLconstraint(m, e31, x[50]*b[34]+x[50]*x[45]-x[45]*b[34] <= 0.0)
@NLconstraint(m, e32, x[51]*b[35]+x[51]*x[45]-x[45]*b[35] <= 0.0)
@NLconstraint(m, e33, x[52]*b[36]+x[52]*x[46]-x[46]*b[36] <= 0.0)
@NLconstraint(m, e34, x[53]*b[37]+x[53]*x[46]-x[46]*b[37] <= 0.0)
@NLconstraint(m, e35, x[54]*b[38]+x[54]*x[46]-x[46]*b[38] <= 0.0)
@NLconstraint(m, e36, x[55]*b[39]+x[55]*x[47]-x[47]*b[39] <= 0.0)
@NLconstraint(m, e37, x[56]*b[40]+x[56]*x[47]-x[47]*b[40] <= 0.0)
@NLconstraint(m, e38, x[57]*b[41]+x[57]*x[47]-x[47]*b[41] <= 0.0)
@NLconstraint(m, e39, x[58]*b[42]+x[58]*x[48]-x[48]*b[42] <= 0.0)
@NLconstraint(m, e40, x[59]*b[43]+x[59]*x[48]-x[48]*b[43] <= 0.0)
@NLconstraint(m, e41, x[60]*b[44]+x[60]*x[48]-x[48]*b[44] <= 0.0)
