...
setupperbound(x[79], 14.0)
setlowerbound(x[80], 1.0)
setupperbound(x[80], 13.0)
...
setupperbound(x[85], 14.0)
setupperbound(x[107], 109669.003926881)
setupperbound(x[108], 99699.094478983)
setupperbound(x[109], 109669.003926881)
setupperbound(x[110], 69789.3661352881)
setupperbound(x[111], 99699.094478983)
setupperbound(x[112], 11.0)
setupperbound(x[113], 11.0)
setupperbound(x[114], 11.0)
setupperbound(x[115], 11.0)
setupperbound(x[116], 11.0)
setupperbound(x[117], 11.0)
setupperbound(x[118], 11.0)
setupperbound(x[119], 11.0)
setupperbound(x[120], 11.0)
setupperbound(x[121], 11.0)
...
setupperbound(x[134], 11.0)
setupperbound(x[135], 11.0)
setupperbound(x[136], 11.0)
setupperbound(x[137], 11.0)
setupperbound(x[138], 11.0)
setupperbound(x[139], 11.0)
setupperbound(x[140], 11.0)
setupperbound(x[141], 11.0)
setupperbound(x[142], 7.0)
setupperbound(x[143], 7.0)
setupperbound(x[144], 7.0)
setupperbound(x[145], 7.0)
setupperbound(x[146], 7.0)
setupperbound(x[147], 7.0)
setupperbound(x[148], 7.0)
setupperbound(x[149], 7.0)
setupperbound(x[150], 7.0)
setupperbound(x[151], 7.0)
...
setupperbound(x[162], 11.0)
setupperbound(x[163], 11.0)
setupperbound(x[164], 11.0)
setupperbound(x[165], 11.0)
setupperbound(x[166], 11.0)
setupperbound(x[167], 11.0)
setupperbound(x[168], 11.0)
setupperbound(x[169], 11.0)
setupperbound(x[170], 11.0)
setupperbound(x[171], 11.0)
...
setupperbound(x[190], 11.0)
setupperbound(x[191], 11.0)
setupperbound(x[192], 7.0)
setupperbound(x[193], 7.0)
setupperbound(x[194], 7.0)
setupperbound(x[195], 7.0)
setupperbound(x[196], 7.0)
setupperbound(x[197], 7.0)
setupperbound(x[198], 7.0)
setupperbound(x[199], 7.0)
setupperbound(x[200], 7.0)
setupperbound(x[201], 7.0)
