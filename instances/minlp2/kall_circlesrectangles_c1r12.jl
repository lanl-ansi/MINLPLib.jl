...
setlowerbound(x[27], -0.5)
setupperbound(x[27], 0.5)
setlowerbound(x[28], -0.75)
setupperbound(x[28], 0.75)
setlowerbound(x[29], -0.5)
setupperbound(x[29], 0.5)
setlowerbound(x[30], -0.75)
setupperbound(x[30], 0.75)
setlowerbound(x[31], -0.5)
setupperbound(x[31], 0.5)
setlowerbound(x[32], -0.75)
setupperbound(x[32], 0.75)
setlowerbound(x[33], -0.5)
setupperbound(x[33], 0.5)
setlowerbound(x[34], -0.75)
setupperbound(x[34], 0.75)
...
@NLconstraint(m, e26, x[27]*x[27]+x[28]*x[28] == 0.5625)
@NLconstraint(m, e27, x[29]*x[29]+x[30]*x[30] == 0.25)
