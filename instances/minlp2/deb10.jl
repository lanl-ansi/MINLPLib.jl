...
setupperbound(x[80], 0.5)
setlowerbound(x[81], -0.2)
setupperbound(x[81], 0.6)
setlowerbound(x[82], 0.0)
...
setlowerbound(x[85], -0.3)
setupperbound(x[85], 0.6)
setlowerbound(x[86], 0.0)
setupperbound(x[86], 0.0)
setlowerbound(x[87], 0.0)
setupperbound(x[87], 0.0)
setlowerbound(x[88], -0.1)
setupperbound(x[88], 0.13)
setlowerbound(x[89], 0.0)
...
setlowerbound(b[174], 0.0)
setupperbound(b[174], 0.0)
...
setlowerbound(b[180], 0.0)
setupperbound(b[180], 0.0)
