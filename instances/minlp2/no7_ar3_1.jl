...
set_upper_bound(i[41], 100.0)
set_upper_bound(i[42], 100.0)
set_lower_bound(x[66], 2.3094)
set_upper_bound(x[66], 6.9282)
set_lower_bound(x[67], 2.3094)
set_upper_bound(x[67], 6.9282)
set_lower_bound(x[69], 2.3094)
set_upper_bound(x[69], 6.9282)
set_lower_bound(x[70], 2.3094)
set_upper_bound(x[70], 6.9282)
set_lower_bound(x[72], 2.3094)
set_upper_bound(x[72], 6.9282)
set_lower_bound(x[74], 2.3094)
set_upper_bound(x[74], 6.9282)
set_lower_bound(x[76], 3.4641)
set_upper_bound(x[76], 8.54)
set_lower_bound(x[77], 4.2155)
set_upper_bound(x[77], 10.3923)
set_lower_bound(x[78], 1.7321)
set_upper_bound(x[78], 5.1962)
...
set_lower_bound(x[87], 1.7321)
set_upper_bound(x[87], 5.1962)
...
@constraint(m, e47, -0.433013*x[66]-0.144338*x[69] <= -2.0)
@constraint(m, e48, -0.144338*x[66]-0.433013*x[69] <= -2.0)
@constraint(m, e49, -0.433013*x[67]-0.144338*x[70] <= -2.0)
@constraint(m, e50, -0.144338*x[67]-0.433013*x[70] <= -2.0)
@constraint(m, e51, -0.433013*x[72]-0.144338*x[74] <= -2.0)
@constraint(m, e52, -0.144338*x[72]-0.433013*x[74] <= -2.0)
@constraint(m, e53, -0.288675*x[76]-0.096225*x[77] <= -2.0)
@constraint(m, e54, -0.117096*x[76]-0.237222*x[77] <= -2.0)
@constraint(m, e55, -0.577334*x[78]-0.192456*x[80] <= -2.0)
@constraint(m, e56, -0.192448*x[78]-0.577356*x[80] <= -2.0)
@constraint(m, e57, -0.577334*x[82]-0.192456*x[84] <= -2.0)
@constraint(m, e58, -0.192448*x[82]-0.577356*x[84] <= -2.0)
@constraint(m, e59, -0.577334*x[86]-0.192456*x[87] <= -2.0)
@constraint(m, e60, -0.192448*x[86]-0.577356*x[87] <= -2.0)
