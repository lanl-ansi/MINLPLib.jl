...
set_lower_bound(x[33], 0.0909)
set_upper_bound(x[33], 0.5)
set_lower_bound(x[34], 0.125)
set_upper_bound(x[34], 0.5455)
set_lower_bound(x[35], 0.1428)
set_upper_bound(x[35], 0.5195)
set_lower_bound(x[36], 0.0909)
set_upper_bound(x[36], 0.5)
set_lower_bound(x[37], 0.125)
set_upper_bound(x[37], 0.5455)
set_lower_bound(x[38], 0.1428)
set_upper_bound(x[38], 0.5195)
set_lower_bound(x[39], 0.0909)
set_upper_bound(x[39], 0.5)
set_lower_bound(x[40], 0.125)
set_upper_bound(x[40], 0.5455)
set_lower_bound(x[41], 0.1428)
set_upper_bound(x[41], 0.5195)
set_lower_bound(x[42], 0.0909)
set_upper_bound(x[42], 0.5)
set_lower_bound(x[43], 0.125)
set_upper_bound(x[43], 0.5455)
set_lower_bound(x[44], 0.1428)
set_upper_bound(x[44], 0.5195)


# ----- Constraints ----- #
@constraint(m, e1, -6.2*x[1]-9.4*x[2]-7.6*x[3]-10.2*x[4]-1.67*x[5]-2.53*x[6]-2.05*x[7]-2.75*x[8]-3.58*x[9]-5.42*x[10]-4.39*x[11]-5.89*x[12]-4.53*x[13]-6.87*x[14]-5.55*x[15]-7.45*x[16]-2.62*x[17]-3.98*x[18]-3.22*x[19]-4.32*x[20]+10.5*x[21]+11.2*x[22]+12.5*x[23]+10.5*x[24]+11.2*x[25]+12.5*x[26]+10.5*x[27]+11.2*x[28]+12.5*x[29]+10.5*x[30]+11.2*x[31]+12.5*x[32]-260*b[45]-70*b[46]-150*b[47]-190*b[48]-110*b[49]-310*b[50]-470*b[51]-380*b[52]-510*b[53]+objvar == 0.0)
