...
@variable(m, x[x_Idx])
b_Idx = Any[88, 89, 90, 91, 92, 93, 94, 95, 96, 97, 98, 99, 100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 122, 123, 124, 125, 126, 127, 128, 129, 130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 140, 141, 142, 143, 144, 145, 146, 147, 148, 149, 150, 151, 167, 168, 169, 170, 171]
@variable(m, b[b_Idx])
...
@NLconstraint(m, e264, -log(1+x[153])+x[155]+b[167] <= 1.0)
@constraint(m, e265, x[153]-10*b[167] <= 0.0)
@constraint(m, e266, x[155]-2.39789527279837*b[167] <= 0.0)
@NLconstraint(m, e267, -1.2*log(1+x[154])+x[156]+b[168] <= 1.0)
@constraint(m, e268, x[154]-10*b[168] <= 0.0)
@constraint(m, e269, x[156]-2.87747432735804*b[168] <= 0.0)
@constraint(m, e270, -0.75*x[160]+x[164]+b[169] <= 1.0)
@constraint(m, e271, -0.75*x[160]+x[164]-b[169] >= -1.0)
@constraint(m, e272, x[160]-2.87747432735804*b[169] <= 0.0)
@constraint(m, e273, x[164]-2.15810574551853*b[169] <= 0.0)
@NLconstraint(m, e274, -1.5*log(1+x[161])+x[165]+b[170] <= 1.0)
@constraint(m, e275, x[161]-2.87747432735804*b[170] <= 0.0)
@constraint(m, e276, x[165]-2.03277599268042*b[170] <= 0.0)
@constraint(m, e277, -x[162]+x[166]+b[171] <= 1.0)
@constraint(m, e278, -x[162]+x[166]-b[171] >= -1.0)
@constraint(m, e279, -0.5*x[163]+x[166]+b[171] <= 1.0)
@constraint(m, e280, -0.5*x[163]+x[166]-b[171] >= -1.0)
@constraint(m, e281, x[162]-2.87747432735804*b[171] <= 0.0)
@constraint(m, e282, x[163]-7*b[171] <= 0.0)
@constraint(m, e283, x[166]-3.5*b[171] <= 0.0)
@constraint(m, e284, b[167]+b[168] == 1.0)
@constraint(m, e285, b[167]+b[168]-b[169] >= 0.0)
@constraint(m, e286, b[167]+b[168]-b[170] >= 0.0)
@constraint(m, e287, b[167]+b[168]-b[171] >= 0.0)
