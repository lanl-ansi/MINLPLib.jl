...
setlowerbound(x[38], -1.69454444444444)
setupperbound(x[38], 1.69454444444444)
setlowerbound(x[39], -1.69454444444444)
setupperbound(x[39], 1.69454444444444)
setlowerbound(x[40], -1.69454444444444)
setupperbound(x[40], 1.69454444444444)
setlowerbound(x[41], -1.69444444444444)
setupperbound(x[41], 1.69444444444444)
setlowerbound(x[42], -1.69454444444444)
setupperbound(x[42], 1.69454444444444)
setlowerbound(x[43], -1.69454444444444)
setupperbound(x[43], 1.69454444444444)
setlowerbound(x[44], -1.69444444444444)
setupperbound(x[44], 1.69444444444444)
setlowerbound(x[45], -1.69444444444444)
setupperbound(x[45], 1.69444444444444)
setlowerbound(x[46], -1.69454444444444)
setupperbound(x[46], 1.69454444444444)
setlowerbound(x[47], -5.34037777777778)
setupperbound(x[47], 5.34037777777778)
setlowerbound(x[48], -5.34037777777778)
setupperbound(x[48], 5.34037777777778)
setlowerbound(x[49], -5.34037777777778)
setupperbound(x[49], 5.34037777777778)
setlowerbound(x[50], -5.34027777777778)
setupperbound(x[50], 5.34027777777778)
setlowerbound(x[51], -5.34037777777778)
setupperbound(x[51], 5.34037777777778)
setlowerbound(x[52], -5.34037777777778)
setupperbound(x[52], 5.34037777777778)
setlowerbound(x[53], -5.34027777777778)
setupperbound(x[53], 5.34027777777778)
setlowerbound(x[54], -5.34027777777778)
setupperbound(x[54], 5.34027777777778)
setlowerbound(x[55], -5.34037777777778)
setupperbound(x[55], 5.34037777777778)
setlowerbound(x[56], -3.48536077097506)
setupperbound(x[56], 3.48536077097506)
setlowerbound(x[57], -3.48536077097506)
setupperbound(x[57], 3.48536077097506)
setlowerbound(x[58], -3.48536077097506)
setupperbound(x[58], 3.48536077097506)
setlowerbound(x[59], -3.48526077097506)
setupperbound(x[59], 3.48526077097506)
setlowerbound(x[60], -3.48536077097506)
setupperbound(x[60], 3.48536077097506)
setlowerbound(x[61], -3.48536077097506)
setupperbound(x[61], 3.48536077097506)
setlowerbound(x[62], -3.48526077097506)
setupperbound(x[62], 3.48526077097506)
setlowerbound(x[63], -3.48526077097506)
setupperbound(x[63], 3.48526077097506)
setlowerbound(x[64], -3.48536077097506)
setupperbound(x[64], 3.48536077097506)
...
setlowerbound(x[155], 18.9752196276824)
setlowerbound(x[156], 0.333333333333333)
setupperbound(x[156], 0.666666666666667)
setlowerbound(x[157], 0.333333333333333)
setupperbound(x[157], 0.666666666666667)
setlowerbound(x[158], 0.333333333333333)
setupperbound(x[158], 0.666666666666667)
setlowerbound(x[159], 1.25)
setupperbound(x[159], 2.08333333333333)
setlowerbound(x[160], 1.25)
setupperbound(x[160], 2.08333333333333)
setlowerbound(x[161], 1.25)
setupperbound(x[161], 2.08333333333333)
setlowerbound(x[162], 0.666666666666667)
setupperbound(x[162], 1.42857142857143)
setlowerbound(x[163], 0.666666666666667)
setupperbound(x[163], 1.42857142857143)
setlowerbound(x[164], 0.666666666666667)
setupperbound(x[164], 1.42857142857143)
setlowerbound(x[165], 2.0)
setupperbound(x[165], 9.0)
setlowerbound(x[166], 2.0)
setupperbound(x[166], 9.0)
setlowerbound(x[167], 2.0)
setupperbound(x[167], 9.0)
setlowerbound(x[168], 1.0)
setupperbound(x[168], 8.0)
setlowerbound(x[169], 1.0)
setupperbound(x[169], 8.0)
setlowerbound(x[170], 1.0)
setupperbound(x[170], 8.0)
setlowerbound(x[171], 0.6)
setupperbound(x[171], 8.4)
setlowerbound(x[172], 0.6)
setupperbound(x[172], 8.4)
setlowerbound(x[173], 0.6)
setupperbound(x[173], 8.4)
setlowerbound(x[174], 0.7)
setupperbound(x[174], 8.3)
setlowerbound(x[175], 0.7)
setupperbound(x[175], 8.3)
setlowerbound(x[176], 0.7)
setupperbound(x[176], 8.3)
