...
setlowerbound(x[2], 0.3)
setupperbound(x[2], 0.7)
setlowerbound(x[3], -0.05)
setupperbound(x[3], 0.2)
setlowerbound(x[35], 0.0001)
setlowerbound(x[36], 0.0001)
setlowerbound(x[37], 0.0001)
setlowerbound(x[38], 0.0001)
setlowerbound(x[39], 0.0001)
setlowerbound(x[40], 0.0001)
setlowerbound(x[41], 0.0001)
setlowerbound(x[42], 0.0001)
setlowerbound(x[43], 0.0001)
setlowerbound(x[44], 1.0)
setupperbound(x[44], 1.0)
setlowerbound(x[45], 0.0001)
setlowerbound(x[46], 0.0001)
setlowerbound(x[47], 0.0001)
setlowerbound(x[48], 0.0001)
setlowerbound(x[49], 0.0001)
setlowerbound(x[50], 0.0001)
setlowerbound(x[51], 0.0001)
setlowerbound(x[52], 0.0001)
setlowerbound(x[53], 0.0001)
setlowerbound(x[54], 0.0001)
setlowerbound(x[55], 0.0001)
setlowerbound(x[56], 0.0001)
setlowerbound(x[57], 0.0001)
setlowerbound(x[58], 0.0001)
setlowerbound(x[59], 0.0001)
setlowerbound(x[60], 0.0001)
setlowerbound(x[61], 0.0001)
setlowerbound(x[62], 0.0001)
setlowerbound(x[63], 0.0001)
setlowerbound(x[64], 0.0001)
setlowerbound(x[65], 0.0001)
setlowerbound(x[66], 0.0001)
setlowerbound(x[67], 0.0001)
setlowerbound(x[68], 0.0001)
setlowerbound(x[69], 0.0001)
setlowerbound(x[70], 0.0001)
setlowerbound(x[71], 0.0001)
setlowerbound(x[72], 0.0001)


# ----- Constraints ----- #
@constraint(m, e1, x[1]-x[31] == 0.0)
