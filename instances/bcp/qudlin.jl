...
# ----- Constraints ----- #
@constraint(m, e1, -(x[1]*x[2]+x[2]*x[3]+x[3]*x[4]+x[4]*x[5]+x[5]*x[6]+x[6]*x[7]-10*x[1]-20*x[2]-30*x[3]-40*x[4]-50*x[5]-60*x[6]-70*x[7])+80*x[8]+90*x[9]+100*x[10]+110*x[11]+120*x[12]+x[13] == 0.0)
