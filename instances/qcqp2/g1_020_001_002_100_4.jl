...
@constraint(m, e3, 0.97*x[2]-0.08*x[3]-0.57*x[4]-0.73*x[5]-0.29*x[6]-0.86*x[7]+0.29*x[8]-0.86*x[9]+0.1*x[10]-0.95*x[11]+0.17*x[12]+0.39*x[13]-0.75*x[14]-0.64*x[15]-0.87*x[16]-0.92*x[17]+0.13*x[18]+0.48*x[19]+0.28*x[20]+0.29*x[21] == 0.84)
@constraint(m, e4, -0.85*x[2]-0.59*x[3]+0.4*x[4]-0.8*x[5]+0.05*x[6]-0.04*x[7]-0.6*x[8]-0.43*x[9]-0.12*x[10]+0.76*x[11]+0.54*x[12]-0.32*x[13]-0.96*x[14]+0.74*x[15]+0.59*x[16]-0.83*x[17]+0.31*x[18]-0.1*x[19]-0.42*x[20]-0.62*x[21] == 0.06)
