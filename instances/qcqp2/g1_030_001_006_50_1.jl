...
@constraint(m, e3, 0.23*x[2]-0.35*x[3]+0.38*x[4]+0.48*x[5]+0.09*x[6]+0.82*x[7]-0.24*x[8]+0.13*x[9]+0.39*x[10]-0.52*x[11]-0.71*x[12]+0.02*x[13]-0.28*x[14]-0.53*x[15]-0.24*x[16]+0.24*x[17]+0.72*x[18]-0.07*x[19]-0.24*x[20]-0.94*x[21]-0.18*x[22]+0.19*x[23]-0.49*x[24]+0.81*x[25]+0.26*x[26]+0.05*x[27]+0.26*x[28]-x[29]-0.23*x[30]+0.77*x[31] == -0.03)
@constraint(m, e4, 0.75*x[2]-0.91*x[3]+0.38*x[4]-0.19*x[5]+0.63*x[6]-0.85*x[7]+0.03*x[8]+0.28*x[9]-0.74*x[10]+0.62*x[11]-0.05*x[12]-0.66*x[13]+0.3*x[14]-0.45*x[15]-0.73*x[16]-0.8*x[17]+0.62*x[18]+0.25*x[19]+0.84*x[20]-0.96*x[21]+0.19*x[22]+0.01*x[23]+0.31*x[24]-0.22*x[25]+0.48*x[26]+0.34*x[27]+0.62*x[28]+0.57*x[29]+0.82*x[30]-0.95*x[31] == 0.58)
@constraint(m, e5, 0.24*x[2]-0.59*x[3]+0.95*x[4]-0.95*x[5]+0.03*x[6]-0.82*x[7]-0.29*x[8]+0.85*x[9]-0.08*x[10]+0.59*x[11]-0.27*x[12]+0.65*x[13]-0.04*x[14]-0.49*x[15]+0.23*x[16]-0.77*x[17]+0.01*x[18]+0.99*x[19]+0.83*x[20]-0.84*x[21]-0.94*x[22]+0.5*x[23]+0.37*x[24]-0.28*x[25]+0.94*x[26]+0.15*x[27]+0.11*x[28]+0.5*x[29]+0.08*x[30]-0.89*x[31] == -0.91)
@constraint(m, e6, -0.07*x[2]-0.86*x[3]+0.88*x[4]-0.23*x[5]+0.34*x[6]+0.62*x[7]-0.22*x[8]-0.46*x[9]+0.89*x[10]-0.52*x[11]-0.49*x[12]-0.52*x[13]-0.07*x[14]-0.61*x[15]-0.28*x[16]+0.11*x[17]+0.06*x[18]+0.7*x[19]+0.32*x[20]+0.99*x[21]+0.63*x[22]-0.22*x[23]+0.48*x[24]-0.08*x[25]+0.4*x[26]-0.14*x[27]-0.25*x[28]-0.05*x[29]+0.17*x[30]+0.4*x[31] == -0.31)
@constraint(m, e7, -0.63*x[2]+0.08*x[3]+0.73*x[4]-x[5]-0.24*x[6]-0.24*x[7]+0.98*x[8]-0.86*x[9]-0.79*x[10]-0.95*x[11]+0.27*x[12]+0.75*x[13]-0.22*x[14]-0.81*x[15]+0.54*x[16]-0.28*x[17]+0.96*x[18]+0.65*x[19]-0.21*x[20]-0.39*x[21]+0.5*x[22]-0.74*x[23]-0.55*x[24]-0.22*x[25]+0.2*x[26]-0.49*x[27]+0.06*x[28]-0.67*x[29]+0.43*x[30]+0.05*x[31] == -0.37)
@constraint(m, e8, -0.41*x[2]-0.88*x[3]-0.3*x[4]+0.5*x[5]-0.9*x[6]-0.63*x[7]+0.1*x[8]+0.69*x[9]-0.28*x[10]+0.88*x[11]+0.07*x[12]+0.49*x[13]+0.33*x[14]-0.46*x[15]+0.17*x[16]-0.55*x[17]+0.7*x[18]-0.14*x[19]+0.91*x[20]+0.38*x[21]+0.46*x[22]-0.71*x[23]-0.14*x[24]-0.82*x[25]+0.28*x[26]+0.84*x[27]+0.32*x[28]+0.78*x[29]+0.64*x[30]-0.53*x[31] == 0.16)
