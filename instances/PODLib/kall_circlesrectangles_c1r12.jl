...
set_upper_bound(x[4], 8.94427190999916)
set_upper_bound(x[5], 8.94427190999916)
set_upper_bound(x[6], 8.94427190999916)
set_upper_bound(x[7], 8.94427190999916)
set_lower_bound(x[8], -8.94427190999916)
set_upper_bound(x[8], 8.94427190999916)
set_lower_bound(x[9], -8.94427190999916)
...
set_lower_bound(x[17], -8.94427190999916)
set_upper_bound(x[17], 8.94427190999916)
set_lower_bound(x[18], -8.94427190999916)
...
set_lower_bound(x[27], -0.5)
set_upper_bound(x[27], 0.5)
set_lower_bound(x[28], -0.75)
set_upper_bound(x[28], 0.75)
set_lower_bound(x[29], -0.5)
set_upper_bound(x[29], 0.5)
set_lower_bound(x[30], -0.75)
set_upper_bound(x[30], 0.75)
set_lower_bound(x[31], -0.5)
set_upper_bound(x[31], 0.5)
set_lower_bound(x[32], -0.75)
set_upper_bound(x[32], 0.75)
set_lower_bound(x[33], -0.5)
set_upper_bound(x[33], 0.5)
set_lower_bound(x[34], -0.75)
set_upper_bound(x[34], 0.75)
set_lower_bound(x[35], 0.5)
set_upper_bound(x[35], 7.5)
...
set_upper_bound(x[43], 8.0)
set_upper_bound(x[44], 4.0)
set_upper_bound(x[45], 8.0)
set_upper_bound(x[46], 4.0)
set_upper_bound(x[47], 8.0)
