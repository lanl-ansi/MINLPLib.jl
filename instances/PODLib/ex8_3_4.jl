...
@NLconstraint(m, e8, x[12]*x[7]-(x[37]*x[57]+x[41]*x[62]+x[45]*x[67]+x[49]*x[72]+x[53]*x[77])-5.8*x[2] == 0.0)
...
@NLconstraint(m, e12, x[16]*x[8]-(x[37]*x[58]+x[41]*x[63]+x[45]*x[68]+x[49]*x[73]+x[53]*x[78])-5.8*x[3] == 0.0)
...
@NLconstraint(m, e16, x[20]*x[9]-(x[37]*x[59]+x[41]*x[64]+x[45]*x[69]+x[49]*x[74]+x[53]*x[79])-5.8*x[4] == 0.0)
...
@NLconstraint(m, e20, x[24]*x[10]-(x[37]*x[60]+x[41]*x[65]+x[45]*x[70]+x[49]*x[75]+x[53]*x[80])-5.8*x[5] == 0.0)
...
@NLconstraint(m, e24, x[28]*x[11]-(x[37]*x[61]+x[41]*x[66]+x[45]*x[71]+x[49]*x[76]+x[53]*x[81])-5.8*x[6] == 0.0)
