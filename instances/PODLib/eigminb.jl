...
@NLconstraint(m, e2, x[2]*x[1]-2*x[2]+x[3] == 0.0)
@NLconstraint(m, e3, x[3]*x[1]-2*x[3]+x[2]+x[4] == 0.0)
@NLconstraint(m, e4, x[4]*x[1]-2*x[4]+x[3]+x[5] == 0.0)
@NLconstraint(m, e5, x[5]*x[1]-2*x[5]+x[4]+x[6] == 0.0)
@NLconstraint(m, e6, x[6]*x[1]-2*x[6]+x[5]+x[7] == 0.0)
@NLconstraint(m, e7, x[7]*x[1]-2*x[7]+x[6]+x[8] == 0.0)
@NLconstraint(m, e8, x[8]*x[1]-2*x[8]+x[7]+x[9] == 0.0)
@NLconstraint(m, e9, x[9]*x[1]-2*x[9]+x[8]+x[10] == 0.0)
@NLconstraint(m, e10, x[10]*x[1]-2*x[10]+x[9]+x[11] == 0.0)
@NLconstraint(m, e11, x[11]*x[1]-2*x[11]+x[10]+x[12] == 0.0)
@NLconstraint(m, e12, x[12]*x[1]-2*x[12]+x[11]+x[13] == 0.0)
@NLconstraint(m, e13, x[13]*x[1]-2*x[13]+x[12]+x[14] == 0.0)
@NLconstraint(m, e14, x[14]*x[1]-2*x[14]+x[13]+x[15] == 0.0)
@NLconstraint(m, e15, x[15]*x[1]-2*x[15]+x[14]+x[16] == 0.0)
@NLconstraint(m, e16, x[16]*x[1]-2*x[16]+x[15]+x[17] == 0.0)
@NLconstraint(m, e17, x[17]*x[1]-2*x[17]+x[16]+x[18] == 0.0)
@NLconstraint(m, e18, x[18]*x[1]-2*x[18]+x[17]+x[19] == 0.0)
@NLconstraint(m, e19, x[19]*x[1]-2*x[19]+x[18]+x[20] == 0.0)
@NLconstraint(m, e20, x[20]*x[1]-2*x[20]+x[19]+x[21] == 0.0)
@NLconstraint(m, e21, x[21]*x[1]-2*x[21]+x[20]+x[22] == 0.0)
@NLconstraint(m, e22, x[22]*x[1]-2*x[22]+x[21]+x[23] == 0.0)
@NLconstraint(m, e23, x[23]*x[1]-2*x[23]+x[22]+x[24] == 0.0)
@NLconstraint(m, e24, x[24]*x[1]-2*x[24]+x[23]+x[25] == 0.0)
@NLconstraint(m, e25, x[25]*x[1]-2*x[25]+x[24]+x[26] == 0.0)
@NLconstraint(m, e26, x[26]*x[1]-2*x[26]+x[25]+x[27] == 0.0)
@NLconstraint(m, e27, x[27]*x[1]-2*x[27]+x[26]+x[28] == 0.0)
@NLconstraint(m, e28, x[28]*x[1]-2*x[28]+x[27]+x[29] == 0.0)
@NLconstraint(m, e29, x[29]*x[1]-2*x[29]+x[28]+x[30] == 0.0)
@NLconstraint(m, e30, x[30]*x[1]-2*x[30]+x[29]+x[31] == 0.0)
@NLconstraint(m, e31, x[31]*x[1]-2*x[31]+x[30]+x[32] == 0.0)
@NLconstraint(m, e32, x[32]*x[1]-2*x[32]+x[31]+x[33] == 0.0)
@NLconstraint(m, e33, x[33]*x[1]-2*x[33]+x[32]+x[34] == 0.0)
@NLconstraint(m, e34, x[34]*x[1]-2*x[34]+x[33]+x[35] == 0.0)
@NLconstraint(m, e35, x[35]*x[1]-2*x[35]+x[34]+x[36] == 0.0)
@NLconstraint(m, e36, x[36]*x[1]-2*x[36]+x[35]+x[37] == 0.0)
@NLconstraint(m, e37, x[37]*x[1]-2*x[37]+x[36]+x[38] == 0.0)
@NLconstraint(m, e38, x[38]*x[1]-2*x[38]+x[37]+x[39] == 0.0)
@NLconstraint(m, e39, x[39]*x[1]-2*x[39]+x[38]+x[40] == 0.0)
@NLconstraint(m, e40, x[40]*x[1]-2*x[40]+x[39]+x[41] == 0.0)
@NLconstraint(m, e41, x[41]*x[1]-2*x[41]+x[40]+x[42] == 0.0)
@NLconstraint(m, e42, x[42]*x[1]-2*x[42]+x[41]+x[43] == 0.0)
@NLconstraint(m, e43, x[43]*x[1]-2*x[43]+x[42]+x[44] == 0.0)
@NLconstraint(m, e44, x[44]*x[1]-2*x[44]+x[43]+x[45] == 0.0)
@NLconstraint(m, e45, x[45]*x[1]-2*x[45]+x[44]+x[46] == 0.0)
@NLconstraint(m, e46, x[46]*x[1]-2*x[46]+x[45]+x[47] == 0.0)
@NLconstraint(m, e47, x[47]*x[1]-2*x[47]+x[46]+x[48] == 0.0)
@NLconstraint(m, e48, x[48]*x[1]-2*x[48]+x[47]+x[49] == 0.0)
@NLconstraint(m, e49, x[49]*x[1]-2*x[49]+x[48]+x[50] == 0.0)
@NLconstraint(m, e50, x[50]*x[1]-2*x[50]+x[49]+x[51] == 0.0)
@NLconstraint(m, e51, x[51]*x[1]-2*x[51]+x[50]+x[52] == 0.0)
@NLconstraint(m, e52, x[52]*x[1]-2*x[52]+x[51]+x[53] == 0.0)
@NLconstraint(m, e53, x[53]*x[1]-2*x[53]+x[52]+x[54] == 0.0)
@NLconstraint(m, e54, x[54]*x[1]-2*x[54]+x[53]+x[55] == 0.0)
@NLconstraint(m, e55, x[55]*x[1]-2*x[55]+x[54]+x[56] == 0.0)
@NLconstraint(m, e56, x[56]*x[1]-2*x[56]+x[55]+x[57] == 0.0)
@NLconstraint(m, e57, x[57]*x[1]-2*x[57]+x[56]+x[58] == 0.0)
@NLconstraint(m, e58, x[58]*x[1]-2*x[58]+x[57]+x[59] == 0.0)
@NLconstraint(m, e59, x[59]*x[1]-2*x[59]+x[58]+x[60] == 0.0)
@NLconstraint(m, e60, x[60]*x[1]-2*x[60]+x[59]+x[61] == 0.0)
@NLconstraint(m, e61, x[61]*x[1]-2*x[61]+x[60]+x[62] == 0.0)
@NLconstraint(m, e62, x[62]*x[1]-2*x[62]+x[61]+x[63] == 0.0)
@NLconstraint(m, e63, x[63]*x[1]-2*x[63]+x[62]+x[64] == 0.0)
@NLconstraint(m, e64, x[64]*x[1]-2*x[64]+x[63]+x[65] == 0.0)
@NLconstraint(m, e65, x[65]*x[1]-2*x[65]+x[64]+x[66] == 0.0)
@NLconstraint(m, e66, x[66]*x[1]-2*x[66]+x[65]+x[67] == 0.0)
@NLconstraint(m, e67, x[67]*x[1]-2*x[67]+x[66]+x[68] == 0.0)
@NLconstraint(m, e68, x[68]*x[1]-2*x[68]+x[67]+x[69] == 0.0)
@NLconstraint(m, e69, x[69]*x[1]-2*x[69]+x[68]+x[70] == 0.0)
@NLconstraint(m, e70, x[70]*x[1]-2*x[70]+x[69]+x[71] == 0.0)
@NLconstraint(m, e71, x[71]*x[1]-2*x[71]+x[70]+x[72] == 0.0)
@NLconstraint(m, e72, x[72]*x[1]-2*x[72]+x[71]+x[73] == 0.0)
@NLconstraint(m, e73, x[73]*x[1]-2*x[73]+x[72]+x[74] == 0.0)
@NLconstraint(m, e74, x[74]*x[1]-2*x[74]+x[73]+x[75] == 0.0)
@NLconstraint(m, e75, x[75]*x[1]-2*x[75]+x[74]+x[76] == 0.0)
@NLconstraint(m, e76, x[76]*x[1]-2*x[76]+x[75]+x[77] == 0.0)
@NLconstraint(m, e77, x[77]*x[1]-2*x[77]+x[76]+x[78] == 0.0)
@NLconstraint(m, e78, x[78]*x[1]-2*x[78]+x[77]+x[79] == 0.0)
@NLconstraint(m, e79, x[79]*x[1]-2*x[79]+x[78]+x[80] == 0.0)
@NLconstraint(m, e80, x[80]*x[1]-2*x[80]+x[79]+x[81] == 0.0)
@NLconstraint(m, e81, x[81]*x[1]-2*x[81]+x[80]+x[82] == 0.0)
@NLconstraint(m, e82, x[82]*x[1]-2*x[82]+x[81]+x[83] == 0.0)
@NLconstraint(m, e83, x[83]*x[1]-2*x[83]+x[82]+x[84] == 0.0)
@NLconstraint(m, e84, x[84]*x[1]-2*x[84]+x[83]+x[85] == 0.0)
@NLconstraint(m, e85, x[85]*x[1]-2*x[85]+x[84]+x[86] == 0.0)
@NLconstraint(m, e86, x[86]*x[1]-2*x[86]+x[85]+x[87] == 0.0)
@NLconstraint(m, e87, x[87]*x[1]-2*x[87]+x[86]+x[88] == 0.0)
@NLconstraint(m, e88, x[88]*x[1]-2*x[88]+x[87]+x[89] == 0.0)
@NLconstraint(m, e89, x[89]*x[1]-2*x[89]+x[88]+x[90] == 0.0)
@NLconstraint(m, e90, x[90]*x[1]-2*x[90]+x[89]+x[91] == 0.0)
@NLconstraint(m, e91, x[91]*x[1]-2*x[91]+x[90]+x[92] == 0.0)
@NLconstraint(m, e92, x[92]*x[1]-2*x[92]+x[91]+x[93] == 0.0)
@NLconstraint(m, e93, x[93]*x[1]-2*x[93]+x[92]+x[94] == 0.0)
@NLconstraint(m, e94, x[94]*x[1]-2*x[94]+x[93]+x[95] == 0.0)
@NLconstraint(m, e95, x[95]*x[1]-2*x[95]+x[94]+x[96] == 0.0)
@NLconstraint(m, e96, x[96]*x[1]-2*x[96]+x[95]+x[97] == 0.0)
@NLconstraint(m, e97, x[97]*x[1]-2*x[97]+x[96]+x[98] == 0.0)
@NLconstraint(m, e98, x[98]*x[1]-2*x[98]+x[97]+x[99] == 0.0)
@NLconstraint(m, e99, x[99]*x[1]-2*x[99]+x[98]+x[100] == 0.0)
@NLconstraint(m, e100, x[100]*x[1]-2*x[100]+x[99]+x[101] == 0.0)
@NLconstraint(m, e101, x[101]*x[1]-2*x[101]+x[100] == 0.0)
