...
setupperbound(x[47], 50.0)
setupperbound(x[48], 50.0)
setupperbound(x[49], 50.0)
setupperbound(x[50], 50.0)
setupperbound(x[51], 50.0)
setupperbound(x[52], 50.0)
setupperbound(x[53], 50.0)
setupperbound(x[54], 50.0)
setupperbound(x[55], 50.0)
setupperbound(x[56], 50.0)
setupperbound(x[57], 50.0)
setupperbound(x[58], 50.0)
setupperbound(x[59], 50.0)
setupperbound(x[60], 50.0)
setupperbound(x[61], 50.0)
...
setupperbound(x[77], 600.0)
setupperbound(x[78], 600.0)
setupperbound(x[79], 600.0)
setupperbound(x[80], 600.0)
setupperbound(x[81], 600.0)
setupperbound(x[82], 600.0)
setupperbound(x[83], 50.0)
setupperbound(x[84], 50.0)
setupperbound(x[85], 50.0)
setupperbound(x[86], 600.0)
setupperbound(x[87], 600.0)
setupperbound(x[88], 600.0)
