...
set_lower_bound(x[13], -3.90512483795333)
set_upper_bound(x[13], 3.90512483795333)
set_lower_bound(x[14], -3.90512483795333)
set_upper_bound(x[14], 3.90512483795333)
...
set_lower_bound(x[27], -3.90512483795333)
set_upper_bound(x[27], 3.90512483795333)
set_lower_bound(x[28], -3.90512483795333)
set_upper_bound(x[28], 3.90512483795333)
set_lower_bound(x[29], 0.5)
set_upper_bound(x[29], 2.5)
set_lower_bound(x[30], 0.5)
set_upper_bound(x[30], 2.0)
set_upper_bound(x[31], 3.0)
set_upper_bound(x[32], 2.5)
set_upper_bound(x[33], 3.0)
set_upper_bound(x[34], 2.5)
set_upper_bound(x[35], 3.0)
set_upper_bound(x[36], 2.5)
