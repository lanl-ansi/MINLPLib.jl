...
setupperbound(x[11], 1.6)
setlowerbound(x[12], 0.5)
setupperbound(x[12], 7.5)
setlowerbound(x[13], 0.5)
setupperbound(x[13], 1.6)
setlowerbound(x[14], 0.5)
setupperbound(x[14], 7.5)
setlowerbound(x[15], 0.5)
setupperbound(x[15], 1.6)
setlowerbound(x[16], 0.5)
setupperbound(x[16], 7.5)
setlowerbound(x[17], 0.5)
setupperbound(x[17], 1.6)
setlowerbound(x[18], 0.7)
setupperbound(x[18], 7.3)
setlowerbound(x[19], 0.7)
setupperbound(x[19], 1.4)
setupperbound(x[20], 8.0)
setupperbound(x[21], 2.1)
setlowerbound(objvar, 0.0)
setupperbound(objvar, 16.8)
...
@constraint(m, e9, (x[2]-x[16])*(x[2]-x[16])+(x[3]-x[17])*(x[3]-x[17]) >= 1.0)
@constraint(m, e10, (x[2]-x[18])*(x[2]-x[18])+(x[3]-x[19])*(x[3]-x[19]) >= 1.44)
@constraint(m, e11, (x[4]-x[6])*(x[4]-x[6])+(x[5]-x[7])*(x[5]-x[7]) >= 1.0)
@constraint(m, e12, (x[4]-x[8])*(x[4]-x[8])+(x[5]-x[9])*(x[5]-x[9]) >= 1.0)
@constraint(m, e13, (x[4]-x[10])*(x[4]-x[10])+(x[5]-x[11])*(x[5]-x[11]) >= 1.0)
@constraint(m, e14, (x[4]-x[12])*(x[4]-x[12])+(x[5]-x[13])*(x[5]-x[13]) >= 1.0)
@constraint(m, e15, (x[4]-x[14])*(x[4]-x[14])+(x[5]-x[15])*(x[5]-x[15]) >= 1.0)
@constraint(m, e16, (x[4]-x[16])*(x[4]-x[16])+(x[5]-x[17])*(x[5]-x[17]) >= 1.0)
@constraint(m, e17, (x[4]-x[18])*(x[4]-x[18])+(x[5]-x[19])*(x[5]-x[19]) >= 1.44)
@constraint(m, e18, (x[6]-x[8])*(x[6]-x[8])+(x[7]-x[9])*(x[7]-x[9]) >= 1.0)
@constraint(m, e19, (x[6]-x[10])*(x[6]-x[10])+(x[7]-x[11])*(x[7]-x[11]) >= 1.0)
@constraint(m, e20, (x[6]-x[12])*(x[6]-x[12])+(x[7]-x[13])*(x[7]-x[13]) >= 1.0)
@constraint(m, e21, (x[6]-x[14])*(x[6]-x[14])+(x[7]-x[15])*(x[7]-x[15]) >= 1.0)
@constraint(m, e22, (x[6]-x[16])*(x[6]-x[16])+(x[7]-x[17])*(x[7]-x[17]) >= 1.0)
@constraint(m, e23, (x[6]-x[18])*(x[6]-x[18])+(x[7]-x[19])*(x[7]-x[19]) >= 1.44)
@constraint(m, e24, (x[8]-x[10])*(x[8]-x[10])+(x[9]-x[11])*(x[9]-x[11]) >= 1.0)
@constraint(m, e25, (x[8]-x[12])*(x[8]-x[12])+(x[9]-x[13])*(x[9]-x[13]) >= 1.0)
@constraint(m, e26, (x[8]-x[14])*(x[8]-x[14])+(x[9]-x[15])*(x[9]-x[15]) >= 1.0)
@constraint(m, e27, (x[8]-x[16])*(x[8]-x[16])+(x[9]-x[17])*(x[9]-x[17]) >= 1.0)
@constraint(m, e28, (x[8]-x[18])*(x[8]-x[18])+(x[9]-x[19])*(x[9]-x[19]) >= 1.44)
@constraint(m, e29, (x[10]-x[12])*(x[10]-x[12])+(x[11]-x[13])*(x[11]-x[13]) >= 1.0)
@constraint(m, e30, (x[10]-x[14])*(x[10]-x[14])+(x[11]-x[15])*(x[11]-x[15]) >= 1.0)
@constraint(m, e31, (x[10]-x[16])*(x[10]-x[16])+(x[11]-x[17])*(x[11]-x[17]) >= 1.0)
@constraint(m, e32, (x[10]-x[18])*(x[10]-x[18])+(x[11]-x[19])*(x[11]-x[19]) >= 1.44)
@constraint(m, e33, (x[12]-x[14])*(x[12]-x[14])+(x[13]-x[15])*(x[13]-x[15]) >= 1.0)
@constraint(m, e34, (x[12]-x[16])*(x[12]-x[16])+(x[13]-x[17])*(x[13]-x[17]) >= 1.0)
@constraint(m, e35, (x[12]-x[18])*(x[12]-x[18])+(x[13]-x[19])*(x[13]-x[19]) >= 1.44)
@constraint(m, e36, (x[14]-x[16])*(x[14]-x[16])+(x[15]-x[17])*(x[15]-x[17]) >= 1.0)
@constraint(m, e37, (x[14]-x[18])*(x[14]-x[18])+(x[15]-x[19])*(x[15]-x[19]) >= 1.44)
@constraint(m, e38, (x[16]-x[18])*(x[16]-x[18])+(x[17]-x[19])*(x[17]-x[19]) >= 1.44)
