...
setlowerbound(x[31], 1.92)
setupperbound(x[31], 2.02)
setlowerbound(x[32], 3.82)
setupperbound(x[32], 4.01333333333333)
setlowerbound(x[33], 4.53333333333333)
setupperbound(x[33], 4.76)
setlowerbound(x[34], 5.39333333333333)
setupperbound(x[34], 5.96)
setlowerbound(x[35], 36.3533333333333)
setupperbound(x[35], 42.0933333333333)
setlowerbound(x[36], 85.7466666666667)
setupperbound(x[36], 99.28)
setlowerbound(x[37], 6.28)
setupperbound(x[37], 6.59333333333333)
setlowerbound(x[38], 53.4333333333333)
setupperbound(x[38], 61.8666666666667)
setlowerbound(x[39], 48.6133333333333)
setupperbound(x[39], 56.2866666666667)
setlowerbound(x[40], 33.9533333333333)
setupperbound(x[40], 41.5)
setlowerbound(x[41], 53.9666666666667)
setupperbound(x[41], 62.4933333333333)
setlowerbound(x[42], 77.0533333333333)
setupperbound(x[42], 80.9066666666667)
setlowerbound(x[43], 24.9066666666667)
setupperbound(x[43], 26.1466666666667)
setlowerbound(x[44], 36.1866666666667)
setupperbound(x[44], 38.0)
setlowerbound(x[45], 56.3133333333333)
