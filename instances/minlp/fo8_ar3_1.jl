...
set_lower_bound(x[77], 2.3094)
set_upper_bound(x[77], 6.9282)
set_lower_bound(x[78], 2.3094)
set_upper_bound(x[78], 6.9282)
set_lower_bound(x[79], 2.3094)
set_upper_bound(x[79], 6.9282)
set_lower_bound(x[80], 2.3094)
set_upper_bound(x[80], 6.9282)
set_lower_bound(x[82], 2.3094)
set_upper_bound(x[82], 6.9282)
set_lower_bound(x[84], 3.4641)
set_upper_bound(x[84], 10.3923)
set_lower_bound(x[86], 3.4641)
set_upper_bound(x[86], 10.3923)
set_lower_bound(x[88], 3.4641)
set_upper_bound(x[88], 10.3923)
set_lower_bound(x[90], 3.4641)
set_upper_bound(x[90], 10.3923)
set_lower_bound(x[92], 1.7321)
set_upper_bound(x[92], 5.1962)
set_lower_bound(x[94], 1.7321)
set_upper_bound(x[94], 5.1962)
set_lower_bound(x[96], 1.7321)
set_upper_bound(x[96], 5.1962)
set_lower_bound(x[98], 1.7321)
set_upper_bound(x[98], 5.1962)
set_lower_bound(x[100], 1.7321)
set_upper_bound(x[100], 5.1962)
set_lower_bound(x[102], 1.7321)
set_upper_bound(x[102], 5.1962)
...
@constraint(m, e61, -0.433013*x[76]-0.144338*x[78] <= -2.0)
@constraint(m, e62, -0.144338*x[76]-0.433013*x[78] <= -2.0)
@constraint(m, e63, -0.433013*x[77]-0.144338*x[79] <= -2.0)
@constraint(m, e64, -0.144338*x[77]-0.433013*x[79] <= -2.0)
@constraint(m, e65, -0.433013*x[80]-0.144338*x[82] <= -2.0)
@constraint(m, e66, -0.144338*x[80]-0.433013*x[82] <= -2.0)
@constraint(m, e67, -0.288675*x[84]-0.096225*x[86] <= -2.0)
@constraint(m, e68, -0.096225*x[84]-0.288675*x[86] <= -2.0)
@constraint(m, e69, -0.288675*x[88]-0.096225*x[90] <= -2.0)
@constraint(m, e70, -0.096225*x[88]-0.288675*x[90] <= -2.0)
@constraint(m, e71, -0.577334*x[92]-0.192456*x[94] <= -2.0)
@constraint(m, e72, -0.192448*x[92]-0.577356*x[94] <= -2.0)
@constraint(m, e73, -0.577334*x[96]-0.192456*x[98] <= -2.0)
@constraint(m, e74, -0.192448*x[96]-0.577356*x[98] <= -2.0)
@constraint(m, e75, -0.577334*x[100]-0.192456*x[102] <= -2.0)
@constraint(m, e76, -0.192448*x[100]-0.577356*x[102] <= -2.0)
