...
setupperbound(x[151], 15.0)
setupperbound(x[152], 12.0)
setupperbound(x[153], 8.0)
setupperbound(x[154], 7.0)
...
@constraint(m, e2, x[151]*x[1]+x[152]*x[2]+x[153]*x[3]+x[154]*x[4]+x[155]*x[5]+x[156]*x[6] >= 8.0)
@constraint(m, e3, x[151]*x[7]+x[152]*x[8]+x[153]*x[9]+x[154]*x[10]+x[155]*x[11]+x[156]*x[12] >= 16.0)
@constraint(m, e4, x[151]*x[13]+x[152]*x[14]+x[153]*x[15]+x[154]*x[16]+x[155]*x[17]+x[156]*x[18] >= 12.0)
@constraint(m, e5, x[151]*x[19]+x[152]*x[20]+x[153]*x[21]+x[154]*x[22]+x[155]*x[23]+x[156]*x[24] >= 7.0)
@constraint(m, e6, x[151]*x[25]+x[152]*x[26]+x[153]*x[27]+x[154]*x[28]+x[155]*x[29]+x[156]*x[30] >= 14.0)
@constraint(m, e7, x[151]*x[31]+x[152]*x[32]+x[153]*x[33]+x[154]*x[34]+x[155]*x[35]+x[156]*x[36] >= 16.0)
