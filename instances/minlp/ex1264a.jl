...
@constraint(m, e2, i[21]*i[1]+i[22]*i[2]+i[23]*i[3]+i[24]*i[4] >= 9.0)
@constraint(m, e3, i[21]*i[5]+i[22]*i[6]+i[23]*i[7]+i[24]*i[8] >= 7.0)
@constraint(m, e4, i[21]*i[9]+i[22]*i[10]+i[23]*i[11]+i[24]*i[12] >= 12.0)
@constraint(m, e5, i[21]*i[13]+i[22]*i[14]+i[23]*i[15]+i[24]*i[16] >= 11.0)
