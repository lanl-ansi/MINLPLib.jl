...
set_upper_bound(x[58], 6.4807)
set_lower_bound(x[59], 2.0)
set_upper_bound(x[59], 5.4772)
set_lower_bound(x[60], 2.1602)
set_upper_bound(x[60], 5.0)
set_lower_bound(x[61], 1.8257)
set_upper_bound(x[61], 5.0)
set_lower_bound(x[62], 1.8)
set_upper_bound(x[62], 5.1962)
set_lower_bound(x[64], 1.7321)
set_upper_bound(x[64], 5.0)
set_lower_bound(x[66], 1.4142)
set_upper_bound(x[66], 4.2426)
set_lower_bound(x[68], 1.4142)
set_upper_bound(x[68], 4.2426)
set_lower_bound(x[70], 2.0)
set_upper_bound(x[70], 5.4772)
set_lower_bound(x[72], 1.8257)
set_upper_bound(x[72], 5.0)
set_lower_bound(x[74], 5.0)
set_upper_bound(x[74], 8.6603)
set_lower_bound(x[76], 2.8868)
set_upper_bound(x[76], 5.0)
set_lower_bound(x[78], 5.0)
set_upper_bound(x[78], 8.6603)
set_lower_bound(x[80], 2.8868)
