...
setlowerbound(x[52], 1.26)
setupperbound(x[52], 6.0)
setlowerbound(x[53], 1.26)
setupperbound(x[53], 6.0)
setlowerbound(x[54], 1.26)
setupperbound(x[54], 6.0)
setlowerbound(x[55], 1.26)
setupperbound(x[55], 6.0)
setlowerbound(x[56], 1.13e-5)
setlowerbound(x[57], 1.13e-5)
setlowerbound(x[58], 1.13e-5)
setlowerbound(x[59], 1.13e-5)
...
setlowerbound(x[68], 3.0e-7)
setlowerbound(x[69], 3.0e-7)
setlowerbound(x[70], 3.0e-7)
setlowerbound(x[71], 3.0e-7)
...
@constraint(m, e98, -4.57380420143865*x[2]*x[3]+x[148] == 0.0)
