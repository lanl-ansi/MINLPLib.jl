...
setlowerbound(x[94], 2.8284)
setupperbound(x[94], 5.6569)
setlowerbound(x[95], 2.8284)
setupperbound(x[95], 5.6569)
setlowerbound(x[96], 2.8284)
setupperbound(x[96], 5.6569)
setlowerbound(x[97], 2.8284)
setupperbound(x[97], 5.6569)
setlowerbound(x[98], 2.8284)
setupperbound(x[98], 5.6569)
setlowerbound(x[100], 2.8284)
setupperbound(x[100], 5.6569)
setlowerbound(x[102], 4.2426)
setupperbound(x[102], 8.4853)
setlowerbound(x[104], 4.2426)
setupperbound(x[104], 8.4853)
setlowerbound(x[106], 4.2426)
setupperbound(x[106], 8.4853)
setlowerbound(x[108], 4.2426)
setupperbound(x[108], 8.4853)
setlowerbound(x[110], 2.1213)
setupperbound(x[110], 4.2426)
setlowerbound(x[112], 2.1213)
setupperbound(x[112], 4.2426)
setlowerbound(x[114], 2.1213)
setupperbound(x[114], 4.2426)
setlowerbound(x[116], 2.1213)
setupperbound(x[116], 4.2426)
setlowerbound(x[118], 2.1213)
setupperbound(x[118], 4.2426)
setlowerbound(x[120], 2.1213)
setupperbound(x[120], 4.2426)
setlowerbound(x[122], 2.1213)
setupperbound(x[122], 4.2426)
setlowerbound(x[124], 2.1213)
setupperbound(x[124], 4.2426)
