...
@variable(m, x[x_Idx])
set_lower_bound(x[86], 1.7889)
set_upper_bound(x[86], 8.54)
set_lower_bound(x[87], 1.7889)
set_upper_bound(x[87], 8.54)
set_lower_bound(x[88], 1.7889)
set_upper_bound(x[88], 8.54)
set_lower_bound(x[89], 2.7692)
set_upper_bound(x[89], 8.5399)
set_lower_bound(x[90], 1.3416)
set_upper_bound(x[90], 6.7082)
set_lower_bound(x[91], 1.3416)
set_upper_bound(x[91], 6.7082)
set_lower_bound(x[92], 1.3416)
set_upper_bound(x[92], 6.7082)
set_lower_bound(x[93], 8.54)
set_upper_bound(x[93], 8.54)
set_lower_bound(x[94], 1.8735)
set_upper_bound(x[94], 8.944)
set_lower_bound(x[95], 1.8735)
set_upper_bound(x[95], 8.944)
set_lower_bound(x[96], 1.8735)
set_upper_bound(x[96], 8.944)
set_lower_bound(x[97], 4.2155)
set_upper_bound(x[97], 13.0)
set_lower_bound(x[98], 1.3416)
set_upper_bound(x[98], 6.7082)
set_lower_bound(x[99], 1.3416)
set_upper_bound(x[99], 6.7082)
