...
@constraint(m, e32, -(i[7]*i[13]+i[8]*i[14]+i[9]*i[15]+i[10]*i[16]+i[11]*i[17]+i[12]*i[18]) <= -8.0)
@constraint(m, e33, -(i[7]*i[19]+i[8]*i[20]+i[9]*i[21]+i[10]*i[22]+i[11]*i[23]+i[12]*i[24]) <= -16.0)
@constraint(m, e34, -(i[7]*i[25]+i[8]*i[26]+i[9]*i[27]+i[10]*i[28]+i[11]*i[29]+i[12]*i[30]) <= -12.0)
@constraint(m, e35, -(i[7]*i[31]+i[8]*i[32]+i[9]*i[33]+i[10]*i[34]+i[11]*i[35]+i[12]*i[36]) <= -7.0)
@constraint(m, e36, -(i[7]*i[37]+i[8]*i[38]+i[9]*i[39]+i[10]*i[40]+i[11]*i[41]+i[12]*i[42]) <= -14.0)
@constraint(m, e37, -(i[7]*i[43]+i[8]*i[44]+i[9]*i[45]+i[10]*i[46]+i[11]*i[47]+i[12]*i[48]) <= -16.0)
