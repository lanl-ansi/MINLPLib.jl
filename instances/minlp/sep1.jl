...
@constraint(m, e3, -x[25]*x[7]+x[9] == 0.0)
@constraint(m, e4, -x[25]*x[8]+x[10] == 0.0)
@constraint(m, e5, -x[26]*x[7]+x[11] == 0.0)
@constraint(m, e6, -x[26]*x[8]+x[12] == 0.0)
@constraint(m, e7, -x[27]*x[7]+x[13] == 0.0)
@constraint(m, e8, -x[27]*x[8]+x[14] == 0.0)
