...
set_upper_bound(i[71], 100.0)
set_upper_bound(i[72], 100.0)
set_lower_bound(x[94], 1.7889)
set_upper_bound(x[94], 8.9443)
set_lower_bound(x[95], 1.7889)
set_upper_bound(x[95], 8.9443)
set_lower_bound(x[96], 1.7889)
set_upper_bound(x[96], 8.9443)
set_lower_bound(x[97], 1.7889)
set_upper_bound(x[97], 8.9443)
set_lower_bound(x[98], 1.7889)
set_upper_bound(x[98], 8.9443)
set_lower_bound(x[100], 1.7889)
set_upper_bound(x[100], 8.9443)
set_lower_bound(x[102], 2.7692)
set_upper_bound(x[102], 12.0)
set_lower_bound(x[104], 3.0)
set_upper_bound(x[104], 13.0)
set_lower_bound(x[106], 2.7692)
set_upper_bound(x[106], 12.0)
set_lower_bound(x[108], 3.0)
set_upper_bound(x[108], 13.0)
set_lower_bound(x[110], 1.3416)
set_upper_bound(x[110], 6.7082)
set_lower_bound(x[112], 1.3416)
set_upper_bound(x[112], 6.7082)
set_lower_bound(x[114], 1.3416)
set_upper_bound(x[114], 6.7082)
set_lower_bound(x[116], 1.3416)
set_upper_bound(x[116], 6.7082)
set_lower_bound(x[118], 1.3416)
set_upper_bound(x[118], 6.7082)
set_lower_bound(x[120], 1.3416)
set_upper_bound(x[120], 6.7082)
set_lower_bound(x[122], 1.3416)
set_upper_bound(x[122], 6.7082)
set_lower_bound(x[124], 1.3416)
set_upper_bound(x[124], 6.7082)
