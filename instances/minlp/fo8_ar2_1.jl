...
set_lower_bound(x[77], 2.8284)
set_upper_bound(x[77], 5.6569)
set_lower_bound(x[78], 2.8284)
set_upper_bound(x[78], 5.6569)
set_lower_bound(x[79], 2.8284)
set_upper_bound(x[79], 5.6569)
set_lower_bound(x[80], 2.8284)
set_upper_bound(x[80], 5.6569)
set_lower_bound(x[82], 2.8284)
set_upper_bound(x[82], 5.6569)
set_lower_bound(x[84], 4.2426)
set_upper_bound(x[84], 8.4853)
set_lower_bound(x[86], 4.2426)
set_upper_bound(x[86], 8.4853)
set_lower_bound(x[88], 4.2426)
set_upper_bound(x[88], 8.4853)
set_lower_bound(x[90], 4.2426)
set_upper_bound(x[90], 8.4853)
set_lower_bound(x[92], 2.1213)
set_upper_bound(x[92], 4.2426)
set_lower_bound(x[94], 2.1213)
set_upper_bound(x[94], 4.2426)
set_lower_bound(x[96], 2.1213)
set_upper_bound(x[96], 4.2426)
set_lower_bound(x[98], 2.1213)
set_upper_bound(x[98], 4.2426)
set_lower_bound(x[100], 2.1213)
set_upper_bound(x[100], 4.2426)
set_lower_bound(x[102], 2.1213)
set_upper_bound(x[102], 4.2426)
...
@constraint(m, e61, -0.353557*x[76]-0.176775*x[78] <= -2.0)
@constraint(m, e62, -0.176775*x[76]-0.353556*x[78] <= -2.0)
@constraint(m, e63, -0.353557*x[77]-0.176775*x[79] <= -2.0)
@constraint(m, e64, -0.176775*x[77]-0.353556*x[79] <= -2.0)
@constraint(m, e65, -0.353557*x[80]-0.176775*x[82] <= -2.0)
@constraint(m, e66, -0.176775*x[80]-0.353556*x[82] <= -2.0)
@constraint(m, e67, -0.235705*x[84]-0.11785*x[86] <= -2.0)
@constraint(m, e68, -0.117851*x[84]-0.235703*x[86] <= -2.0)
@constraint(m, e69, -0.235705*x[88]-0.11785*x[90] <= -2.0)
@constraint(m, e70, -0.117851*x[88]-0.235703*x[90] <= -2.0)
@constraint(m, e71, -0.471409*x[92]-0.2357*x[94] <= -2.0)
@constraint(m, e72, -0.235705*x[92]-0.4714*x[94] <= -2.0)
@constraint(m, e73, -0.471409*x[96]-0.2357*x[98] <= -2.0)
@constraint(m, e74, -0.235705*x[96]-0.4714*x[98] <= -2.0)
@constraint(m, e75, -0.471409*x[100]-0.2357*x[102] <= -2.0)
@constraint(m, e76, -0.235705*x[100]-0.4714*x[102] <= -2.0)
