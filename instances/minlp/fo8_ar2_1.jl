...
setlowerbound(x[77], 2.8284)
setupperbound(x[77], 5.6569)
setlowerbound(x[78], 2.8284)
setupperbound(x[78], 5.6569)
setlowerbound(x[79], 2.8284)
setupperbound(x[79], 5.6569)
setlowerbound(x[80], 2.8284)
setupperbound(x[80], 5.6569)
setlowerbound(x[82], 2.8284)
setupperbound(x[82], 5.6569)
setlowerbound(x[84], 4.2426)
setupperbound(x[84], 8.4853)
setlowerbound(x[86], 4.2426)
setupperbound(x[86], 8.4853)
setlowerbound(x[88], 4.2426)
setupperbound(x[88], 8.4853)
setlowerbound(x[90], 4.2426)
setupperbound(x[90], 8.4853)
setlowerbound(x[92], 2.1213)
setupperbound(x[92], 4.2426)
setlowerbound(x[94], 2.1213)
setupperbound(x[94], 4.2426)
setlowerbound(x[96], 2.1213)
setupperbound(x[96], 4.2426)
setlowerbound(x[98], 2.1213)
setupperbound(x[98], 4.2426)
setlowerbound(x[100], 2.1213)
setupperbound(x[100], 4.2426)
setlowerbound(x[102], 2.1213)
setupperbound(x[102], 4.2426)
