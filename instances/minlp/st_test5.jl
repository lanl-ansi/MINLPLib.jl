...
@constraint(m, e12, -(5*i[1]*i[1]-20*i[1]+5*i[2]*i[2]-80*i[2]+5*i[3]*i[3]-20*i[3]+5*i[4]*i[4]-50*i[4]+5*i[5]*i[5]-60*i[5]+5*i[6]*i[6]-90*i[6]+5*i[7]*i[7])-10*i[8]-10*i[9]-10*i[10]+objvar == 0.0)
