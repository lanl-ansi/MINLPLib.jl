...
set_upper_bound(i[41], 100.0)
set_upper_bound(i[42], 100.0)
set_lower_bound(x[60], 2.8284)
set_upper_bound(x[60], 5.6569)
set_lower_bound(x[61], 2.8284)
set_upper_bound(x[61], 5.6569)
set_lower_bound(x[62], 2.8284)
set_upper_bound(x[62], 5.6569)
set_lower_bound(x[63], 2.8284)
set_upper_bound(x[63], 5.6569)
set_lower_bound(x[64], 2.8284)
set_upper_bound(x[64], 5.6569)
set_lower_bound(x[66], 2.8284)
set_upper_bound(x[66], 5.6569)
set_lower_bound(x[68], 4.2426)
set_upper_bound(x[68], 8.4853)
set_lower_bound(x[70], 4.2426)
set_upper_bound(x[70], 8.4853)
set_lower_bound(x[72], 2.1213)
set_upper_bound(x[72], 4.2426)
set_lower_bound(x[74], 2.1213)
set_upper_bound(x[74], 4.2426)
set_lower_bound(x[76], 2.1213)
set_upper_bound(x[76], 4.2426)
set_lower_bound(x[78], 2.1213)
set_upper_bound(x[78], 4.2426)
...
@constraint(m, e47, -0.353557*x[60]-0.176775*x[62] <= -2.0)
@constraint(m, e48, -0.176775*x[60]-0.353556*x[62] <= -2.0)
@constraint(m, e49, -0.353557*x[61]-0.176775*x[63] <= -2.0)
@constraint(m, e50, -0.176775*x[61]-0.353556*x[63] <= -2.0)
@constraint(m, e51, -0.353557*x[64]-0.176775*x[66] <= -2.0)
@constraint(m, e52, -0.176775*x[64]-0.353556*x[66] <= -2.0)
@constraint(m, e53, -0.235705*x[68]-0.11785*x[70] <= -2.0)
@constraint(m, e54, -0.117851*x[68]-0.235703*x[70] <= -2.0)
@constraint(m, e55, -0.471409*x[72]-0.2357*x[74] <= -2.0)
@constraint(m, e56, -0.235705*x[72]-0.4714*x[74] <= -2.0)
@constraint(m, e57, -0.471409*x[76]-0.2357*x[78] <= -2.0)
@constraint(m, e58, -0.235705*x[76]-0.4714*x[78] <= -2.0)
@constraint(m, e59, -0.471409*x[80]-0.2357*x[82] <= -2.0)
@constraint(m, e60, -0.235705*x[80]-0.4714*x[82] <= -2.0)
