...
setupperbound(i[41], 100.0)
setupperbound(i[42], 100.0)
setlowerbound(x[60], 2.8284)
setupperbound(x[60], 5.6569)
setlowerbound(x[61], 2.8284)
setupperbound(x[61], 5.6569)
setlowerbound(x[62], 2.8284)
setupperbound(x[62], 5.6569)
setlowerbound(x[63], 2.8284)
setupperbound(x[63], 5.6569)
setlowerbound(x[64], 2.8284)
setupperbound(x[64], 5.6569)
setlowerbound(x[66], 2.8284)
setupperbound(x[66], 5.6569)
setlowerbound(x[68], 4.2426)
setupperbound(x[68], 8.4853)
setlowerbound(x[70], 4.2426)
setupperbound(x[70], 8.4853)
setlowerbound(x[72], 2.1213)
setupperbound(x[72], 4.2426)
setlowerbound(x[74], 2.1213)
setupperbound(x[74], 4.2426)
setlowerbound(x[76], 2.1213)
setupperbound(x[76], 4.2426)
