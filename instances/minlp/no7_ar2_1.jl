...
set_lower_bound(x[67], 2.8284)
set_upper_bound(x[67], 5.6569)
set_lower_bound(x[69], 2.8284)
set_upper_bound(x[69], 5.6569)
set_lower_bound(x[70], 2.8284)
set_upper_bound(x[70], 5.6569)
set_lower_bound(x[72], 2.8284)
set_upper_bound(x[72], 5.6569)
set_lower_bound(x[74], 2.8284)
set_upper_bound(x[74], 5.6569)
set_lower_bound(x[76], 4.2426)
set_upper_bound(x[76], 8.4853)
set_lower_bound(x[77], 4.2426)
set_upper_bound(x[77], 8.4853)
...
set_lower_bound(x[87], 2.1213)
set_upper_bound(x[87], 4.2426)
