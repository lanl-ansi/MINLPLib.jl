...
set_lower_bound(x[66], 2.5298)
set_upper_bound(x[66], 6.3246)
set_lower_bound(x[67], 2.5298)
set_upper_bound(x[67], 6.3246)
set_lower_bound(x[69], 2.5298)
set_upper_bound(x[69], 6.3246)
set_lower_bound(x[70], 2.5298)
...
set_lower_bound(x[76], 3.7947)
set_upper_bound(x[76], 8.54)
set_lower_bound(x[77], 4.2155)
set_upper_bound(x[77], 9.4868)
set_lower_bound(x[78], 1.8974)
set_upper_bound(x[78], 4.7434)
...
set_lower_bound(x[87], 1.8974)
set_upper_bound(x[87], 4.7434)
...
@constraint(m, e47, -0.395288*x[66]-0.158112*x[69] <= -2.0)
@constraint(m, e48, -0.158113*x[66]-0.395288*x[69] <= -2.0)
@constraint(m, e49, -0.395288*x[67]-0.158112*x[70] <= -2.0)
@constraint(m, e50, -0.158113*x[67]-0.395288*x[70] <= -2.0)
@constraint(m, e51, -0.395288*x[72]-0.158112*x[74] <= -2.0)
@constraint(m, e52, -0.158113*x[72]-0.395288*x[74] <= -2.0)
@constraint(m, e53, -0.263525*x[76]-0.105408*x[77] <= -2.0)
@constraint(m, e54, -0.117096*x[76]-0.237222*x[77] <= -2.0)
@constraint(m, e55, -0.527037*x[78]-0.210822*x[80] <= -2.0)
@constraint(m, e56, -0.210819*x[78]-0.527044*x[80] <= -2.0)
@constraint(m, e57, -0.527037*x[82]-0.210822*x[84] <= -2.0)
@constraint(m, e58, -0.210819*x[82]-0.527044*x[84] <= -2.0)
@constraint(m, e59, -0.527037*x[86]-0.210822*x[87] <= -2.0)
@constraint(m, e60, -0.210819*x[86]-0.527044*x[87] <= -2.0)
