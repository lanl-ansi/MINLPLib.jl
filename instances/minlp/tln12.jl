...
@constraint(m, e62, -(i[13]*i[25]+i[14]*i[26]+i[15]*i[27]+i[16]*i[28]+i[17]*i[29]+i[18]*i[30]+i[19]*i[31]+i[20]*i[32]+i[21]*i[33]+i[22]*i[34]+i[23]*i[35]+i[24]*i[36]) <= -10.0)
@constraint(m, e63, -(i[13]*i[37]+i[14]*i[38]+i[15]*i[39]+i[16]*i[40]+i[17]*i[41]+i[18]*i[42]+i[19]*i[43]+i[20]*i[44]+i[21]*i[45]+i[22]*i[46]+i[23]*i[47]+i[24]*i[48]) <= -28.0)
@constraint(m, e64, -(i[13]*i[49]+i[14]*i[50]+i[15]*i[51]+i[16]*i[52]+i[17]*i[53]+i[18]*i[54]+i[19]*i[55]+i[20]*i[56]+i[21]*i[57]+i[22]*i[58]+i[23]*i[59]+i[24]*i[60]) <= -48.0)
@constraint(m, e65, -(i[13]*i[61]+i[14]*i[62]+i[15]*i[63]+i[16]*i[64]+i[17]*i[65]+i[18]*i[66]+i[19]*i[67]+i[20]*i[68]+i[21]*i[69]+i[22]*i[70]+i[23]*i[71]+i[24]*i[72]) <= -28.0)
@constraint(m, e66, -(i[13]*i[73]+i[14]*i[74]+i[15]*i[75]+i[16]*i[76]+i[17]*i[77]+i[18]*i[78]+i[19]*i[79]+i[20]*i[80]+i[21]*i[81]+i[22]*i[82]+i[23]*i[83]+i[24]*i[84]) <= -40.0)
@constraint(m, e67, -(i[13]*i[85]+i[14]*i[86]+i[15]*i[87]+i[16]*i[88]+i[17]*i[89]+i[18]*i[90]+i[19]*i[91]+i[20]*i[92]+i[21]*i[93]+i[22]*i[94]+i[23]*i[95]+i[24]*i[96]) <= -30.0)
@constraint(m, e68, -(i[13]*i[97]+i[14]*i[98]+i[15]*i[99]+i[16]*i[100]+i[17]*i[101]+i[18]*i[102]+i[19]*i[103]+i[20]*i[104]+i[21]*i[105]+i[22]*i[106]+i[23]*i[107]+i[24]*i[108]) <= -21.0)
@constraint(m, e69, -(i[13]*i[109]+i[14]*i[110]+i[15]*i[111]+i[16]*i[112]+i[17]*i[113]+i[18]*i[114]+i[19]*i[115]+i[20]*i[116]+i[21]*i[117]+i[22]*i[118]+i[23]*i[119]+i[24]*i[120]) <= -22.0)
@constraint(m, e70, -(i[13]*i[121]+i[14]*i[122]+i[15]*i[123]+i[16]*i[124]+i[17]*i[125]+i[18]*i[126]+i[19]*i[127]+i[20]*i[128]+i[21]*i[129]+i[22]*i[130]+i[23]*i[131]+i[24]*i[132]) <= -8.0)
@constraint(m, e71, -(i[13]*i[133]+i[14]*i[134]+i[15]*i[135]+i[16]*i[136]+i[17]*i[137]+i[18]*i[138]+i[19]*i[139]+i[20]*i[140]+i[21]*i[141]+i[22]*i[142]+i[23]*i[143]+i[24]*i[144]) <= -8.0)
@constraint(m, e72, -(i[13]*i[145]+i[14]*i[146]+i[15]*i[147]+i[16]*i[148]+i[17]*i[149]+i[18]*i[150]+i[19]*i[151]+i[20]*i[152]+i[21]*i[153]+i[22]*i[154]+i[23]*i[155]+i[24]*i[156]) <= -9.0)
@constraint(m, e73, -(i[13]*i[157]+i[14]*i[158]+i[15]*i[159]+i[16]*i[160]+i[17]*i[161]+i[18]*i[162]+i[19]*i[163]+i[20]*i[164]+i[21]*i[165]+i[22]*i[166]+i[23]*i[167]+i[24]*i[168]) <= -8.0)
