...
@constraint(m, e61, -0.5*x[76]-0.125*x[78] <= -2.0)
@constraint(m, e62, -0.125*x[76]-0.5*x[78] <= -2.0)
@constraint(m, e63, -0.5*x[77]-0.125*x[79] <= -2.0)
@constraint(m, e64, -0.125*x[77]-0.5*x[79] <= -2.0)
@constraint(m, e65, -0.5*x[80]-0.125*x[82] <= -2.0)
@constraint(m, e66, -0.125*x[80]-0.5*x[82] <= -2.0)
@constraint(m, e67, -0.333333*x[84]-0.083333*x[86] <= -2.0)
@constraint(m, e68, -0.088417*x[84]-0.314167*x[86] <= -2.0)
@constraint(m, e69, -0.333333*x[88]-0.083333*x[90] <= -2.0)
@constraint(m, e70, -0.088417*x[88]-0.314167*x[90] <= -2.0)
@constraint(m, e71, -0.666667*x[92]-0.166667*x[94] <= -2.0)
@constraint(m, e72, -0.166667*x[92]-0.666667*x[94] <= -2.0)
@constraint(m, e73, -0.666667*x[96]-0.166667*x[98] <= -2.0)
@constraint(m, e74, -0.166667*x[96]-0.666667*x[98] <= -2.0)
@constraint(m, e75, -0.666667*x[100]-0.166667*x[102] <= -2.0)
@constraint(m, e76, -0.166667*x[100]-0.666667*x[102] <= -2.0)
