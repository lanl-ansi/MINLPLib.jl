...
setlowerbound(x[60], 2.3094)
setupperbound(x[60], 6.9282)
setlowerbound(x[61], 2.3094)
setupperbound(x[61], 6.9282)
setlowerbound(x[62], 2.3094)
setupperbound(x[62], 6.9282)
setlowerbound(x[63], 2.3094)
setupperbound(x[63], 6.9282)
setlowerbound(x[64], 2.3094)
setupperbound(x[64], 6.9282)
setlowerbound(x[66], 2.3094)
setupperbound(x[66], 6.9282)
setlowerbound(x[68], 3.4641)
setupperbound(x[68], 8.54)
setlowerbound(x[70], 4.2155)
setupperbound(x[70], 10.3923)
setlowerbound(x[72], 1.7321)
setupperbound(x[72], 5.1962)
setlowerbound(x[74], 1.7321)
setupperbound(x[74], 5.1962)
setlowerbound(x[76], 1.7321)
setupperbound(x[76], 5.1962)
setlowerbound(x[78], 1.7321)
setupperbound(x[78], 5.1962)
