...
set_upper_bound(i[41], 100.0)
set_upper_bound(i[42], 100.0)
set_lower_bound(x[60], 2.3094)
set_upper_bound(x[60], 6.9282)
set_lower_bound(x[61], 2.3094)
set_upper_bound(x[61], 6.9282)
set_lower_bound(x[62], 2.3094)
set_upper_bound(x[62], 6.9282)
set_lower_bound(x[63], 2.3094)
set_upper_bound(x[63], 6.9282)
set_lower_bound(x[64], 2.3094)
set_upper_bound(x[64], 6.9282)
set_lower_bound(x[66], 2.3094)
set_upper_bound(x[66], 6.9282)
set_lower_bound(x[68], 3.4641)
set_upper_bound(x[68], 8.54)
set_lower_bound(x[70], 4.2155)
set_upper_bound(x[70], 10.3923)
set_lower_bound(x[72], 1.7321)
set_upper_bound(x[72], 5.1962)
set_lower_bound(x[74], 1.7321)
set_upper_bound(x[74], 5.1962)
set_lower_bound(x[76], 1.7321)
set_upper_bound(x[76], 5.1962)
...
@constraint(m, e47, -0.433013*x[60]-0.144338*x[62] <= -2.0)
@constraint(m, e48, -0.144338*x[60]-0.433013*x[62] <= -2.0)
@constraint(m, e49, -0.433013*x[61]-0.144338*x[63] <= -2.0)
@constraint(m, e50, -0.144338*x[61]-0.433013*x[63] <= -2.0)
@constraint(m, e51, -0.433013*x[64]-0.144338*x[66] <= -2.0)
@constraint(m, e52, -0.144338*x[64]-0.433013*x[66] <= -2.0)
@constraint(m, e53, -0.288675*x[68]-0.096225*x[70] <= -2.0)
@constraint(m, e54, -0.117096*x[68]-0.237222*x[70] <= -2.0)
@constraint(m, e55, -0.577334*x[72]-0.192456*x[74] <= -2.0)
@constraint(m, e56, -0.192448*x[72]-0.577356*x[74] <= -2.0)
@constraint(m, e57, -0.577334*x[76]-0.192456*x[78] <= -2.0)
@constraint(m, e58, -0.192448*x[76]-0.577356*x[78] <= -2.0)
@constraint(m, e59, -0.577334*x[80]-0.192456*x[82] <= -2.0)
@constraint(m, e60, -0.192448*x[80]-0.577356*x[82] <= -2.0)
