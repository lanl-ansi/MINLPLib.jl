...
set_upper_bound(x[58], 8.3666)
set_lower_bound(x[59], 2.0)
set_upper_bound(x[59], 7.0711)
set_lower_bound(x[60], 1.6733)
set_upper_bound(x[60], 5.0)
set_lower_bound(x[61], 1.4142)
set_upper_bound(x[61], 5.0)
set_lower_bound(x[62], 1.8)
set_upper_bound(x[62], 6.7082)
set_lower_bound(x[64], 1.3416)
set_upper_bound(x[64], 5.0)
set_lower_bound(x[66], 1.2)
set_upper_bound(x[66], 5.4772)
set_lower_bound(x[68], 1.0954)
set_upper_bound(x[68], 5.0)
set_lower_bound(x[70], 2.0)
set_upper_bound(x[70], 7.0711)
set_lower_bound(x[72], 1.4142)
set_upper_bound(x[72], 5.0)
set_lower_bound(x[74], 5.0)
set_upper_bound(x[74], 11.1803)
set_lower_bound(x[76], 2.2361)
set_upper_bound(x[76], 5.0)
set_lower_bound(x[78], 5.0)
set_upper_bound(x[78], 11.1803)
set_lower_bound(x[80], 2.2361)
