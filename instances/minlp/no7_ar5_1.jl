...
setlowerbound(x[66], 1.7889)
setupperbound(x[66], 8.54)
setlowerbound(x[67], 1.7889)
setupperbound(x[67], 8.54)
setlowerbound(x[69], 1.8735)
setupperbound(x[69], 8.9443)
setlowerbound(x[70], 1.8735)
setupperbound(x[70], 8.9443)
setlowerbound(x[72], 1.7889)
setupperbound(x[72], 8.54)
setlowerbound(x[74], 1.8735)
setupperbound(x[74], 8.9443)
setlowerbound(x[76], 2.7692)
setupperbound(x[76], 8.54)
setlowerbound(x[77], 4.2155)
setupperbound(x[77], 13.0)
setlowerbound(x[78], 1.3416)
setupperbound(x[78], 6.7082)
...
setlowerbound(x[87], 1.3416)
setupperbound(x[87], 6.7082)
