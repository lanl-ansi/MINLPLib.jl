...
setupperbound(x[1], 254.001)
setupperbound(x[2], 254.001)
setupperbound(x[3], 254.001)
setlowerbound(x[85], 254.0)
setupperbound(x[85], 254.0)
...
@constraint(m, e48, x[85]*(1-x[46])-x[1] >= -0.001)
@constraint(m, e49, x[86]*(1-x[47])-x[2] >= -0.001)
@constraint(m, e50, x[87]*(1-x[48])-x[3] >= -0.001)
...
@constraint(m, e57, -81.9*x[40]*x[4]+x[67] == 0.0)
@constraint(m, e58, -81.9*x[41]*x[7]+x[70] == 0.0)
@constraint(m, e59, -81.9*x[42]*x[10]+x[73] == 0.0)
@constraint(m, e60, -81.9*x[40]*x[5]+x[68] == 0.0)
@constraint(m, e61, -81.9*x[41]*x[8]+x[71] == 0.0)
@constraint(m, e62, -81.9*x[42]*x[11]+x[74] == 0.0)
@constraint(m, e63, -54.6*x[40]*x[6]+x[69] == 0.0)
@constraint(m, e64, -54.6*x[41]*x[9]+x[72] == 0.0)
@constraint(m, e65, -54.6*x[42]*x[12]+x[75] == 0.0)
@constraint(m, e66, -136.62*x[40]*x[13]+x[76] == 0.0)
@constraint(m, e67, -136.62*x[41]*x[16]+x[79] == 0.0)
@constraint(m, e68, -136.62*x[42]*x[19]+x[82] == 0.0)
@constraint(m, e69, -136.62*x[40]*x[14]+x[77] == 0.0)
@constraint(m, e70, -136.62*x[41]*x[17]+x[80] == 0.0)
@constraint(m, e71, -136.62*x[42]*x[20]+x[83] == 0.0)
@constraint(m, e72, -91.08*x[40]*x[15]+x[78] == 0.0)
@constraint(m, e73, -91.08*x[41]*x[18]+x[81] == 0.0)
@constraint(m, e74, -91.08*x[42]*x[21]+x[84] == 0.0)
