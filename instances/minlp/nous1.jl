...
setlowerbound(x[46], 0.85)
setupperbound(x[46], 1.0)
setlowerbound(x[47], 0.85)
setupperbound(x[47], 1.0)
setlowerbound(x[48], 0.85)
setupperbound(x[48], 1.0)
setlowerbound(x[49], 0.85)
setupperbound(x[49], 1.0)


# ----- Constraints ----- #
@constraint(m, e1, -((0.0042656*x[29]-0.0005719*x[28]+0.0093514*x[46]+0.0077308*x[47]-0.0139904)*x[4]+(0.0016371*x[31]+0.0288996*x[32]+0.0338147*x[48]+0.0373349*x[49]-0.0661588)*x[5])+objvar-0.23947*b[50]-0.75835*b[51] == 0.0)
...
@constraint(m, e7, -x[10]*x[40]-0.333333333333333*x[2]+x[22] == 0.0)
@constraint(m, e8, -x[10]*x[41]-0.333333333333333*x[2]+x[23] == 0.0)
@constraint(m, e9, -x[10]*x[42]-0.333333333333333*x[2]+x[24] == 0.0)
@constraint(m, e10, -x[11]*x[37]-0.333333333333333*x[3]+x[25] == 0.0)
@constraint(m, e11, -x[11]*x[38]-0.333333333333333*x[3]+x[26] == 0.0)
@constraint(m, e12, -x[11]*x[39]-0.333333333333333*x[3]+x[27] == 0.0)
@constraint(m, e13, -(x[6]*x[34]+x[7]*x[37])+x[22] == 0.0)
@constraint(m, e14, -(x[6]*x[35]+x[7]*x[38])+x[23] == 0.0)
@constraint(m, e15, -(x[6]*x[36]+x[7]*x[39])+x[24] == 0.0)
@constraint(m, e16, -(x[8]*x[40]+x[9]*x[43])+x[25] == 0.0)
@constraint(m, e17, -(x[8]*x[41]+x[9]*x[44])+x[26] == 0.0)
@constraint(m, e18, -(x[8]*x[42]+x[9]*x[45])+x[27] == 0.0)
@constraint(m, e19, x[22]*x[46]-x[6]*x[34] == 0.0)
@constraint(m, e20, x[23]*x[47]-x[7]*x[38] == 0.0)
@constraint(m, e21, x[26]*x[48]-x[8]*x[41] == 0.0)
@constraint(m, e22, x[27]*x[49]-x[9]*x[45] == 0.0)
@constraint(m, e23, x[12]*x[34]+x[14]*x[37]+x[16]*x[40]+x[18]*x[43]+0.333333333333333*x[20] == 30.0)
@constraint(m, e24, x[12]*x[35]+x[14]*x[38]+x[16]*x[41]+x[18]*x[44]+0.333333333333333*x[20] == 50.0)
@constraint(m, e25, x[12]*x[36]+x[14]*x[39]+x[16]*x[42]+x[18]*x[45]+0.333333333333333*x[20] == 30.0)
@constraint(m, e26, x[13]*x[34]+x[15]*x[37]+x[17]*x[40]+x[19]*x[43]+0.333333333333333*x[21] == 70.0)
@constraint(m, e27, x[13]*x[35]+x[15]*x[38]+x[17]*x[41]+x[19]*x[44]+0.333333333333333*x[21] == 50.0)
@constraint(m, e28, x[13]*x[36]+x[15]*x[39]+x[17]*x[42]+x[19]*x[45]+0.333333333333333*x[21] == 70.0)
@constraint(m, e29, x[4]*x[28]-x[22] == 0.0)
@constraint(m, e30, x[4]*x[29]-x[23] == 0.0)
@constraint(m, e31, x[4]*x[30]-x[24] == 0.0)
@constraint(m, e32, x[5]*x[31]-x[25] == 0.0)
@constraint(m, e33, x[5]*x[32]-x[26] == 0.0)
@constraint(m, e34, x[5]*x[33]-x[27] == 0.0)
