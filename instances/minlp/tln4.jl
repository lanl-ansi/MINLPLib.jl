...
@constraint(m, e22, -(i[5]*i[9]+i[6]*i[10]+i[7]*i[11]+i[8]*i[12]) <= -8.0)
@constraint(m, e23, -(i[5]*i[13]+i[6]*i[14]+i[7]*i[15]+i[8]*i[16]) <= -7.0)
@constraint(m, e24, -(i[5]*i[17]+i[6]*i[18]+i[7]*i[19]+i[8]*i[20]) <= -12.0)
@constraint(m, e25, -(i[5]*i[21]+i[6]*i[22]+i[7]*i[23]+i[8]*i[24]) <= -11.0)
