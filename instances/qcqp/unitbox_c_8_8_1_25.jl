...
# ----- Constraints ----- #
@NLconstraint(m, e1, -(-1.04*x[2]*x[7]-0.93*x[2]*x[9]+(-1.11*x[3]*x[7])-1.52*x[3]*x[8]+1.26*x[4]*x[8]-1.6*x[4]*x[6]-1.62*x[4]*x[9]+1.43*x[5]*x[6]+0.21*x[2]-0.75*x[3]+0.93*x[4]+0.88*x[5]+0.35*x[6]+0.67*x[7]+0.74*x[8]+0.92*x[9])+x[1] == 0.0)
