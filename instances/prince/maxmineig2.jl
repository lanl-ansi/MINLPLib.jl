...
@variable(m, x[x_Idx])
set_lower_bound(x[101], 1.0e-8)
set_lower_bound(x[102], 1.0e-8)
set_lower_bound(x[103], 1.0e-8)
set_lower_bound(x[104], 1.0e-8)
set_lower_bound(x[105], 1.0e-8)
set_lower_bound(x[106], 1.0e-8)
set_lower_bound(x[107], 1.0e-8)
set_lower_bound(x[108], 1.0e-8)
set_lower_bound(x[109], 1.0e-8)
set_lower_bound(x[110], 1.0e-8)
set_lower_bound(x[111], 1.0e-8)
set_lower_bound(x[112], 1.0e-8)
set_lower_bound(x[113], 1.0e-8)
set_lower_bound(x[114], 1.0e-8)
set_lower_bound(x[115], 1.0e-8)
set_lower_bound(x[116], 1.0e-8)
set_lower_bound(x[117], 1.0e-8)
set_lower_bound(x[118], 1.0e-8)
set_lower_bound(x[119], 1.0e-8)
set_lower_bound(x[120], 1.0e-8)
set_lower_bound(x[121], 1.0e-8)
set_lower_bound(x[122], 1.0e-8)
set_lower_bound(x[123], 1.0e-8)
set_lower_bound(x[124], 1.0e-8)
set_lower_bound(x[125], 1.0e-8)
set_lower_bound(x[126], 1.0e-8)
set_lower_bound(x[127], 1.0e-8)
set_lower_bound(x[128], 1.0e-8)
set_lower_bound(x[129], 1.0e-8)
set_lower_bound(x[130], 1.0e-8)
set_lower_bound(x[131], 1.0e-8)
set_lower_bound(x[132], 1.0e-8)
set_lower_bound(x[133], 1.0e-8)
set_lower_bound(x[134], 1.0e-8)
set_lower_bound(x[135], 1.0e-8)
set_lower_bound(x[136], 1.0e-8)
set_lower_bound(x[137], 1.0e-8)
set_lower_bound(x[138], 1.0e-8)
set_lower_bound(x[139], 1.0e-8)
set_lower_bound(x[140], 1.0e-8)
set_lower_bound(x[141], 1.0e-8)
set_lower_bound(x[142], 1.0e-8)
set_lower_bound(x[143], 1.0e-8)
set_lower_bound(x[144], 1.0e-8)
set_lower_bound(x[145], 1.0e-8)
set_lower_bound(x[146], 1.0e-8)
set_lower_bound(x[147], 1.0e-8)
set_lower_bound(x[148], 1.0e-8)
set_lower_bound(x[149], 1.0e-8)
set_lower_bound(x[150], 1.0e-8)
set_lower_bound(x[151], 1.0e-8)
set_lower_bound(x[152], 1.0e-8)
set_lower_bound(x[153], 1.0e-8)
set_lower_bound(x[154], 1.0e-8)
set_lower_bound(x[155], 1.0e-8)
set_lower_bound(x[156], 0.01)
set_lower_bound(x[157], 0.01)
set_lower_bound(x[158], 0.01)
set_lower_bound(x[159], 0.01)
set_lower_bound(x[160], 0.01)
set_lower_bound(x[161], 0.01)
set_lower_bound(x[162], 0.01)
set_lower_bound(x[163], 0.01)
set_lower_bound(x[164], 0.01)
set_lower_bound(x[165], 0.01)
set_lower_bound(x[166], 0.01)
set_lower_bound(x[167], 0.01)
set_lower_bound(x[168], 0.01)
set_lower_bound(x[169], 0.01)
set_lower_bound(x[170], 0.01)
set_lower_bound(x[171], 0.01)
