...
setupperbound(x[1], 0.044)
setlowerbound(x[2], 13.13)
setupperbound(x[2], 24.0)
...
setupperbound(x[15], 0.9999)
setlowerbound(x[16], 6000.0)
setupperbound(x[16], 6000.0)
setlowerbound(x[17], 1.0e-7)
