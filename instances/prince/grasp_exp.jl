...
@NLconstraint(m, e41, exp( (x[6])^2+ (x[11])^2+ (x[16])^2- (0.3*x[1])^2) <= 1.0)
@NLconstraint(m, e42, exp( (x[7])^2+ (x[12])^2+ (x[17])^2- (0.3*x[2])^2) <= 1.0)
@NLconstraint(m, e43, exp( (x[8])^2+ (x[13])^2+ (x[18])^2- (0.3*x[3])^2) <= 1.0)
@NLconstraint(m, e44, exp( (x[9])^2+ (x[14])^2+ (x[19])^2- (0.3*x[4])^2) <= 1.0)
@NLconstraint(m, e45, exp( (x[10])^2+ (x[15])^2+ (x[20])^2- (0.3*x[5])^2) <= 1.0)
