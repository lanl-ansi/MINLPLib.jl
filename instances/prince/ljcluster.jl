...
setlowerbound(x[41], 0.8)
setlowerbound(x[42], 0.8)
setlowerbound(x[43], 0.8)
setlowerbound(x[44], 0.8)
setlowerbound(x[45], 0.8)
setlowerbound(x[46], 0.8)
setlowerbound(x[47], 0.8)
setlowerbound(x[48], 0.8)
setlowerbound(x[49], 0.8)
setlowerbound(x[50], 0.8)
setlowerbound(x[51], 0.8)
setlowerbound(x[52], 0.8)
setlowerbound(x[53], 0.8)
setlowerbound(x[54], 0.8)
setlowerbound(x[55], 0.8)
setlowerbound(x[56], 0.8)
setlowerbound(x[57], 0.8)
setlowerbound(x[58], 0.8)
setlowerbound(x[59], 0.8)
setlowerbound(x[60], 0.8)
setlowerbound(x[61], 0.8)
setlowerbound(x[62], 0.8)
setlowerbound(x[63], 0.8)
setlowerbound(x[64], 0.8)
setlowerbound(x[65], 0.8)
