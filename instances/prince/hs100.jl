...
@NLconstraint(m, e4, (-4* (x[1])^2)- (x[2])^2+3*x[1]*x[2]-2* (x[3])^2-5*x[6]+11*x[7] >= 0.0)
@NLconstraint(m, e5, -( ((-10)+x[1])^2+5* ((-12)+x[2])^2+ ( (x[3])^2)^2+3* ((-11)+x[4])^2+10* (x[5])^6+7* (x[6])^2+ (x[7])^4-4*x[6]*x[7]-10*x[6]-8*x[7])+objvar == 0.0)
