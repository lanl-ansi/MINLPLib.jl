...
setlowerbound(x[1], -220.12)
setupperbound(x[1], 220.12)
setlowerbound(x[2], -220.12)
setupperbound(x[2], 220.12)
setlowerbound(x[3], -220.12)
setupperbound(x[3], 220.12)
setlowerbound(x[4], -220.12)
setupperbound(x[4], 220.12)
setlowerbound(x[5], -220.12)
setupperbound(x[5], 220.12)
setlowerbound(x[6], -220.12)
setupperbound(x[6], 220.12)
setlowerbound(x[7], -220.12)
setupperbound(x[7], 220.12)
setlowerbound(x[8], -220.12)
setupperbound(x[8], 220.12)
setlowerbound(x[9], -220.12)
setupperbound(x[9], 220.12)
setupperbound(x[10], 220.12)
setupperbound(x[11], 220.12)
setlowerbound(x[12], -220.12)
setupperbound(x[12], 220.12)
setlowerbound(x[13], -220.12)
setupperbound(x[13], 220.12)
setlowerbound(x[14], -220.12)
setupperbound(x[14], 220.12)
setlowerbound(x[15], -220.12)
setupperbound(x[15], 220.12)
setlowerbound(x[16], -220.12)
setupperbound(x[16], 220.12)
setlowerbound(x[17], -220.12)
setupperbound(x[17], 220.12)
setlowerbound(x[18], -220.12)
setupperbound(x[18], 220.12)
setlowerbound(x[19], -220.12)
setupperbound(x[19], 220.12)
setlowerbound(x[20], -220.12)
setupperbound(x[20], 220.12)
setlowerbound(x[21], -220.12)
setupperbound(x[21], 220.12)
setupperbound(x[22], 220.12)
setlowerbound(x[23], -220.12)
setupperbound(x[23], 220.12)
setlowerbound(x[24], -220.12)
setupperbound(x[24], 220.12)
setlowerbound(x[25], 8.87)
setupperbound(x[25], 11.594)
setupperbound(x[26], 8.4)
setupperbound(x[27], 4.8)
setlowerbound(x[28], 20.344)
setupperbound(x[28], 22.012)
setupperbound(x[29], 1.2)
setupperbound(x[30], 0.96)
setupperbound(x[31], 11.594)
setupperbound(x[32], 8.4)
setupperbound(x[33], 4.8)
setupperbound(x[34], 22.012)
setupperbound(x[35], 1.2)
setupperbound(x[36], 0.96)
setupperbound(x[46], 5929.0)
setupperbound(x[47], 5929.0)
setlowerbound(x[48], 900.0)
setupperbound(x[48], 6400.0)
setupperbound(x[49], 6400.0)
setupperbound(x[50], 5929.0)
setlowerbound(x[51], 900.0)
setupperbound(x[51], 6400.0)
setlowerbound(x[52], 900.0)
setupperbound(x[52], 6400.0)
setlowerbound(x[53], 2500.0)
setupperbound(x[53], 4382.44)
setupperbound(x[54], 4382.44)
setlowerbound(x[55], 900.0)
setupperbound(x[55], 4382.44)
setupperbound(x[56], 4382.44)
setlowerbound(x[57], 900.0)
setupperbound(x[57], 4382.44)
setupperbound(x[58], 4382.44)
setupperbound(x[59], 4382.44)
setlowerbound(x[60], 900.0)
setupperbound(x[60], 4382.44)
setlowerbound(x[61], 2500.0)
setupperbound(x[61], 4382.44)
setupperbound(x[62], 4382.44)
setupperbound(x[63], 3969.0)
setlowerbound(x[64], 625.0)
setupperbound(x[64], 4382.44)
setlowerbound(x[65], 625.0)
setupperbound(x[65], 4382.44)
