...
setupperbound(x[1], 0.04)
setupperbound(x[2], 0.04)
setupperbound(x[3], 0.04)
setupperbound(x[4], 0.04)
setupperbound(x[5], 0.04)
setupperbound(x[6], 0.03)
setupperbound(x[7], 0.03)
setupperbound(x[8], 0.03)
setupperbound(x[9], 0.03)
setupperbound(x[10], 0.03)
setupperbound(x[11], 0.03)
setupperbound(x[12], 0.03)
setupperbound(x[13], 0.03)
setupperbound(x[14], 0.03)
