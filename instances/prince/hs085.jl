...
setlowerbound(x[1], 704.4148)
setupperbound(x[1], 906.3855)
setlowerbound(x[2], 68.6)
setupperbound(x[2], 288.88)
setupperbound(x[3], 134.75)
setlowerbound(x[4], 193.0)
setupperbound(x[4], 287.0966)
setlowerbound(x[5], 25.0)
setupperbound(x[5], 84.1988)
setlowerbound(x[6], 213.1)
setupperbound(x[6], 405.23)
setlowerbound(x[8], 17.505)
setupperbound(x[8], 1053.6667)
setlowerbound(x[11], 11.275)
setupperbound(x[11], 35.03)
setlowerbound(x[12], 214.228)
setupperbound(x[12], 665.585)
setlowerbound(x[17], 7.458)
setupperbound(x[17], 584.463)
setlowerbound(x[18], 0.961)
setupperbound(x[18], 265.916)
setlowerbound(x[20], 1.612)
setupperbound(x[20], 7.046)
setlowerbound(x[21], 0.146)
setupperbound(x[21], 0.222)
setlowerbound(x[23], 107.99)
setupperbound(x[23], 273.366)
setlowerbound(x[24], 922.693)
setupperbound(x[24], 1286.105)
setlowerbound(x[25], 926.832)
setupperbound(x[25], 1444.046)
setlowerbound(x[28], 18.766)
setupperbound(x[28], 537.141)
setlowerbound(x[29], 1072.163)
setupperbound(x[29], 3247.039)
setlowerbound(x[30], 8961.448)
setupperbound(x[30], 26844.086)
setlowerbound(x[32], 0.063)
setupperbound(x[32], 0.386)
setlowerbound(x[33], 71084.33)
setupperbound(x[33], 140000.0)
setlowerbound(x[35], 2.802713e6)
setupperbound(x[35], 1.2146108e7)
