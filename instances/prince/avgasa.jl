...
@NLconstraint(m, e11, -(2* (x[1])^2+2* (x[2])^2+2.5* (x[3])^2+1.5* (x[4])^2+2.5* (x[5])^2+2* (x[6])^2+2.5* (x[7])^2+2.5* (x[8])^2+(-x[1]*x[2])-2*x[2]*x[3]-x[3]*x[4]-x[4]*x[5]+2*x[5]*x[6]-x[6]*x[7]-2*x[7]*x[8]-2*x[2]-x[3]-3*x[4]-2*x[5]-4*x[6]-3*x[7]-5*x[8])+objvar == 0.0)
