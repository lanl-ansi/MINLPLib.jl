...
setupperbound(x[1], 21.0)
setlowerbound(x[2], 43.0)
setupperbound(x[2], 57.0)
setlowerbound(x[3], 3.0)
setupperbound(x[3], 16.0)
setupperbound(x[4], 90.0)
setupperbound(x[5], 120.0)
setupperbound(x[6], 60.0)
setupperbound(x[7], 90.0)
setupperbound(x[8], 120.0)
setupperbound(x[9], 60.0)
setupperbound(x[10], 90.0)
setupperbound(x[11], 120.0)
setupperbound(x[12], 60.0)
setupperbound(x[13], 90.0)
setupperbound(x[14], 120.0)
