...
@NLconstraint(m, e6, -(10197*x[1]*x[1]-12454*x[1]*x[2]-1013*x[1]*x[3]+1948*x[1]*x[4]+329*x[1]*x[5]-12454*x[2]*x[1]+20909*x[2]*x[2]-1733*x[2]*x[3]-4914*x[2]*x[4]-186*x[2]*x[5]-1013*x[3]*x[1]-1733*x[3]*x[2]+1755*x[3]*x[3]+1089*x[3]*x[4]-174*x[3]*x[5]+1948*x[4]*x[1]-4914*x[4]*x[2]+1089*x[4]*x[3]+1515*x[4]*x[4]-22*x[4]*x[5]+329*x[5]*x[1]-186*x[5]*x[2]-174*x[5]*x[3]-22*x[5]*x[4]+27*x[5]*x[5]+18340*x[1]-34198*x[2]+4542*x[3]+8672*x[4]+86*x[5])+objvar == 14463.0)
