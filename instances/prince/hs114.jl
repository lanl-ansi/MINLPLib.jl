...
set_upper_bound(x[6], 16000.0)
set_lower_bound(x[7], 1.0e-5)
set_upper_bound(x[7], 120.0)
set_lower_bound(x[8], 1.0e-5)
set_upper_bound(x[8], 5000.0)
set_lower_bound(x[9], 1.0e-5)
set_upper_bound(x[9], 2000.0)
set_lower_bound(x[10], 85.0)
set_upper_bound(x[10], 93.0)
set_lower_bound(x[11], 90.0)
set_upper_bound(x[11], 95.0)
set_lower_bound(x[12], 3.0)
set_upper_bound(x[12], 12.0)
set_lower_bound(x[13], 1.2)
set_upper_bound(x[13], 4.0)
set_lower_bound(x[14], 145.0)
set_upper_bound(x[14], 162.0)
