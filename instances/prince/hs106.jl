...
@constraint(m, e2, 0.0025*x[4]-0.0025*x[5]-0.0025*x[7] >= -1.0)
@constraint(m, e3, 0.01*x[5]-0.01*x[8] >= -1.0)
@NLconstraint(m, e4, x[1]*x[6]-100*x[1]-833.3325*x[4] >= -83333.33)
@NLconstraint(m, e5, x[2]*x[7]-x[2]*x[4]+1250*x[4]-1250*x[5] >= 0.0)
@NLconstraint(m, e6, x[3]*x[8]-x[3]*x[5]+2500*x[5] >= 1.25e6)
