...
setupperbound(x[4], 220.0)
setupperbound(x[5], 150.0)
setupperbound(x[6], 100.0)
setlowerbound(x[7], 0.0)
setupperbound(x[7], 0.0)
setupperbound(x[8], 280.0)
setupperbound(x[9], 400.0)
setupperbound(x[10], 450.0)
setupperbound(x[11], 450.0)
setupperbound(x[12], 400.0)
setlowerbound(x[13], 0.0)
setupperbound(x[13], 0.0)
setupperbound(x[14], 520.0)
setupperbound(x[15], 400.0)
setupperbound(x[16], 500.0)
setupperbound(x[17], 630.0)
