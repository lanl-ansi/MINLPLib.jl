...
setlowerbound(x[23], -0.2)
setupperbound(x[23], 0.2)
setlowerbound(x[24], -0.2)
setupperbound(x[24], 0.2)
setlowerbound(x[25], -0.2)
setupperbound(x[25], 0.2)
setlowerbound(x[26], -0.2)
setupperbound(x[26], 0.2)
setlowerbound(x[27], -0.2)
setupperbound(x[27], 0.2)
setlowerbound(x[28], -0.2)
setupperbound(x[28], 0.2)
setlowerbound(x[29], -0.2)
setupperbound(x[29], 0.2)
setlowerbound(x[30], -0.2)
setupperbound(x[30], 0.2)
setlowerbound(x[31], -0.2)
setupperbound(x[31], 0.2)
setlowerbound(x[32], -0.2)
setupperbound(x[32], 0.2)
