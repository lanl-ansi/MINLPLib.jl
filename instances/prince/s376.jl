...
setupperbound(x[2], 0.1)
setlowerbound(x[3], 5.0e-5)
setupperbound(x[3], 0.0081)
setlowerbound(x[4], 10.0)
setupperbound(x[4], 1000.0)
setlowerbound(x[5], 5.0e-5)
setupperbound(x[5], 0.0017)
setlowerbound(x[6], 5.0e-5)
setupperbound(x[6], 0.0013)
setlowerbound(x[7], 5.0e-5)
setupperbound(x[7], 0.0027)
setlowerbound(x[8], 5.0e-5)
setupperbound(x[8], 0.002)
setlowerbound(x[9], 5.0e-5)
setupperbound(x[9], 1.0)
setlowerbound(x[10], 5.0e-5)
