...
setupperbound(x[20], 20000.0)
setlowerbound(x[21], 2.0)
setupperbound(x[21], 30.0)
setlowerbound(x[22], 2000.0)
setupperbound(x[22], 20000.0)
setlowerbound(x[23], 3000.0)
setupperbound(x[23], 30000.0)
setlowerbound(x[24], 5000.0)
setupperbound(x[24], 50000.0)
setlowerbound(x[25], 0.2)
setupperbound(x[25], 0.8)
setlowerbound(x[26], 1.0)
setupperbound(x[26], 5.0)
setupperbound(x[27], 20.0)
setlowerbound(x[28], 100.0)
...
setlowerbound(x[33], 250.0)
setupperbound(x[33], 5000.0)
setlowerbound(x[34], 750.0)
setupperbound(x[34], 15000.0)
setlowerbound(x[35], 250.0)
setupperbound(x[35], 3000.0)
setlowerbound(x[36], 10.0)
setupperbound(x[36], 5000.0)
setlowerbound(x[37], 35.0)
setupperbound(x[37], 70.0)
setlowerbound(x[38], 100.0)
setupperbound(x[38], 3000.0)
setlowerbound(x[39], 200.0)
setupperbound(x[39], 400.0)
setlowerbound(x[40], 120.0)
setupperbound(x[40], 240.0)
setlowerbound(x[41], 700.0)
setupperbound(x[41], 1900.0)
setlowerbound(x[42], 100.0)
