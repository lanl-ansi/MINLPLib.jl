...
setupperbound(x[1], 10.1)
setlowerbound(x[2], 0.1)
setupperbound(x[2], 10.1)
setlowerbound(x[3], 0.1)
setupperbound(x[3], 10.1)
setlowerbound(x[4], 0.1)
setupperbound(x[4], 10.1)
setlowerbound(x[5], 0.1)
setupperbound(x[5], 10.1)
setlowerbound(x[6], 0.1)
setupperbound(x[6], 10.1)
setlowerbound(x[7], 0.1)
setupperbound(x[7], 10.1)
setlowerbound(x[8], 0.1)
setupperbound(x[8], 10.1)
