...
@NLconstraint(m, e8, (3*x[1]+x[4]+x[7]+1.5*x[10]-2.5)*x[18]+(3*x[2]+x[5]+x[8]+1.5*x[11]-2.5)*x[23]+(3*x[3]+x[6]+x[9]+1.5*x[12]-2.5)*x[28]-0.5*x[13] <= 0.0)
@NLconstraint(m, e9, (x[1]+3*x[4]+2.5*x[7]+2.5*x[10]-2)*x[18]+(x[2]+3*x[5]+2.5*x[8]+2.5*x[11]-2)*x[23]+(x[3]+3*x[6]+2.5*x[9]+2.5*x[12]-2)*x[28]+0.5*x[13] <= 0.0)
@NLconstraint(m, e10, (3*x[1]+x[4]+x[7]+1.5*x[10]-1.5)*x[19]+(3*x[2]+x[5]+x[8]+1.5*x[11]-1.5)*x[24]+(3*x[3]+x[6]+x[9]+1.5*x[12]-1.5)*x[29]+0.5*x[14] <= 0.0)
@NLconstraint(m, e11, (x[1]+3*x[4]+2.5*x[7]+2.5*x[10]-2.5)*x[19]+(x[2]+3*x[5]+2.5*x[8]+2.5*x[11]-2.5)*x[24]+(x[3]+3*x[6]+2.5*x[9]+2.5*x[12]-2.5)*x[29] <= 0.0)
@NLconstraint(m, e12, (3*x[1]+x[4]+x[7]+1.5*x[10]-2)*x[20]+(3*x[2]+x[5]+x[8]+1.5*x[11]-2)*x[25]+(3*x[3]+x[6]+x[9]+1.5*x[12]-2)*x[30] <= 0.0)
@NLconstraint(m, e13, (x[1]+3*x[4]+2.5*x[7]+2.5*x[10]-2.6)*x[20]+(x[2]+3*x[5]+2.5*x[8]+2.5*x[11]-2.6)*x[25]+(x[3]+3*x[6]+2.5*x[9]+2.5*x[12]-2.6)*x[30]-0.1*x[15] <= 0.0)
@NLconstraint(m, e14, (3*x[1]+x[4]+x[7]+1.5*x[10]-2)*x[21]+(3*x[2]+x[5]+x[8]+1.5*x[11]-2)*x[26]+(3*x[3]+x[6]+x[9]+1.5*x[12]-2)*x[31] <= 0.0)
@NLconstraint(m, e15, (x[1]+3*x[4]+2.5*x[7]+2.5*x[10]-2)*x[21]+(x[2]+3*x[5]+2.5*x[8]+2.5*x[11]-2)*x[26]+(x[3]+3*x[6]+2.5*x[9]+2.5*x[12]-2)*x[31]+0.5*x[16] <= 0.0)
@NLconstraint(m, e16, (3*x[1]+x[4]+x[7]+1.5*x[10]-2)*x[22]+(3*x[2]+x[5]+x[8]+1.5*x[11]-2)*x[27]+(3*x[3]+x[6]+x[9]+1.5*x[12]-2)*x[32] <= 0.0)
@NLconstraint(m, e17, (x[1]+3*x[4]+2.5*x[7]+2.5*x[10]-2)*x[22]+(x[2]+3*x[5]+2.5*x[8]+2.5*x[11]-2)*x[27]+(x[3]+3*x[6]+2.5*x[9]+2.5*x[12]-2)*x[32]+0.5*x[17] <= 0.0)
