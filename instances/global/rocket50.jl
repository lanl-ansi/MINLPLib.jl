...
@NLconstraint(m, e154, -0.5*x[2]*((x[208]-x[157]*x[106]-x[259])/x[157]+(x[207]-x[156]*x[105]-x[258])/x[156])-x[3]+x[4] == 0.0)
@NLconstraint(m, e155, -0.5*x[2]*((x[209]-x[158]*x[107]-x[260])/x[158]+(x[208]-x[157]*x[106]-x[259])/x[157])-x[4]+x[5] == 0.0)
@NLconstraint(m, e156, -0.5*x[2]*((x[210]-x[159]*x[108]-x[261])/x[159]+(x[209]-x[158]*x[107]-x[260])/x[158])-x[5]+x[6] == 0.0)
@NLconstraint(m, e157, -0.5*x[2]*((x[211]-x[160]*x[109]-x[262])/x[160]+(x[210]-x[159]*x[108]-x[261])/x[159])-x[6]+x[7] == 0.0)
@NLconstraint(m, e158, -0.5*x[2]*((x[212]-x[161]*x[110]-x[263])/x[161]+(x[211]-x[160]*x[109]-x[262])/x[160])-x[7]+x[8] == 0.0)
@NLconstraint(m, e159, -0.5*x[2]*((x[213]-x[162]*x[111]-x[264])/x[162]+(x[212]-x[161]*x[110]-x[263])/x[161])-x[8]+x[9] == 0.0)
@NLconstraint(m, e160, -0.5*x[2]*((x[214]-x[163]*x[112]-x[265])/x[163]+(x[213]-x[162]*x[111]-x[264])/x[162])-x[9]+x[10] == 0.0)
@NLconstraint(m, e161, -0.5*x[2]*((x[215]-x[164]*x[113]-x[266])/x[164]+(x[214]-x[163]*x[112]-x[265])/x[163])-x[10]+x[11] == 0.0)
@NLconstraint(m, e162, -0.5*x[2]*((x[216]-x[165]*x[114]-x[267])/x[165]+(x[215]-x[164]*x[113]-x[266])/x[164])-x[11]+x[12] == 0.0)
@NLconstraint(m, e163, -0.5*x[2]*((x[217]-x[166]*x[115]-x[268])/x[166]+(x[216]-x[165]*x[114]-x[267])/x[165])-x[12]+x[13] == 0.0)
@NLconstraint(m, e164, -0.5*x[2]*((x[218]-x[167]*x[116]-x[269])/x[167]+(x[217]-x[166]*x[115]-x[268])/x[166])-x[13]+x[14] == 0.0)
@NLconstraint(m, e165, -0.5*x[2]*((x[219]-x[168]*x[117]-x[270])/x[168]+(x[218]-x[167]*x[116]-x[269])/x[167])-x[14]+x[15] == 0.0)
@NLconstraint(m, e166, -0.5*x[2]*((x[220]-x[169]*x[118]-x[271])/x[169]+(x[219]-x[168]*x[117]-x[270])/x[168])-x[15]+x[16] == 0.0)
@NLconstraint(m, e167, -0.5*x[2]*((x[221]-x[170]*x[119]-x[272])/x[170]+(x[220]-x[169]*x[118]-x[271])/x[169])-x[16]+x[17] == 0.0)
@NLconstraint(m, e168, -0.5*x[2]*((x[222]-x[171]*x[120]-x[273])/x[171]+(x[221]-x[170]*x[119]-x[272])/x[170])-x[17]+x[18] == 0.0)
@NLconstraint(m, e169, -0.5*x[2]*((x[223]-x[172]*x[121]-x[274])/x[172]+(x[222]-x[171]*x[120]-x[273])/x[171])-x[18]+x[19] == 0.0)
@NLconstraint(m, e170, -0.5*x[2]*((x[224]-x[173]*x[122]-x[275])/x[173]+(x[223]-x[172]*x[121]-x[274])/x[172])-x[19]+x[20] == 0.0)
@NLconstraint(m, e171, -0.5*x[2]*((x[225]-x[174]*x[123]-x[276])/x[174]+(x[224]-x[173]*x[122]-x[275])/x[173])-x[20]+x[21] == 0.0)
@NLconstraint(m, e172, -0.5*x[2]*((x[226]-x[175]*x[124]-x[277])/x[175]+(x[225]-x[174]*x[123]-x[276])/x[174])-x[21]+x[22] == 0.0)
@NLconstraint(m, e173, -0.5*x[2]*((x[227]-x[176]*x[125]-x[278])/x[176]+(x[226]-x[175]*x[124]-x[277])/x[175])-x[22]+x[23] == 0.0)
@NLconstraint(m, e174, -0.5*x[2]*((x[228]-x[177]*x[126]-x[279])/x[177]+(x[227]-x[176]*x[125]-x[278])/x[176])-x[23]+x[24] == 0.0)
@NLconstraint(m, e175, -0.5*x[2]*((x[229]-x[178]*x[127]-x[280])/x[178]+(x[228]-x[177]*x[126]-x[279])/x[177])-x[24]+x[25] == 0.0)
@NLconstraint(m, e176, -0.5*x[2]*((x[230]-x[179]*x[128]-x[281])/x[179]+(x[229]-x[178]*x[127]-x[280])/x[178])-x[25]+x[26] == 0.0)
@NLconstraint(m, e177, -0.5*x[2]*((x[231]-x[180]*x[129]-x[282])/x[180]+(x[230]-x[179]*x[128]-x[281])/x[179])-x[26]+x[27] == 0.0)
@NLconstraint(m, e178, -0.5*x[2]*((x[232]-x[181]*x[130]-x[283])/x[181]+(x[231]-x[180]*x[129]-x[282])/x[180])-x[27]+x[28] == 0.0)
@NLconstraint(m, e179, -0.5*x[2]*((x[233]-x[182]*x[131]-x[284])/x[182]+(x[232]-x[181]*x[130]-x[283])/x[181])-x[28]+x[29] == 0.0)
@NLconstraint(m, e180, -0.5*x[2]*((x[234]-x[183]*x[132]-x[285])/x[183]+(x[233]-x[182]*x[131]-x[284])/x[182])-x[29]+x[30] == 0.0)
@NLconstraint(m, e181, -0.5*x[2]*((x[235]-x[184]*x[133]-x[286])/x[184]+(x[234]-x[183]*x[132]-x[285])/x[183])-x[30]+x[31] == 0.0)
@NLconstraint(m, e182, -0.5*x[2]*((x[236]-x[185]*x[134]-x[287])/x[185]+(x[235]-x[184]*x[133]-x[286])/x[184])-x[31]+x[32] == 0.0)
@NLconstraint(m, e183, -0.5*x[2]*((x[237]-x[186]*x[135]-x[288])/x[186]+(x[236]-x[185]*x[134]-x[287])/x[185])-x[32]+x[33] == 0.0)
@NLconstraint(m, e184, -0.5*x[2]*((x[238]-x[187]*x[136]-x[289])/x[187]+(x[237]-x[186]*x[135]-x[288])/x[186])-x[33]+x[34] == 0.0)
@NLconstraint(m, e185, -0.5*x[2]*((x[239]-x[188]*x[137]-x[290])/x[188]+(x[238]-x[187]*x[136]-x[289])/x[187])-x[34]+x[35] == 0.0)
@NLconstraint(m, e186, -0.5*x[2]*((x[240]-x[189]*x[138]-x[291])/x[189]+(x[239]-x[188]*x[137]-x[290])/x[188])-x[35]+x[36] == 0.0)
@NLconstraint(m, e187, -0.5*x[2]*((x[241]-x[190]*x[139]-x[292])/x[190]+(x[240]-x[189]*x[138]-x[291])/x[189])-x[36]+x[37] == 0.0)
@NLconstraint(m, e188, -0.5*x[2]*((x[242]-x[191]*x[140]-x[293])/x[191]+(x[241]-x[190]*x[139]-x[292])/x[190])-x[37]+x[38] == 0.0)
@NLconstraint(m, e189, -0.5*x[2]*((x[243]-x[192]*x[141]-x[294])/x[192]+(x[242]-x[191]*x[140]-x[293])/x[191])-x[38]+x[39] == 0.0)
@NLconstraint(m, e190, -0.5*x[2]*((x[244]-x[193]*x[142]-x[295])/x[193]+(x[243]-x[192]*x[141]-x[294])/x[192])-x[39]+x[40] == 0.0)
@NLconstraint(m, e191, -0.5*x[2]*((x[245]-x[194]*x[143]-x[296])/x[194]+(x[244]-x[193]*x[142]-x[295])/x[193])-x[40]+x[41] == 0.0)
@NLconstraint(m, e192, -0.5*x[2]*((x[246]-x[195]*x[144]-x[297])/x[195]+(x[245]-x[194]*x[143]-x[296])/x[194])-x[41]+x[42] == 0.0)
@NLconstraint(m, e193, -0.5*x[2]*((x[247]-x[196]*x[145]-x[298])/x[196]+(x[246]-x[195]*x[144]-x[297])/x[195])-x[42]+x[43] == 0.0)
@NLconstraint(m, e194, -0.5*x[2]*((x[248]-x[197]*x[146]-x[299])/x[197]+(x[247]-x[196]*x[145]-x[298])/x[196])-x[43]+x[44] == 0.0)
@NLconstraint(m, e195, -0.5*x[2]*((x[249]-x[198]*x[147]-x[300])/x[198]+(x[248]-x[197]*x[146]-x[299])/x[197])-x[44]+x[45] == 0.0)
@NLconstraint(m, e196, -0.5*x[2]*((x[250]-x[199]*x[148]-x[301])/x[199]+(x[249]-x[198]*x[147]-x[300])/x[198])-x[45]+x[46] == 0.0)
@NLconstraint(m, e197, -0.5*x[2]*((x[251]-x[200]*x[149]-x[302])/x[200]+(x[250]-x[199]*x[148]-x[301])/x[199])-x[46]+x[47] == 0.0)
@NLconstraint(m, e198, -0.5*x[2]*((x[252]-x[201]*x[150]-x[303])/x[201]+(x[251]-x[200]*x[149]-x[302])/x[200])-x[47]+x[48] == 0.0)
@NLconstraint(m, e199, -0.5*x[2]*((x[253]-x[202]*x[151]-x[304])/x[202]+(x[252]-x[201]*x[150]-x[303])/x[201])-x[48]+x[49] == 0.0)
@NLconstraint(m, e200, -0.5*x[2]*((x[254]-x[203]*x[152]-x[305])/x[203]+(x[253]-x[202]*x[151]-x[304])/x[202])-x[49]+x[50] == 0.0)
@NLconstraint(m, e201, -0.5*x[2]*((x[255]-x[204]*x[153]-x[306])/x[204]+(x[254]-x[203]*x[152]-x[305])/x[203])-x[50]+x[51] == 0.0)
@NLconstraint(m, e202, -0.5*x[2]*((x[256]-x[205]*x[154]-x[307])/x[205]+(x[255]-x[204]*x[153]-x[306])/x[204])-x[51]+x[52] == 0.0)
@NLconstraint(m, e203, -0.5*x[2]*((x[257]-x[206]*x[155]-x[308])/x[206]+(x[256]-x[205]*x[154]-x[307])/x[205])-x[52]+x[53] == 0.0)
