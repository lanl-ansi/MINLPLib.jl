...
setupperbound(x[3], 16.0)
setlowerbound(x[4], 1.0)
setupperbound(x[4], 16.0)
setlowerbound(x[6], 1.0)
setupperbound(x[6], 1000.0)
setlowerbound(x[7], 0.0001)
setlowerbound(x[8], 0.0001)
...
@NLconstraint(m, e3, 10*x[7]*x[9]-0.00968946189201592*x[3]*(x[1]^4-x[2]^4) == 0.0)
@NLconstraint(m, e4, 143.3076*x[10]*x[4]-10000*x[7] == 0.0)
@NLconstraint(m, e5, 3.1415927*x[6]*(0.001*x[9])^3-6e-6*x[3]*x[4]*x[13] == 0.0)
