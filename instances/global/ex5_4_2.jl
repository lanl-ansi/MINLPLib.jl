...
# ----- Constraints ----- #
@constraint(m, e1, -x[1]-x[2]-x[3]+objvar == 0.0)
@constraint(m, e2, x[4]+x[6] <= 400.0)
@constraint(m, e3, -x[4]+x[5]+x[7] <= 300.0)
@constraint(m, e4, -x[5]+x[8] <= 100.0)
@NLconstraint(m, e5, x[1]-x[1]*x[6]+833.333333333333*x[4] <= 83333.3333333333)
