...
setupperbound(x[92], 50000.0)
setupperbound(x[93], 50000.0)
setupperbound(x[94], 50000.0)
setupperbound(x[95], 50000.0)
setupperbound(x[96], 50000.0)
setlowerbound(x[97], 300.0)
setupperbound(x[97], 1200.0)
setlowerbound(x[98], 300.0)
setupperbound(x[98], 1200.0)
setlowerbound(x[99], 300.0)
setupperbound(x[99], 1200.0)
setlowerbound(x[100], 300.0)
setupperbound(x[100], 1200.0)
setlowerbound(x[101], 300.0)
setupperbound(x[101], 1200.0)
