...
@NLconstraint(m, e8, x[12]*x[7]-(x[37]*x[57]+x[41]*x[62]+x[45]*x[67]+x[49]*x[72]+x[53]*x[77])-0.58*x[2] == 0.0)
...
@NLconstraint(m, e12, x[16]*x[8]-(x[37]*x[58]+x[41]*x[63]+x[45]*x[68]+x[49]*x[73]+x[53]*x[78])-0.58*x[3] == 0.0)
...
@NLconstraint(m, e16, x[20]*x[9]-(x[37]*x[59]+x[41]*x[64]+x[45]*x[69]+x[49]*x[74]+x[53]*x[79])-0.58*x[4] == 0.0)
...
@NLconstraint(m, e20, x[24]*x[10]-(x[37]*x[60]+x[41]*x[65]+x[45]*x[70]+x[49]*x[75]+x[53]*x[80])-0.58*x[5] == 0.0)
...
@NLconstraint(m, e24, x[28]*x[11]-(x[37]*x[61]+x[41]*x[66]+x[45]*x[71]+x[49]*x[76]+x[53]*x[81])-0.58*x[6] == 0.0)
...
@constraint(m, e33, x[37]*x[32]-(x[12]*x[7]+x[92]*(-x[97]-x[99])) == 0.0)
...
@constraint(m, e37, x[41]*x[33]-(x[16]*x[8]+x[93]*(-x[100]-x[102])) == 0.0)
...
@constraint(m, e41, x[45]*x[34]-(x[20]*x[9]+x[94]*(-x[103]-x[105])) == 0.0)
...
@constraint(m, e45, x[49]*x[35]-(x[24]*x[10]+x[95]*(-x[106]-x[108])) == 0.0)
...
@constraint(m, e49, x[53]*x[36]-(x[28]*x[11]+x[96]*(-x[109]-x[111])) == 0.0)
...
@constraint(m, e62, -x[54]+x[110] == 0.0)
@NLconstraint(m, e63, -0.5*x[37]*x[37]+x[99] == 0.0)
@NLconstraint(m, e64, -0.5*x[41]*x[41]+x[102] == 0.0)
@NLconstraint(m, e65, -0.5*x[45]*x[45]+x[105] == 0.0)
@NLconstraint(m, e66, -0.5*x[49]*x[49]+x[108] == 0.0)
@NLconstraint(m, e67, -0.5*x[53]*x[53]+x[111] == 0.0)
