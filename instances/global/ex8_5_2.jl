...
# ----- Constraints ----- #
@NLconstraint(m, e1, -(x[2]*log(x[2])+x[3]*log(x[3])+x[4]*log(x[4])+x[7]/(x[5]-x[7])-log(x[5]-x[7])-2*x[6]/x[5]+0.585616681390832*x[2]+3.53797016206289*x[3]+2.18345516206289*x[4])+objvar == 0.0)
