...
setupperbound(x[2], 0.2995)
setlowerbound(x[3], 1.0e-7)
setupperbound(x[3], 0.2995)
setlowerbound(x[4], 1.0e-7)
setupperbound(x[4], 0.1998)
setlowerbound(x[5], 1.0e-7)
setupperbound(x[5], 0.1998)
setlowerbound(x[6], 1.0e-7)
setupperbound(x[6], 0.4994)
setlowerbound(x[7], 1.0e-7)
setupperbound(x[7], 0.4994)


# ----- Constraints ----- #
@NLconstraint(m, e1, -(x[2]*(log(x[2])-log(x[2]+x[4]+x[6]))+x[4]*(log(x[4])-log(x[2]+x[4]+x[6]))+x[6]*(log(x[6])-log(x[2]+x[4]+x[6]))+x[3]*(log(x[3])-log(x[3]+x[5]+x[7]))+x[5]*(log(x[5])-log(x[3]+x[5]+x[7]))+x[7]*(log(x[7])-log(x[3]+x[5]+x[7]))+x[2]*(1.44805026165593*x[10]+0.989428667054834*x[12])+x[4]*(1.12676386427658*x[8]+1.00363012835441*x[12])+x[6]*(0.0347225450624344*x[8]+0.82681418300153*x[10])+x[3]*(1.44805026165593*x[11]+0.989428667054834*x[13])+x[5]*(1.12676386427658*x[9]+1.00363012835441*x[13])+x[7]*(0.0347225450624344*x[9]+0.82681418300153*x[11]))+objvar == 0.0)
