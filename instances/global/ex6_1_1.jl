...
# ----- Constraints ----- #
@NLconstraint(m, e1, -(x[2]*(log(x[2])-log(x[2]+x[4]))+x[4]*(log(x[4])-log(x[2]+x[4]))+x[3]*(log(x[3])-log(x[3]+x[5]))+x[5]*(log(x[5])-log(x[3]+x[5]))+0.925356626778358*x[2]*x[8]+0.746014540096753*x[4]*x[6]+0.925356626778358*x[3]*x[9]+0.746014540096753*x[5]*x[7])+objvar == 0.0)
