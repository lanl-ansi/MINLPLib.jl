...
# ----- Constraints ----- #
@NLconstraint(m, e1, -x[90]/(1-x[88])-objvar == 0.0)
...
@NLconstraint(m, e33, x[37]*x[32]-(x[12]*x[7]+x[92]*(-x[97]-x[98]-x[99])) == 0.0)
@NLconstraint(m, e34, x[38]*x[32]-(x[13]*x[7]+x[92]*x[97]) == 0.0)
@NLconstraint(m, e35, x[39]*x[32]-(x[14]*x[7]+x[92]*x[98]) == 0.0)
@NLconstraint(m, e36, x[40]*x[32]-(x[15]*x[7]+x[92]*x[99]) == 0.0)
@NLconstraint(m, e37, x[41]*x[33]-(x[16]*x[8]+x[93]*(-x[100]-x[101]-x[102])) == 0.0)
@NLconstraint(m, e38, x[42]*x[33]-(x[17]*x[8]+x[93]*x[100]) == 0.0)
@NLconstraint(m, e39, x[43]*x[33]-(x[18]*x[8]+x[93]*x[101]) == 0.0)
@NLconstraint(m, e40, x[44]*x[33]-(x[19]*x[8]+x[93]*x[102]) == 0.0)
@NLconstraint(m, e41, x[45]*x[34]-(x[20]*x[9]+x[94]*(-x[103]-x[104]-x[105])) == 0.0)
@NLconstraint(m, e42, x[46]*x[34]-(x[21]*x[9]+x[94]*x[103]) == 0.0)
@NLconstraint(m, e43, x[47]*x[34]-(x[22]*x[9]+x[94]*x[104]) == 0.0)
@NLconstraint(m, e44, x[48]*x[34]-(x[23]*x[9]+x[94]*x[105]) == 0.0)
@NLconstraint(m, e45, x[49]*x[35]-(x[24]*x[10]+x[95]*(-x[106]-x[107]-x[108])) == 0.0)
@NLconstraint(m, e46, x[50]*x[35]-(x[25]*x[10]+x[95]*x[106]) == 0.0)
@NLconstraint(m, e47, x[51]*x[35]-(x[26]*x[10]+x[95]*x[107]) == 0.0)
@NLconstraint(m, e48, x[52]*x[35]-(x[27]*x[10]+x[95]*x[108]) == 0.0)
@NLconstraint(m, e49, x[53]*x[36]-(x[28]*x[11]+x[96]*(-x[109]-x[110]-x[111])) == 0.0)
@NLconstraint(m, e50, x[54]*x[36]-(x[29]*x[11]+x[96]*x[109]) == 0.0)
@NLconstraint(m, e51, x[55]*x[36]-(x[30]*x[11]+x[96]*x[110]) == 0.0)
@NLconstraint(m, e52, x[56]*x[36]-(x[31]*x[11]+x[96]*x[111]) == 0.0)
@constraint(m, e53, x[97] == 0.025)
@constraint(m, e54, x[100] == 0.025)
@constraint(m, e55, x[103] == 0.025)
@constraint(m, e56, x[106] == 0.025)
@constraint(m, e57, x[109] == 0.025)
@constraint(m, e58, -0.2*x[37]+x[98] == 0.0)
@constraint(m, e59, -0.2*x[41]+x[101] == 0.0)
@constraint(m, e60, -0.2*x[45]+x[104] == 0.0)
@constraint(m, e61, -0.2*x[49]+x[107] == 0.0)
@constraint(m, e62, -0.2*x[53]+x[110] == 0.0)
@NLconstraint(m, e63, -0.4*x[37]*x[37]+x[99] == 0.0)
@NLconstraint(m, e64, -0.4*x[41]*x[41]+x[102] == 0.0)
@NLconstraint(m, e65, -0.4*x[45]*x[45]+x[105] == 0.0)
@NLconstraint(m, e66, -0.4*x[49]*x[49]+x[108] == 0.0)
@NLconstraint(m, e67, -0.4*x[53]*x[53]+x[111] == 0.0)
