...
setlowerbound(x[92], 320.0)
setupperbound(x[92], 500.0)
setlowerbound(x[93], 320.0)
setupperbound(x[93], 500.0)
setlowerbound(x[94], 380.0)
setupperbound(x[94], 480.0)
setlowerbound(x[95], 380.0)
setupperbound(x[95], 480.0)
setlowerbound(x[96], 360.0)
setupperbound(x[96], 460.0)
setlowerbound(x[97], 360.0)
setupperbound(x[97], 460.0)
setlowerbound(x[98], 360.0)
setupperbound(x[98], 380.0)
setlowerbound(x[99], 360.0)
setupperbound(x[99], 380.0)
setlowerbound(x[100], 320.0)
setupperbound(x[100], 380.0)
setlowerbound(x[101], 320.0)
setupperbound(x[101], 380.0)
setlowerbound(x[102], 290.0)
setupperbound(x[102], 660.0)
setlowerbound(x[103], 290.0)
setupperbound(x[103], 660.0)
setlowerbound(x[104], 290.0)
setupperbound(x[104], 660.0)
setlowerbound(x[105], 290.0)
setupperbound(x[105], 660.0)
setlowerbound(x[106], 290.0)
setupperbound(x[106], 660.0)
setlowerbound(x[107], 290.0)
setupperbound(x[107], 660.0)
setlowerbound(x[108], 290.0)
setupperbound(x[108], 660.0)
setlowerbound(x[109], 290.0)
setupperbound(x[109], 660.0)
setlowerbound(x[110], 290.0)
setupperbound(x[110], 660.0)
setlowerbound(x[111], 290.0)
setupperbound(x[111], 660.0)
