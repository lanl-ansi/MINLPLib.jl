...
@constraint(m, e125, x[1]-x[41] >= 6.0)
@constraint(m, e126, x[2]-x[42] >= 6.0)
@constraint(m, e127, x[3]-x[43] >= 6.0)
@constraint(m, e128, x[4]-x[44] >= 6.0)
@constraint(m, e129, x[5]-x[45] >= 6.0)
@constraint(m, e130, x[6]-x[46] >= 6.0)
@constraint(m, e131, x[7]-x[47] >= 6.0)
@constraint(m, e132, x[8]-x[48] >= 6.0)
@constraint(m, e133, x[9]-x[49] >= 6.0)
@constraint(m, e134, x[10]-x[50] >= 6.0)
@constraint(m, e135, x[11]-x[51] >= 6.0)
@constraint(m, e136, x[12]-x[52] >= 6.0)
@constraint(m, e137, x[13]-x[53] >= 6.0)
@constraint(m, e138, x[14]-x[54] >= 6.0)
@constraint(m, e139, x[15]-x[55] >= 6.0)
@constraint(m, e140, x[16]-x[56] >= 6.0)
@constraint(m, e141, x[17]-x[57] >= 6.0)
@constraint(m, e142, x[18]-x[58] >= 6.0)
@constraint(m, e143, x[19]-x[59] >= 6.0)
@constraint(m, e144, x[20]-x[60] >= 6.0)
@constraint(m, e145, x[21]-x[61] >= 6.0)
@constraint(m, e146, x[22]-x[62] >= 6.0)
@constraint(m, e147, x[23]-x[63] >= 6.0)
@constraint(m, e148, x[24]-x[64] >= 6.0)
@constraint(m, e149, x[25]-x[65] >= 6.0)
@constraint(m, e150, x[26]-x[66] >= 6.0)
@constraint(m, e151, x[27]-x[67] >= 6.0)
@constraint(m, e152, x[28]-x[68] >= 6.0)
@constraint(m, e153, x[29]-x[69] >= 6.0)
@constraint(m, e154, x[30]-x[70] >= 6.0)
@constraint(m, e155, x[31]-x[71] >= 6.0)
@constraint(m, e156, x[32]-x[72] >= 6.0)
@constraint(m, e157, x[33]-x[73] >= 6.0)
@constraint(m, e158, x[34]-x[74] >= 6.0)
@constraint(m, e159, x[35]-x[75] >= 6.0)
@constraint(m, e160, x[36]-x[76] >= 6.0)
@constraint(m, e161, x[37]-x[77] >= 6.0)
@constraint(m, e162, x[38]-x[78] >= 6.0)
@constraint(m, e163, x[39]-x[79] >= 6.0)
@constraint(m, e164, x[40]-x[80] >= 6.0)
@constraint(m, e165, x[41]-x[81] >= 6.0)
@constraint(m, e166, x[42]-x[82] >= 6.0)
@constraint(m, e167, x[43]-x[83] >= 6.0)
@constraint(m, e168, x[44]-x[84] >= 6.0)
@constraint(m, e169, x[45]-x[85] >= 6.0)
@constraint(m, e170, x[46]-x[86] >= 6.0)
@constraint(m, e171, x[47]-x[87] >= 6.0)
@constraint(m, e172, x[48]-x[88] >= 6.0)
@constraint(m, e173, x[49]-x[89] >= 6.0)
@constraint(m, e174, x[50]-x[90] >= 6.0)
@constraint(m, e175, x[51]-x[91] >= 6.0)
@constraint(m, e176, x[52]-x[92] >= 6.0)
@constraint(m, e177, x[53]-x[93] >= 6.0)
@constraint(m, e178, x[54]-x[94] >= 6.0)
@constraint(m, e179, x[55]-x[95] >= 6.0)
@constraint(m, e180, x[56]-x[96] >= 6.0)
@constraint(m, e181, x[57]-x[97] >= 6.0)
@constraint(m, e182, x[58]-x[98] >= 6.0)
@constraint(m, e183, x[59]-x[99] >= 6.0)
@constraint(m, e184, x[60]-x[100] >= 6.0)
@constraint(m, e185, x[61]-x[101] >= 6.0)
@constraint(m, e186, x[62]-x[102] >= 6.0)
@constraint(m, e187, x[63]-x[103] >= 6.0)
@constraint(m, e188, x[64]-x[104] >= 6.0)
@constraint(m, e189, x[65]-x[105] >= 6.0)
@constraint(m, e190, x[66]-x[106] >= 6.0)
@constraint(m, e191, x[67]-x[107] >= 6.0)
@constraint(m, e192, x[68]-x[108] >= 6.0)
@constraint(m, e193, x[69]-x[109] >= 6.0)
@constraint(m, e194, x[70]-x[110] >= 6.0)
@constraint(m, e195, x[71]-x[111] >= 6.0)
@constraint(m, e196, x[72]-x[112] >= 6.0)
@constraint(m, e197, x[73]-x[113] >= 6.0)
@constraint(m, e198, x[74]-x[114] >= 6.0)
@constraint(m, e199, x[75]-x[115] >= 6.0)
@constraint(m, e200, x[76]-x[116] >= 6.0)
@constraint(m, e201, x[77]-x[117] >= 6.0)
@constraint(m, e202, x[78]-x[118] >= 6.0)
@constraint(m, e203, x[79]-x[119] >= 6.0)
@constraint(m, e204, x[80]-x[120] >= 6.0)
