...
@NLconstraint(m, e67, b[16]*(x[1]-x[2])-0.249149*x[6]*x[6] == 0.0)
@NLconstraint(m, e68, b[17]*(x[2]-x[1])-0.249149*x[7]*x[7] == 0.0)
@NLconstraint(m, e69, b[18]*(x[2]-x[3])-0.249149*x[8]*x[8] == 0.0)
@NLconstraint(m, e70, b[19]*(x[2]-x[4])-0.249149*x[9]*x[9] == 0.0)
@NLconstraint(m, e71, b[20]*(x[3]-x[2])-0.249149*x[10]*x[10] == 0.0)
@NLconstraint(m, e72, b[21]*(x[3]-x[5])-0.249149*x[11]*x[11] == 0.0)
@NLconstraint(m, e73, b[22]*(x[4]-x[2])-0.249149*x[12]*x[12] == 0.0)
@NLconstraint(m, e74, b[23]*(x[4]-x[5])-0.249149*x[13]*x[13] == 0.0)
@NLconstraint(m, e75, b[24]*(x[5]-x[3])-0.249149*x[14]*x[14] == 0.0)
@NLconstraint(m, e76, b[25]*(x[5]-x[4])-0.249149*x[15]*x[15] == 0.0)
