...
@constraint(m, e290, x[4]-x[37]+7.4125*b[42]+4*b[51]-4*b[60]+4*b[69] <= -0.9)
@constraint(m, e291, x[5]-x[37]+4.94*b[43]+4.84*b[52]-4.84*b[61]+4.84*b[70] <= -0.46)
@constraint(m, e292, x[6]-x[37]+5.6*b[44]+3.75*b[53]-3.75*b[62]+3.75*b[71] <= -0.65)
@constraint(m, e293, x[7]-x[37]+6.45*b[45]+4.4*b[54]-4.4*b[63]+4.4*b[72] <= -0.8)
@constraint(m, e294, x[8]-x[37]+5*b[46]+5*b[55]-5*b[64]+5*b[73] <= -0.4)
@constraint(m, e295, x[9]-x[37]+6.95*b[47]+4.1*b[56]-4.1*b[65]+4.1*b[74] <= -1.3)
...
@constraint(m, e302, x[22]+3.4125*b[51]-4*b[69] <= -1.86)
@constraint(m, e303, x[23]+0.100000000000001*b[52]-4.84*b[70] <= -2.26)
@constraint(m, e304, x[24]+1.85*b[53]-3.75*b[71] <= -1.36)
@constraint(m, e305, x[25]+2.05*b[54]-4.4*b[72] <= -2.16)
@constraint(m, e306, x[26]-5*b[73] <= -2.36)
@constraint(m, e307, x[27]+2.85*b[56]-4.1*b[74] <= -2.36)
@NLconstraint(m, e308, x[28]*b[39]+x[31]*(b[48]-b[57]+b[66])+x[34]*(1-b[39]-b[48]+b[57]-b[66])+x[1]-x[37] <= 0.0)
@NLconstraint(m, e309, x[29]*b[40]+x[32]*(b[49]-b[58]+b[67])+x[35]*(1-b[40]-b[49]+b[58]-b[67])+x[2]-x[37] <= 0.0)
@NLconstraint(m, e310, x[30]*b[41]+x[33]*(b[50]-b[59]+b[68])+x[36]*(1-b[41]-b[50]+b[59]-b[68])+x[3]-x[37] <= 0.0)
...
@NLconstraint(m, e314, x[34]*b[66]+x[31]*(1-b[48]-b[66])+x[28]*b[48]+x[19] <= 3.04)
@NLconstraint(m, e315, x[35]*b[67]+x[32]*(1-b[49]-b[67])+x[29]*b[49]+x[20] <= 3.04)
@NLconstraint(m, e316, x[36]*b[68]+x[33]*(1-b[50]-b[68])+x[30]*b[50]+x[21] <= 3.04)
...
@constraint(m, e392, x[29]-190*b[312] >= -185.0)
@constraint(m, e393, x[29]-190*b[313] >= -187.625)
@constraint(m, e394, x[29]-190*b[314] >= -187.625)
@constraint(m, e395, x[30]-190*b[315] >= -183.0)
@constraint(m, e396, x[30]-190*b[316] >= -185.0)
@constraint(m, e397, x[30]-190*b[317] >= -185.0)
@constraint(m, e398, x[28]+190*b[309] <= 195.5)
@constraint(m, e399, x[28]+190*b[310] <= 194.125)
@constraint(m, e400, x[28]+190*b[311] <= 193.25)
@constraint(m, e401, x[29]+190*b[312] <= 195.0)
@constraint(m, e402, x[29]+190*b[313] <= 192.375)
@constraint(m, e403, x[29]+190*b[314] <= 192.375)
@constraint(m, e404, x[30]+190*b[315] <= 197.0)
@constraint(m, e405, x[30]+190*b[316] <= 195.0)
@constraint(m, e406, x[30]+190*b[317] <= 195.0)
@constraint(m, e407, x[31]-190*b[309] >= -187.625)
@constraint(m, e408, x[31]-190*b[310] >= -187.875)
@constraint(m, e409, x[31]-190*b[311] >= -188.75)
@constraint(m, e410, x[32]-190*b[312] >= -185.875)
@constraint(m, e411, x[32]-190*b[313] >= -185.75)
@constraint(m, e412, x[32]-190*b[314] >= -185.75)
@constraint(m, e413, x[33]-190*b[315] >= -185.0)
@constraint(m, e414, x[33]-190*b[316] >= -185.0)
@constraint(m, e415, x[33]-190*b[317] >= -185.0)
@constraint(m, e416, x[31]+190*b[309] <= 192.375)
@constraint(m, e417, x[31]+190*b[310] <= 192.125)
@constraint(m, e418, x[31]+190*b[311] <= 191.25)
@constraint(m, e419, x[32]+190*b[312] <= 194.125)
@constraint(m, e420, x[32]+190*b[313] <= 194.25)
@constraint(m, e421, x[32]+190*b[314] <= 194.25)
@constraint(m, e422, x[33]+190*b[315] <= 195.0)
@constraint(m, e423, x[33]+190*b[316] <= 195.0)
@constraint(m, e424, x[33]+190*b[317] <= 195.0)
@constraint(m, e425, x[34]-190*b[309] >= -189.625)
@constraint(m, e426, x[34]-190*b[310] >= -189.0)
@constraint(m, e427, x[34]-190*b[311] >= -188.75)
@constraint(m, e428, x[35]-190*b[312] >= -189.75)
@constraint(m, e429, x[35]-190*b[313] >= -189.625)
@constraint(m, e430, x[35]-190*b[314] >= -189.625)
@constraint(m, e431, x[36]-190*b[315] >= -189.0)
@constraint(m, e432, x[36]-190*b[316] >= -188.5)
@constraint(m, e433, x[36]-190*b[317] >= -188.5)
@constraint(m, e434, x[34]+190*b[309] <= 190.375)
@constraint(m, e435, x[34]+190*b[310] <= 191.0)
@constraint(m, e436, x[34]+190*b[311] <= 191.25)
@constraint(m, e437, x[35]+190*b[312] <= 190.25)
@constraint(m, e438, x[35]+190*b[313] <= 190.375)
@constraint(m, e439, x[35]+190*b[314] <= 190.375)
@constraint(m, e440, x[36]+190*b[315] <= 191.0)
@constraint(m, e441, x[36]+190*b[316] <= 191.5)
@constraint(m, e442, x[36]+190*b[317] <= 191.5)
