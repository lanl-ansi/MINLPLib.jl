...
@constraint(m, e16, 6*x[16]-3*x[55]-2*x[68]+x[146] == 1493.0)
@constraint(m, e17, 6*x[17]-3*x[56]-2*x[69]+x[147] == 1393.0)
@constraint(m, e18, 6*x[18]-3*x[57]-2*x[70]+x[148] == 1293.0)
@constraint(m, e19, 6*x[19]-3*x[58]-2*x[71]+x[149] == 1193.0)
@constraint(m, e20, 6*x[20]-3*x[59]-2*x[72]+x[150] == 1093.0)
@constraint(m, e21, 6*x[21]-3*x[60]-2*x[73]+x[151] == 993.0)
@constraint(m, e22, 6*x[22]-3*x[61]-2*x[74]+x[152] == 893.0)
@constraint(m, e23, 6*x[23]-3*x[62]-2*x[75]+x[153] == 793.0)
@constraint(m, e24, 6*x[24]-3*x[63]-2*x[76]+x[154] == 693.0)
@constraint(m, e25, 6*x[25]-3*x[64]-2*x[77]+x[155] == 593.0)
@constraint(m, e26, 6*x[26]-3*x[65]-2*x[78]+x[156] == 493.0)
@constraint(m, e27, 6*x[27]-3*x[66]-2*x[79]+x[157] == 393.0)
@constraint(m, e28, 6*x[28]-3*x[67]-2*x[80]+x[158] == 293.0)
@constraint(m, e29, 8*x[29]-2*x[55]+x[159] == 1193.0)
@constraint(m, e30, 8*x[30]-2*x[56]+x[160] == 1093.0)
@constraint(m, e31, 8*x[31]-2*x[57]+x[161] == 993.0)
@constraint(m, e32, 8*x[32]-2*x[58]+x[162] == 893.0)
@constraint(m, e33, 8*x[33]-2*x[59]+x[163] == 793.0)
@constraint(m, e34, 8*x[34]-2*x[60]+x[164] == 693.0)
@constraint(m, e35, 8*x[35]-2*x[61]+x[165] == 593.0)
@constraint(m, e36, 8*x[36]-2*x[62]+x[166] == 493.0)
@constraint(m, e37, 8*x[37]-2*x[63]+x[167] == 393.0)
@constraint(m, e38, 8*x[38]-2*x[64]+x[168] == 293.0)
@constraint(m, e39, 8*x[39]-2*x[65]+x[169] == 193.0)
@constraint(m, e40, 8*x[40]-2*x[66]+x[170] == 93.0)
@constraint(m, e41, 8*x[41]-2*x[67]+x[171] == -7.0)
@constraint(m, e42, 9*x[42]-x[68]+x[172] == 1293.0)
@constraint(m, e43, 9*x[43]-x[69]+x[173] == 1193.0)
@constraint(m, e44, 9*x[44]-x[70]+x[174] == 1093.0)
@constraint(m, e45, 9*x[45]-x[71]+x[175] == 993.0)
@constraint(m, e46, 9*x[46]-x[72]+x[176] == 893.0)
@constraint(m, e47, 9*x[47]-x[73]+x[177] == 793.0)
@constraint(m, e48, 9*x[48]-x[74]+x[178] == 693.0)
@constraint(m, e49, 9*x[49]-x[75]+x[179] == 593.0)
@constraint(m, e50, 9*x[50]-x[76]+x[180] == 493.0)
@constraint(m, e51, 9*x[51]-x[77]+x[181] == 393.0)
@constraint(m, e52, 9*x[52]-x[78]+x[182] == 293.0)
@constraint(m, e53, 9*x[53]-x[79]+x[183] == 193.0)
@constraint(m, e54, 9*x[54]-x[80]+x[184] == 93.0)
@constraint(m, e55, 5*x[55]-2*x[94]+x[185] == 1693.0)
@constraint(m, e56, 5*x[56]-2*x[95]+x[186] == 1593.0)
@constraint(m, e57, 5*x[57]-2*x[96]+x[187] == 1493.0)
@constraint(m, e58, 5*x[58]-2*x[97]+x[188] == 1393.0)
@constraint(m, e59, 5*x[59]-2*x[98]+x[189] == 1293.0)
@constraint(m, e60, 5*x[60]-2*x[99]+x[190] == 1193.0)
@constraint(m, e61, 5*x[61]-2*x[100]+x[191] == 1093.0)
@constraint(m, e62, 5*x[62]-2*x[101]+x[192] == 993.0)
@constraint(m, e63, 5*x[63]-2*x[102]+x[193] == 893.0)
@constraint(m, e64, 5*x[64]-2*x[103]+x[194] == 793.0)
@constraint(m, e65, 5*x[65]-2*x[104]+x[195] == 693.0)
@constraint(m, e66, 5*x[66]-2*x[105]+x[196] == 593.0)
@constraint(m, e67, 5*x[67]-2*x[106]+x[197] == 493.0)
@constraint(m, e68, 6*x[68]-2*x[94]+x[198] == 1393.0)
@constraint(m, e69, 6*x[69]-2*x[95]+x[199] == 1293.0)
@constraint(m, e70, 6*x[70]-2*x[96]+x[200] == 1193.0)
@constraint(m, e71, 6*x[71]-2*x[97]+x[201] == 1093.0)
@constraint(m, e72, 6*x[72]-2*x[98]+x[202] == 993.0)
@constraint(m, e73, 6*x[73]-2*x[99]+x[203] == 893.0)
@constraint(m, e74, 6*x[74]-2*x[100]+x[204] == 793.0)
@constraint(m, e75, 6*x[75]-2*x[101]+x[205] == 693.0)
@constraint(m, e76, 6*x[76]-2*x[102]+x[206] == 593.0)
@constraint(m, e77, 6*x[77]-2*x[103]+x[207] == 493.0)
@constraint(m, e78, 6*x[78]-2*x[104]+x[208] == 393.0)
@constraint(m, e79, 6*x[79]-2*x[105]+x[209] == 293.0)
@constraint(m, e80, 6*x[80]-2*x[106]+x[210] == 193.0)
@constraint(m, e81, x[211] == 1293.0)
@constraint(m, e82, x[212] == 1193.0)
@constraint(m, e83, x[213] == 1093.0)
@constraint(m, e84, x[214] == 993.0)
@constraint(m, e85, x[215] == 893.0)
@constraint(m, e86, x[216] == 793.0)
@constraint(m, e87, x[217] == 693.0)
@constraint(m, e88, x[218] == 593.0)
@constraint(m, e89, x[219] == 493.0)
@constraint(m, e90, x[220] == 393.0)
@constraint(m, e91, x[221] == 293.0)
@constraint(m, e92, x[222] == 193.0)
@constraint(m, e93, x[223] == 93.0)
@constraint(m, e94, 9*x[94]+x[224] == 2793.0)
@constraint(m, e95, 9*x[95]+x[225] == 2693.0)
@constraint(m, e96, 9*x[96]+x[226] == 2593.0)
@constraint(m, e97, 9*x[97]+x[227] == 2493.0)
@constraint(m, e98, 9*x[98]+x[228] == 2393.0)
@constraint(m, e99, 9*x[99]+x[229] == 2293.0)
@constraint(m, e100, 9*x[100]+x[230] == 2193.0)
@constraint(m, e101, 9*x[101]+x[231] == 2093.0)
@constraint(m, e102, 9*x[102]+x[232] == 1993.0)
@constraint(m, e103, 9*x[103]+x[233] == 1893.0)
@constraint(m, e104, 9*x[104]+x[234] == 1793.0)
@constraint(m, e105, 9*x[105]+x[235] == 1693.0)
@constraint(m, e106, 9*x[106]+x[236] == 1593.0)
...
@constraint(m, e289, x[2]+x[5]+x[6]+x[8] <= 100000.0)
@constraint(m, e290, x[3]+x[5]+x[7]+x[8] <= 100000.0)
@constraint(m, e291, x[4]+x[6]+x[7]+x[8] <= 100000.0)
