...
@constraint(m, e171, x[4]-x[28]+4.8*b[33]+4*b[40]-4*b[47]+4*b[54] <= -1.1)
@constraint(m, e172, x[5]-x[28]+4.97*b[34]+4.87*b[41]-4.87*b[48]+4.87*b[55] <= -0.43)
@constraint(m, e173, x[6]-x[28]+6.625*b[35]+4.25*b[42]-4.25*b[49]+4.25*b[56] <= -0.75)
@constraint(m, e174, x[7]-x[28]+7.33*b[36]+3.98*b[43]-3.98*b[50]+3.98*b[57] <= -0.92)
...
@constraint(m, e181, x[18]+0.800000000000001*b[40]-4*b[54] <= -2.06)
@constraint(m, e182, x[19]+0.100000000000001*b[41]-4.87*b[55] <= -2.26)
@constraint(m, e183, x[20]+2.375*b[42]-4.25*b[56] <= -1.96)
@constraint(m, e184, x[21]+3.35*b[43]-3.98*b[57] <= -1.86)
...
@constraint(m, e247, x[22]-190*b[199] >= -181.125)
@constraint(m, e248, x[22]-190*b[200] >= -185.5)
@constraint(m, e249, x[22]-190*b[201] >= -181.5)
@constraint(m, e250, x[23]-190*b[202] >= -184.5)
@constraint(m, e251, x[23]-190*b[203] >= -185.875)
@constraint(m, e252, x[23]-190*b[204] >= -186.75)
@constraint(m, e253, x[22]+190*b[199] <= 198.875)
@constraint(m, e254, x[22]+190*b[200] <= 194.5)
@constraint(m, e255, x[22]+190*b[201] <= 198.5)
@constraint(m, e256, x[23]+190*b[202] <= 195.5)
@constraint(m, e257, x[23]+190*b[203] <= 194.125)
@constraint(m, e258, x[23]+190*b[204] <= 193.25)
@constraint(m, e259, x[24]-190*b[199] >= -184.5)
@constraint(m, e260, x[24]-190*b[200] >= -184.75)
...
@constraint(m, e265, x[24]+190*b[199] <= 195.5)
@constraint(m, e266, x[24]+190*b[200] <= 195.25)
...
@constraint(m, e273, x[26]-190*b[201] >= -188.5)
...
@constraint(m, e279, x[26]+190*b[201] <= 191.5)
