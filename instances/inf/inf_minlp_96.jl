...
@constraint(m, e290, x[3]+5.15*b[38]+5.15*b[47]-5.15*b[56]+5.15*b[65] <= 7.65)
@constraint(m, e291, x[4]+5.3*b[39]+5.1*b[48]-5.1*b[57]+5.1*b[66] <= 7.3)
@constraint(m, e292, x[5]+6.2*b[40]+3.8*b[49]-3.8*b[58]+3.8*b[67] <= 6.4)
@constraint(m, e293, x[6]+5.6*b[41]+3.75*b[50]-3.75*b[59]+3.75*b[68] <= 7.35)
@constraint(m, e294, x[7]+4.4*b[42]+1.8*b[51]-1.8*b[60]+1.8*b[69] <= 7.4)
@constraint(m, e295, x[8]+4.9*b[43]+4.8*b[52]-4.8*b[61]+4.8*b[70] <= 7.6)
@constraint(m, e296, x[9]+6.38*b[44]+4.03*b[53]-4.03*b[62]+4.03*b[71] <= 7.13)
...
@constraint(m, e304, x[21]-x[34]-5.15*b[65] <= -5.5)
@constraint(m, e305, x[22]-x[34]+0.2*b[48]-5.1*b[66] <= -5.8)
@constraint(m, e306, x[23]-x[34]+2.4*b[49]-3.8*b[67] <= -5.4)
@constraint(m, e307, x[24]-x[34]+1.85*b[50]-3.75*b[68] <= -4.4)
@constraint(m, e308, x[25]-x[34]+2.6*b[51]-1.8*b[69] <= -2.4)
@constraint(m, e309, x[26]-x[34]+0.0999999999999996*b[52]-4.8*b[70] <= -5.2)
@constraint(m, e310, x[27]-x[34]+2.35*b[53]-4.03*b[71] <= -4.9)
@NLconstraint(m, e311, x[28]*b[36]+x[30]*(b[45]-b[54]+b[63])+x[32]*(1-b[36]-b[45]+b[54]-b[63])+x[1] <= 8.0)
@NLconstraint(m, e312, x[29]*b[37]+x[31]*(b[46]-b[55]+b[64])+x[33]*(1-b[37]-b[46]+b[55]-b[64])+x[2] <= 8.0)
...
@NLconstraint(m, e389, -x[28]*x[30]*x[32] == -5.0)
@NLconstraint(m, e390, -x[29]*x[31]*x[33] == -15.0)
@constraint(m, e391, x[28] <= 5.125)
@constraint(m, e392, x[29] <= 8.5)
@constraint(m, e393, x[28] >= 1.5)
@constraint(m, e394, x[29] >= 3.4)
@constraint(m, e395, x[30] <= 2.125)
@constraint(m, e396, x[31] <= 4.7)
@constraint(m, e397, x[30] >= 0.25)
@constraint(m, e398, x[31] >= 1.7)
@constraint(m, e399, x[32] <= 3.5)
@constraint(m, e400, x[33] <= 2.7)
@constraint(m, e401, x[32] >= 3.5)
@constraint(m, e402, x[33] >= 2.7)
