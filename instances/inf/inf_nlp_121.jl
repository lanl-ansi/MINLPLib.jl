...
@variable(m, x[x_Idx])
setlowerbound(x[1], 0.46)
setupperbound(x[1], 2.08)
setlowerbound(x[2], 0.6)
setupperbound(x[2], 2.89)
setlowerbound(x[3], 0.12)
setupperbound(x[3], 2.49)
setlowerbound(x[4], 0.67)
setupperbound(x[4], 2.34)
setlowerbound(x[5], 0.83)
setupperbound(x[5], 2.93)
setlowerbound(x[6], 0.53)
setupperbound(x[6], 2.71)
setlowerbound(x[7], 0.67)
setupperbound(x[7], 2.26)
setlowerbound(x[8], 0.69)
setupperbound(x[8], 2.47)
setlowerbound(x[9], 0.57)
setupperbound(x[9], 2.26)
setlowerbound(x[10], 0.71)
setupperbound(x[10], 2.73)
setlowerbound(x[11], 0.38)
setupperbound(x[11], 2.46)
setlowerbound(x[12], 0.36)
setupperbound(x[12], 2.85)
setlowerbound(x[13], 0.54)
setupperbound(x[13], 2.24)
setlowerbound(x[14], 0.74)
setupperbound(x[14], 2.13)
