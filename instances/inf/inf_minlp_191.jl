...
@constraint(m, e16, 18*x[16]-9*x[55]-6*x[68]+x[146] == 2986.0)
@constraint(m, e17, 18*x[17]-9*x[56]-6*x[69]+x[147] == 2979.0)
@constraint(m, e18, 18*x[18]-9*x[57]-6*x[70]+x[148] == 2972.0)
@constraint(m, e19, 18*x[19]-9*x[58]-6*x[71]+x[149] == 2965.0)
@constraint(m, e20, 18*x[20]-9*x[59]-6*x[72]+x[150] == 2958.0)
@constraint(m, e21, 18*x[21]-9*x[60]-6*x[73]+x[151] == 2951.0)
@constraint(m, e22, 18*x[22]-9*x[61]-6*x[74]+x[152] == 2944.0)
@constraint(m, e23, 18*x[23]-9*x[62]-6*x[75]+x[153] == 2937.0)
@constraint(m, e24, 18*x[24]-9*x[63]-6*x[76]+x[154] == 2930.0)
@constraint(m, e25, 18*x[25]-9*x[64]-6*x[77]+x[155] == 2923.0)
@constraint(m, e26, 18*x[26]-9*x[65]-6*x[78]+x[156] == 2916.0)
@constraint(m, e27, 18*x[27]-9*x[66]-6*x[79]+x[157] == 2909.0)
@constraint(m, e28, 18*x[28]-9*x[67]-6*x[80]+x[158] == 2902.0)
@constraint(m, e29, 24*x[29]-6*x[55]+x[159] == 2386.0)
@constraint(m, e30, 24*x[30]-6*x[56]+x[160] == 2379.0)
@constraint(m, e31, 24*x[31]-6*x[57]+x[161] == 2372.0)
@constraint(m, e32, 24*x[32]-6*x[58]+x[162] == 2365.0)
@constraint(m, e33, 24*x[33]-6*x[59]+x[163] == 2358.0)
@constraint(m, e34, 24*x[34]-6*x[60]+x[164] == 2351.0)
@constraint(m, e35, 24*x[35]-6*x[61]+x[165] == 2344.0)
@constraint(m, e36, 24*x[36]-6*x[62]+x[166] == 2337.0)
@constraint(m, e37, 24*x[37]-6*x[63]+x[167] == 2330.0)
@constraint(m, e38, 24*x[38]-6*x[64]+x[168] == 2323.0)
@constraint(m, e39, 24*x[39]-6*x[65]+x[169] == 2316.0)
@constraint(m, e40, 24*x[40]-6*x[66]+x[170] == 2309.0)
@constraint(m, e41, 24*x[41]-6*x[67]+x[171] == 2302.0)
@constraint(m, e42, 27*x[42]-3*x[68]+x[172] == 2586.0)
@constraint(m, e43, 27*x[43]-3*x[69]+x[173] == 2579.0)
@constraint(m, e44, 27*x[44]-3*x[70]+x[174] == 2572.0)
@constraint(m, e45, 27*x[45]-3*x[71]+x[175] == 2565.0)
@constraint(m, e46, 27*x[46]-3*x[72]+x[176] == 2558.0)
@constraint(m, e47, 27*x[47]-3*x[73]+x[177] == 2551.0)
@constraint(m, e48, 27*x[48]-3*x[74]+x[178] == 2544.0)
@constraint(m, e49, 27*x[49]-3*x[75]+x[179] == 2537.0)
@constraint(m, e50, 27*x[50]-3*x[76]+x[180] == 2530.0)
@constraint(m, e51, 27*x[51]-3*x[77]+x[181] == 2523.0)
@constraint(m, e52, 27*x[52]-3*x[78]+x[182] == 2516.0)
@constraint(m, e53, 27*x[53]-3*x[79]+x[183] == 2509.0)
@constraint(m, e54, 27*x[54]-3*x[80]+x[184] == 2502.0)
@constraint(m, e55, 15*x[55]-6*x[94]+x[185] == 3386.0)
@constraint(m, e56, 15*x[56]-6*x[95]+x[186] == 3379.0)
@constraint(m, e57, 15*x[57]-6*x[96]+x[187] == 3372.0)
@constraint(m, e58, 15*x[58]-6*x[97]+x[188] == 3365.0)
@constraint(m, e59, 15*x[59]-6*x[98]+x[189] == 3358.0)
@constraint(m, e60, 15*x[60]-6*x[99]+x[190] == 3351.0)
@constraint(m, e61, 15*x[61]-6*x[100]+x[191] == 3344.0)
@constraint(m, e62, 15*x[62]-6*x[101]+x[192] == 3337.0)
@constraint(m, e63, 15*x[63]-6*x[102]+x[193] == 3330.0)
@constraint(m, e64, 15*x[64]-6*x[103]+x[194] == 3323.0)
@constraint(m, e65, 15*x[65]-6*x[104]+x[195] == 3316.0)
@constraint(m, e66, 15*x[66]-6*x[105]+x[196] == 3309.0)
@constraint(m, e67, 15*x[67]-6*x[106]+x[197] == 3302.0)
@constraint(m, e68, 18*x[68]-6*x[94]+x[198] == 2786.0)
@constraint(m, e69, 18*x[69]-6*x[95]+x[199] == 2779.0)
@constraint(m, e70, 18*x[70]-6*x[96]+x[200] == 2772.0)
@constraint(m, e71, 18*x[71]-6*x[97]+x[201] == 2765.0)
@constraint(m, e72, 18*x[72]-6*x[98]+x[202] == 2758.0)
@constraint(m, e73, 18*x[73]-6*x[99]+x[203] == 2751.0)
@constraint(m, e74, 18*x[74]-6*x[100]+x[204] == 2744.0)
@constraint(m, e75, 18*x[75]-6*x[101]+x[205] == 2737.0)
@constraint(m, e76, 18*x[76]-6*x[102]+x[206] == 2730.0)
@constraint(m, e77, 18*x[77]-6*x[103]+x[207] == 2723.0)
@constraint(m, e78, 18*x[78]-6*x[104]+x[208] == 2716.0)
@constraint(m, e79, 18*x[79]-6*x[105]+x[209] == 2709.0)
@constraint(m, e80, 18*x[80]-6*x[106]+x[210] == 2702.0)
...
@constraint(m, e94, 27*x[94]+x[224] == 5586.0)
@constraint(m, e95, 27*x[95]+x[225] == 5579.0)
@constraint(m, e96, 27*x[96]+x[226] == 5572.0)
@constraint(m, e97, 27*x[97]+x[227] == 5565.0)
@constraint(m, e98, 27*x[98]+x[228] == 5558.0)
@constraint(m, e99, 27*x[99]+x[229] == 5551.0)
@constraint(m, e100, 27*x[100]+x[230] == 5544.0)
@constraint(m, e101, 27*x[101]+x[231] == 5537.0)
@constraint(m, e102, 27*x[102]+x[232] == 5530.0)
@constraint(m, e103, 27*x[103]+x[233] == 5523.0)
@constraint(m, e104, 27*x[104]+x[234] == 5516.0)
@constraint(m, e105, 27*x[105]+x[235] == 5509.0)
@constraint(m, e106, 27*x[106]+x[236] == 5502.0)
...
@constraint(m, e289, x[2]+x[5]+x[6]+x[8] <= 30000.0)
@constraint(m, e290, x[3]+x[5]+x[7]+x[8] <= 30000.0)
@constraint(m, e291, x[4]+x[6]+x[7]+x[8] <= 30000.0)
...
@constraint(m, e295, x[107]+20*b[237] == 200.0)
@constraint(m, e296, x[120]+12*b[250] == 120.0)
@constraint(m, e297, x[133]+6*b[263] == 60.0)
