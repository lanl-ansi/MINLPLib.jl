...
@constraint(m, e226, x[4]-x[34]+5.33*b[39]+5.25*b[47]-5.25*b[55]+5.25*b[63] <= -0.57)
@constraint(m, e227, x[5]-x[34]+4.3*b[40]+4.2*b[48]-4.2*b[56]+4.2*b[64] <= -1.1)
@constraint(m, e228, x[6]-x[34]+4.82*b[41]+4.8*b[49]-4.8*b[57]+4.8*b[65] <= -0.8)
@constraint(m, e229, x[7]-x[34]+7.3775*b[42]+4.04*b[50]-4.04*b[58]+4.04*b[66] <= -0.81)
@constraint(m, e230, x[8]-x[34]+6.995*b[43]+2.125*b[51]-2.125*b[59]+2.125*b[67] <= -1.13)
...
@constraint(m, e236, x[20]+0.0800000000000001*b[47]-5.25*b[63] <= -2.78)
@constraint(m, e237, x[21]+0.100000000000001*b[48]-4.2*b[64] <= -2.26)
@constraint(m, e238, x[22]+0.0200000000000005*b[49]-4.8*b[65] <= -2.56)
@constraint(m, e239, x[23]+3.3375*b[50]-4.04*b[66] <= -1.81)
@constraint(m, e240, x[24]+4.87*b[51]-2.125*b[67] <= -0.215)
