...
@NLconstraint(m, e2, i[3]*i[3]-i[1]*i[1]+i[6]*i[6] == 700.0)
@NLconstraint(m, e3, i[2]*i[2]+i[6]*i[6] == 1000.0)
@NLconstraint(m, e4, i[3]*i[3]+i[6]*i[6]+i[9]*i[9] == 1300.0)
@NLconstraint(m, e5, i[8]*i[8]-i[4]*i[4] == 2000.0)
@NLconstraint(m, e6, i[2]*i[2]+i[5]*i[5] == 800.0)
@NLconstraint(m, e7, i[3]*i[3]-i[6]*i[6]+i[9]*i[9] == 500.0)
@NLconstraint(m, e8, i[7]*i[7] == 840.0)
@NLconstraint(m, e9, i[3]*i[3]+i[5]*i[5]+i[8]*i[8] == 3000.0)
@NLconstraint(m, e10, i[5]*i[5]+i[9]*i[9] == 2500.0)
@NLconstraint(m, e11, i[3]*i[3]+i[4]*i[4]+i[10]*i[10] == 3200.0)
