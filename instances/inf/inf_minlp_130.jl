...
@constraint(m, e16, 12*x[16]-6*x[55]-4*x[68]+x[146] == 2586.0)
@constraint(m, e17, 12*x[17]-6*x[56]-4*x[69]+x[147] == 2579.0)
@constraint(m, e18, 12*x[18]-6*x[57]-4*x[70]+x[148] == 2572.0)
@constraint(m, e19, 12*x[19]-6*x[58]-4*x[71]+x[149] == 2565.0)
@constraint(m, e20, 12*x[20]-6*x[59]-4*x[72]+x[150] == 2558.0)
@constraint(m, e21, 12*x[21]-6*x[60]-4*x[73]+x[151] == 2551.0)
@constraint(m, e22, 12*x[22]-6*x[61]-4*x[74]+x[152] == 2544.0)
@constraint(m, e23, 12*x[23]-6*x[62]-4*x[75]+x[153] == 2537.0)
@constraint(m, e24, 12*x[24]-6*x[63]-4*x[76]+x[154] == 2530.0)
@constraint(m, e25, 12*x[25]-6*x[64]-4*x[77]+x[155] == 2523.0)
@constraint(m, e26, 12*x[26]-6*x[65]-4*x[78]+x[156] == 2516.0)
@constraint(m, e27, 12*x[27]-6*x[66]-4*x[79]+x[157] == 2509.0)
@constraint(m, e28, 12*x[28]-6*x[67]-4*x[80]+x[158] == 2502.0)
@constraint(m, e29, 16*x[29]-4*x[55]+x[159] == 1786.0)
@constraint(m, e30, 16*x[30]-4*x[56]+x[160] == 1779.0)
@constraint(m, e31, 16*x[31]-4*x[57]+x[161] == 1772.0)
@constraint(m, e32, 16*x[32]-4*x[58]+x[162] == 1765.0)
@constraint(m, e33, 16*x[33]-4*x[59]+x[163] == 1758.0)
@constraint(m, e34, 16*x[34]-4*x[60]+x[164] == 1751.0)
@constraint(m, e35, 16*x[35]-4*x[61]+x[165] == 1744.0)
@constraint(m, e36, 16*x[36]-4*x[62]+x[166] == 1737.0)
@constraint(m, e37, 16*x[37]-4*x[63]+x[167] == 1730.0)
@constraint(m, e38, 16*x[38]-4*x[64]+x[168] == 1723.0)
@constraint(m, e39, 16*x[39]-4*x[65]+x[169] == 1716.0)
@constraint(m, e40, 16*x[40]-4*x[66]+x[170] == 1709.0)
@constraint(m, e41, 16*x[41]-4*x[67]+x[171] == 1702.0)
@constraint(m, e42, 18*x[42]-2*x[68]+x[172] == 1986.0)
@constraint(m, e43, 18*x[43]-2*x[69]+x[173] == 1979.0)
@constraint(m, e44, 18*x[44]-2*x[70]+x[174] == 1972.0)
@constraint(m, e45, 18*x[45]-2*x[71]+x[175] == 1965.0)
@constraint(m, e46, 18*x[46]-2*x[72]+x[176] == 1958.0)
@constraint(m, e47, 18*x[47]-2*x[73]+x[177] == 1951.0)
@constraint(m, e48, 18*x[48]-2*x[74]+x[178] == 1944.0)
@constraint(m, e49, 18*x[49]-2*x[75]+x[179] == 1937.0)
@constraint(m, e50, 18*x[50]-2*x[76]+x[180] == 1930.0)
@constraint(m, e51, 18*x[51]-2*x[77]+x[181] == 1923.0)
@constraint(m, e52, 18*x[52]-2*x[78]+x[182] == 1916.0)
@constraint(m, e53, 18*x[53]-2*x[79]+x[183] == 1909.0)
@constraint(m, e54, 18*x[54]-2*x[80]+x[184] == 1902.0)
@constraint(m, e55, 10*x[55]-4*x[94]+x[185] == 2786.0)
@constraint(m, e56, 10*x[56]-4*x[95]+x[186] == 2779.0)
@constraint(m, e57, 10*x[57]-4*x[96]+x[187] == 2772.0)
@constraint(m, e58, 10*x[58]-4*x[97]+x[188] == 2765.0)
@constraint(m, e59, 10*x[59]-4*x[98]+x[189] == 2758.0)
@constraint(m, e60, 10*x[60]-4*x[99]+x[190] == 2751.0)
@constraint(m, e61, 10*x[61]-4*x[100]+x[191] == 2744.0)
@constraint(m, e62, 10*x[62]-4*x[101]+x[192] == 2737.0)
@constraint(m, e63, 10*x[63]-4*x[102]+x[193] == 2730.0)
@constraint(m, e64, 10*x[64]-4*x[103]+x[194] == 2723.0)
@constraint(m, e65, 10*x[65]-4*x[104]+x[195] == 2716.0)
@constraint(m, e66, 10*x[66]-4*x[105]+x[196] == 2709.0)
@constraint(m, e67, 10*x[67]-4*x[106]+x[197] == 2702.0)
@constraint(m, e68, 12*x[68]-4*x[94]+x[198] == 2186.0)
@constraint(m, e69, 12*x[69]-4*x[95]+x[199] == 2179.0)
@constraint(m, e70, 12*x[70]-4*x[96]+x[200] == 2172.0)
@constraint(m, e71, 12*x[71]-4*x[97]+x[201] == 2165.0)
@constraint(m, e72, 12*x[72]-4*x[98]+x[202] == 2158.0)
@constraint(m, e73, 12*x[73]-4*x[99]+x[203] == 2151.0)
@constraint(m, e74, 12*x[74]-4*x[100]+x[204] == 2144.0)
@constraint(m, e75, 12*x[75]-4*x[101]+x[205] == 2137.0)
@constraint(m, e76, 12*x[76]-4*x[102]+x[206] == 2130.0)
@constraint(m, e77, 12*x[77]-4*x[103]+x[207] == 2123.0)
@constraint(m, e78, 12*x[78]-4*x[104]+x[208] == 2116.0)
@constraint(m, e79, 12*x[79]-4*x[105]+x[209] == 2109.0)
@constraint(m, e80, 12*x[80]-4*x[106]+x[210] == 2102.0)
@constraint(m, e81, x[211] == 1986.0)
@constraint(m, e82, x[212] == 1979.0)
@constraint(m, e83, x[213] == 1972.0)
@constraint(m, e84, x[214] == 1965.0)
@constraint(m, e85, x[215] == 1958.0)
@constraint(m, e86, x[216] == 1951.0)
@constraint(m, e87, x[217] == 1944.0)
@constraint(m, e88, x[218] == 1937.0)
@constraint(m, e89, x[219] == 1930.0)
@constraint(m, e90, x[220] == 1923.0)
@constraint(m, e91, x[221] == 1916.0)
@constraint(m, e92, x[222] == 1909.0)
@constraint(m, e93, x[223] == 1902.0)
@constraint(m, e94, 18*x[94]+x[224] == 4986.0)
@constraint(m, e95, 18*x[95]+x[225] == 4979.0)
@constraint(m, e96, 18*x[96]+x[226] == 4972.0)
@constraint(m, e97, 18*x[97]+x[227] == 4965.0)
@constraint(m, e98, 18*x[98]+x[228] == 4958.0)
@constraint(m, e99, 18*x[99]+x[229] == 4951.0)
@constraint(m, e100, 18*x[100]+x[230] == 4944.0)
@constraint(m, e101, 18*x[101]+x[231] == 4937.0)
@constraint(m, e102, 18*x[102]+x[232] == 4930.0)
@constraint(m, e103, 18*x[103]+x[233] == 4923.0)
@constraint(m, e104, 18*x[104]+x[234] == 4916.0)
@constraint(m, e105, 18*x[105]+x[235] == 4909.0)
@constraint(m, e106, 18*x[106]+x[236] == 4902.0)
