...
setupperbound(x[1], 2.33)
setlowerbound(x[2], 0.54)
setupperbound(x[2], 2.24)
setlowerbound(x[3], 0.73)
setupperbound(x[3], 2.18)
setlowerbound(x[4], 0.46)
setupperbound(x[4], 2.93)
setlowerbound(x[5], 0.58)
setupperbound(x[5], 2.97)
setlowerbound(x[6], 0.78)
setupperbound(x[6], 2.84)
setlowerbound(x[7], 0.45)
setupperbound(x[7], 2.02)
setlowerbound(x[8], 0.51)
setupperbound(x[8], 2.47)
setlowerbound(x[9], 0.73)
setupperbound(x[9], 2.8)
setlowerbound(x[10], 0.84)
setupperbound(x[10], 2.03)
setlowerbound(x[11], 0.93)
setupperbound(x[11], 2.03)
setlowerbound(x[12], 0.3)
setupperbound(x[12], 2.14)
setlowerbound(x[13], 0.99)
setupperbound(x[13], 2.84)
setlowerbound(x[14], 0.16)
setupperbound(x[14], 2.8)
