...
@constraint(m, e226, x[4]+5.33*b[39]+5.25*b[47]-5.25*b[55]+5.25*b[63] <= 4.43)
@constraint(m, e227, x[5]+4.3*b[40]+4.2*b[48]-4.2*b[56]+4.2*b[64] <= 3.9)
@constraint(m, e228, x[6]+4.82*b[41]+4.8*b[49]-4.8*b[57]+4.8*b[65] <= 4.2)
@constraint(m, e229, x[7]+7.3775*b[42]+4.04*b[50]-4.04*b[58]+4.04*b[66] <= 4.19)
@constraint(m, e230, x[8]+6.995*b[43]+2.125*b[51]-2.125*b[59]+2.125*b[67] <= 3.87)
...
@constraint(m, e317, x[26]-190*b[254] >= -184.875)
@constraint(m, e318, x[26]-190*b[255] >= -186.0)
@constraint(m, e319, x[26]-190*b[256] >= -187.875)
@constraint(m, e320, x[27]-190*b[257] >= -185.0)
@constraint(m, e321, x[27]-190*b[258] >= -187.625)
@constraint(m, e322, x[27]-190*b[259] >= -185.1)
@constraint(m, e323, x[25]+190*b[251] <= 195.5)
@constraint(m, e324, x[25]+190*b[252] <= 194.025)
@constraint(m, e325, x[25]+190*b[253] <= 193.25)
@constraint(m, e326, x[26]+190*b[254] <= 195.125)
@constraint(m, e327, x[26]+190*b[255] <= 194.0)
@constraint(m, e328, x[26]+190*b[256] <= 192.125)
@constraint(m, e329, x[27]+190*b[257] <= 195.0)
@constraint(m, e330, x[27]+190*b[258] <= 192.375)
@constraint(m, e331, x[27]+190*b[259] <= 194.9)
@constraint(m, e332, x[28]-190*b[251] >= -187.725)
@constraint(m, e333, x[28]-190*b[252] >= -187.875)
@constraint(m, e334, x[28]-190*b[253] >= -188.75)
@constraint(m, e335, x[29]-190*b[254] >= -187.625)
@constraint(m, e336, x[29]-190*b[255] >= -187.875)
@constraint(m, e337, x[29]-190*b[256] >= -188.375)
@constraint(m, e338, x[30]-190*b[257] >= -185.875)
@constraint(m, e339, x[30]-190*b[258] >= -185.75)
@constraint(m, e340, x[30]-190*b[259] >= -185.75)
@constraint(m, e341, x[28]+190*b[251] <= 192.275)
@constraint(m, e342, x[28]+190*b[252] <= 192.125)
@constraint(m, e343, x[28]+190*b[253] <= 191.25)
@constraint(m, e344, x[29]+190*b[254] <= 192.375)
@constraint(m, e345, x[29]+190*b[255] <= 192.125)
@constraint(m, e346, x[29]+190*b[256] <= 191.625)
@constraint(m, e347, x[30]+190*b[257] <= 194.125)
@constraint(m, e348, x[30]+190*b[258] <= 194.25)
@constraint(m, e349, x[30]+190*b[259] <= 194.25)
@constraint(m, e350, x[31]-190*b[251] >= -189.725)
@constraint(m, e351, x[31]-190*b[252] >= -189.0)
@constraint(m, e352, x[31]-190*b[253] >= -188.75)
@constraint(m, e353, x[32]-190*b[254] >= -189.625)
@constraint(m, e354, x[32]-190*b[255] >= -189.125)
@constraint(m, e355, x[32]-190*b[256] >= -188.875)
@constraint(m, e356, x[33]-190*b[257] >= -189.75)
@constraint(m, e357, x[33]-190*b[258] >= -189.625)
@constraint(m, e358, x[33]-190*b[259] >= -189.37)
@constraint(m, e359, x[31]+190*b[251] <= 190.275)
@constraint(m, e360, x[31]+190*b[252] <= 191.0)
@constraint(m, e361, x[31]+190*b[253] <= 191.25)
@constraint(m, e362, x[32]+190*b[254] <= 190.375)
@constraint(m, e363, x[32]+190*b[255] <= 190.875)
@constraint(m, e364, x[32]+190*b[256] <= 191.125)
@constraint(m, e365, x[33]+190*b[257] <= 190.25)
@constraint(m, e366, x[33]+190*b[258] <= 190.375)
@constraint(m, e367, x[33]+190*b[259] <= 190.63)
