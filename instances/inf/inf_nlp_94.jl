...
@variable(m, x[x_Idx])
setlowerbound(x[1], 0.69)
setupperbound(x[1], 2.21)
setlowerbound(x[2], 0.91)
setupperbound(x[2], 2.26)
setlowerbound(x[3], 0.62)
setupperbound(x[3], 2.41)
setlowerbound(x[4], 0.85)
setupperbound(x[4], 2.26)
setlowerbound(x[5], 0.87)
setupperbound(x[5], 2.92)
setlowerbound(x[6], 0.48)
setupperbound(x[6], 2.15)
setlowerbound(x[7], 0.13)
setupperbound(x[7], 2.42)
setlowerbound(x[8], 0.94)
setupperbound(x[8], 2.41)
setlowerbound(x[9], 0.97)
setupperbound(x[9], 2.65)
setlowerbound(x[10], 0.27)
setupperbound(x[10], 2.66)
setlowerbound(x[11], 0.62)
setupperbound(x[11], 2.1)
setlowerbound(x[12], 0.86)
setupperbound(x[12], 2.64)
