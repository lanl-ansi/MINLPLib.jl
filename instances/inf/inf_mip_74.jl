...
set_lower_bound(x[75], -0.36)
set_upper_bound(x[75], 12.5)
set_lower_bound(x[76], -0.36)
set_upper_bound(x[76], 12.5)
set_lower_bound(x[77], -0.36)
set_upper_bound(x[77], 12.5)
set_lower_bound(x[78], -12.5)
set_upper_bound(x[78], 0.4)
set_lower_bound(x[79], -12.5)
set_upper_bound(x[79], 0.4)
set_lower_bound(x[80], -12.5)
...
set_upper_bound(x[108], 3.4809436396088)
set_upper_bound(x[109], 3.5856633948088)
set_upper_bound(x[110], 3.4809436396088)
set_upper_bound(x[111], 3.5856633948088)
set_upper_bound(x[112], 3.4809436396088)
set_upper_bound(x[113], 3.5856633948088)
set_upper_bound(x[114], 3.5856633948088)
set_upper_bound(x[115], 3.4809436396088)
set_upper_bound(x[116], 3.5856633948088)
set_upper_bound(x[117], 3.4809436396088)
set_upper_bound(x[118], 3.5856633948088)
set_upper_bound(x[119], 3.4809436396088)
...
set_upper_bound(x[126], 3.16535851721019)
set_upper_bound(x[127], 3.69419328097019)
set_upper_bound(x[128], 3.16535851721019)
set_upper_bound(x[129], 3.69419328097019)
set_upper_bound(x[130], 3.16535851721019)
set_upper_bound(x[131], 3.69419328097019)
