...
@NLconstraint(m, e8, (-3*i[1]*i[2])-23*i[1]+118*i[2]+12*i[1]*i[3]+11*i[1]*i[4]-474*i[4]+196*i[2]*i[3]-180*i[2]*i[4]-8*i[3]*i[4]-19* (i[2])^2-173* (i[3])^2+207* (i[4])^2 <= -384.0)
...
@NLconstraint(m, e10, 119*i[1]-6*i[1]*i[2]+263*i[2]+45*i[1]*i[3]+37*i[1]*i[4]-1609*i[4]+810*i[2]*i[3]-798*i[2]*i[4]-31*i[3]*i[4]-7* (i[1])^2-36* (i[2])^2-712* (i[3])^2+857* (i[4])^2 <= -23.0)
