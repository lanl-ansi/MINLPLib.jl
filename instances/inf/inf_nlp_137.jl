...
@constraint(m, e11, 0.166666666666667*x[2] >= -0.5)
@constraint(m, e12, 0.166666666666667*x[3] >= -0.5)
@constraint(m, e13, 0.166666666666667*x[4] >= -0.5)
@constraint(m, e14, 0.166666666666667*x[5] >= -0.5)
@constraint(m, e15, 0.166666666666667*x[1] <= 0.5)
@constraint(m, e16, 0.166666666666667*x[2] <= 0.5)
@constraint(m, e17, 0.166666666666667*x[3] <= 0.5)
@constraint(m, e18, 0.166666666666667*x[4] <= 0.5)
@constraint(m, e19, -0.166666666666667*x[1]+0.166666666666667*x[2] >= 1.00000008274037e-10)
@constraint(m, e20, -0.166666666666667*x[2]+0.166666666666667*x[3] >= 1.00000008274037e-10)
@constraint(m, e21, -0.166666666666667*x[3]+0.166666666666667*x[4] >= 1.00000008274037e-10)
@constraint(m, e22, -0.166666666666667*x[4]+0.166666666666667*x[5] >= 1.00000008274037e-10)
