...
@constraint(m, e17, 6*x[17]-9*x[56]-6*x[69]+x[147] == 1286.0)
@constraint(m, e18, 6*x[18]-9*x[57]-6*x[70]+x[148] == 1279.0)
@constraint(m, e19, 6*x[19]-9*x[58]-6*x[71]+x[149] == 1272.0)
@constraint(m, e20, 6*x[20]-9*x[59]-6*x[72]+x[150] == 1265.0)
@constraint(m, e21, 6*x[21]-9*x[60]-6*x[73]+x[151] == 1258.0)
@constraint(m, e22, 6*x[22]-9*x[61]-6*x[74]+x[152] == 1251.0)
@constraint(m, e23, 6*x[23]-9*x[62]-6*x[75]+x[153] == 1244.0)
@constraint(m, e24, 6*x[24]-9*x[63]-6*x[76]+x[154] == 1237.0)
@constraint(m, e25, 6*x[25]-9*x[64]-6*x[77]+x[155] == 1230.0)
@constraint(m, e26, 6*x[26]-9*x[65]-6*x[78]+x[156] == 1223.0)
@constraint(m, e27, 6*x[27]-9*x[66]-6*x[79]+x[157] == 1216.0)
@constraint(m, e28, 6*x[28]-9*x[67]-6*x[80]+x[158] == 1209.0)
