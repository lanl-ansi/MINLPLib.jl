...
set_lower_bound(x[154], -2.5)
set_upper_bound(x[154], -2.5)
set_lower_bound(x[155], 2.5)
set_upper_bound(x[155], 2.5)
set_lower_bound(x[156], 0.0)
set_upper_bound(x[156], 0.0)
set_lower_bound(x[157], 6.0)
set_upper_bound(x[157], 6.0)
set_lower_bound(x[158], 0.0)
...
set_lower_bound(x[162], -3.0)
set_upper_bound(x[162], -3.0)
set_lower_bound(x[163], 7.0)
