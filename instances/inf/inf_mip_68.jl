...
setupperbound(x[84], 12.5378076947974)
setupperbound(x[85], 12.5103517177536)
setupperbound(x[86], 12.5378076947974)
setupperbound(x[87], 12.5103517177536)
setupperbound(x[88], 12.5378076947974)
setupperbound(x[89], 12.5103517177536)
setupperbound(x[90], 12.527600080748)
setupperbound(x[91], 12.5069296622978)
setupperbound(x[92], 12.527600080748)
setupperbound(x[93], 12.5069296622978)
setupperbound(x[94], 12.527600080748)
setupperbound(x[95], 12.5069296622978)
setupperbound(x[96], 12.5172483631865)
setupperbound(x[97], 12.52760008094)
setupperbound(x[98], 12.5172483631865)
setupperbound(x[99], 12.52760008094)
setupperbound(x[100], 12.5172483631865)
setupperbound(x[101], 12.52760008094)
setupperbound(x[102], 12.5172483631865)
setupperbound(x[103], 12.52760008094)
setupperbound(x[104], 12.5172483631865)
setupperbound(x[105], 12.52760008094)
setupperbound(x[106], 12.5172483631865)
setupperbound(x[107], 12.52760008094)
setupperbound(x[108], 3.6393322693488)
setupperbound(x[109], 3.4809436396088)
setupperbound(x[110], 3.6393322693488)
setupperbound(x[111], 3.4809436396088)
setupperbound(x[112], 3.6393322693488)
setupperbound(x[113], 3.4809436396088)
setupperbound(x[114], 3.6916921469488)
setupperbound(x[115], 3.5333035172088)
setupperbound(x[116], 3.6916921469488)
setupperbound(x[117], 3.5333035172088)
setupperbound(x[118], 3.6916921469488)
setupperbound(x[119], 3.5333035172088)
setupperbound(x[120], 3.16535851721019)
setupperbound(x[121], 3.27138726935019)
setupperbound(x[122], 3.16535851721019)
setupperbound(x[123], 3.27138726935019)
setupperbound(x[124], 3.16535851721019)
setupperbound(x[125], 3.27138726935019)
setupperbound(x[126], 4.16535851721019)
setupperbound(x[127], 4.27138726935019)
setupperbound(x[128], 4.16535851721019)
setupperbound(x[129], 4.27138726935019)
setupperbound(x[130], 4.16535851721019)
setupperbound(x[131], 4.27138726935019)
