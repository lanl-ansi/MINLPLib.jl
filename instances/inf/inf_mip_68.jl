...
set_upper_bound(x[84], 12.5378076947974)
set_upper_bound(x[85], 12.5103517177536)
set_upper_bound(x[86], 12.5378076947974)
set_upper_bound(x[87], 12.5103517177536)
set_upper_bound(x[88], 12.5378076947974)
set_upper_bound(x[89], 12.5103517177536)
set_upper_bound(x[90], 12.527600080748)
set_upper_bound(x[91], 12.5069296622978)
set_upper_bound(x[92], 12.527600080748)
set_upper_bound(x[93], 12.5069296622978)
set_upper_bound(x[94], 12.527600080748)
set_upper_bound(x[95], 12.5069296622978)
set_upper_bound(x[96], 12.5172483631865)
set_upper_bound(x[97], 12.52760008094)
set_upper_bound(x[98], 12.5172483631865)
set_upper_bound(x[99], 12.52760008094)
set_upper_bound(x[100], 12.5172483631865)
set_upper_bound(x[101], 12.52760008094)
set_upper_bound(x[102], 12.5172483631865)
set_upper_bound(x[103], 12.52760008094)
set_upper_bound(x[104], 12.5172483631865)
set_upper_bound(x[105], 12.52760008094)
set_upper_bound(x[106], 12.5172483631865)
set_upper_bound(x[107], 12.52760008094)
set_upper_bound(x[108], 3.6393322693488)
set_upper_bound(x[109], 3.4809436396088)
set_upper_bound(x[110], 3.6393322693488)
set_upper_bound(x[111], 3.4809436396088)
set_upper_bound(x[112], 3.6393322693488)
set_upper_bound(x[113], 3.4809436396088)
set_upper_bound(x[114], 3.6916921469488)
set_upper_bound(x[115], 3.5333035172088)
set_upper_bound(x[116], 3.6916921469488)
set_upper_bound(x[117], 3.5333035172088)
set_upper_bound(x[118], 3.6916921469488)
set_upper_bound(x[119], 3.5333035172088)
set_upper_bound(x[120], 3.16535851721019)
set_upper_bound(x[121], 3.27138726935019)
set_upper_bound(x[122], 3.16535851721019)
set_upper_bound(x[123], 3.27138726935019)
set_upper_bound(x[124], 3.16535851721019)
set_upper_bound(x[125], 3.27138726935019)
set_upper_bound(x[126], 4.16535851721019)
set_upper_bound(x[127], 4.27138726935019)
set_upper_bound(x[128], 4.16535851721019)
set_upper_bound(x[129], 4.27138726935019)
set_upper_bound(x[130], 4.16535851721019)
set_upper_bound(x[131], 4.27138726935019)
...
@constraint(m, e26, x[45]-0.991444861360702*x[51]-1.21*x[54]-12.1*b[60]-x[84] == -13.2996482822465)
@constraint(m, e27, x[45]-x[51]-1.21*x[54]-12.1*b[61]-x[85] == -13.31)
@constraint(m, e28, x[46]-0.991444861360702*x[52]-1.21*x[55]-12.1*b[62]-x[86] == -13.2996482822465)
@constraint(m, e29, x[46]-x[52]-1.21*x[55]-12.1*b[63]-x[87] == -13.31)
@constraint(m, e30, x[47]-0.991444861360702*x[53]-1.21*x[56]-12.1*b[64]-x[88] == -13.2996482822465)
...
@constraint(m, e33, x[45]-0.991444861360702*x[51]-0.81*x[54]-12.1*b[61]-x[91] == -12.9030703377022)
@constraint(m, e34, x[46]-0.965925826237084*x[52]-0.81*x[55]-12.1*b[62]-x[92] == -12.882399919252)
@constraint(m, e35, x[46]-0.991444861360702*x[52]-0.81*x[55]-12.1*b[63]-x[93] == -12.9030703377022)
@constraint(m, e36, x[47]-0.965925826237084*x[53]-0.81*x[56]-12.1*b[64]-x[94] == -12.882399919252)
@constraint(m, e37, x[47]-0.991444861360702*x[53]-0.81*x[56]-12.1*b[65]-x[95] == -12.9030703377022)
@constraint(m, e38, x[45]-0.991444861360702*x[51]-0.81*x[54]+12.1*b[60]+x[96] == 11.2969296622978)
@constraint(m, e39, x[45]-x[51]-0.81*x[54]+12.1*b[61]+x[97] == 11.29)
@constraint(m, e40, x[46]-0.991444861360702*x[52]-0.81*x[55]+12.1*b[62]+x[98] == 11.2969296622978)
@constraint(m, e41, x[46]-x[52]-0.81*x[55]+12.1*b[63]+x[99] == 11.29)
@constraint(m, e42, x[47]-0.991444861360702*x[53]-0.81*x[56]+12.1*b[64]+x[100] == 11.2969296622978)
...
@constraint(m, e45, x[45]-0.991444861360702*x[51]-1.21*x[54]+12.1*b[61]+x[103] == 10.9003517177536)
@constraint(m, e46, x[46]-0.965925826237084*x[52]-1.21*x[55]+12.1*b[62]+x[104] == 10.9312297502531)
@constraint(m, e47, x[46]-0.991444861360702*x[52]-1.21*x[55]+12.1*b[63]+x[105] == 10.9003517177536)
@constraint(m, e48, x[47]-0.965925826237084*x[53]-1.21*x[56]+12.1*b[64]+x[106] == 10.9312297502531)
@constraint(m, e49, x[47]-0.991444861360702*x[53]-1.21*x[56]+12.1*b[65]+x[107] == 10.9003517177536)
@constraint(m, e50, x[48]+0.130899694*x[51]-1.21*x[57]-3.1677725948*b[60]-x[108] == -3.00938396506)
@constraint(m, e51, x[48]-1.21*x[57]-3.1677725948*b[61]-x[109] == -3.1677725948)
@constraint(m, e52, x[49]+0.130899694*x[52]-1.21*x[58]-3.1677725948*b[62]-x[110] == -3.00938396506)
@constraint(m, e53, x[49]-1.21*x[58]-3.1677725948*b[63]-x[111] == -3.1677725948)
@constraint(m, e54, x[50]+0.130899694*x[53]-1.21*x[59]-3.1677725948*b[64]-x[112] == -3.00938396506)
@constraint(m, e55, x[50]-1.21*x[59]-3.1677725948*b[65]-x[113] == -3.1677725948)
@constraint(m, e56, x[48]+0.261799388*x[51]-0.81*x[57]-3.1677725948*b[60]-x[114] == -2.95571509052)
@constraint(m, e57, x[48]+0.130899694*x[51]-0.81*x[57]-3.1677725948*b[61]-x[115] == -3.06174384266)
@constraint(m, e58, x[49]+0.261799388*x[52]-0.81*x[58]-3.1677725948*b[62]-x[116] == -2.95571509052)
@constraint(m, e59, x[49]+0.130899694*x[52]-0.81*x[58]-3.1677725948*b[63]-x[117] == -3.06174384266)
@constraint(m, e60, x[50]+0.261799388*x[53]-0.81*x[59]-3.1677725948*b[64]-x[118] == -2.95571509052)
@constraint(m, e61, x[50]+0.130899694*x[53]-0.81*x[59]-3.1677725948*b[65]-x[119] == -3.06174384266)
@constraint(m, e62, x[48]+0.130899694*x[51]-0.81*x[57]+3.1677725948*b[60]+x[120] == 3.27380134694)
@constraint(m, e63, x[48]-0.81*x[57]+3.1677725948*b[61]+x[121] == 3.1677725948)
@constraint(m, e64, x[49]+0.130899694*x[52]-0.81*x[58]+3.1677725948*b[62]+x[122] == 3.27380134694)
@constraint(m, e65, x[49]-0.81*x[58]+3.1677725948*b[63]+x[123] == 3.1677725948)
@constraint(m, e66, x[50]+0.130899694*x[53]-0.81*x[59]+3.1677725948*b[64]+x[124] == 3.27380134694)
@constraint(m, e67, x[50]-0.81*x[59]+3.1677725948*b[65]+x[125] == 3.1677725948)
@constraint(m, e68, x[48]+0.261799388*x[51]-1.21*x[57]+3.1677725948*b[60]+x[126] == 3.48454985428)
@constraint(m, e69, x[48]+0.130899694*x[51]-1.21*x[57]+3.1677725948*b[61]+x[127] == 3.32616122454)
@constraint(m, e70, x[49]+0.261799388*x[52]-1.21*x[58]+3.1677725948*b[62]+x[128] == 3.48454985428)
@constraint(m, e71, x[49]+0.130899694*x[52]-1.21*x[58]+3.1677725948*b[63]+x[129] == 3.32616122454)
@constraint(m, e72, x[50]+0.261799388*x[53]-1.21*x[59]+3.1677725948*b[64]+x[130] == 3.48454985428)
@constraint(m, e73, x[50]+0.130899694*x[53]-1.21*x[59]+3.1677725948*b[65]+x[131] == 3.32616122454)
