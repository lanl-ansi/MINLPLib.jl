...
@variable(m, x[x_Idx])
setlowerbound(x[1], 0.99)
setupperbound(x[1], 2.14)
setlowerbound(x[2], 0.83)
setupperbound(x[2], 2.69)
setlowerbound(x[3], 0.89)
setupperbound(x[3], 2.74)
setlowerbound(x[4], 0.21)
setupperbound(x[4], 2.93)
setlowerbound(x[5], 0.34)
setupperbound(x[5], 2.95)
setlowerbound(x[6], 0.58)
setupperbound(x[6], 2.73)
setlowerbound(x[7], 0.39)
setupperbound(x[7], 2.79)
setlowerbound(x[8], 0.88)
setupperbound(x[8], 2.81)
setlowerbound(x[9], 0.83)
setupperbound(x[9], 2.57)
setlowerbound(x[10], 0.77)
setupperbound(x[10], 2.99)
setlowerbound(x[11], 0.32)
setupperbound(x[11], 2.53)
setlowerbound(x[12], 0.27)
setupperbound(x[12], 2.39)
