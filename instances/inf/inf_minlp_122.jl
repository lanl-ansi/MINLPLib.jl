...
@NLconstraint(m, e2, (-2.35*i[1]*i[2])-10.7*i[1]-63.3*i[2]+10.9*i[1]*i[3]+93.5*i[3]+0.108*i[1]*i[4]-25.1*i[4]-76.8*i[2]*i[3]+37.9*i[2]*i[4]-9.31*i[3]*i[4]-0.295* (i[1])^2+25.1* (i[2])^2+30.4* (i[3])^2-28.1* (i[4])^2 <= -351.0)
@NLconstraint(m, e3, (-29.7*i[1]*i[2])-308*i[1]+1297*i[2]+32*i[1]*i[3]-37.5*i[3]-136*i[1]*i[4]-173*i[4]-235*i[2]*i[3]+310*i[2]*i[4]+3.61*i[3]*i[4]+21.4* (i[1])^2-139* (i[2])^2+113* (i[3])^2+138* (i[4])^2 <= -637.0)
...
@NLconstraint(m, e5, (-30.8*i[1]*i[2])-346*i[1]+659*i[2]+106*i[1]*i[3]+634*i[3]-260*i[1]*i[4]-629*i[4]-121*i[2]*i[3]+878*i[2]*i[4]+33.5*i[3]*i[4]+22.9* (i[1])^2-110* (i[2])^2-298* (i[3])^2+52.8* (i[4])^2 <= -3541.0)
