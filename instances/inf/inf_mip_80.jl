...
setlowerbound(x[108], 0.211853587989813)
setupperbound(x[108], 3.9024406542888)
setlowerbound(x[109], 0.211853587989813)
setupperbound(x[109], 3.9024406542888)
setlowerbound(x[110], 0.211853587989813)
setupperbound(x[110], 3.9024406542888)
setlowerbound(x[111], 0.211853587989813)
setupperbound(x[111], 3.9024406542888)
setlowerbound(x[112], 0.211853587989813)
setupperbound(x[112], 3.9024406542888)
setlowerbound(x[113], 0.211853587989813)
setupperbound(x[113], 3.9024406542888)
setlowerbound(x[114], -0.421700930970187)
setupperbound(x[114], 3.7977208990888)
setlowerbound(x[115], -0.421700930970187)
setupperbound(x[115], 3.7977208990888)
setlowerbound(x[116], -0.421700930970187)
setupperbound(x[116], 3.7977208990888)
setlowerbound(x[117], -0.421700930970187)
setupperbound(x[117], 3.7977208990888)
setlowerbound(x[118], -0.421700930970187)
setupperbound(x[118], 3.7977208990888)
setlowerbound(x[119], -0.421700930970187)
setupperbound(x[119], 3.7977208990888)
setupperbound(x[120], 3.69419328097019)
setupperbound(x[121], 3.69419328097019)
setupperbound(x[122], 3.69419328097019)
setupperbound(x[123], 3.69419328097019)
setupperbound(x[124], 3.69419328097019)
setupperbound(x[125], 3.69419328097019)
setupperbound(x[126], 3.79891303617019)
setupperbound(x[127], 3.79891303617019)
setupperbound(x[128], 3.79891303617019)
setupperbound(x[129], 3.79891303617019)
setupperbound(x[130], 3.79891303617019)
setupperbound(x[131], 3.79891303617019)
