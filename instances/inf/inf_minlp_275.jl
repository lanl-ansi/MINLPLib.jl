...
@constraint(m, e16, 6*x[16]-9*x[55]-6*x[68]+x[146] == 1293.0)
@constraint(m, e17, 6*x[17]-9*x[56]-6*x[69]+x[147] == 1243.0)
@constraint(m, e18, 6*x[18]-9*x[57]-6*x[70]+x[148] == 1193.0)
@constraint(m, e19, 6*x[19]-9*x[58]-6*x[71]+x[149] == 1143.0)
@constraint(m, e20, 6*x[20]-9*x[59]-6*x[72]+x[150] == 1093.0)
@constraint(m, e21, 6*x[21]-9*x[60]-6*x[73]+x[151] == 1043.0)
@constraint(m, e22, 6*x[22]-9*x[61]-6*x[74]+x[152] == 993.0)
@constraint(m, e23, 6*x[23]-9*x[62]-6*x[75]+x[153] == 943.0)
@constraint(m, e24, 6*x[24]-9*x[63]-6*x[76]+x[154] == 893.0)
@constraint(m, e25, 6*x[25]-9*x[64]-6*x[77]+x[155] == 843.0)
@constraint(m, e26, 6*x[26]-9*x[65]-6*x[78]+x[156] == 793.0)
@constraint(m, e27, 6*x[27]-9*x[66]-6*x[79]+x[157] == 743.0)
@constraint(m, e28, 6*x[28]-9*x[67]-6*x[80]+x[158] == 693.0)
@constraint(m, e29, 24*x[29]-6*x[55]+x[159] == 893.0)
@constraint(m, e30, 24*x[30]-6*x[56]+x[160] == 843.0)
@constraint(m, e31, 24*x[31]-6*x[57]+x[161] == 793.0)
@constraint(m, e32, 24*x[32]-6*x[58]+x[162] == 743.0)
@constraint(m, e33, 24*x[33]-6*x[59]+x[163] == 693.0)
@constraint(m, e34, 24*x[34]-6*x[60]+x[164] == 643.0)
@constraint(m, e35, 24*x[35]-6*x[61]+x[165] == 593.0)
@constraint(m, e36, 24*x[36]-6*x[62]+x[166] == 543.0)
@constraint(m, e37, 24*x[37]-6*x[63]+x[167] == 493.0)
@constraint(m, e38, 24*x[38]-6*x[64]+x[168] == 443.0)
@constraint(m, e39, 24*x[39]-6*x[65]+x[169] == 393.0)
@constraint(m, e40, 24*x[40]-6*x[66]+x[170] == 343.0)
@constraint(m, e41, 24*x[41]-6*x[67]+x[171] == 293.0)
@constraint(m, e42, 27*x[42]-3*x[68]+x[172] == 993.0)
@constraint(m, e43, 27*x[43]-3*x[69]+x[173] == 943.0)
@constraint(m, e44, 27*x[44]-3*x[70]+x[174] == 893.0)
@constraint(m, e45, 27*x[45]-3*x[71]+x[175] == 843.0)
@constraint(m, e46, 27*x[46]-3*x[72]+x[176] == 793.0)
@constraint(m, e47, 27*x[47]-3*x[73]+x[177] == 743.0)
@constraint(m, e48, 27*x[48]-3*x[74]+x[178] == 693.0)
@constraint(m, e49, 27*x[49]-3*x[75]+x[179] == 643.0)
@constraint(m, e50, 27*x[50]-3*x[76]+x[180] == 593.0)
@constraint(m, e51, 27*x[51]-3*x[77]+x[181] == 543.0)
@constraint(m, e52, 27*x[52]-3*x[78]+x[182] == 493.0)
@constraint(m, e53, 27*x[53]-3*x[79]+x[183] == 443.0)
@constraint(m, e54, 27*x[54]-3*x[80]+x[184] == 393.0)
@constraint(m, e55, 15*x[55]-6*x[94]+x[185] == 1393.0)
@constraint(m, e56, 15*x[56]-6*x[95]+x[186] == 1343.0)
@constraint(m, e57, 15*x[57]-6*x[96]+x[187] == 1293.0)
@constraint(m, e58, 15*x[58]-6*x[97]+x[188] == 1243.0)
@constraint(m, e59, 15*x[59]-6*x[98]+x[189] == 1193.0)
@constraint(m, e60, 15*x[60]-6*x[99]+x[190] == 1143.0)
@constraint(m, e61, 15*x[61]-6*x[100]+x[191] == 1093.0)
@constraint(m, e62, 15*x[62]-6*x[101]+x[192] == 1043.0)
@constraint(m, e63, 15*x[63]-6*x[102]+x[193] == 993.0)
@constraint(m, e64, 15*x[64]-6*x[103]+x[194] == 943.0)
@constraint(m, e65, 15*x[65]-6*x[104]+x[195] == 893.0)
@constraint(m, e66, 15*x[66]-6*x[105]+x[196] == 843.0)
@constraint(m, e67, 15*x[67]-6*x[106]+x[197] == 793.0)
@constraint(m, e68, 18*x[68]-6*x[94]+x[198] == 1093.0)
@constraint(m, e69, 18*x[69]-6*x[95]+x[199] == 1043.0)
@constraint(m, e70, 18*x[70]-6*x[96]+x[200] == 993.0)
@constraint(m, e71, 18*x[71]-6*x[97]+x[201] == 943.0)
@constraint(m, e72, 18*x[72]-6*x[98]+x[202] == 893.0)
@constraint(m, e73, 18*x[73]-6*x[99]+x[203] == 843.0)
@constraint(m, e74, 18*x[74]-6*x[100]+x[204] == 793.0)
@constraint(m, e75, 18*x[75]-6*x[101]+x[205] == 743.0)
@constraint(m, e76, 18*x[76]-6*x[102]+x[206] == 693.0)
@constraint(m, e77, 18*x[77]-6*x[103]+x[207] == 643.0)
@constraint(m, e78, 18*x[78]-6*x[104]+x[208] == 593.0)
@constraint(m, e79, 18*x[79]-6*x[105]+x[209] == 543.0)
@constraint(m, e80, 18*x[80]-6*x[106]+x[210] == 493.0)
@constraint(m, e81, x[211] == 993.0)
@constraint(m, e82, x[212] == 943.0)
@constraint(m, e83, x[213] == 893.0)
@constraint(m, e84, x[214] == 843.0)
@constraint(m, e85, x[215] == 793.0)
@constraint(m, e86, x[216] == 743.0)
@constraint(m, e87, x[217] == 693.0)
@constraint(m, e88, x[218] == 643.0)
@constraint(m, e89, x[219] == 593.0)
@constraint(m, e90, x[220] == 543.0)
@constraint(m, e91, x[221] == 493.0)
@constraint(m, e92, x[222] == 443.0)
@constraint(m, e93, x[223] == 393.0)
@constraint(m, e94, 27*x[94]+x[224] == 2493.0)
@constraint(m, e95, 27*x[95]+x[225] == 2443.0)
@constraint(m, e96, 27*x[96]+x[226] == 2393.0)
@constraint(m, e97, 27*x[97]+x[227] == 2343.0)
@constraint(m, e98, 27*x[98]+x[228] == 2293.0)
@constraint(m, e99, 27*x[99]+x[229] == 2243.0)
@constraint(m, e100, 27*x[100]+x[230] == 2193.0)
@constraint(m, e101, 27*x[101]+x[231] == 2143.0)
@constraint(m, e102, 27*x[102]+x[232] == 2093.0)
@constraint(m, e103, 27*x[103]+x[233] == 2043.0)
@constraint(m, e104, 27*x[104]+x[234] == 1993.0)
@constraint(m, e105, 27*x[105]+x[235] == 1943.0)
@constraint(m, e106, 27*x[106]+x[236] == 1893.0)
