...
@constraint(m, e226, x[4]+4.3*b[39]+4.2*b[47]-4.2*b[55]+4.2*b[63] <= 7.9)
@constraint(m, e227, x[5]+5.37*b[40]+5.18*b[48]-5.18*b[56]+5.18*b[64] <= 8.47)
@constraint(m, e228, x[6]+7.45*b[41]+4.1*b[49]-4.1*b[57]+4.1*b[65] <= 8.2)
@constraint(m, e229, x[7]+6.725*b[42]+4.15*b[50]-4.15*b[58]+4.15*b[66] <= 8.35)
@constraint(m, e230, x[8]+5.01*b[43]+5.01*b[51]-5.01*b[59]+5.01*b[67] <= 8.61)
