...
@NLconstraint(m, e70, -2.49149e-7*x[7]*x[7]+x[1]-x[2] >= 0.0)
@NLconstraint(m, e71, -2.49149e-7*x[8]*x[8]-x[1]+x[2] >= 0.0)
@NLconstraint(m, e72, -2.49149e-7*x[9]*x[9]+x[2]-x[3] >= 0.0)
@NLconstraint(m, e73, -2.49149e-7*x[10]*x[10]+x[2]-x[4] >= 0.0)
@NLconstraint(m, e74, -2.49149e-7*x[11]*x[11]-x[2]+x[3] >= 0.0)
@NLconstraint(m, e75, -2.49149e-7*x[12]*x[12]+x[3]-x[5] >= 0.0)
@NLconstraint(m, e76, -2.49149e-7*x[13]*x[13]-x[2]+x[4] >= 0.0)
@NLconstraint(m, e77, -2.49149e-7*x[14]*x[14]-x[3]+x[5] >= 0.0)
@NLconstraint(m, e78, -2.49149e-7*x[15]*x[15]+x[5]-x[6] >= 0.0)
@NLconstraint(m, e79, -2.49149e-7*x[16]*x[16]-x[5]+x[6] >= 0.0)
@NLconstraint(m, e80, -2.49149e-7*x[7]*x[7]+x[1]-x[2] <= 0.0)
@NLconstraint(m, e81, -2.49149e-7*x[8]*x[8]-x[1]+x[2] <= 0.0)
@NLconstraint(m, e82, -2.49149e-7*x[9]*x[9]+x[2]-x[3] <= 0.0)
@NLconstraint(m, e83, -2.49149e-7*x[10]*x[10]+x[2]-x[4] <= 0.0)
@NLconstraint(m, e84, -2.49149e-7*x[11]*x[11]-x[2]+x[3] <= 0.0)
@NLconstraint(m, e85, -2.49149e-7*x[12]*x[12]+x[3]-x[5] <= 0.0)
@NLconstraint(m, e86, -2.49149e-7*x[13]*x[13]-x[2]+x[4] <= 0.0)
@NLconstraint(m, e87, -2.49149e-7*x[14]*x[14]-x[3]+x[5] <= 0.0)
@NLconstraint(m, e88, -2.49149e-7*x[15]*x[15]+x[5]-x[6] <= 0.0)
@NLconstraint(m, e89, -2.49149e-7*x[16]*x[16]-x[5]+x[6] <= 0.0)
