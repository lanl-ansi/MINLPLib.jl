...
@constraint(m, e290, x[4]-x[37]+4.99*b[42]+4.79*b[51]-4.79*b[60]+4.79*b[69] <= -0.51)
@constraint(m, e291, x[5]-x[37]+4.3*b[43]+4.2*b[52]-4.2*b[61]+4.2*b[70] <= -1.1)
@constraint(m, e292, x[6]-x[37]+5.45*b[44]+1.85*b[53]-1.85*b[62]+1.85*b[71] <= -0.8)
@constraint(m, e293, x[7]-x[37]+6.345*b[45]+2.97*b[54]-2.97*b[63]+2.97*b[72] <= -0.53)
@constraint(m, e294, x[8]-x[37]+7.42*b[46]+4.07*b[55]-4.07*b[64]+4.07*b[73] <= -0.83)
@constraint(m, e295, x[9]-x[37]+6.645*b[47]+4.17*b[56]-4.17*b[65]+4.17*b[74] <= -0.73)
...
@constraint(m, e302, x[22]+0.2*b[51]-4.79*b[69] <= -2.26)
@constraint(m, e303, x[23]+0.100000000000001*b[52]-4.2*b[70] <= -2.26)
@constraint(m, e304, x[24]+3.6*b[53]-1.85*b[71] <= 0.39)
@constraint(m, e305, x[25]+3.375*b[54]-2.97*b[72] <= -0.46)
@constraint(m, e306, x[26]+3.35*b[55]-4.07*b[73] <= -1.86)
@constraint(m, e307, x[27]+2.475*b[56]-4.17*b[74] <= -1.86)
