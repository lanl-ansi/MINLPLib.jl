...
@NLconstraint(m, e21, x[2]*x[11]+x[12]*x[21]+0.653643620863612*x[3]-0.756802495307928*x[13] == 0.0)
@NLconstraint(m, e22, x[3]*x[10]+x[13]*x[20]+0.145500033808614*x[5]+0.989358246623382*x[15] == 0.0)
@NLconstraint(m, e23, x[4]*x[9]+x[14]*x[19]-0.843853958732492*x[7]-0.536572918000435*x[17] == 0.0)
@NLconstraint(m, e24, x[5]*x[8]+x[15]*x[18]+0.957659480323385*x[9]-0.287903316665065*x[19] == 0.0)
@NLconstraint(m, e25, x[6]*x[7]+x[16]*x[17]-0.408082061813392*x[11]+0.912945250727628*x[21] == 0.0)
@NLconstraint(m, e26, x[6]*x[7]+x[16]*x[17]-0.424179007336997*x[11]+0.905578362006624*x[21] == 0.0)
@NLconstraint(m, e27, x[5]*x[8]+x[15]*x[18]+0.962605866313567*x[9]-0.270905788307869*x[19] == 0.0)
@NLconstraint(m, e28, x[4]*x[9]+x[14]*x[19]-0.83422336050651*x[7]-0.551426681241691*x[17] == 0.0)
@NLconstraint(m, e29, x[3]*x[10]+x[13]*x[20]+0.127963689627405*x[5]+0.991778853443116*x[15] == 0.0)
@NLconstraint(m, e30, x[2]*x[11]+x[12]*x[21]+0.666938061652262*x[3]-0.745113160479349*x[13] == 0.0)
@NLconstraint(m, e31, x[11]*x[12]-x[2]*x[21]+0.756802495307928*x[3]+2.61457448345445*x[13] == 0.0)
@NLconstraint(m, e32, x[10]*x[13]-x[3]*x[20]+0.582000135234454*x[13]-0.989358246623382*x[5] == 0.0)
@NLconstraint(m, e33, x[9]*x[14]-x[4]*x[19]+0.536572918000435*x[7]-3.37541583492997*x[13] == 0.0)
@NLconstraint(m, e34, x[8]*x[15]-x[5]*x[18]+0.287903316665065*x[9]+3.83063792129354*x[13] == 0.0)
@NLconstraint(m, e35, x[7]*x[16]-x[6]*x[17]-0.912945250727628*x[11]-1.63232824725357*x[13] == 0.0)
@NLconstraint(m, e36, x[6]*x[17]-x[7]*x[16]+0.905578362006624*x[11]-1.69671602934799*x[13] == 0.0)
@NLconstraint(m, e37, x[5]*x[18]-x[8]*x[15]-0.270905788307869*x[9]+3.85042346525427*x[13] == 0.0)
@NLconstraint(m, e38, x[4]*x[19]-x[9]*x[14]-0.551426681241691*x[7]-3.33689344202604*x[13] == 0.0)
@NLconstraint(m, e39, x[3]*x[20]-x[10]*x[13]+0.511854758509619*x[13]+0.991778853443116*x[5] == 0.0)
@NLconstraint(m, e40, x[2]*x[21]-x[11]*x[12]-0.745113160479349*x[3]+2.66775224660905*x[13] == 0.0)
