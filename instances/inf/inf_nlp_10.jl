...
@NLconstraint(m, e21, x[2]*x[11]+x[12]*x[21]-0.753902254343305*x[3]+0.656986598718789*x[13] == 0.0)
@NLconstraint(m, e22, x[3]*x[10]+x[13]*x[20]-0.136737218207834*x[5]+0.99060735569487*x[15] == 0.0)
@NLconstraint(m, e23, x[4]*x[9]+x[14]*x[19]+0.547729260224268*x[7]+0.836655638536056*x[17] == 0.0)
@NLconstraint(m, e24, x[5]*x[8]+x[15]*x[18]+0.962605866313567*x[9]+0.270905788307869*x[19] == 0.0)
@NLconstraint(m, e25, x[6]*x[7]+x[16]*x[17]+0.903692205091507*x[11]-0.428182669496151*x[21] == 0.0)
@NLconstraint(m, e26, x[6]*x[7]+x[16]*x[17]+0.399985314988351*x[11]+0.916521547915634*x[21] == 0.0)
@NLconstraint(m, e27, x[5]*x[8]+x[15]*x[18]-0.300592543743637*x[9]+0.953752652759472*x[19] == 0.0)
@NLconstraint(m, e28, x[4]*x[9]+x[14]*x[19]-0.853220107722584*x[7]+0.521551002086912*x[17] == 0.0)
@NLconstraint(m, e29, x[3]*x[10]+x[13]*x[20]-0.98589658158255*x[5]-0.167355700302807*x[15] == 0.0)
@NLconstraint(m, e30, x[2]*x[11]+x[12]*x[21]-0.6333192030863*x[3]-0.773890681557889*x[13] == 0.0)
@NLconstraint(m, e31, x[11]*x[12]-x[2]*x[21]-0.656986598718789*x[3]-5.27731578040313*x[13] == 0.0)
@NLconstraint(m, e32, x[10]*x[13]-x[3]*x[20]-0.957160527454835*x[13]-0.99060735569487*x[5] == 0.0)
@NLconstraint(m, e33, x[9]*x[14]-x[4]*x[19]-0.836655638536056*x[7]+3.83410482156988*x[13] == 0.0)
@NLconstraint(m, e34, x[8]*x[15]-x[5]*x[18]-0.270905788307869*x[9]+6.73824106419497*x[13] == 0.0)
@NLconstraint(m, e35, x[7]*x[16]-x[6]*x[17]+0.428182669496151*x[11]+6.32584543564055*x[13] == 0.0)
@NLconstraint(m, e36, x[6]*x[17]-x[7]*x[16]+0.916521547915634*x[11]+2.79989720491846*x[13] == 0.0)
@NLconstraint(m, e37, x[5]*x[18]-x[8]*x[15]+0.953752652759472*x[9]-2.10414780620546*x[13] == 0.0)
@NLconstraint(m, e38, x[4]*x[19]-x[9]*x[14]+0.521551002086912*x[7]-5.97254075405809*x[13] == 0.0)
@NLconstraint(m, e39, x[3]*x[20]-x[10]*x[13]-6.90127607107785*x[13]-0.167355700302807*x[5] == 0.0)
@NLconstraint(m, e40, x[2]*x[21]-x[11]*x[12]-0.773890681557889*x[3]-4.4332344216041*x[13] == 0.0)
