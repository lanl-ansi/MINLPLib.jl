...
setupperbound(i[1], 7.0)
setupperbound(i[2], 7.0)
setupperbound(i[3], 7.0)
setupperbound(i[4], 7.0)
setupperbound(i[5], 7.0)
setupperbound(i[6], 7.0)
setupperbound(i[7], 7.0)
setlowerbound(x[8], 420.0)
setupperbound(x[8], 425.0)
setlowerbound(x[9], 1.4)
setupperbound(x[9], 1.6)
setupperbound(x[10], 0.009)
setlowerbound(x[11], 3.3e-5)
setlowerbound(x[12], 10.0)
setlowerbound(x[13], 2700.0)
setlowerbound(x[14], 14.0)
