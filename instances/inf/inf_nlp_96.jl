...
setupperbound(x[1], 2.84)
setlowerbound(x[2], 0.65)
setupperbound(x[2], 2.13)
setlowerbound(x[3], 0.39)
setupperbound(x[3], 2.55)
setlowerbound(x[4], 0.81)
setupperbound(x[4], 2.64)
setlowerbound(x[5], 0.49)
setupperbound(x[5], 2.69)
setlowerbound(x[6], 0.02)
setupperbound(x[6], 2.01)
setlowerbound(x[7], 0.44)
setupperbound(x[7], 2.37)
setlowerbound(x[8], 0.19)
setupperbound(x[8], 2.51)
setlowerbound(x[9], 0.06)
setupperbound(x[9], 2.87)
setlowerbound(x[10], 0.73)
setupperbound(x[10], 2.57)
setlowerbound(x[11], 0.49)
setupperbound(x[11], 2.73)
setlowerbound(x[12], 0.53)
