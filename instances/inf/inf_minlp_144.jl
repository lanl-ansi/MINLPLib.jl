...
@constraint(m, e226, x[4]+4.76*b[39]+4.56*b[47]-4.56*b[55]+4.56*b[63] <= 8.36)
@constraint(m, e227, x[5]+5.35*b[40]+5.25*b[48]-5.25*b[56]+5.25*b[64] <= 8.45)
@constraint(m, e228, x[6]+5.34*b[41]+5.24*b[49]-5.24*b[57]+5.24*b[65] <= 8.44)
@constraint(m, e229, x[7]+7.21*b[42]+3.86*b[50]-3.86*b[58]+3.86*b[66] <= 7.96)
@constraint(m, e230, x[8]+5.6*b[43]+3.75*b[51]-3.75*b[59]+3.75*b[67] <= 8.35)
...
@NLconstraint(m, e316, -x[27]*x[30]*x[33] == -10.0)
