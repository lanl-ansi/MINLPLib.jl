...
@NLconstraint(m, e11, 15*i[1]*i[2]-3460*i[1]+236*i[2]+11*i[1]*i[3]-12*i[1]*i[4]+744*i[4]+174*i[2]*i[3]-274*i[2]*i[4]+61*i[3]*i[4]+112* (i[1])^2- (i[2])^2-215* (i[3])^2+47* (i[4])^2 <= -24778.0)
