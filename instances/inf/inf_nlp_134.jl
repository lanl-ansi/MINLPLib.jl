...
setupperbound(x[1], 1.0e9)
setupperbound(x[2], 1.0e9)
setupperbound(x[3], 1.0e9)
setupperbound(x[4], 1.0e9)
setupperbound(x[5], 1.0e9)
setupperbound(x[6], 1.0e9)
setupperbound(x[7], 1.0e9)
setupperbound(x[8], 1.0e9)
setupperbound(x[9], 1.0e9)
setupperbound(x[10], 1.0e9)
setupperbound(x[11], 1.0e9)
setupperbound(x[12], 1.0e9)
setupperbound(x[13], 1.0e9)
setupperbound(x[14], 1.0e9)
setupperbound(x[15], 1.0e9)
setupperbound(x[16], 1.0e9)
setupperbound(x[17], 1.0e9)
setupperbound(x[18], 1.0e9)
setupperbound(x[19], 1.0e9)
setupperbound(x[20], 1.0e9)
setupperbound(x[21], 1.0e9)
setlowerbound(x[22], -1.0e9)
setupperbound(x[22], 1.0e9)
