...
@constraint(m, e290, x[3]-x[34]+6.6525*b[38]+4.24*b[47]-4.24*b[56]+4.24*b[65] <= -0.66)
@constraint(m, e291, x[4]-x[34]+6.5*b[39]+4.15*b[48]-4.15*b[57]+4.15*b[66] <= -0.75)
@constraint(m, e292, x[5]-x[34]+6.18*b[40]+2.985*b[49]-2.985*b[58]+2.985*b[67] <= -0.57)
@constraint(m, e293, x[6]-x[34]+5.345*b[41]+2.045*b[50]-2.045*b[59]+2.045*b[68] <= -0.255)
@constraint(m, e294, x[7]-x[34]+5.445*b[42]+5.145*b[51]-5.145*b[60]+5.145*b[69] <= -0.455)
@constraint(m, e295, x[8]-x[34]+6.1*b[43]+4.25*b[52]-4.25*b[61]+4.25*b[70] <= -0.15)
@constraint(m, e296, x[9]-x[34]+2.43*b[44]+1.53*b[53]-1.53*b[62]+1.53*b[71] <= -0.07)
...
@constraint(m, e304, x[21]+2.4125*b[47]-4.24*b[65] <= -1.86)
@constraint(m, e305, x[22]+2.35*b[48]-4.15*b[66] <= -1.86)
@constraint(m, e306, x[23]+3.195*b[49]-2.985*b[67] <= -0.515)
@constraint(m, e307, x[24]+3.3*b[50]-2.045*b[68] <= 0.74)
@constraint(m, e308, x[25]+0.300000000000001*b[51]-5.145*b[69] <= -2.56)
@constraint(m, e309, x[26]+1.85*b[52]-4.25*b[70] <= -1.36)
@constraint(m, e310, x[27]+0.9*b[53]-1.53*b[71] <= 1.44)
...
@constraint(m, e389, x[28]-190*b[309] >= -184.25)
@constraint(m, e390, x[28]-190*b[310] >= -185.75)
@constraint(m, e391, x[28]-190*b[311] >= -186.5)
@constraint(m, e392, x[29]-190*b[312] >= -185.0)
@constraint(m, e393, x[29]-190*b[313] >= -187.625)
@constraint(m, e394, x[29]-190*b[314] >= -184.9)
@constraint(m, e395, x[28]+190*b[309] <= 195.75)
@constraint(m, e396, x[28]+190*b[310] <= 194.25)
@constraint(m, e397, x[28]+190*b[311] <= 193.5)
@constraint(m, e398, x[29]+190*b[312] <= 195.0)
@constraint(m, e399, x[29]+190*b[313] <= 192.375)
@constraint(m, e400, x[29]+190*b[314] <= 195.1)
@constraint(m, e401, x[30]-190*b[309] >= -187.75)
@constraint(m, e402, x[30]-190*b[310] >= -187.875)
@constraint(m, e403, x[30]-190*b[311] >= -188.75)
@constraint(m, e404, x[31]-190*b[312] >= -185.875)
@constraint(m, e405, x[31]-190*b[313] >= -185.75)
@constraint(m, e406, x[31]-190*b[314] >= -185.875)
@constraint(m, e407, x[30]+190*b[309] <= 192.25)
@constraint(m, e408, x[30]+190*b[310] <= 192.125)
@constraint(m, e409, x[30]+190*b[311] <= 191.25)
@constraint(m, e410, x[31]+190*b[312] <= 194.125)
@constraint(m, e411, x[31]+190*b[313] <= 194.25)
@constraint(m, e412, x[31]+190*b[314] <= 194.125)
@constraint(m, e413, x[32]-190*b[309] >= -189.625)
@constraint(m, e414, x[32]-190*b[310] >= -189.125)
@constraint(m, e415, x[32]-190*b[311] >= -188.875)
@constraint(m, e416, x[33]-190*b[312] >= -189.75)
@constraint(m, e417, x[33]-190*b[313] >= -189.625)
@constraint(m, e418, x[33]-190*b[314] >= -189.85)
@constraint(m, e419, x[32]+190*b[309] <= 190.375)
@constraint(m, e420, x[32]+190*b[310] <= 190.875)
@constraint(m, e421, x[32]+190*b[311] <= 191.125)
@constraint(m, e422, x[33]+190*b[312] <= 190.25)
@constraint(m, e423, x[33]+190*b[313] <= 190.375)
@constraint(m, e424, x[33]+190*b[314] <= 190.15)
