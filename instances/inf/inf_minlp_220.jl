...
@constraint(m, e226, x[4]-x[34]+4.3*b[39]+4.2*b[47]-4.2*b[55]+4.2*b[63] <= -1.1)
@constraint(m, e227, x[5]-x[34]+5.37*b[40]+5.18*b[48]-5.18*b[56]+5.18*b[64] <= -0.53)
@constraint(m, e228, x[6]-x[34]+7.45*b[41]+4.1*b[49]-4.1*b[57]+4.1*b[65] <= -0.8)
@constraint(m, e229, x[7]-x[34]+6.725*b[42]+4.15*b[50]-4.15*b[58]+4.15*b[66] <= -0.65)
@constraint(m, e230, x[8]-x[34]+5.01*b[43]+5.01*b[51]-5.01*b[59]+5.01*b[67] <= -0.39)
...
@constraint(m, e236, x[20]+0.100000000000001*b[47]-4.2*b[63] <= -2.26)
@constraint(m, e237, x[21]+0.19*b[48]-5.18*b[64] <= -2.67)
@constraint(m, e238, x[22]+3.35*b[49]-4.1*b[65] <= -1.86)
@constraint(m, e239, x[23]+2.575*b[50]-4.15*b[66] <= -1.76)
@constraint(m, e240, x[24]-5.01*b[67] <= -2.36)
