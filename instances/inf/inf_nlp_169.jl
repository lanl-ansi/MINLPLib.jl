...
@NLconstraint(m, e21, x[2]*x[11]+x[12]*x[21]-0.54030230586814*x[3]+0.841470984807897*x[13] == 0.0)
@NLconstraint(m, e22, x[3]*x[10]+x[13]*x[20]+0.416146836547142*x[5]+0.909297426825682*x[15] == 0.0)
@NLconstraint(m, e23, x[4]*x[9]+x[14]*x[19]+0.989992496600445*x[7]+0.141120008059867*x[17] == 0.0)
@NLconstraint(m, e24, x[5]*x[8]+x[15]*x[18]+0.653643620863612*x[9]-0.756802495307928*x[19] == 0.0)
@NLconstraint(m, e25, x[6]*x[7]+x[16]*x[17]-0.283662185463226*x[11]-0.958924274663138*x[21] == 0.0)
@NLconstraint(m, e26, x[6]*x[7]+x[16]*x[17]-0.960170286650366*x[11]+0.279415498198926*x[21] == 0.0)
@NLconstraint(m, e27, x[5]*x[8]+x[15]*x[18]-0.753902254343305*x[9]-0.656986598718789*x[19] == 0.0)
@NLconstraint(m, e28, x[4]*x[9]+x[14]*x[19]+0.145500033808614*x[7]-0.989358246623382*x[17] == 0.0)
@NLconstraint(m, e29, x[3]*x[10]+x[13]*x[20]+0.911130261884677*x[5]-0.412118485241757*x[15] == 0.0)
@NLconstraint(m, e30, x[2]*x[11]+x[12]*x[21]+0.839071529076452*x[3]+0.54402111088937*x[13] == 0.0)
@NLconstraint(m, e31, x[11]*x[12]-x[2]*x[21]-0.841470984807897*x[3]-0.54030230586814*x[13] == 0.0)
@NLconstraint(m, e32, x[10]*x[13]-x[3]*x[20]+0.416146836547142*x[13]-0.909297426825682*x[5] == 0.0)
@NLconstraint(m, e33, x[9]*x[14]-x[4]*x[19]-0.141120008059867*x[7]+0.989992496600445*x[13] == 0.0)
@NLconstraint(m, e34, x[8]*x[15]-x[5]*x[18]+0.756802495307928*x[9]+0.653643620863612*x[13] == 0.0)
@NLconstraint(m, e35, x[7]*x[16]-x[6]*x[17]+0.958924274663138*x[11]-0.283662185463226*x[13] == 0.0)
@NLconstraint(m, e36, x[6]*x[17]-x[7]*x[16]+0.279415498198926*x[11]-0.960170286650366*x[13] == 0.0)
@NLconstraint(m, e37, x[5]*x[18]-x[8]*x[15]-0.656986598718789*x[9]-0.753902254343305*x[13] == 0.0)
@NLconstraint(m, e38, x[4]*x[19]-x[9]*x[14]-0.989358246623382*x[7]+0.145500033808614*x[13] == 0.0)
@NLconstraint(m, e39, x[3]*x[20]-x[10]*x[13]+0.911130261884677*x[13]-0.412118485241757*x[5] == 0.0)
@NLconstraint(m, e40, x[2]*x[21]-x[11]*x[12]+0.54402111088937*x[3]+0.839071529076452*x[13] == 0.0)
