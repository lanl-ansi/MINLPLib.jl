...
set_lower_bound(x[18], -0.00913852260110389)
set_upper_bound(x[18], 0.00913852260110389)
set_lower_bound(x[19], -0.00913852260110389)
set_upper_bound(x[19], 0.00913852260110389)
set_lower_bound(x[20], -0.00913852260110389)
set_upper_bound(x[20], 0.00913852260110389)
...
@constraint(m, e230, -x[18]+x[19]+x[57] == 0.0)
@constraint(m, e231, -x[18]+x[20]+x[58] == 0.0)
@constraint(m, e232, -x[19]+x[20]+x[59] == 0.0)
@constraint(m, e233, x[18] == 0.0)
@constraint(m, e234, 0.9875*x[21]+x[24]-0.9875*x[27]-x[30] >= 0.0)
@constraint(m, e235, 0.975*x[21]+x[24]-0.975*x[27]-x[30] >= -0.015625)
@constraint(m, e236, 0.95*x[21]+x[24]-0.95*x[27]-x[30] >= -0.0625)
@constraint(m, e237, 0.925*x[21]+x[24]-0.925*x[27]-x[30] >= -0.140625)
@constraint(m, e238, 0.9*x[21]+x[24]-0.9*x[27]-x[30] >= -0.25)
@constraint(m, e239, 0.9875*x[22]+x[25]-0.9875*x[28]-x[31] >= 0.0)
@constraint(m, e240, 0.975*x[22]+x[25]-0.975*x[28]-x[31] >= -0.015625)
@constraint(m, e241, 0.95*x[22]+x[25]-0.95*x[28]-x[31] >= -0.0625)
@constraint(m, e242, 0.925*x[22]+x[25]-0.925*x[28]-x[31] >= -0.140625)
@constraint(m, e243, 0.9*x[22]+x[25]-0.9*x[28]-x[31] >= -0.25)
@constraint(m, e244, 0.9875*x[23]+x[26]-0.9875*x[29]-x[32] >= 0.0)
@constraint(m, e245, 0.975*x[23]+x[26]-0.975*x[29]-x[32] >= -0.015625)
@constraint(m, e246, 0.95*x[23]+x[26]-0.95*x[29]-x[32] >= -0.0625)
@constraint(m, e247, 0.925*x[23]+x[26]-0.925*x[29]-x[32] >= -0.140625)
@constraint(m, e248, 0.9*x[23]+x[26]-0.9*x[29]-x[32] >= -0.25)
@constraint(m, e249, x[21]+0.9875*x[24]-x[27]-0.9875*x[30] >= 0.0)
@constraint(m, e250, x[21]+0.975*x[24]-x[27]-0.975*x[30] >= -0.015625)
@constraint(m, e251, x[21]+0.95*x[24]-x[27]-0.95*x[30] >= -0.0625)
@constraint(m, e252, x[21]+0.925*x[24]-x[27]-0.925*x[30] >= -0.140625)
@constraint(m, e253, x[21]+0.9*x[24]-x[27]-0.9*x[30] >= -0.25)
@constraint(m, e254, x[22]+0.9875*x[25]-x[28]-0.9875*x[31] >= 0.0)
@constraint(m, e255, x[22]+0.975*x[25]-x[28]-0.975*x[31] >= -0.015625)
@constraint(m, e256, x[22]+0.95*x[25]-x[28]-0.95*x[31] >= -0.0625)
@constraint(m, e257, x[22]+0.925*x[25]-x[28]-0.925*x[31] >= -0.140625)
@constraint(m, e258, x[22]+0.9*x[25]-x[28]-0.9*x[31] >= -0.25)
@constraint(m, e259, x[23]+0.9875*x[26]-x[29]-0.9875*x[32] >= 0.0)
@constraint(m, e260, x[23]+0.975*x[26]-x[29]-0.975*x[32] >= -0.015625)
@constraint(m, e261, x[23]+0.95*x[26]-x[29]-0.95*x[32] >= -0.0625)
@constraint(m, e262, x[23]+0.925*x[26]-x[29]-0.925*x[32] >= -0.140625)
@constraint(m, e263, x[23]+0.9*x[26]-x[29]-0.9*x[32] >= -0.25)
@constraint(m, e264, x[9]-1.1*b[75] <= 0.0)
@constraint(m, e265, x[10]-1.1*b[76] <= 0.0)
@constraint(m, e266, x[11]-1.1*b[77] <= 0.0)
@constraint(m, e267, x[9]-0.9*b[75] >= 0.0)
@constraint(m, e268, x[10]-0.9*b[76] >= 0.0)
@constraint(m, e269, x[11]-0.9*b[77] >= 0.0)
@constraint(m, e270, b[75] == 1.0)
@constraint(m, e271, b[76] == 1.0)
@constraint(m, e272, b[77] == 1.0)
@constraint(m, e273, -0.9*x[9]+x[51] >= 0.0)
@constraint(m, e274, -0.9*x[9]+x[52] >= 0.0)
@constraint(m, e275, -0.9*x[10]+x[53] >= 0.0)
@constraint(m, e276, -1.1*x[9]+x[51] <= 0.0)
@constraint(m, e277, -1.1*x[9]+x[52] <= 0.0)
@constraint(m, e278, -1.1*x[10]+x[53] <= 0.0)
@constraint(m, e279, -0.9*x[10]+x[51] >= 0.0)
@constraint(m, e280, -0.9*x[11]+x[52] >= 0.0)
@constraint(m, e281, -0.9*x[11]+x[53] >= 0.0)
@constraint(m, e282, -1.1*x[10]+x[51] <= 0.0)
@constraint(m, e283, -1.1*x[11]+x[52] <= 0.0)
@constraint(m, e284, -1.1*x[11]+x[53] <= 0.0)
@constraint(m, e285, x[45]-0.965925826*x[51] >= 0.0)
@constraint(m, e286, x[46]-0.965925826*x[52] >= 0.0)
@constraint(m, e287, x[47]-0.965925826*x[53] >= 0.0)
@constraint(m, e288, x[45]-x[51] <= 0.0)
@constraint(m, e289, x[46]-x[52] <= 0.0)
@constraint(m, e290, x[47]-x[53] <= 0.0)
