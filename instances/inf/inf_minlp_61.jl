...
@constraint(m, e171, x[4]+6.05*b[33]+2.8*b[40]-2.8*b[47]+2.8*b[54] <= 8.3)
@constraint(m, e172, x[5]+5.25*b[34]+1.7*b[41]-1.7*b[48]+1.7*b[55] <= 8.0)
@constraint(m, e173, x[6]+5*b[35]+4.9*b[42]-4.9*b[49]+4.9*b[56] <= 8.6)
@constraint(m, e174, x[7]+7.32*b[36]+4.07*b[43]-4.07*b[50]+4.07*b[57] <= 8.07)
...
@constraint(m, e181, x[18]-x[28]+3.25*b[40]-2.8*b[54] <= -3.5)
@constraint(m, e182, x[19]-x[28]+3.55*b[41]-1.7*b[55] <= -2.7)
@constraint(m, e183, x[20]-x[28]+0.100000000000001*b[42]-4.9*b[56] <= -5.3)
@constraint(m, e184, x[21]-x[28]+3.25*b[43]-4.07*b[57] <= -5.0)
...
@NLconstraint(m, e247, -x[22]*x[24]*x[26] == -5.0)
@NLconstraint(m, e248, -x[23]*x[25]*x[27] == -7.0)
@constraint(m, e249, x[22] <= 5.0)
@constraint(m, e250, x[23] <= 4.5)
@constraint(m, e251, x[22] >= 2.375)
@constraint(m, e252, x[23] >= 1.125)
@constraint(m, e253, x[24] <= 4.125)
@constraint(m, e254, x[25] <= 2.375)
@constraint(m, e255, x[24] >= 1.25)
@constraint(m, e256, x[25] >= 0.125)
@constraint(m, e257, x[26] <= 2.25)
@constraint(m, e258, x[27] <= 2.375)
@constraint(m, e259, x[26] >= 2.25)
@constraint(m, e260, x[27] >= 2.375)
