...
setlowerbound(x[2], 81.09)
setupperbound(x[2], 81.09)
setlowerbound(x[3], 23.92)
setupperbound(x[3], 23.92)
setlowerbound(x[4], 6.29)
setupperbound(x[4], 6.29)
setlowerbound(x[5], 38.7)
setupperbound(x[5], 38.7)
setlowerbound(x[6], 134.74)
setupperbound(x[6], 134.74)
setlowerbound(x[7], 48.2)
setupperbound(x[7], 48.2)
setlowerbound(x[8], 16.23)
setupperbound(x[8], 16.23)
setlowerbound(x[9], 100.85)
setupperbound(x[9], 100.85)
