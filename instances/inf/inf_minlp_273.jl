...
@NLconstraint(m, e53, -(0.9*x[38]*b[75]+x[38]*(1-b[75]))+x[39] == 0.0)
@NLconstraint(m, e54, -(0.9*x[42]*b[79]+x[42]*(1-b[79]))+x[43] == 0.0)
@NLconstraint(m, e55, -(0.9*x[46]*b[83]+x[46]*(1-b[83]))+x[47] == 0.0)
@NLconstraint(m, e56, -(0.9*x[39]*b[76]+x[39]*(1-b[76]))+x[40] == 0.0)
@NLconstraint(m, e57, -(0.9*x[43]*b[80]+x[43]*(1-b[80]))+x[44] == 0.0)
@NLconstraint(m, e58, -(0.9*x[47]*b[84]+x[47]*(1-b[84]))+x[48] == 0.0)
@NLconstraint(m, e59, -(0.9*x[40]*b[77]+x[40]*(1-b[77]))+x[41] == 0.0)
@NLconstraint(m, e60, -(0.9*x[44]*b[81]+x[44]*(1-b[81]))+x[45] == 0.0)
@NLconstraint(m, e61, -(0.9*x[48]*b[85]+x[48]*(1-b[85]))+x[49] == 0.0)
