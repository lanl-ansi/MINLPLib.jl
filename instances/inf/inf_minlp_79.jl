...
@NLconstraint(m, e8, (-3*i[1]*i[2])-23*i[1]+118*i[2]+12*i[1]*i[3]+11*i[1]*i[4]-474*i[4]+196*i[2]*i[3]-180*i[2]*i[4]-8*i[3]*i[4]-19* (i[2])^2-173* (i[3])^2+207* (i[4])^2 <= -164.0)
@NLconstraint(m, e9, 4*i[1]*i[2]-712*i[1]-9*i[2]-6*i[1]*i[3]-11*i[1]*i[4]+437*i[4]-162*i[2]*i[3]+171*i[2]*i[4]-3*i[3]*i[4]+24* (i[1])^2+4* (i[2])^2+140* (i[3])^2-187* (i[4])^2 <= -4897.0)
@NLconstraint(m, e10, 119*i[1]-6*i[1]*i[2]+263*i[2]+45*i[1]*i[3]+37*i[1]*i[4]-1609*i[4]+810*i[2]*i[3]-798*i[2]*i[4]-31*i[3]*i[4]-7* (i[1])^2-36* (i[2])^2-712* (i[3])^2+857* (i[4])^2 <= 127.0)
@NLconstraint(m, e11, 15*i[1]*i[2]-3460*i[1]+236*i[2]+11*i[1]*i[3]-12*i[1]*i[4]+744*i[4]+174*i[2]*i[3]-274*i[2]*i[4]+61*i[3]*i[4]+112* (i[1])^2- (i[2])^2-215* (i[3])^2+47* (i[4])^2 <= -25478.0)
...
@NLconstraint(m, e14, (-347.958+0.0036*(13895*i[1]-92*i[1]*i[2]-2669*i[2]-15*i[1]*i[3]+20*i[1]*i[4]-2050*i[4]+687*i[2]*i[3]-867*i[2]*i[4]+40*i[3]*i[4]-451* (i[1])^2+691* (i[2])^2-487* (i[3])^2+1051* (i[4])^2))*(0.1356+0.01332*i[2])+0.085*i[1] <= 3.5)
