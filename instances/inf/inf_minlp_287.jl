...
@constraint(m, e226, x[4]+5.25*b[39]+5.05*b[47]-5.05*b[55]+5.05*b[63] <= 8.35)
@constraint(m, e227, x[5]+4.3*b[40]+4.2*b[48]-4.2*b[56]+4.2*b[64] <= 7.9)
@constraint(m, e228, x[6]+6.1*b[41]+4.25*b[49]-4.25*b[57]+4.25*b[65] <= 7.85)
@constraint(m, e229, x[7]+7.45*b[42]+4.1*b[50]-4.1*b[58]+4.1*b[66] <= 8.2)
@constraint(m, e230, x[8]+6.725*b[43]+4.15*b[51]-4.15*b[59]+4.15*b[67] <= 8.35)
...
@constraint(m, e236, x[20]-x[34]+0.2*b[47]-5.05*b[63] <= -5.7)
@constraint(m, e237, x[21]-x[34]+0.100000000000001*b[48]-4.2*b[64] <= -5.3)
@constraint(m, e238, x[22]-x[34]+1.85*b[49]-4.25*b[65] <= -5.4)
@constraint(m, e239, x[23]-x[34]+3.35*b[50]-4.1*b[66] <= -4.9)
@constraint(m, e240, x[24]-x[34]+2.575*b[51]-4.15*b[67] <= -4.8)
...
@NLconstraint(m, e314, -x[25]*x[28]*x[31] == -51.0)
...
@constraint(m, e320, x[25] >= 0.125)
@constraint(m, e321, x[26] >= 0.375)
@constraint(m, e322, x[27] >= 0.6)
@constraint(m, e323, x[28] <= 2.375)
@constraint(m, e324, x[29] <= 4.125)
@constraint(m, e325, x[30] <= 2.5)
@constraint(m, e326, x[28] >= 0.125)
@constraint(m, e327, x[29] >= 0.25)
@constraint(m, e328, x[30] >= 0.35)
@constraint(m, e329, x[31] <= 3.375)
@constraint(m, e330, x[32] <= 3.25)
@constraint(m, e331, x[33] <= 3.65)
@constraint(m, e332, x[31] >= 3.375)
@constraint(m, e333, x[32] >= 3.25)
@constraint(m, e334, x[33] >= 3.65)
