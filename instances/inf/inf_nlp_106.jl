...
setlowerbound(x[1], 0.45)
setupperbound(x[1], 2.56)
setlowerbound(x[2], 0.54)
setupperbound(x[2], 2.07)
setlowerbound(x[3], 0.55)
setupperbound(x[3], 2.93)
setlowerbound(x[4], 0.81)
setupperbound(x[4], 2.03)
setlowerbound(x[5], 0.7)
setupperbound(x[5], 2.4)
setlowerbound(x[6], 0.52)
setupperbound(x[6], 2.86)
setlowerbound(x[7], 0.44)
setupperbound(x[7], 2.18)
setlowerbound(x[8], 0.13)
setupperbound(x[8], 2.37)
setlowerbound(x[9], 0.24)
setupperbound(x[9], 2.57)
setupperbound(x[10], 2.19)
setlowerbound(x[11], 0.65)
setupperbound(x[11], 2.29)
setlowerbound(x[12], 0.57)
setupperbound(x[12], 2.83)
setlowerbound(x[13], 0.1)
setupperbound(x[13], 2.49)
setlowerbound(x[14], 0.31)
setupperbound(x[14], 2.49)
setlowerbound(x[15], 0.72)
setupperbound(x[15], 2.15)
setlowerbound(x[16], 0.83)
setupperbound(x[16], 2.32)
setlowerbound(x[17], 0.64)
setupperbound(x[17], 2.67)
setlowerbound(x[18], 0.06)
setupperbound(x[18], 2.44)
setlowerbound(x[19], 0.02)
setupperbound(x[19], 2.38)
setlowerbound(x[20], 0.01)
setupperbound(x[20], 2.54)
setlowerbound(x[21], 0.51)
setupperbound(x[21], 2.87)
setlowerbound(x[22], 0.76)
setupperbound(x[22], 2.19)
setlowerbound(x[23], 0.21)
setupperbound(x[23], 2.75)
setlowerbound(x[24], 0.39)
setupperbound(x[24], 2.93)
setlowerbound(x[25], 0.77)
setupperbound(x[25], 2.84)
setlowerbound(x[26], 0.54)
setupperbound(x[26], 2.08)
setlowerbound(x[27], 0.93)
setupperbound(x[27], 2.29)
setlowerbound(x[28], 0.13)
setupperbound(x[28], 2.29)
setlowerbound(x[29], 0.01)
setupperbound(x[29], 2.72)
setlowerbound(x[30], 0.04)
setupperbound(x[30], 2.08)
setlowerbound(x[31], 0.56)
setupperbound(x[31], 2.92)
setlowerbound(x[32], 0.27)
setupperbound(x[32], 3.0)
setlowerbound(x[33], 0.79)
setupperbound(x[33], 2.02)
setlowerbound(x[34], 0.38)
setupperbound(x[34], 2.86)
setlowerbound(x[35], 0.08)
setupperbound(x[35], 2.84)
setlowerbound(x[36], 0.74)
setupperbound(x[36], 2.82)
setupperbound(x[37], 2.27)
setlowerbound(x[38], 0.29)
setupperbound(x[38], 2.39)
setlowerbound(x[39], 0.16)
setupperbound(x[39], 2.4)
setlowerbound(x[40], 0.55)
setupperbound(x[40], 2.44)
