...
@NLconstraint(m, e2, (-2.35*i[1]*i[2])-10.7*i[1]-63.3*i[2]+10.9*i[1]*i[3]+93.5*i[3]+0.108*i[1]*i[4]-25.1*i[4]-76.8*i[2]*i[3]+37.9*i[2]*i[4]-9.31*i[3]*i[4]-0.295* (i[1])^2+25.1* (i[2])^2+30.4* (i[3])^2-28.1* (i[4])^2 <= -81.0)
@NLconstraint(m, e3, (-2.35*i[1]*i[2])-10.7*i[1]-63.3*i[2]+10.9*i[1]*i[3]+93.5*i[3]+0.108*i[1]*i[4]-25.1*i[4]-76.8*i[2]*i[3]+37.9*i[2]*i[4]-9.31*i[3]*i[4]-0.295* (i[1])^2+25.1* (i[2])^2+30.4* (i[3])^2-28.1* (i[4])^2 <= -81.0)
@NLconstraint(m, e4, (-2.35*i[1]*i[2])-10.7*i[1]-63.3*i[2]+10.9*i[1]*i[3]+93.5*i[3]+0.108*i[1]*i[4]-25.1*i[4]-76.8*i[2]*i[3]+37.9*i[2]*i[4]-9.31*i[3]*i[4]-0.295* (i[1])^2+25.1* (i[2])^2+30.4* (i[3])^2-28.1* (i[4])^2 <= -81.0)
@NLconstraint(m, e5, (-2.35*i[1]*i[2])-10.7*i[1]-63.3*i[2]+10.9*i[1]*i[3]+93.5*i[3]+0.108*i[1]*i[4]-25.1*i[4]-76.8*i[2]*i[3]+37.9*i[2]*i[4]-9.31*i[3]*i[4]-0.295* (i[1])^2+25.1* (i[2])^2+30.4* (i[3])^2-28.1* (i[4])^2 <= -81.0)
@NLconstraint(m, e6, (-2.35*i[1]*i[2])-10.7*i[1]-63.3*i[2]+10.9*i[1]*i[3]+93.5*i[3]+0.108*i[1]*i[4]-25.1*i[4]-76.8*i[2]*i[3]+37.9*i[2]*i[4]-9.31*i[3]*i[4]-0.295* (i[1])^2+25.1* (i[2])^2+30.4* (i[3])^2-28.1* (i[4])^2 <= -81.0)
@NLconstraint(m, e7, (-2.35*i[1]*i[2])-10.7*i[1]-63.3*i[2]+10.9*i[1]*i[3]+93.5*i[3]+0.108*i[1]*i[4]-25.1*i[4]-76.8*i[2]*i[3]+37.9*i[2]*i[4]-9.31*i[3]*i[4]-0.295* (i[1])^2+25.1* (i[2])^2+30.4* (i[3])^2-28.1* (i[4])^2 <= -81.0)
@NLconstraint(m, e8, (-2.35*i[1]*i[2])-10.7*i[1]-63.3*i[2]+10.9*i[1]*i[3]+93.5*i[3]+0.108*i[1]*i[4]-25.1*i[4]-76.8*i[2]*i[3]+37.9*i[2]*i[4]-9.31*i[3]*i[4]-0.295* (i[1])^2+25.1* (i[2])^2+30.4* (i[3])^2-28.1* (i[4])^2 <= -81.0)
@NLconstraint(m, e9, (-2.35*i[1]*i[2])-10.7*i[1]-63.3*i[2]+10.9*i[1]*i[3]+93.5*i[3]+0.108*i[1]*i[4]-25.1*i[4]-76.8*i[2]*i[3]+37.9*i[2]*i[4]-9.31*i[3]*i[4]-0.295* (i[1])^2+25.1* (i[2])^2+30.4* (i[3])^2-28.1* (i[4])^2 <= -81.0)
@NLconstraint(m, e10, (-2.35*i[1]*i[2])-10.7*i[1]-63.3*i[2]+10.9*i[1]*i[3]+93.5*i[3]+0.108*i[1]*i[4]-25.1*i[4]-76.8*i[2]*i[3]+37.9*i[2]*i[4]-9.31*i[3]*i[4]-0.295* (i[1])^2+25.1* (i[2])^2+30.4* (i[3])^2-28.1* (i[4])^2 <= -81.0)
@NLconstraint(m, e11, (-2.35*i[1]*i[2])-10.7*i[1]-63.3*i[2]+10.9*i[1]*i[3]+93.5*i[3]+0.108*i[1]*i[4]-25.1*i[4]-76.8*i[2]*i[3]+37.9*i[2]*i[4]-9.31*i[3]*i[4]-0.295* (i[1])^2+25.1* (i[2])^2+30.4* (i[3])^2-28.1* (i[4])^2 <= -81.0)
@NLconstraint(m, e12, (-2.35*i[1]*i[2])-10.7*i[1]-63.3*i[2]+10.9*i[1]*i[3]+93.5*i[3]+0.108*i[1]*i[4]-25.1*i[4]-76.8*i[2]*i[3]+37.9*i[2]*i[4]-9.31*i[3]*i[4]-0.295* (i[1])^2+25.1* (i[2])^2+30.4* (i[3])^2-28.1* (i[4])^2 <= -81.0)
@NLconstraint(m, e13, (-2.35*i[1]*i[2])-10.7*i[1]-63.3*i[2]+10.9*i[1]*i[3]+93.5*i[3]+0.108*i[1]*i[4]-25.1*i[4]-76.8*i[2]*i[3]+37.9*i[2]*i[4]-9.31*i[3]*i[4]-0.295* (i[1])^2+25.1* (i[2])^2+30.4* (i[3])^2-28.1* (i[4])^2 <= -81.0)
@NLconstraint(m, e14, (-2.35*i[1]*i[2])-10.7*i[1]-63.3*i[2]+10.9*i[1]*i[3]+93.5*i[3]+0.108*i[1]*i[4]-25.1*i[4]-76.8*i[2]*i[3]+37.9*i[2]*i[4]-9.31*i[3]*i[4]-0.295* (i[1])^2+25.1* (i[2])^2+30.4* (i[3])^2-28.1* (i[4])^2 <= -81.0)
@NLconstraint(m, e15, (-2.35*i[1]*i[2])-10.7*i[1]-63.3*i[2]+10.9*i[1]*i[3]+93.5*i[3]+0.108*i[1]*i[4]-25.1*i[4]-76.8*i[2]*i[3]+37.9*i[2]*i[4]-9.31*i[3]*i[4]-0.295* (i[1])^2+25.1* (i[2])^2+30.4* (i[3])^2-28.1* (i[4])^2 <= -81.0)
@NLconstraint(m, e16, (-2.35*i[1]*i[2])-10.7*i[1]-63.3*i[2]+10.9*i[1]*i[3]+93.5*i[3]+0.108*i[1]*i[4]-25.1*i[4]-76.8*i[2]*i[3]+37.9*i[2]*i[4]-9.31*i[3]*i[4]-0.295* (i[1])^2+25.1* (i[2])^2+30.4* (i[3])^2-28.1* (i[4])^2 <= -81.0)
@NLconstraint(m, e17, (-1.92*i[1]*i[2])-30.3*i[1]-269*i[2]+36.2*i[1]*i[3]+378*i[3]-5.18*i[1]*i[4]-145*i[4]-286*i[2]*i[3]+167*i[2]*i[4]-19.2*i[3]*i[4]-1.44* (i[1])^2+79.7* (i[2])^2+103* (i[3])^2-108* (i[4])^2 <= -425.0)
@NLconstraint(m, e18, (-1.92*i[1]*i[2])-30.3*i[1]-269*i[2]+36.2*i[1]*i[3]+378*i[3]-5.18*i[1]*i[4]-145*i[4]-286*i[2]*i[3]+167*i[2]*i[4]-19.2*i[3]*i[4]-1.44* (i[1])^2+79.7* (i[2])^2+103* (i[3])^2-108* (i[4])^2 <= -425.0)
@NLconstraint(m, e19, (-1.92*i[1]*i[2])-30.3*i[1]-269*i[2]+36.2*i[1]*i[3]+378*i[3]-5.18*i[1]*i[4]-145*i[4]-286*i[2]*i[3]+167*i[2]*i[4]-19.2*i[3]*i[4]-1.44* (i[1])^2+79.7* (i[2])^2+103* (i[3])^2-108* (i[4])^2 <= -425.0)
@NLconstraint(m, e20, (-1.92*i[1]*i[2])-30.3*i[1]-269*i[2]+36.2*i[1]*i[3]+378*i[3]-5.18*i[1]*i[4]-145*i[4]-286*i[2]*i[3]+167*i[2]*i[4]-19.2*i[3]*i[4]-1.44* (i[1])^2+79.7* (i[2])^2+103* (i[3])^2-108* (i[4])^2 <= -425.0)
@NLconstraint(m, e21, (-1.92*i[1]*i[2])-30.3*i[1]-269*i[2]+36.2*i[1]*i[3]+378*i[3]-5.18*i[1]*i[4]-145*i[4]-286*i[2]*i[3]+167*i[2]*i[4]-19.2*i[3]*i[4]-1.44* (i[1])^2+79.7* (i[2])^2+103* (i[3])^2-108* (i[4])^2 <= -425.0)
@NLconstraint(m, e22, (-1.92*i[1]*i[2])-30.3*i[1]-269*i[2]+36.2*i[1]*i[3]+378*i[3]-5.18*i[1]*i[4]-145*i[4]-286*i[2]*i[3]+167*i[2]*i[4]-19.2*i[3]*i[4]-1.44* (i[1])^2+79.7* (i[2])^2+103* (i[3])^2-108* (i[4])^2 <= -425.0)
@NLconstraint(m, e23, (-1.92*i[1]*i[2])-30.3*i[1]-269*i[2]+36.2*i[1]*i[3]+378*i[3]-5.18*i[1]*i[4]-145*i[4]-286*i[2]*i[3]+167*i[2]*i[4]-19.2*i[3]*i[4]-1.44* (i[1])^2+79.7* (i[2])^2+103* (i[3])^2-108* (i[4])^2 <= -425.0)
@NLconstraint(m, e24, (-1.92*i[1]*i[2])-30.3*i[1]-269*i[2]+36.2*i[1]*i[3]+378*i[3]-5.18*i[1]*i[4]-145*i[4]-286*i[2]*i[3]+167*i[2]*i[4]-19.2*i[3]*i[4]-1.44* (i[1])^2+79.7* (i[2])^2+103* (i[3])^2-108* (i[4])^2 <= -425.0)
@NLconstraint(m, e25, (-1.92*i[1]*i[2])-30.3*i[1]-269*i[2]+36.2*i[1]*i[3]+378*i[3]-5.18*i[1]*i[4]-145*i[4]-286*i[2]*i[3]+167*i[2]*i[4]-19.2*i[3]*i[4]-1.44* (i[1])^2+79.7* (i[2])^2+103* (i[3])^2-108* (i[4])^2 <= -425.0)
@NLconstraint(m, e26, (-1.92*i[1]*i[2])-30.3*i[1]-269*i[2]+36.2*i[1]*i[3]+378*i[3]-5.18*i[1]*i[4]-145*i[4]-286*i[2]*i[3]+167*i[2]*i[4]-19.2*i[3]*i[4]-1.44* (i[1])^2+79.7* (i[2])^2+103* (i[3])^2-108* (i[4])^2 <= -425.0)
@NLconstraint(m, e27, (-1.92*i[1]*i[2])-30.3*i[1]-269*i[2]+36.2*i[1]*i[3]+378*i[3]-5.18*i[1]*i[4]-145*i[4]-286*i[2]*i[3]+167*i[2]*i[4]-19.2*i[3]*i[4]-1.44* (i[1])^2+79.7* (i[2])^2+103* (i[3])^2-108* (i[4])^2 <= -425.0)
@NLconstraint(m, e28, (-1.92*i[1]*i[2])-30.3*i[1]-269*i[2]+36.2*i[1]*i[3]+378*i[3]-5.18*i[1]*i[4]-145*i[4]-286*i[2]*i[3]+167*i[2]*i[4]-19.2*i[3]*i[4]-1.44* (i[1])^2+79.7* (i[2])^2+103* (i[3])^2-108* (i[4])^2 <= -425.0)
@NLconstraint(m, e29, (-1.92*i[1]*i[2])-30.3*i[1]-269*i[2]+36.2*i[1]*i[3]+378*i[3]-5.18*i[1]*i[4]-145*i[4]-286*i[2]*i[3]+167*i[2]*i[4]-19.2*i[3]*i[4]-1.44* (i[1])^2+79.7* (i[2])^2+103* (i[3])^2-108* (i[4])^2 <= -425.0)
@NLconstraint(m, e30, (-1.92*i[1]*i[2])-30.3*i[1]-269*i[2]+36.2*i[1]*i[3]+378*i[3]-5.18*i[1]*i[4]-145*i[4]-286*i[2]*i[3]+167*i[2]*i[4]-19.2*i[3]*i[4]-1.44* (i[1])^2+79.7* (i[2])^2+103* (i[3])^2-108* (i[4])^2 <= -425.0)
@NLconstraint(m, e31, (-1.92*i[1]*i[2])-30.3*i[1]-269*i[2]+36.2*i[1]*i[3]+378*i[3]-5.18*i[1]*i[4]-145*i[4]-286*i[2]*i[3]+167*i[2]*i[4]-19.2*i[3]*i[4]-1.44* (i[1])^2+79.7* (i[2])^2+103* (i[3])^2-108* (i[4])^2 <= -425.0)
...
@NLconstraint(m, e47, 0.145*i[1]*i[2]+0.257*i[1]-1.38*i[2]-0.019*i[1]*i[3]+2.9*i[3]-0.182*i[1]*i[4]-0.77*i[4]-1.87*i[2]*i[3]-1.79*i[2]*i[4]+1.24*i[3]*i[4]-0.01* (i[1])^2+1.32* (i[2])^2+0.062* (i[3])^2+1.04* (i[4])^2 <= 11.38)
@NLconstraint(m, e48, 0.145*i[1]*i[2]+0.257*i[1]-1.38*i[2]-0.019*i[1]*i[3]+2.9*i[3]-0.182*i[1]*i[4]-0.77*i[4]-1.87*i[2]*i[3]-1.79*i[2]*i[4]+1.24*i[3]*i[4]-0.01* (i[1])^2+1.32* (i[2])^2+0.062* (i[3])^2+1.04* (i[4])^2 <= 11.38)
@NLconstraint(m, e49, 0.145*i[1]*i[2]+0.257*i[1]-1.38*i[2]-0.019*i[1]*i[3]+2.9*i[3]-0.182*i[1]*i[4]-0.77*i[4]-1.87*i[2]*i[3]-1.79*i[2]*i[4]+1.24*i[3]*i[4]-0.01* (i[1])^2+1.32* (i[2])^2+0.062* (i[3])^2+1.04* (i[4])^2 <= 11.38)
@NLconstraint(m, e50, 0.145*i[1]*i[2]+0.257*i[1]-1.38*i[2]-0.019*i[1]*i[3]+2.9*i[3]-0.182*i[1]*i[4]-0.77*i[4]-1.87*i[2]*i[3]-1.79*i[2]*i[4]+1.24*i[3]*i[4]-0.01* (i[1])^2+1.32* (i[2])^2+0.062* (i[3])^2+1.04* (i[4])^2 <= 11.38)
@NLconstraint(m, e51, 0.145*i[1]*i[2]+0.257*i[1]-1.38*i[2]-0.019*i[1]*i[3]+2.9*i[3]-0.182*i[1]*i[4]-0.77*i[4]-1.87*i[2]*i[3]-1.79*i[2]*i[4]+1.24*i[3]*i[4]-0.01* (i[1])^2+1.32* (i[2])^2+0.062* (i[3])^2+1.04* (i[4])^2 <= 11.38)
@NLconstraint(m, e52, 0.145*i[1]*i[2]+0.257*i[1]-1.38*i[2]-0.019*i[1]*i[3]+2.9*i[3]-0.182*i[1]*i[4]-0.77*i[4]-1.87*i[2]*i[3]-1.79*i[2]*i[4]+1.24*i[3]*i[4]-0.01* (i[1])^2+1.32* (i[2])^2+0.062* (i[3])^2+1.04* (i[4])^2 <= 11.38)
@NLconstraint(m, e53, 0.145*i[1]*i[2]+0.257*i[1]-1.38*i[2]-0.019*i[1]*i[3]+2.9*i[3]-0.182*i[1]*i[4]-0.77*i[4]-1.87*i[2]*i[3]-1.79*i[2]*i[4]+1.24*i[3]*i[4]-0.01* (i[1])^2+1.32* (i[2])^2+0.062* (i[3])^2+1.04* (i[4])^2 <= 11.38)
@NLconstraint(m, e54, 0.145*i[1]*i[2]+0.257*i[1]-1.38*i[2]-0.019*i[1]*i[3]+2.9*i[3]-0.182*i[1]*i[4]-0.77*i[4]-1.87*i[2]*i[3]-1.79*i[2]*i[4]+1.24*i[3]*i[4]-0.01* (i[1])^2+1.32* (i[2])^2+0.062* (i[3])^2+1.04* (i[4])^2 <= 11.38)
@NLconstraint(m, e55, 0.145*i[1]*i[2]+0.257*i[1]-1.38*i[2]-0.019*i[1]*i[3]+2.9*i[3]-0.182*i[1]*i[4]-0.77*i[4]-1.87*i[2]*i[3]-1.79*i[2]*i[4]+1.24*i[3]*i[4]-0.01* (i[1])^2+1.32* (i[2])^2+0.062* (i[3])^2+1.04* (i[4])^2 <= 11.38)
@NLconstraint(m, e56, 0.145*i[1]*i[2]+0.257*i[1]-1.38*i[2]-0.019*i[1]*i[3]+2.9*i[3]-0.182*i[1]*i[4]-0.77*i[4]-1.87*i[2]*i[3]-1.79*i[2]*i[4]+1.24*i[3]*i[4]-0.01* (i[1])^2+1.32* (i[2])^2+0.062* (i[3])^2+1.04* (i[4])^2 <= 11.38)
@NLconstraint(m, e57, 0.145*i[1]*i[2]+0.257*i[1]-1.38*i[2]-0.019*i[1]*i[3]+2.9*i[3]-0.182*i[1]*i[4]-0.77*i[4]-1.87*i[2]*i[3]-1.79*i[2]*i[4]+1.24*i[3]*i[4]-0.01* (i[1])^2+1.32* (i[2])^2+0.062* (i[3])^2+1.04* (i[4])^2 <= 11.38)
@NLconstraint(m, e58, 0.145*i[1]*i[2]+0.257*i[1]-1.38*i[2]-0.019*i[1]*i[3]+2.9*i[3]-0.182*i[1]*i[4]-0.77*i[4]-1.87*i[2]*i[3]-1.79*i[2]*i[4]+1.24*i[3]*i[4]-0.01* (i[1])^2+1.32* (i[2])^2+0.062* (i[3])^2+1.04* (i[4])^2 <= 11.38)
@NLconstraint(m, e59, 0.145*i[1]*i[2]+0.257*i[1]-1.38*i[2]-0.019*i[1]*i[3]+2.9*i[3]-0.182*i[1]*i[4]-0.77*i[4]-1.87*i[2]*i[3]-1.79*i[2]*i[4]+1.24*i[3]*i[4]-0.01* (i[1])^2+1.32* (i[2])^2+0.062* (i[3])^2+1.04* (i[4])^2 <= 11.38)
@NLconstraint(m, e60, 0.145*i[1]*i[2]+0.257*i[1]-1.38*i[2]-0.019*i[1]*i[3]+2.9*i[3]-0.182*i[1]*i[4]-0.77*i[4]-1.87*i[2]*i[3]-1.79*i[2]*i[4]+1.24*i[3]*i[4]-0.01* (i[1])^2+1.32* (i[2])^2+0.062* (i[3])^2+1.04* (i[4])^2 <= 11.38)
@NLconstraint(m, e61, 0.145*i[1]*i[2]+0.257*i[1]-1.38*i[2]-0.019*i[1]*i[3]+2.9*i[3]-0.182*i[1]*i[4]-0.77*i[4]-1.87*i[2]*i[3]-1.79*i[2]*i[4]+1.24*i[3]*i[4]-0.01* (i[1])^2+1.32* (i[2])^2+0.062* (i[3])^2+1.04* (i[4])^2 <= 11.38)
@NLconstraint(m, e62, 27.3*i[1]*i[2]+54.9*i[1]-37.2*i[2]-0.55*i[1]*i[3]+441*i[3]-42.2*i[1]*i[4]-497*i[4]-169*i[2]*i[3]-148*i[2]*i[4]+147*i[3]*i[4]-2.05* (i[1])^2+89.4* (i[2])^2-56.6* (i[3])^2+193* (i[4])^2 <= 79.0)
@NLconstraint(m, e63, 27.3*i[1]*i[2]+54.9*i[1]-37.2*i[2]-0.55*i[1]*i[3]+441*i[3]-42.2*i[1]*i[4]-497*i[4]-169*i[2]*i[3]-148*i[2]*i[4]+147*i[3]*i[4]-2.05* (i[1])^2+89.4* (i[2])^2-56.6* (i[3])^2+193* (i[4])^2 <= 79.0)
@NLconstraint(m, e64, 27.3*i[1]*i[2]+54.9*i[1]-37.2*i[2]-0.55*i[1]*i[3]+441*i[3]-42.2*i[1]*i[4]-497*i[4]-169*i[2]*i[3]-148*i[2]*i[4]+147*i[3]*i[4]-2.05* (i[1])^2+89.4* (i[2])^2-56.6* (i[3])^2+193* (i[4])^2 <= 79.0)
@NLconstraint(m, e65, 27.3*i[1]*i[2]+54.9*i[1]-37.2*i[2]-0.55*i[1]*i[3]+441*i[3]-42.2*i[1]*i[4]-497*i[4]-169*i[2]*i[3]-148*i[2]*i[4]+147*i[3]*i[4]-2.05* (i[1])^2+89.4* (i[2])^2-56.6* (i[3])^2+193* (i[4])^2 <= 79.0)
@NLconstraint(m, e66, 27.3*i[1]*i[2]+54.9*i[1]-37.2*i[2]-0.55*i[1]*i[3]+441*i[3]-42.2*i[1]*i[4]-497*i[4]-169*i[2]*i[3]-148*i[2]*i[4]+147*i[3]*i[4]-2.05* (i[1])^2+89.4* (i[2])^2-56.6* (i[3])^2+193* (i[4])^2 <= 79.0)
@NLconstraint(m, e67, 27.3*i[1]*i[2]+54.9*i[1]-37.2*i[2]-0.55*i[1]*i[3]+441*i[3]-42.2*i[1]*i[4]-497*i[4]-169*i[2]*i[3]-148*i[2]*i[4]+147*i[3]*i[4]-2.05* (i[1])^2+89.4* (i[2])^2-56.6* (i[3])^2+193* (i[4])^2 <= 79.0)
@NLconstraint(m, e68, 27.3*i[1]*i[2]+54.9*i[1]-37.2*i[2]-0.55*i[1]*i[3]+441*i[3]-42.2*i[1]*i[4]-497*i[4]-169*i[2]*i[3]-148*i[2]*i[4]+147*i[3]*i[4]-2.05* (i[1])^2+89.4* (i[2])^2-56.6* (i[3])^2+193* (i[4])^2 <= 79.0)
@NLconstraint(m, e69, 27.3*i[1]*i[2]+54.9*i[1]-37.2*i[2]-0.55*i[1]*i[3]+441*i[3]-42.2*i[1]*i[4]-497*i[4]-169*i[2]*i[3]-148*i[2]*i[4]+147*i[3]*i[4]-2.05* (i[1])^2+89.4* (i[2])^2-56.6* (i[3])^2+193* (i[4])^2 <= 79.0)
@NLconstraint(m, e70, 27.3*i[1]*i[2]+54.9*i[1]-37.2*i[2]-0.55*i[1]*i[3]+441*i[3]-42.2*i[1]*i[4]-497*i[4]-169*i[2]*i[3]-148*i[2]*i[4]+147*i[3]*i[4]-2.05* (i[1])^2+89.4* (i[2])^2-56.6* (i[3])^2+193* (i[4])^2 <= 79.0)
@NLconstraint(m, e71, 27.3*i[1]*i[2]+54.9*i[1]-37.2*i[2]-0.55*i[1]*i[3]+441*i[3]-42.2*i[1]*i[4]-497*i[4]-169*i[2]*i[3]-148*i[2]*i[4]+147*i[3]*i[4]-2.05* (i[1])^2+89.4* (i[2])^2-56.6* (i[3])^2+193* (i[4])^2 <= 79.0)
@NLconstraint(m, e72, 27.3*i[1]*i[2]+54.9*i[1]-37.2*i[2]-0.55*i[1]*i[3]+441*i[3]-42.2*i[1]*i[4]-497*i[4]-169*i[2]*i[3]-148*i[2]*i[4]+147*i[3]*i[4]-2.05* (i[1])^2+89.4* (i[2])^2-56.6* (i[3])^2+193* (i[4])^2 <= 79.0)
@NLconstraint(m, e73, 27.3*i[1]*i[2]+54.9*i[1]-37.2*i[2]-0.55*i[1]*i[3]+441*i[3]-42.2*i[1]*i[4]-497*i[4]-169*i[2]*i[3]-148*i[2]*i[4]+147*i[3]*i[4]-2.05* (i[1])^2+89.4* (i[2])^2-56.6* (i[3])^2+193* (i[4])^2 <= 79.0)
@NLconstraint(m, e74, 27.3*i[1]*i[2]+54.9*i[1]-37.2*i[2]-0.55*i[1]*i[3]+441*i[3]-42.2*i[1]*i[4]-497*i[4]-169*i[2]*i[3]-148*i[2]*i[4]+147*i[3]*i[4]-2.05* (i[1])^2+89.4* (i[2])^2-56.6* (i[3])^2+193* (i[4])^2 <= 79.0)
@NLconstraint(m, e75, 27.3*i[1]*i[2]+54.9*i[1]-37.2*i[2]-0.55*i[1]*i[3]+441*i[3]-42.2*i[1]*i[4]-497*i[4]-169*i[2]*i[3]-148*i[2]*i[4]+147*i[3]*i[4]-2.05* (i[1])^2+89.4* (i[2])^2-56.6* (i[3])^2+193* (i[4])^2 <= 79.0)
@NLconstraint(m, e76, 27.3*i[1]*i[2]+54.9*i[1]-37.2*i[2]-0.55*i[1]*i[3]+441*i[3]-42.2*i[1]*i[4]-497*i[4]-169*i[2]*i[3]-148*i[2]*i[4]+147*i[3]*i[4]-2.05* (i[1])^2+89.4* (i[2])^2-56.6* (i[3])^2+193* (i[4])^2 <= 79.0)
...
@NLconstraint(m, e152, 458*i[1]-73.7*i[1]*i[2]-804*i[2]+3.92*i[1]*i[3]-21*i[3]+0.346*i[1]*i[4]-202*i[4]-112*i[2]*i[3]-89.3*i[2]*i[4]-15.1*i[3]*i[4]-4.86* (i[1])^2+212* (i[2])^2+96.2* (i[3])^2+105* (i[4])^2 >= 2246.0)
@NLconstraint(m, e153, 458*i[1]-73.7*i[1]*i[2]-804*i[2]+3.92*i[1]*i[3]-21*i[3]+0.346*i[1]*i[4]-202*i[4]-112*i[2]*i[3]-89.3*i[2]*i[4]-15.1*i[3]*i[4]-4.86* (i[1])^2+212* (i[2])^2+96.2* (i[3])^2+105* (i[4])^2 >= 2246.0)
@NLconstraint(m, e154, 458*i[1]-73.7*i[1]*i[2]-804*i[2]+3.92*i[1]*i[3]-21*i[3]+0.346*i[1]*i[4]-202*i[4]-112*i[2]*i[3]-89.3*i[2]*i[4]-15.1*i[3]*i[4]-4.86* (i[1])^2+212* (i[2])^2+96.2* (i[3])^2+105* (i[4])^2 >= 2246.0)
@NLconstraint(m, e155, 458*i[1]-73.7*i[1]*i[2]-804*i[2]+3.92*i[1]*i[3]-21*i[3]+0.346*i[1]*i[4]-202*i[4]-112*i[2]*i[3]-89.3*i[2]*i[4]-15.1*i[3]*i[4]-4.86* (i[1])^2+212* (i[2])^2+96.2* (i[3])^2+105* (i[4])^2 >= 2246.0)
@NLconstraint(m, e156, 458*i[1]-73.7*i[1]*i[2]-804*i[2]+3.92*i[1]*i[3]-21*i[3]+0.346*i[1]*i[4]-202*i[4]-112*i[2]*i[3]-89.3*i[2]*i[4]-15.1*i[3]*i[4]-4.86* (i[1])^2+212* (i[2])^2+96.2* (i[3])^2+105* (i[4])^2 >= 2246.0)
@NLconstraint(m, e157, 458*i[1]-73.7*i[1]*i[2]-804*i[2]+3.92*i[1]*i[3]-21*i[3]+0.346*i[1]*i[4]-202*i[4]-112*i[2]*i[3]-89.3*i[2]*i[4]-15.1*i[3]*i[4]-4.86* (i[1])^2+212* (i[2])^2+96.2* (i[3])^2+105* (i[4])^2 >= 2246.0)
@NLconstraint(m, e158, 458*i[1]-73.7*i[1]*i[2]-804*i[2]+3.92*i[1]*i[3]-21*i[3]+0.346*i[1]*i[4]-202*i[4]-112*i[2]*i[3]-89.3*i[2]*i[4]-15.1*i[3]*i[4]-4.86* (i[1])^2+212* (i[2])^2+96.2* (i[3])^2+105* (i[4])^2 >= 2246.0)
@NLconstraint(m, e159, 458*i[1]-73.7*i[1]*i[2]-804*i[2]+3.92*i[1]*i[3]-21*i[3]+0.346*i[1]*i[4]-202*i[4]-112*i[2]*i[3]-89.3*i[2]*i[4]-15.1*i[3]*i[4]-4.86* (i[1])^2+212* (i[2])^2+96.2* (i[3])^2+105* (i[4])^2 >= 2246.0)
@NLconstraint(m, e160, 458*i[1]-73.7*i[1]*i[2]-804*i[2]+3.92*i[1]*i[3]-21*i[3]+0.346*i[1]*i[4]-202*i[4]-112*i[2]*i[3]-89.3*i[2]*i[4]-15.1*i[3]*i[4]-4.86* (i[1])^2+212* (i[2])^2+96.2* (i[3])^2+105* (i[4])^2 >= 2246.0)
@NLconstraint(m, e161, 458*i[1]-73.7*i[1]*i[2]-804*i[2]+3.92*i[1]*i[3]-21*i[3]+0.346*i[1]*i[4]-202*i[4]-112*i[2]*i[3]-89.3*i[2]*i[4]-15.1*i[3]*i[4]-4.86* (i[1])^2+212* (i[2])^2+96.2* (i[3])^2+105* (i[4])^2 >= 2246.0)
@NLconstraint(m, e162, 458*i[1]-73.7*i[1]*i[2]-804*i[2]+3.92*i[1]*i[3]-21*i[3]+0.346*i[1]*i[4]-202*i[4]-112*i[2]*i[3]-89.3*i[2]*i[4]-15.1*i[3]*i[4]-4.86* (i[1])^2+212* (i[2])^2+96.2* (i[3])^2+105* (i[4])^2 >= 2246.0)
@NLconstraint(m, e163, 458*i[1]-73.7*i[1]*i[2]-804*i[2]+3.92*i[1]*i[3]-21*i[3]+0.346*i[1]*i[4]-202*i[4]-112*i[2]*i[3]-89.3*i[2]*i[4]-15.1*i[3]*i[4]-4.86* (i[1])^2+212* (i[2])^2+96.2* (i[3])^2+105* (i[4])^2 >= 2246.0)
@NLconstraint(m, e164, 458*i[1]-73.7*i[1]*i[2]-804*i[2]+3.92*i[1]*i[3]-21*i[3]+0.346*i[1]*i[4]-202*i[4]-112*i[2]*i[3]-89.3*i[2]*i[4]-15.1*i[3]*i[4]-4.86* (i[1])^2+212* (i[2])^2+96.2* (i[3])^2+105* (i[4])^2 >= 2246.0)
@NLconstraint(m, e165, 458*i[1]-73.7*i[1]*i[2]-804*i[2]+3.92*i[1]*i[3]-21*i[3]+0.346*i[1]*i[4]-202*i[4]-112*i[2]*i[3]-89.3*i[2]*i[4]-15.1*i[3]*i[4]-4.86* (i[1])^2+212* (i[2])^2+96.2* (i[3])^2+105* (i[4])^2 >= 2246.0)
@NLconstraint(m, e166, 458*i[1]-73.7*i[1]*i[2]-804*i[2]+3.92*i[1]*i[3]-21*i[3]+0.346*i[1]*i[4]-202*i[4]-112*i[2]*i[3]-89.3*i[2]*i[4]-15.1*i[3]*i[4]-4.86* (i[1])^2+212* (i[2])^2+96.2* (i[3])^2+105* (i[4])^2 >= 2246.0)
