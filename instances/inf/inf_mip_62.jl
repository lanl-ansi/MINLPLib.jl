...
set_upper_bound(x[108], 6.6487162344088)
set_upper_bound(x[109], 6.7534359896088)
set_upper_bound(x[110], 6.6487162344088)
set_upper_bound(x[111], 6.7534359896088)
set_upper_bound(x[112], 6.6487162344088)
set_upper_bound(x[113], 6.7534359896088)
set_upper_bound(x[114], 6.7534359896088)
set_upper_bound(x[115], 6.6487162344088)
set_upper_bound(x[116], 6.7534359896088)
set_upper_bound(x[117], 6.6487162344088)
set_upper_bound(x[118], 6.7534359896088)
set_upper_bound(x[119], 6.6487162344088)
set_upper_bound(x[120], 6.33313111201019)
set_upper_bound(x[121], 6.86196587577019)
set_upper_bound(x[122], 6.33313111201019)
set_upper_bound(x[123], 6.86196587577019)
set_upper_bound(x[124], 6.33313111201019)
set_upper_bound(x[125], 6.86196587577019)
set_upper_bound(x[126], 6.33313111201019)
set_upper_bound(x[127], 6.86196587577019)
set_upper_bound(x[128], 6.33313111201019)
set_upper_bound(x[129], 6.86196587577019)
set_upper_bound(x[130], 6.33313111201019)
set_upper_bound(x[131], 6.86196587577019)
...
@constraint(m, e50, x[48]-1.21*x[57]-6.3355451896*b[60]-x[108] == -6.3355451896)
@constraint(m, e51, x[48]-0.261799388*x[51]-1.21*x[57]-6.3355451896*b[61]-x[109] == -6.65232244908)
@constraint(m, e52, x[49]-1.21*x[58]-6.3355451896*b[62]-x[110] == -6.3355451896)
@constraint(m, e53, x[49]-0.261799388*x[52]-1.21*x[58]-6.3355451896*b[63]-x[111] == -6.65232244908)
@constraint(m, e54, x[50]-1.21*x[59]-6.3355451896*b[64]-x[112] == -6.3355451896)
@constraint(m, e55, x[50]-0.261799388*x[53]-1.21*x[59]-6.3355451896*b[65]-x[113] == -6.65232244908)
@constraint(m, e56, x[48]+0.261799388*x[51]-0.81*x[57]-6.3355451896*b[60]-x[114] == -6.12348768532)
@constraint(m, e57, x[48]-0.81*x[57]-6.3355451896*b[61]-x[115] == -6.3355451896)
@constraint(m, e58, x[49]+0.261799388*x[52]-0.81*x[58]-6.3355451896*b[62]-x[116] == -6.12348768532)
@constraint(m, e59, x[49]-0.81*x[58]-6.3355451896*b[63]-x[117] == -6.3355451896)
@constraint(m, e60, x[50]+0.261799388*x[53]-0.81*x[59]-6.3355451896*b[64]-x[118] == -6.12348768532)
@constraint(m, e61, x[50]-0.81*x[59]-6.3355451896*b[65]-x[119] == -6.3355451896)
@constraint(m, e62, x[48]-0.81*x[57]+6.3355451896*b[60]+x[120] == 6.3355451896)
@constraint(m, e63, x[48]-0.261799388*x[51]-0.81*x[57]+6.3355451896*b[61]+x[121] == 6.12348768532)
@constraint(m, e64, x[49]-0.81*x[58]+6.3355451896*b[62]+x[122] == 6.3355451896)
@constraint(m, e65, x[49]-0.261799388*x[52]-0.81*x[58]+6.3355451896*b[63]+x[123] == 6.12348768532)
@constraint(m, e66, x[50]-0.81*x[59]+6.3355451896*b[64]+x[124] == 6.3355451896)
@constraint(m, e67, x[50]-0.261799388*x[53]-0.81*x[59]+6.3355451896*b[65]+x[125] == 6.12348768532)
@constraint(m, e68, x[48]+0.261799388*x[51]-1.21*x[57]+6.3355451896*b[60]+x[126] == 6.65232244908)
@constraint(m, e69, x[48]-1.21*x[57]+6.3355451896*b[61]+x[127] == 6.3355451896)
@constraint(m, e70, x[49]+0.261799388*x[52]-1.21*x[58]+6.3355451896*b[62]+x[128] == 6.65232244908)
@constraint(m, e71, x[49]-1.21*x[58]+6.3355451896*b[63]+x[129] == 6.3355451896)
@constraint(m, e72, x[50]+0.261799388*x[53]-1.21*x[59]+6.3355451896*b[64]+x[130] == 6.65232244908)
@constraint(m, e73, x[50]-1.21*x[59]+6.3355451896*b[65]+x[131] == 6.3355451896)
