...
@constraint(m, e2, x[5] == 5.0)
@constraint(m, e3, x[2] >= 1.0)
@constraint(m, e4, x[3] >= 1.0)
@constraint(m, e5, x[4] >= 1.0)
@constraint(m, e6, x[5] >= 1.0)
@constraint(m, e7, x[1] <= 5.0)
@constraint(m, e8, x[2] <= 5.0)
@constraint(m, e9, x[3] <= 5.0)
@constraint(m, e10, x[4] <= 5.0)
@constraint(m, e11, 0.25*x[2] >= 0.25)
@constraint(m, e12, 0.25*x[3] >= 0.25)
@constraint(m, e13, 0.25*x[4] >= 0.25)
@constraint(m, e14, 0.25*x[5] >= 0.25)
@constraint(m, e15, 0.25*x[1] <= 1.25)
@constraint(m, e16, 0.25*x[2] <= 1.25)
@constraint(m, e17, 0.25*x[3] <= 1.25)
@constraint(m, e18, 0.25*x[4] <= 1.25)
@constraint(m, e19, -0.25*x[1]+0.25*x[2] >= 1.00000008274037e-10)
@constraint(m, e20, -0.25*x[2]+0.25*x[3] >= 1.00000008274037e-10)
@constraint(m, e21, -0.25*x[3]+0.25*x[4] >= 1.00000008274037e-10)
@constraint(m, e22, -0.25*x[4]+0.25*x[5] >= 1.00000008274037e-10)
