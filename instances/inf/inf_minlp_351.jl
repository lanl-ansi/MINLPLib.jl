...
# ----- Constraints ----- #
@NLconstraint(m, e1, -(x[1]-x[46]*(x[1]+x[2]+x[3])+x[2]+x[3])+x[69] == 0.0)
...
@constraint(m, e75, -b[47]+b[54] <= 0.0)
@constraint(m, e76, -b[48]+b[55] <= 0.0)
@constraint(m, e77, -b[49]+b[56] <= 0.0)
@constraint(m, e78, -b[47]+b[53] <= 0.0)
@constraint(m, e79, -b[48]+b[53] <= 0.0)
@constraint(m, e80, -b[49]+b[53] <= 0.0)
@constraint(m, e81, b[47]+b[57]+b[58]+b[59] >= 1.0)
@constraint(m, e82, b[48]+b[60]+b[61]+b[62] >= 1.0)
@constraint(m, e83, b[49]+b[63]+b[64]+b[65] >= 1.0)
@constraint(m, e84, -b[50]+b[66] >= 0.0)
@constraint(m, e85, -b[51]+b[67] >= 0.0)
@constraint(m, e86, -b[52]+b[68] >= 0.0)
