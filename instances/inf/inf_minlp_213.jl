...
@constraint(m, e170, x[3]+6.7575*b[32]+4.135*b[39]-4.135*b[46]+4.135*b[53] <= 9.02)
@constraint(m, e171, x[4]+5.6*b[33]+3.75*b[40]-3.75*b[47]+3.75*b[54] <= 9.05)
@constraint(m, e172, x[5]+7.765*b[34]+4.54*b[41]-4.54*b[48]+4.54*b[55] <= 9.34)
@constraint(m, e173, x[6]+5.35*b[35]+1.7*b[42]-1.7*b[49]+1.7*b[56] <= 8.8)
@constraint(m, e174, x[7]+7.45*b[36]+4.01*b[43]-4.01*b[50]+4.01*b[57] <= 8.9)
...
@NLconstraint(m, e185, x[22]*b[30]+x[24]*(b[37]-b[44]+b[51])+x[26]*(1-b[30]-b[37]+b[44]-b[51])+x[1] <= 9.7)
@NLconstraint(m, e186, x[23]*b[31]+x[25]*(b[38]-b[45]+b[52])+x[27]*(1-b[31]-b[38]+b[45]-b[52])+x[2] <= 9.7)
...
@NLconstraint(m, e247, -x[22]*x[24]*x[26] == -10.0)
@NLconstraint(m, e248, -x[23]*x[25]*x[27] == -12.0)
@constraint(m, e249, x[22] <= 5.5)
@constraint(m, e250, x[23] <= 9.0)
@constraint(m, e251, x[22] >= 4.125)
@constraint(m, e252, x[23] >= 6.0)
@constraint(m, e253, x[24] <= 2.375)
@constraint(m, e254, x[25] <= 4.5)
@constraint(m, e255, x[24] >= 2.125)
@constraint(m, e256, x[25] >= 4.5)
@constraint(m, e257, x[26] <= 0.375)
@constraint(m, e258, x[27] <= 0.75)
@constraint(m, e259, x[26] >= 0.375)
@constraint(m, e260, x[27] >= 0.75)
