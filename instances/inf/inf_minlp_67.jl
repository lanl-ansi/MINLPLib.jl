...
@constraint(m, e226, x[4]-x[34]+5.55*b[39]+4.55*b[47]-4.55*b[55]+4.55*b[63] <= -1.2)
@constraint(m, e227, x[5]-x[34]+4.9*b[40]+4.8*b[48]-4.8*b[56]+4.8*b[64] <= -1.0)
@constraint(m, e228, x[6]-x[34]+5.6*b[41]+3.75*b[49]-3.75*b[57]+3.75*b[65] <= -0.65)
@constraint(m, e229, x[7]-x[34]+5.25*b[42]+5.05*b[50]-5.05*b[58]+5.05*b[66] <= -0.55)
@constraint(m, e230, x[8]-x[34]+5.25*b[43]+5.2*b[51]-5.2*b[59]+5.2*b[67] <= -0.6)
...
@constraint(m, e236, x[20]+b[47]-4.55*b[63] <= -2.71)
@constraint(m, e237, x[21]+0.100000000000001*b[48]-4.8*b[64] <= -2.76)
@constraint(m, e238, x[22]+1.85*b[49]-3.75*b[65] <= -1.36)
@constraint(m, e239, x[23]+0.2*b[50]-5.05*b[66] <= -2.56)
@constraint(m, e240, x[24]+0.0499999999999998*b[51]-5.2*b[67] <= -2.76)
...
@constraint(m, e315, x[25]-190*b[252] >= -187.625)
@constraint(m, e316, x[25]-190*b[253] >= -182.0)
@constraint(m, e317, x[26]-190*b[254] >= -183.0)
@constraint(m, e318, x[26]-190*b[255] >= -185.75)
@constraint(m, e319, x[26]-190*b[256] >= -182.9)
@constraint(m, e320, x[27]-190*b[257] >= -185.0)
@constraint(m, e321, x[27]-190*b[258] >= -187.4)
@constraint(m, e322, x[27]-190*b[259] >= -186.875)
@constraint(m, e323, x[25]+190*b[251] <= 195.0)
@constraint(m, e324, x[25]+190*b[252] <= 192.375)
@constraint(m, e325, x[25]+190*b[253] <= 198.0)
@constraint(m, e326, x[26]+190*b[254] <= 197.0)
@constraint(m, e327, x[26]+190*b[255] <= 194.25)
@constraint(m, e328, x[26]+190*b[256] <= 197.1)
@constraint(m, e329, x[27]+190*b[257] <= 195.0)
@constraint(m, e330, x[27]+190*b[258] <= 192.6)
@constraint(m, e331, x[27]+190*b[259] <= 193.125)
@constraint(m, e332, x[28]-190*b[251] >= -185.875)
@constraint(m, e333, x[28]-190*b[252] >= -185.75)
@constraint(m, e334, x[28]-190*b[253] >= -184.4)
@constraint(m, e335, x[29]-190*b[254] >= -184.375)
@constraint(m, e336, x[29]-190*b[255] >= -184.5)
@constraint(m, e337, x[29]-190*b[256] >= -184.475)
@constraint(m, e338, x[30]-190*b[257] >= -187.5)
@constraint(m, e339, x[30]-190*b[258] >= -187.65)
@constraint(m, e340, x[30]-190*b[259] >= -188.3)
@constraint(m, e341, x[28]+190*b[251] <= 194.125)
@constraint(m, e342, x[28]+190*b[252] <= 194.25)
@constraint(m, e343, x[28]+190*b[253] <= 195.6)
@constraint(m, e344, x[29]+190*b[254] <= 195.625)
@constraint(m, e345, x[29]+190*b[255] <= 195.5)
@constraint(m, e346, x[29]+190*b[256] <= 195.525)
@constraint(m, e347, x[30]+190*b[257] <= 192.5)
@constraint(m, e348, x[30]+190*b[258] <= 192.35)
@constraint(m, e349, x[30]+190*b[259] <= 191.7)
@constraint(m, e350, x[31]-190*b[251] >= -189.75)
@constraint(m, e351, x[31]-190*b[252] >= -189.625)
@constraint(m, e352, x[31]-190*b[253] >= -188.9)
@constraint(m, e353, x[32]-190*b[254] >= -189.5)
@constraint(m, e354, x[32]-190*b[255] >= -189.0)
@constraint(m, e355, x[32]-190*b[256] >= -189.5)
@constraint(m, e356, x[33]-190*b[257] >= -189.35)
@constraint(m, e357, x[33]-190*b[258] >= -188.875)
@constraint(m, e358, x[33]-190*b[259] >= -188.875)
@constraint(m, e359, x[31]+190*b[251] <= 190.25)
@constraint(m, e360, x[31]+190*b[252] <= 190.375)
@constraint(m, e361, x[31]+190*b[253] <= 191.1)
@constraint(m, e362, x[32]+190*b[254] <= 190.5)
@constraint(m, e363, x[32]+190*b[255] <= 191.0)
@constraint(m, e364, x[32]+190*b[256] <= 190.5)
