...
@constraint(m, e70, x[1]-x[2]-2491490000000*x[7] == 0.0)
@constraint(m, e71, -x[1]+x[2]-2491490000000*x[8] == 0.0)
@constraint(m, e72, x[2]-x[3]-2491490000000*x[9] == 0.0)
@constraint(m, e73, x[2]-x[4]-2491490000000*x[10] == 0.0)
@constraint(m, e74, -x[2]+x[3]-2491490000000*x[11] == 0.0)
@constraint(m, e75, x[3]-x[5]-2491490000000*x[12] == 0.0)
@constraint(m, e76, -x[2]+x[4]-2491490000000*x[13] == 0.0)
@constraint(m, e77, -x[3]+x[5]-2491490000000*x[14] == 0.0)
@constraint(m, e78, x[5]-x[6]-2491490000000*x[15] == 0.0)
@constraint(m, e79, -x[5]+x[6]-2491490000000*x[16] == 0.0)
