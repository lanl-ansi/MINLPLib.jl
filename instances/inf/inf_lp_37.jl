...
setlowerbound(x[1], 147.45)
setupperbound(x[1], 161.0)
setlowerbound(x[2], 266.89)
setupperbound(x[2], 301.04)
setlowerbound(x[3], 140.25)
setupperbound(x[3], 179.09)
setlowerbound(x[4], 218.34)
setupperbound(x[4], 249.34)
setlowerbound(x[5], 179.28)
setupperbound(x[5], 217.04)
setlowerbound(x[6], 188.6)
setupperbound(x[6], 224.67)
setlowerbound(x[7], 253.73)
setupperbound(x[7], 350.0)
setlowerbound(x[8], 174.42)
setupperbound(x[8], 202.74)
setlowerbound(x[9], 224.51)
setupperbound(x[9], 260.41)
setlowerbound(x[10], 206.09)
setupperbound(x[10], 239.93)
setlowerbound(x[11], 179.62)
setupperbound(x[11], 216.99)
setlowerbound(x[12], 233.92)
setupperbound(x[12], 350.0)
setlowerbound(x[13], 231.25)
setupperbound(x[13], 261.83)
setlowerbound(x[14], 218.19)
setupperbound(x[14], 254.86)
setlowerbound(x[15], 202.3)
setupperbound(x[15], 350.0)
setlowerbound(x[16], 283.14)
setupperbound(x[16], 316.61)
setlowerbound(x[17], 182.99)
setupperbound(x[17], 217.79)
setlowerbound(x[18], 217.45)
setupperbound(x[18], 252.66)
setlowerbound(x[19], 223.59)
setupperbound(x[19], 350.0)
setlowerbound(x[20], 203.09)
setupperbound(x[20], 237.85)
setlowerbound(x[21], 179.32)
setupperbound(x[21], 215.05)
setlowerbound(x[22], 237.23)
setupperbound(x[22], 350.0)
setlowerbound(x[23], 205.93)
setupperbound(x[23], 240.63)
setlowerbound(x[24], 182.02)
setupperbound(x[24], 210.48)
setlowerbound(x[25], 176.77)
setupperbound(x[25], 205.54)
setlowerbound(x[26], 205.51)
setupperbound(x[26], 240.44)
setlowerbound(x[27], 229.99)
setupperbound(x[27], 267.19)
setlowerbound(x[28], 239.41)
setupperbound(x[28], 350.0)
setlowerbound(x[29], 234.72)
setupperbound(x[29], 350.0)
setlowerbound(x[30], 241.86)
setupperbound(x[30], 273.64)
setlowerbound(x[31], 212.03)
setupperbound(x[31], 246.17)
setlowerbound(x[32], 215.76)
setupperbound(x[32], 221.3)
setlowerbound(x[33], 200.0)
setupperbound(x[33], 234.71)
setlowerbound(x[34], 179.82)
setupperbound(x[34], 216.92)
setlowerbound(x[35], 166.58)
setupperbound(x[35], 201.77)
setlowerbound(x[36], 157.75)
setupperbound(x[36], 185.73)
setlowerbound(x[37], 172.41)
setupperbound(x[37], 199.69)
setlowerbound(x[38], 176.28)
setupperbound(x[38], 211.4)
setlowerbound(x[39], 160.85)
setupperbound(x[39], 196.49)
setlowerbound(x[40], 183.55)
setupperbound(x[40], 216.3)
setlowerbound(x[41], 122.65)
setupperbound(x[41], 147.45)
setlowerbound(x[42], 235.57)
setupperbound(x[42], 266.89)
setlowerbound(x[43], 113.86)
setupperbound(x[43], 140.25)
setlowerbound(x[44], 191.02)
setupperbound(x[44], 218.34)
setlowerbound(x[45], 179.28)
setupperbound(x[45], 217.04)
setlowerbound(x[46], 159.25)
setupperbound(x[46], 188.6)
setlowerbound(x[47], 222.05)
setupperbound(x[47], 253.73)
setlowerbound(x[48], 50.0)
setupperbound(x[48], 174.42)
setlowerbound(x[49], 194.58)
setupperbound(x[49], 224.51)
setlowerbound(x[50], 206.09)
setupperbound(x[50], 239.93)
setlowerbound(x[51], 179.62)
setupperbound(x[51], 216.99)
setlowerbound(x[52], 202.79)
setupperbound(x[52], 233.92)
setlowerbound(x[53], 214.25)
setupperbound(x[53], 231.25)
setlowerbound(x[54], 50.0)
setupperbound(x[54], 188.7)
setlowerbound(x[55], 164.37)
setupperbound(x[55], 202.3)
setlowerbound(x[56], 260.36)
setupperbound(x[56], 283.14)
setlowerbound(x[57], 154.82)
setupperbound(x[57], 182.99)
setlowerbound(x[58], 188.98)
setupperbound(x[58], 217.45)
setlowerbound(x[59], 187.26)
setupperbound(x[59], 223.59)
setlowerbound(x[60], 203.09)
setupperbound(x[60], 237.85)
setlowerbound(x[61], 150.84)
setupperbound(x[61], 179.32)
setlowerbound(x[62], 201.56)
setupperbound(x[62], 237.23)
setlowerbound(x[63], 177.17)
setupperbound(x[63], 205.93)
setlowerbound(x[64], 50.0)
setupperbound(x[64], 182.02)
setlowerbound(x[65], 176.77)
setupperbound(x[65], 205.54)
setlowerbound(x[66], 179.85)
setupperbound(x[66], 205.51)
setlowerbound(x[67], 50.0)
setupperbound(x[67], 199.39)
setlowerbound(x[68], 206.24)
setupperbound(x[68], 239.41)
setlowerbound(x[69], 234.72)
setupperbound(x[69], 350.0)
setlowerbound(x[70], 241.86)
setupperbound(x[70], 273.64)
setlowerbound(x[71], 182.33)
setupperbound(x[71], 212.03)
setlowerbound(x[72], 215.76)
setupperbound(x[72], 221.3)
setlowerbound(x[73], 171.27)
setupperbound(x[73], 200.0)
setlowerbound(x[74], 150.83)
setupperbound(x[74], 179.82)
setlowerbound(x[75], 137.93)
setupperbound(x[75], 166.58)
setlowerbound(x[76], 50.0)
setupperbound(x[76], 157.75)
setlowerbound(x[77], 172.41)
setupperbound(x[77], 199.69)
setlowerbound(x[78], 146.45)
setupperbound(x[78], 176.28)
setlowerbound(x[79], 132.4)
setupperbound(x[79], 160.85)
setlowerbound(x[80], 154.89)
setupperbound(x[80], 183.55)
setlowerbound(x[81], 122.65)
setupperbound(x[81], 147.45)
setlowerbound(x[82], 50.0)
setupperbound(x[82], 266.89)
setlowerbound(x[83], 113.86)
setupperbound(x[83], 140.25)
setlowerbound(x[84], 191.02)
setupperbound(x[84], 218.34)
setlowerbound(x[85], 147.71)
setupperbound(x[85], 179.28)
setlowerbound(x[86], 50.0)
setupperbound(x[86], 188.6)
setlowerbound(x[87], 222.05)
setupperbound(x[87], 253.73)
setlowerbound(x[88], 50.0)
setupperbound(x[88], 174.42)
setlowerbound(x[89], 194.58)
setupperbound(x[89], 224.51)
setlowerbound(x[90], 177.68)
setupperbound(x[90], 206.09)
setlowerbound(x[91], 149.4)
setupperbound(x[91], 179.62)
setlowerbound(x[92], 202.79)
setupperbound(x[92], 233.92)
setlowerbound(x[93], 50.0)
setupperbound(x[93], 231.25)
setlowerbound(x[94], 50.0)
setupperbound(x[94], 188.7)
setlowerbound(x[95], 134.79)
setupperbound(x[95], 164.37)
setlowerbound(x[96], 260.36)
setupperbound(x[96], 283.14)
setlowerbound(x[97], 154.82)
setupperbound(x[97], 182.99)
setlowerbound(x[98], 50.0)
setupperbound(x[98], 217.45)
setlowerbound(x[99], 157.78)
setupperbound(x[99], 187.26)
setlowerbound(x[100], 203.09)
setupperbound(x[100], 237.85)
setlowerbound(x[101], 150.84)
setupperbound(x[101], 179.32)
setlowerbound(x[102], 172.72)
setupperbound(x[102], 201.56)
setlowerbound(x[103], 50.0)
setupperbound(x[103], 205.93)
setlowerbound(x[104], 50.0)
setupperbound(x[104], 182.02)
setlowerbound(x[105], 50.0)
setupperbound(x[105], 205.54)
setlowerbound(x[106], 179.85)
setupperbound(x[106], 205.51)
setlowerbound(x[107], 50.0)
setupperbound(x[107], 199.39)
setlowerbound(x[108], 178.3)
setupperbound(x[108], 206.24)
setlowerbound(x[109], 198.55)
setupperbound(x[109], 234.72)
setlowerbound(x[110], 214.2)
setupperbound(x[110], 241.86)
setlowerbound(x[111], 50.0)
setupperbound(x[111], 212.03)
setlowerbound(x[112], 50.0)
setupperbound(x[112], 221.3)
setlowerbound(x[113], 171.27)
setupperbound(x[113], 200.0)
setlowerbound(x[114], 150.83)
setupperbound(x[114], 179.82)
setlowerbound(x[115], 50.0)
setupperbound(x[115], 166.58)
setlowerbound(x[116], 50.0)
setupperbound(x[116], 157.75)
setlowerbound(x[117], 50.0)
setupperbound(x[117], 199.69)
setlowerbound(x[118], 146.45)
setupperbound(x[118], 176.28)
setlowerbound(x[119], 132.4)
setupperbound(x[119], 160.85)
setlowerbound(x[120], 154.89)
setupperbound(x[120], 183.55)
