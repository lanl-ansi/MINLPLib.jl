...
@NLconstraint(m, e9, 4*i[1]*i[2]-712*i[1]-9*i[2]-6*i[1]*i[3]-11*i[1]*i[4]+437*i[4]-162*i[2]*i[3]+171*i[2]*i[4]-3*i[3]*i[4]+24* (i[1])^2+4* (i[2])^2+140* (i[3])^2-187* (i[4])^2 <= -4697.0)
...
@NLconstraint(m, e11, 15*i[1]*i[2]-3460*i[1]+236*i[2]+11*i[1]*i[3]-12*i[1]*i[4]+744*i[4]+174*i[2]*i[3]-274*i[2]*i[4]+61*i[3]*i[4]+112* (i[1])^2- (i[2])^2-215* (i[3])^2+47* (i[4])^2 <= -25278.0)
