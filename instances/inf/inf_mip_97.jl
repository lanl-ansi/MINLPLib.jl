...
setupperbound(x[75], 12.54)
setlowerbound(x[76], -0.4)
setupperbound(x[76], 12.54)
setlowerbound(x[77], -0.4)
setupperbound(x[77], 12.54)
setlowerbound(x[78], -0.36)
setupperbound(x[78], 12.5)
setlowerbound(x[79], -0.36)
setupperbound(x[79], 12.5)
setlowerbound(x[80], -0.36)
setupperbound(x[80], 12.5)
setlowerbound(x[81], -12.5)
setupperbound(x[81], 0.4)
setlowerbound(x[82], -12.5)
setupperbound(x[82], 0.4)
setlowerbound(x[83], -12.5)
setupperbound(x[83], 0.4)
setlowerbound(x[84], -12.5)
setupperbound(x[84], 0.4)
setlowerbound(x[85], -12.5)
setupperbound(x[85], 0.4)
setlowerbound(x[86], -12.5)
setupperbound(x[86], 0.4)
setlowerbound(x[87], -0.42760008094)
setupperbound(x[87], 12.5412297502531)
setlowerbound(x[88], -0.265490819276142)
setupperbound(x[88], 12.8008109567133)
setlowerbound(x[89], -0.42760008094)
setupperbound(x[89], 12.5412297502531)
setlowerbound(x[90], -0.265490819276142)
setupperbound(x[90], 12.8008109567133)
setlowerbound(x[91], -0.42760008094)
setupperbound(x[91], 12.5412297502531)
setlowerbound(x[92], -0.265490819276142)
setupperbound(x[92], 12.8008109567133)
setlowerbound(x[93], -0.413970411434834)
setupperbound(x[93], 12.527600080748)
setlowerbound(x[94], -0.201923370146898)
setupperbound(x[94], 12.737243507584)
setlowerbound(x[95], -0.413970411434834)
setupperbound(x[95], 12.527600080748)
setlowerbound(x[96], -0.201923370146898)
setupperbound(x[96], 12.737243507584)
setlowerbound(x[97], -0.413970411434834)
setupperbound(x[97], 12.527600080748)
setlowerbound(x[98], -0.201923370146898)
setupperbound(x[98], 12.737243507584)
setlowerbound(x[99], -0.427600080747962)
setupperbound(x[99], 12.52760008094)
setlowerbound(x[100], -0.637243507584012)
setupperbound(x[100], 12.3654908192761)
setlowerbound(x[101], -0.427600080747962)
setupperbound(x[101], 12.52760008094)
setlowerbound(x[102], -0.637243507584012)
setupperbound(x[102], 12.3654908192761)
setlowerbound(x[103], -0.427600080747962)
setupperbound(x[103], 12.52760008094)
setlowerbound(x[104], -0.637243507584012)
setupperbound(x[104], 12.3654908192761)
setlowerbound(x[105], -0.427600080747962)
setupperbound(x[105], 12.52760008094)
setlowerbound(x[106], -0.637243507584012)
setupperbound(x[106], 12.3654908192761)
setlowerbound(x[107], -0.427600080747962)
setupperbound(x[107], 12.52760008094)
setlowerbound(x[108], -0.637243507584012)
setupperbound(x[108], 12.3654908192761)
setlowerbound(x[109], -0.427600080747962)
setupperbound(x[109], 12.52760008094)
setlowerbound(x[110], -0.637243507584012)
setupperbound(x[110], 12.3654908192761)
setlowerbound(x[111], 0.107133832789813)
setupperbound(x[111], 3.4809436396088)
setlowerbound(x[112], -1.15997520513019)
setupperbound(x[112], 3.1615483862488)
setlowerbound(x[113], 0.107133832789813)
setupperbound(x[113], 3.4809436396088)
setlowerbound(x[114], -1.15997520513019)
setupperbound(x[114], 3.1615483862488)
setlowerbound(x[115], 0.107133832789813)
setupperbound(x[115], 3.4809436396088)
setlowerbound(x[116], -1.15997520513019)
setupperbound(x[116], 3.1615483862488)
setlowerbound(x[117], 0.00241407758981271)
setupperbound(x[117], 3.5856633948088)
setlowerbound(x[118], -1.05525544993019)
setupperbound(x[118], 3.0568286310488)
setlowerbound(x[119], 0.00241407758981271)
setupperbound(x[119], 3.5856633948088)
setlowerbound(x[120], -1.05525544993019)
setupperbound(x[120], 3.0568286310488)
setlowerbound(x[121], 0.00241407758981271)
setupperbound(x[121], 3.5856633948088)
setlowerbound(x[122], -1.05525544993019)
setupperbound(x[122], 3.0568286310488)
setlowerbound(x[123], -0.313171044808798)
setupperbound(x[123], 3.16535851721019)
setlowerbound(x[124], 0.110943963751202)
setupperbound(x[124], 4.32774779993019)
setlowerbound(x[125], -0.313171044808798)
setupperbound(x[125], 3.16535851721019)
setlowerbound(x[126], 0.110943963751202)
setupperbound(x[126], 4.32774779993019)
setlowerbound(x[127], -0.313171044808798)
setupperbound(x[127], 3.16535851721019)
setlowerbound(x[128], 0.110943963751202)
setupperbound(x[128], 4.32774779993019)
setlowerbound(x[129], -0.313171044808798)
setupperbound(x[129], 3.16535851721019)
setlowerbound(x[130], 0.110943963751202)
setupperbound(x[130], 4.32774779993019)
setlowerbound(x[131], -0.313171044808798)
setupperbound(x[131], 3.16535851721019)
setlowerbound(x[132], 0.110943963751202)
setupperbound(x[132], 4.32774779993019)
setlowerbound(x[133], -0.313171044808798)
setupperbound(x[133], 3.16535851721019)
setlowerbound(x[134], 0.110943963751202)
setupperbound(x[134], 4.32774779993019)
