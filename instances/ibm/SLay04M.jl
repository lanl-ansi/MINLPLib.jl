...
# ----- Constraints ----- #
@constraint(m, e1, -(150*( ((-4)+x[1])^2+ ((-10)+x[5])^2)+390*( ((-10)+x[2])^2+ ((-15)+x[6])^2)+240*( ((-7)+x[3])^2+ ((-9)+x[7])^2)+70*( ((-3)+x[4])^2+ ((-3)+x[8])^2))-300*x[33]-240*x[34]-210*x[35]-100*x[36]-150*x[37]-120*x[38]-300*x[39]-240*x[40]-210*x[41]-100*x[42]-150*x[43]-120*x[44]+x[45] == 0.0)
