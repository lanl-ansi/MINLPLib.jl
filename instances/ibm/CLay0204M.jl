...
@constraint(m, e56,  ((-17.5)+x[1])^2+ ((-7)+x[5])^2+7964*b[33] <= 8000.0)
@constraint(m, e57,  ((-18.5)+x[2])^2+ ((-7.5)+x[6])^2+7808*b[34] <= 7844.0)
@constraint(m, e58,  ((-16.5)+x[3])^2+ ((-8.5)+x[7])^2+8128*b[35] <= 8164.0)
@constraint(m, e59,  ((-16)+x[4])^2+ ((-8.5)+x[8])^2+8213*b[36] <= 8249.0)
@constraint(m, e60,  ((-52.5)+x[1])^2+ ((-77)+x[5])^2+6481*b[37] <= 6581.0)
@constraint(m, e61,  ((-53.5)+x[2])^2+ ((-77.5)+x[6])^2+6622*b[38] <= 6722.0)
@constraint(m, e62,  ((-51.5)+x[3])^2+ ((-78.5)+x[7])^2+6951.25*b[39] <= 7051.25)
@constraint(m, e63,  ((-51)+x[4])^2+ ((-78.5)+x[8])^2+6910*b[40] <= 7010.0)
@constraint(m, e64,  ((-17.5)+x[1])^2+ ((-13)+x[5])^2+7040*b[33] <= 7076.0)
@constraint(m, e65,  ((-18.5)+x[2])^2+ ((-12.5)+x[6])^2+7033*b[34] <= 7069.0)
@constraint(m, e66,  ((-16.5)+x[3])^2+ ((-11.5)+x[7])^2+7657*b[35] <= 7693.0)
@constraint(m, e67,  ((-16)+x[4])^2+ ((-11.5)+x[8])^2+7742*b[36] <= 7778.0)
@constraint(m, e68,  ((-52.5)+x[1])^2+ ((-83)+x[5])^2+7357*b[37] <= 7457.0)
@constraint(m, e69,  ((-53.5)+x[2])^2+ ((-82.5)+x[6])^2+7357*b[38] <= 7457.0)
@constraint(m, e70,  ((-51.5)+x[3])^2+ ((-81.5)+x[7])^2+7398.25*b[39] <= 7498.25)
@constraint(m, e71,  ((-51)+x[4])^2+ ((-81.5)+x[8])^2+7357*b[40] <= 7457.0)
@constraint(m, e72,  ((-12.5)+x[1])^2+ ((-7)+x[5])^2+8389*b[33] <= 8425.0)
@constraint(m, e73,  ((-11.5)+x[2])^2+ ((-7.5)+x[6])^2+8389*b[34] <= 8425.0)
@constraint(m, e74,  ((-13.5)+x[3])^2+ ((-8.5)+x[7])^2+8389*b[35] <= 8425.0)
@constraint(m, e75,  ((-14)+x[4])^2+ ((-8.5)+x[8])^2+8389*b[36] <= 8425.0)
@constraint(m, e76,  ((-47.5)+x[1])^2+ ((-77)+x[5])^2+6096*b[37] <= 6196.0)
@constraint(m, e77,  ((-46.5)+x[2])^2+ ((-77.5)+x[6])^2+6097*b[38] <= 6197.0)
@constraint(m, e78,  ((-48.5)+x[3])^2+ ((-78.5)+x[7])^2+6711.25*b[39] <= 6811.25)
@constraint(m, e79,  ((-49)+x[4])^2+ ((-78.5)+x[8])^2+6750*b[40] <= 6850.0)
@constraint(m, e80,  ((-12.5)+x[1])^2+ ((-13)+x[5])^2+7465*b[33] <= 7501.0)
@constraint(m, e81,  ((-11.5)+x[2])^2+ ((-12.5)+x[6])^2+7614*b[34] <= 7650.0)
@constraint(m, e82,  ((-13.5)+x[3])^2+ ((-11.5)+x[7])^2+7918*b[35] <= 7954.0)
@constraint(m, e83,  ((-14)+x[4])^2+ ((-11.5)+x[8])^2+7918*b[36] <= 7954.0)
@constraint(m, e84,  ((-47.5)+x[1])^2+ ((-83)+x[5])^2+6972*b[37] <= 7072.0)
@constraint(m, e85,  ((-46.5)+x[2])^2+ ((-82.5)+x[6])^2+6832*b[38] <= 6932.0)
@constraint(m, e86,  ((-48.5)+x[3])^2+ ((-81.5)+x[7])^2+7158.25*b[39] <= 7258.25)
@constraint(m, e87,  ((-49)+x[4])^2+ ((-81.5)+x[8])^2+7197*b[40] <= 7297.0)
