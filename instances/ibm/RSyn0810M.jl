...
# ----- Constraints ----- #
@constraint(m, e1, x[1]+4*x[2]+8*x[7]+5*x[11]+8*x[23]-23*x[27]-19*x[29]+10*x[30]-2*x[33]-3*x[34]-25*x[35]-24*x[36]+6*b[89]+40*b[90]+46*b[91]+7*b[93]+30*b[94]+37*b[95]+7*b[97]+15*b[98]+22*b[99]+11*b[101]+13*b[102]+24*b[103]+10*b[105]+13*b[106]+23*b[107]+9*b[109]+30*b[110]+39*b[111]+8*b[113]+20*b[114]+28*b[115]+8*b[117]+15*b[118]+23*b[119]-5*x[158]+2*x[163]-200*x[171]-250*x[172]-200*x[173]-200*x[174]-500*x[175]-350*x[176]+5*b[177]+8*b[178]+6*b[179]+10*b[180]+6*b[181]+7*b[182]+4*b[183]+5*b[184]+2*b[185]+4*b[186] == 0.0)
