...
@constraint(m, e56,  ((-17.5)+x[1])^2+ ((-7)+x[5])^2+6814*b[33] <= 6850.0)
@constraint(m, e57,  ((-18.5)+x[2])^2+ ((-7.5)+x[6])^2+6678*b[34] <= 6714.0)
@constraint(m, e58,  ((-16.5)+x[3])^2+ ((-8.5)+x[7])^2+6958*b[35] <= 6994.0)
@constraint(m, e59,  ((-16)+x[4])^2+ ((-8.5)+x[8])^2+7033*b[36] <= 7069.0)
@constraint(m, e60,  ((-52.5)+x[1])^2+ ((-77)+x[5])^2+6556*b[37] <= 6581.0)
@constraint(m, e61,  ((-53.5)+x[2])^2+ ((-77.5)+x[6])^2+6697*b[38] <= 6722.0)
@constraint(m, e62,  ((-51.5)+x[3])^2+ ((-78.5)+x[7])^2+6985*b[39] <= 7010.0)
@constraint(m, e63,  ((-51)+x[4])^2+ ((-78.5)+x[8])^2+6985*b[40] <= 7010.0)
@constraint(m, e64,  ((-32.5)+x[1])^2+ ((-47)+x[5])^2+2025*b[41] <= 2041.0)
@constraint(m, e65,  ((-33.5)+x[2])^2+ ((-47.5)+x[6])^2+2106*b[42] <= 2122.0)
@constraint(m, e66,  ((-31.5)+x[3])^2+ ((-48.5)+x[7])^2+2317*b[43] <= 2333.0)
@constraint(m, e67,  ((-31)+x[4])^2+ ((-48.5)+x[8])^2+2362*b[44] <= 2378.0)
@constraint(m, e68,  ((-17.5)+x[1])^2+ ((-13)+x[5])^2+5950*b[33] <= 5986.0)
@constraint(m, e69,  ((-18.5)+x[2])^2+ ((-12.5)+x[6])^2+5953*b[34] <= 5989.0)
@constraint(m, e70,  ((-16.5)+x[3])^2+ ((-11.5)+x[7])^2+6517*b[35] <= 6553.0)
@constraint(m, e71,  ((-16)+x[4])^2+ ((-11.5)+x[8])^2+6592*b[36] <= 6628.0)
@constraint(m, e72,  ((-52.5)+x[1])^2+ ((-83)+x[5])^2+7432*b[37] <= 7457.0)
@constraint(m, e73,  ((-53.5)+x[2])^2+ ((-82.5)+x[6])^2+7432*b[38] <= 7457.0)
@constraint(m, e74,  ((-51.5)+x[3])^2+ ((-81.5)+x[7])^2+7432*b[39] <= 7457.0)
@constraint(m, e75,  ((-51)+x[4])^2+ ((-81.5)+x[8])^2+7432*b[40] <= 7457.0)
@constraint(m, e76,  ((-32.5)+x[1])^2+ ((-53)+x[5])^2+2541*b[41] <= 2557.0)
@constraint(m, e77,  ((-33.5)+x[2])^2+ ((-52.5)+x[6])^2+2541*b[42] <= 2557.0)
@constraint(m, e78,  ((-31.5)+x[3])^2+ ((-51.5)+x[7])^2+2584*b[43] <= 2600.0)
@constraint(m, e79,  ((-31)+x[4])^2+ ((-51.5)+x[8])^2+2629*b[44] <= 2645.0)
@constraint(m, e80,  ((-12.5)+x[1])^2+ ((-7)+x[5])^2+7189*b[33] <= 7225.0)
@constraint(m, e81,  ((-11.5)+x[2])^2+ ((-7.5)+x[6])^2+7189*b[34] <= 7225.0)
@constraint(m, e82,  ((-13.5)+x[3])^2+ ((-8.5)+x[7])^2+7189*b[35] <= 7225.0)
@constraint(m, e83,  ((-14)+x[4])^2+ ((-8.5)+x[8])^2+7189*b[36] <= 7225.0)
@constraint(m, e84,  ((-47.5)+x[1])^2+ ((-77)+x[5])^2+6171*b[37] <= 6196.0)
@constraint(m, e85,  ((-46.5)+x[2])^2+ ((-77.5)+x[6])^2+6172*b[38] <= 6197.0)
@constraint(m, e86,  ((-48.5)+x[3])^2+ ((-78.5)+x[7])^2+6748*b[39] <= 6773.0)
@constraint(m, e87,  ((-49)+x[4])^2+ ((-78.5)+x[8])^2+6825*b[40] <= 6850.0)
@constraint(m, e88,  ((-27.5)+x[1])^2+ ((-47)+x[5])^2+2209*b[41] <= 2225.0)
@constraint(m, e89,  ((-26.5)+x[2])^2+ ((-47.5)+x[6])^2+2290*b[42] <= 2306.0)
@constraint(m, e90,  ((-28.5)+x[3])^2+ ((-48.5)+x[7])^2+2458*b[43] <= 2474.0)
@constraint(m, e91,  ((-29)+x[4])^2+ ((-48.5)+x[8])^2+2458*b[44] <= 2474.0)
@constraint(m, e92,  ((-12.5)+x[1])^2+ ((-13)+x[5])^2+6325*b[33] <= 6361.0)
@constraint(m, e93,  ((-11.5)+x[2])^2+ ((-12.5)+x[6])^2+6464*b[34] <= 6500.0)
@constraint(m, e94,  ((-13.5)+x[3])^2+ ((-11.5)+x[7])^2+6748*b[35] <= 6784.0)
@constraint(m, e95,  ((-14)+x[4])^2+ ((-11.5)+x[8])^2+6748*b[36] <= 6784.0)
@constraint(m, e96,  ((-47.5)+x[1])^2+ ((-83)+x[5])^2+7047*b[37] <= 7072.0)
@constraint(m, e97,  ((-46.5)+x[2])^2+ ((-82.5)+x[6])^2+6907*b[38] <= 6932.0)
@constraint(m, e98,  ((-48.5)+x[3])^2+ ((-81.5)+x[7])^2+7195*b[39] <= 7220.0)
@constraint(m, e99,  ((-49)+x[4])^2+ ((-81.5)+x[8])^2+7272*b[40] <= 7297.0)
@constraint(m, e100,  ((-27.5)+x[1])^2+ ((-53)+x[5])^2+2725*b[41] <= 2741.0)
@constraint(m, e101,  ((-26.5)+x[2])^2+ ((-52.5)+x[6])^2+2725*b[42] <= 2741.0)
@constraint(m, e102,  ((-28.5)+x[3])^2+ ((-51.5)+x[7])^2+2725*b[43] <= 2741.0)
@constraint(m, e103,  ((-29)+x[4])^2+ ((-51.5)+x[8])^2+2725*b[44] <= 2741.0)
