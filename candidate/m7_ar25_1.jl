function m7_ar25_1(;options=Dict())
	...
	setupperbound(x[58], 5.9161)
	setlowerbound(x[59], 2.0)
	setupperbound(x[59], 5.0)
	setlowerbound(x[60], 2.3664)
	setupperbound(x[60], 5.0)
	setlowerbound(x[61], 2.0)
	setupperbound(x[61], 5.0)
	setlowerbound(x[62], 1.8974)
	setupperbound(x[62], 4.7434)
	setlowerbound(x[64], 1.8974)
	setupperbound(x[64], 4.7434)
	setlowerbound(x[66], 1.5492)
	setupperbound(x[66], 3.873)
	setlowerbound(x[68], 1.5492)
	setupperbound(x[68], 3.873)
	setlowerbound(x[70], 2.0)
	setupperbound(x[70], 5.0)
	setlowerbound(x[72], 2.0)
	setupperbound(x[72], 5.0)
	setlowerbound(x[74], 5.0)
	setupperbound(x[74], 7.9057)
	setlowerbound(x[76], 3.1623)
	setupperbound(x[76], 5.0)
	setlowerbound(x[78], 5.0)
	setupperbound(x[78], 7.9057)
	setlowerbound(x[80], 3.1623)
	...
	@constraint(m, e48, -0.16903*x[58]-0.422579*x[60] <= -2.0)
	@constraint(m, e49, -0.5*x[59]-0.2*x[61] <= -2.0)
	@constraint(m, e50, -0.2*x[59]-0.5*x[61] <= -2.0)
	@constraint(m, e51, -0.527037*x[62]-0.210822*x[64] <= -2.0)
	@constraint(m, e52, -0.210819*x[62]-0.527044*x[64] <= -2.0)
	@constraint(m, e53, -0.645494*x[66]-0.2582*x[68] <= -2.0)
	@constraint(m, e54, -0.258198*x[66]-0.6455*x[68] <= -2.0)
	@constraint(m, e55, -0.5*x[70]-0.2*x[72] <= -2.0)
	@constraint(m, e56, -0.2*x[70]-0.5*x[72] <= -2.0)
	@constraint(m, e57, -0.2*x[74]-0.2*x[76] <= -2.0)
	@constraint(m, e58, -0.126491*x[74]-0.316228*x[76] <= -2.0)
	@constraint(m, e59, -0.2*x[78]-0.2*x[80] <= -2.0)
	@constraint(m, e60, -0.126491*x[78]-0.316228*x[80] <= -2.0)
